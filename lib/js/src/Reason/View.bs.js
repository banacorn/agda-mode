          ...
          return /* SideEffects */Block.variant("SideEffects", 1, [(function (self) {
                        ...
                        if (match !== undefined) {
                          ...
                          var tab = Tab$AgdaMode.make(self[/* state */1][/* editors */5][/* source */1], (function (param) {
                                  ...
                                  ReactDom.render(ReasonReact.element(undefined, undefined, Settings$AgdaMode.make(handles[/* inquireConnection */5], handles[/* navigateSettingsView */10], /* array */[])), element);
...
function make$1(textEditor, handles, _children) {
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                Util$AgdaMode.Msg[/* recv */5](self[/* onUnmount */4], (function (param) {
                        console.log("inquiring at View.re");
                        return /* () */0;
                      }), handles[/* inquireConnection */5]);
                Util$AgdaMode.Msg[/* recv */5](self[/* onUnmount */4], (function (param) {
                        Curry._1(self[/* send */3], /* InquireQuery */Block.variant("InquireQuery", 2, [
                                param[0],
                                param[1]
                              ]));
                ...
                return Util$AgdaMode.Msg[/* recv */5](self[/* onUnmount */4], (function (activate) {
            ...
            (function (self) {
                ...
                return React.createElement(React.Fragment, undefined, ReasonReact.element(undefined, undefined, Panel$AgdaMode.make(editors, element, (function (mountTo) {
                                      ...
                                      return /* () */0;
                                    }), handles[/* activateSettingsView */9], (function (status) {

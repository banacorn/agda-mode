...
function make(handles) {
  ...
  var activateInputMethod = function (activate) {
    return Channel$AgdaMode.send(activate, handles[/* activateInputMethod */15]);
  };
  var interceptAndInsertKey = function (symbol) {
    return Channel$AgdaMode.send(symbol, handles[/* interceptAndInsertKey */16]);
  };
  var onInputMethodChange = handles[/* onInputMethodChange */17];
    ...
    return Async$AgdaMode.passOk((function (param) {
                    return Event$AgdaMode.emitOk(/* () */0, onDestroy);
                        ...
                        return Channel$AgdaMode.send(/* () */0, handles[/* destroy */14]);
                            ...
                            return Channel$AgdaMode.send(false, handles[/* activateInputMethod */15]);

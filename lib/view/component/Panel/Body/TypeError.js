...
function notInScope(error) {
    return React.createElement("section", null,
        ...
        React.createElement("ul", null, error.payloads.map(({ name, suggestions }, i) => React.createElement("li", { key: i },
            React.createElement(Syntax_1.QName, { names: name }),
            React.createElement("ul", null, suggestions.map((name, i) => React.createElement(Syntax_1.QName, { key: i, names: name })))))));
}

...
function handleCommandError(promise, instance) {
  return $$Promise.mapError(promise, (function (error) {
                if (typeof error === "number") {
                  ...
                  var match = Connection2$AgdaMode.$$Error.toString(error[0]);
...
function handleRemoteCommand(instance, handler, remote) {
  if (remote !== undefined) {
    ...
    $$Promise.getOk(Instance__Connections$AgdaMode.get(instance), (function (connection) {
            if (Command$AgdaMode.Remote.isLoad(cmd) && connection[/* resetLogOnLoad */4]) {
    ...
    $$Promise.getOk(Instance__Connections$AgdaMode.get(instance), (function (connection) {
            Curry._1(Connection$AgdaMode.send(inputForAgda, connection)[/* on */3], (function (param) {
                    ...
                    var param$1 = param;
                    if (param$1.tag) {
                      Curry._1(reject$prime, /* ConnectionError */Caml_chrome_debugger.variant("ConnectionError", 1, [/* ConnectionError */Caml_chrome_debugger.variant("ConnectionError", 2, [param$1[0]])]));
                      return /* () */0;
                    } else {
                      var match = param$1[0];
                      if (match) {

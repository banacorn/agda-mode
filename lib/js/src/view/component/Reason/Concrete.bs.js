                ...
                switch (value.tag | 0) {
                  ...
                  case 5 : 
                      ...
                      var items_001 = List.map((function (arg) {
                              var partial_arg = CommonPrim$AgdaMode.Named[/* render */3];
                              return CommonPrim$AgdaMode.Arg[/* render */3]((function (param) {
                                            return partial_arg((function (param) {
                                                          return ReasonReact.element(undefined, undefined, make$2(param[1], param[0], /* array */[]));
                                                        }), param);
                                          }), /* Prec */Block.simpleVariant("Prec", [
                                            0,
                                            arg
                                          ]));
                            }), match[1]);

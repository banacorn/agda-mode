...
(function (BODY) {
    ...
    BODY.UPDATE_RAW = 'BODY.UPDATE_RAW';
...
exports.updateRaw = redux_actions_1.createAction(BODY.UPDATE_RAW);
var EMACS;
(function (EMACS) {
    EMACS.UPDATE = 'EMACS.UPDATE';
    EMACS.update = redux_actions_1.createAction(EMACS.UPDATE);
})(EMACS = exports.EMACS || (exports.EMACS = {}));

...
function fuseIntervals(a, b) {
  var start = a[/* start */0][/* pos */0] > b[/* start */0][/* pos */0] ? b[/* start */0] : a[/* start */0];
  var end_ = a[/* end_ */1][/* pos */0] > b[/* end_ */1][/* pos */0] ? a[/* end_ */1] : b[/* end_ */1];
...
function fuse(a, b) {
  ...
  var fuseSome = function (s1, r1, s2, r2) {
    var r1$prime = Util$AgdaMode.List_[/* dropWhile */3]((function (x) {
            return x[/* end_ */1][/* pos */0] <= s2[/* end_ */1][/* pos */0];
          }), r1);
  ...
  var outputLeftPrefix = function (s1, r1, s2, is2) {
    var match = Util$AgdaMode.List_[/* span */2]((function (s) {
            return s[/* end_ */1][/* pos */0] < s2[/* start */0][/* pos */0];
          }), r1);
    return List.concat(/* :: */Block.simpleVariant("::", [
                  /* :: */Block.simpleVariant("::", [
                      s1,
      ...
      if (match) {
        if (b) {
          if (match$1) {
            ...
            var r1 = a[1];
            var s1 = a[0];
            if (e1[/* end_ */1][/* pos */0] < s2[/* start */0][/* pos */0]) {
            ...
            } else if (s1[/* end_ */1][/* pos */0] < s2[/* start */0][/* pos */0]) {
              return outputLeftPrefix(s1, r1, s2, b);
            } else if (s2[/* end_ */1][/* pos */0] < s1[/* start */0][/* pos */0]) {
              return outputLeftPrefix(s2, r2, s1, a);
            } else if (s1[/* end_ */1][/* pos */0] < s2[/* end_ */1][/* pos */0]) {
...
function make(range, $staropt$star, _) {
  ...
  return /* record */Block.record([
            ...
            (function () {
                if (abbr) {
                  return ReasonReact.element(undefined, undefined, Link$AgdaMode.make(range, true, undefined, /* array */[React.createElement("span", {

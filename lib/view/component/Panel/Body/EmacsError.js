    ...
    render() {
        ...
        switch (error.kind) {
            case 'BadConstructor': return React.createElement("p", { className: "error" },
                React.createElement(Range_1.default, { emitter: emitter, range: error.range }),
            ...
            case 'MultipleDefinition': return React.createElement("p", { className: "error" },
                ...
                React.createElement(Range_1.default, { emitter: emitter, range: error.rangePrev }),
                React.createElement("br", null),
                "when scope checking the declaration",
                React.createElement("br", null),
                React.createElement(Expr_1.default, { emitter: emitter }, error.decl),
            ...
            case 'Termination': return React.createElement("p", { className: "error" },
                ...
                error.calls.map((call, i) => React.createElement("span", { key: i },
                    ...
                    React.createElement("br", null),
                    React.createElement(Range_1.default, { emitter: emitter, range: call.range }))));

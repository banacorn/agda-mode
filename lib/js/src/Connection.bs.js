...
function parseAgdaOutput(parser, stringAgdaSpatOut) {
  var isEndOfResponse = Rebase.$$String[/* endsWith */4]("Agda2> ", stringAgdaSpatOut);
  var trimmed = isEndOfResponse ? stringAgdaSpatOut.substring(0, Rebase.$$String[/* length */1](stringAgdaSpatOut) - 7 | 0) : stringAgdaSpatOut;
  Rebase.$$Array[/* forEach */8](Curry._1(Parser$AgdaMode.SExpression[/* Incr */6][/* feed */1], parser[0]), Parser$AgdaMode.splitAndTrim(trimmed));
  if (isEndOfResponse) {
    return Curry._1(Parser$AgdaMode.SExpression[/* Incr */6][/* finish */2], parser[0]);
  } else {
    return 0;
  }
}
...
function wire(self) {
  var toResponse = function (param) {
    if (typeof param === "number") {
      return /* OnFinish */0;
    } else if (param.tag) {
      return /* OnError */Caml_chrome_debugger.variant("OnError", 1, [param[0]]);
    } else {
      var expr = param[0];
      ...
      if (match.tag) {
        ...
        Metadata$AgdaMode.logResponse(response)(self[/* metadata */0]);
        return /* OnResult */Caml_chrome_debugger.variant("OnResult", 0, [response]);
      }
    }
  };
  var parser = /* record */Caml_chrome_debugger.record(["contents"], [Curry._1(Parser$AgdaMode.SExpression[/* Incr */6][/* make */0], (function (x) {

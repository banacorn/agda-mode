...
exports.toggleSettingsView = redux_actions_1.createAction(VIEW.TOGGLE_SETTINGS_VIEW);
// | CONNECTION.REMOVE_CONNECTION
var CONNECTION;
(function (CONNECTION) {
    CONNECTION.ADD_CONNECTION = 'CONNECTION.ADD_CONNECTION';
    CONNECTION.SHOW_SETUP_VIEW = 'CONNECTION.SHOW_SETUP_VIEW';
    CONNECTION.SET_CURRENT_CONNECTION = 'CONNECTION.SET_CURRENT_CONNECTION';
    // export const REMOVE_CONNECTION = 'CONNECTION.REMOVE_CONNECTION';
    // export type REMOVE_CONNECTION = number;
    CONNECTION.showSetupView = redux_actions_1.createAction(CONNECTION.SHOW_SETUP_VIEW);
    CONNECTION.setCurrentConnection = redux_actions_1.createAction(CONNECTION.SET_CURRENT_CONNECTION);
})(CONNECTION = exports.CONNECTION || (exports.CONNECTION = {}));
exports.connectionAddConnection = redux_actions_1.createAction(CONNECTION.ADD_CONNECTION);
var DEV;
(function (DEV) {

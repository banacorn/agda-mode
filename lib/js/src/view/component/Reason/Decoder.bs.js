...
function termRep(json) {
  return /* record */Block.record([
            "concrete",
            "internal"
          ], [
            Json_decode.field("concrete", expr(/* () */0), json),
            Json_decode.field("internal", term(/* () */0), json)
          ]);
}
  ...
  return Json_decode.andThen((function (kind, json) {
                if (kind === "UnequalTerms") {
                  return /* UnequalTerms */Block.variant("UnequalTerms", 0, [
                            ...
                            Json_decode.field("term1", termRep, json),
                            Json_decode.field("term2", termRep, json),

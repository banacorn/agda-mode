...
function Emacs__AllGoalsWarnings(Props) {
  ...
  return React.createElement(React.Fragment, undefined, Util$AgdaMode.React.manyIn("ul")($$Array.map((function (value) {
                        return React.createElement(Emacs__Component$AgdaMode.Output.make, {
                                    value: value
                                  });
                      }), value.interactionMetas)), Util$AgdaMode.React.manyIn("ul")($$Array.map((function (value) {
                        return React.createElement(Emacs__Component$AgdaMode.Output.make, {
                                    value: value
                                  });
                      }), value.hiddenMetas)), Util$AgdaMode.React.manyIn("ul")($$Array.map((function (value) {
                        return React.createElement(Emacs__Component$AgdaMode.WarningError.make, {
                                    value: value
                                  });
                      }), value.warnings)), Util$AgdaMode.React.manyIn("ul")($$Array.map((function (value) {
                        return React.createElement(Emacs__Component$AgdaMode.WarningError.make, {
                                    value: value
                                  });
                      }), value.errors)));

...
function parse(xs) {
  ...
  if (match !== undefined) {
    ...
    if (match$1.tag) {
      ...
      var match$2 = Belt_Array.get(xs, 0);
  ...
  if (typeof param === "number") {
    ...
    switch (param.tag | 0) {
      case /* HighlightingInfoDirect */0 :
          if (param[0]) {
            return "HighlightingInfoDirect Keep " + Util$AgdaMode.Pretty.array(Belt_Array.map(param[1], Highlighting$AgdaMode.Annotation.toString));
          } else {
            return "HighlightingInfoDirect Remove " + Util$AgdaMode.Pretty.array(Belt_Array.map(param[1], Highlighting$AgdaMode.Annotation.toString));
          }
      ...
      case /* InteractionPoints */4 :
          return "InteractionPoints " + Util$AgdaMode.Pretty.array(Belt_Array.map(param[0], (function (prim) {
                            return String(prim);
                          })));
      case /* GiveAction */5 :
          var match = param[1];
      ...
      case /* SolveAll */7 :
          return "SolveAll " + Util$AgdaMode.Pretty.array(Belt_Array.map(param[0], (function (param) {
        ...
        switch (match$1[0]) {
          ...
          case "agda2-give-action" :
              ...
              if (match$2 !== undefined) {
                ...
                if (match$3.tag) {
                  ...
                  return Belt_Option.mapWithDefault(Belt_Option.flatMap(Parser$AgdaMode.$$int(match$3[0]), (function (i) {
          ...
          case "agda2-goals-action" :
              ...
              if (match$4 !== undefined) {
                return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [/* InteractionPoints */Caml_chrome_debugger.variant("InteractionPoints", 4, [Belt_Array.keepMap(Parser$AgdaMode.SExpression.flatten(match$4), Parser$AgdaMode.$$int)])]);
              } else {
                return /* Error */Caml_chrome_debugger.variant("Error", 1, [/* Response */Caml_chrome_debugger.variant("Response", 1, [
                              5,
                              tokens
          ...
          case "agda2-highlight-add-annotations" :
              ...
              var match$5 = Belt_Array.get(xs, 1);
          ...
          case "agda2-make-case-action" :
              var match$9 = Belt_Array.get(xs, 1);
          ...
          case "agda2-make-case-action-extendlam" :
              var match$10 = Belt_Array.get(xs, 1);
          ...
          case "agda2-maybe-goto" :
              var match$11 = Belt_Array.get(xs, 1);
                  ...
                  if (match$13.length !== 3) {
                    ...
                    if (match$14.tag) {
                      ...
                      if (match$15.tag) {
                        ...
                        return Belt_Option.mapWithDefault(Belt_Option.flatMap(Parser$AgdaMode.$$int(match$15[0]), (function (index) {
          ...
          case "agda2-solveAll-action" :
              var match$16 = Belt_Array.get(xs, 1);
          ...
          case "agda2-status-action" :
              var match$17 = Belt_Array.get(xs, 1);
          ...
          case "agda2-verbose" :
              var match$19 = Belt_Array.get(xs, 1);
        ...
        if (!match$22.tag && match$22[0] === "*Type-checking*") {
          ...
          if (match$23 !== undefined) {
            ...
            if (match$24.tag || match$24[0] !== "t") {
              ...
              var match$25 = Belt_Array.get(xs, 2);

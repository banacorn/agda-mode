  ...
  if (typeof command === "number") {
    switch (command) {
      ...
      case 17 : 
          ...
          var getSymbol = Rebase.$$String[/* isEmpty */5](Rebase.$$String[/* trim */8](selected)) ? (Curry._1(instance[/* view */2][/* updateShouldDisplay */6], true), Curry._1(instance[/* view */2][/* activate */0], /* () */0), Curry._3(instance[/* view */2][/* inquire */7], "Lookup Unicode Symbol Input Sequence", "symbol to lookup:", "")) : Async$AgdaMode.resolve(selected);

...
function make(value, _children) {
  return /* record */Block.record([
            ...
            (function (_self) {
                return ReasonReact.element(undefined, undefined, Component__Link$AgdaMode.make(/* RangeLink */Block.variant("RangeLink", 0, [getRange(value)]), true, true, undefined, /* array */[toString$1(value)]));
              }),
...
function getRange$1(name) {
  var match = name[0];
  if (match) {
    return Type__Location$AgdaMode.$$Range[/* fuse */1](getRange$1(/* QName */Block.simpleVariant("QName", [
                      match[1],
                      match[0]
                    ])), getRange(name[1]));
  } else {
...
function make$1(value, _children) {
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",
            ...
            (function (_self) {
                var xs = value[0];
                if (xs) {
                  return Util$AgdaMode.React[/* sepBy */0](".", List.map((function (n) {
...
function make$2(value, _children) {
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",

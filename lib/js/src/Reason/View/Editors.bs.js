...
function focusSource(editors) {
  var match = editors[/* focused */0];
  if (match) {
    var element = atom.views.getView(editors[/* query */2]);
    element.focus();
    return /* () */0;
  } else {
    return /* () */0;
...
exports.focusSource = focusSource;
exports.focusQuery = focusQuery;

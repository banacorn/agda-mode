  ...
  return Rebase.$$Array[/* forEach */8]((function (command) {
                subscriptions.add(atom.commands.add("atom-text-editor", "agda-mode:" + command, (function (_event) {
                            return Rebase.Option[/* forEach */8]((function (instance) {
                                          ...
                                          return Promise$AgdaMode.thenDrop((function (param) {
                                                        return partial_arg((function (raw) {
                                                                      return Rebase.$$Array[/* forEach */8]((function (tokens) {
                                                                                    return Rebase.Result[/* forEach */9]((function (res) {
                                                                                                  return Response$AgdaMode.handle(instance, res);
                                                                                                }), Rebase.Result[/* flatMap */6](Response$AgdaMode.parse, tokens));
                                                                                  }), Emacs__Parser$AgdaMode.SExpression[/* parseFile */5](raw));
                                                                    }), param);
                                                      }), Instance$AgdaMode.dispatch(Command$AgdaMode.Primitive[/* parse */0](command), instance));

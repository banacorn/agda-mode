  ...
  if (typeof command === "number") {
    switch (command) {
      ...
      case /* ToggleDocking */11 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* WithInstance */Caml_chrome_debugger.variant("WithInstance", 0, [(function (instance) {
                            return $$Promise.map(Curry._1(instance.view.toggleDocking, /* () */0), (function (param) {
      ...
      case /* QuerySymbol */17 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* WithInstance */Caml_chrome_debugger.variant("WithInstance", 0, [(function (instance) {
                            var selected = Editors$AgdaMode.getSelectedSymbol(instance.editors);
                            var getSymbol = Rebase.$$String.isEmpty(Rebase.$$String.trim(selected)) ? $$Promise.flatMap(Curry._1(instance.view.activate, /* () */0), (function (param) {
                            ...
                            $$Promise.getOk(getSymbol, (function (symbol) {
                                    return Rebase.$$Option.forEach((function (sequences) {
                                                  Curry._3(instance.view.display, "Input sequence for " + symbol, /* PlainText */0, /* Emacs */Caml_chrome_debugger.simpleVariant("Emacs", [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [Rebase.$$String.joinWith("\n", Rebase.List.fromArray(sequences))])]));
                                                  return /* () */0;
                    ...
                    /* WithInstance */Caml_chrome_debugger.variant("WithInstance", 0, [(function (instance) {
                            if (instance.isLoaded) {
                              return $$Promise.flatMap(Instance__TextEditors$AgdaMode.restoreCursorPosition((function (param) {
                                                return $$Promise.resolved(Editors$AgdaMode.getSelectedTextNode(instance.editors));
                      ...
                      /* WithInstance */Caml_chrome_debugger.variant("WithInstance", 0, [(function (instance) {
                              ...
                              if (match[0]) {
                                if (otherFilePath !== undefined) {
                                  var match$2;
                                  if (range) {
                                    var match$3 = Rebase.$$Array.get(range[1], 0);
                                  ...
                                  var option = {
                                    initialLine: match$2[0],
                                    initialColumn: match$2[1],
                                    split: "right",
                                    activatePane: true,
                                    activateItem: true,
                                    pending: false,

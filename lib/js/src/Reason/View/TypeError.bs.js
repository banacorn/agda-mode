  ...
  return /* record */Block.record([
            ...
            (function () {
                ...
                switch (typeError.tag | 0) {
                  ...
                  case 12 : 
                      return React.createElement("div", undefined, "Ambiguous name ", ReasonReact.element(undefined, undefined, Name$AgdaMode.QName[/* make */5](typeError[0], /* array */[])), ".", React.createElement("br", undefined), "It could refer to any one of ", React.createElement("br", undefined), ReactDOMRe.createElementVariadic("ul", undefined, $$Array.of_list(List.map((function (value) {

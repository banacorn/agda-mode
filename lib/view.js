...
require("./view/panel-body"); // for component registration
require("./view/input-method"); // for component registration
require("./view/input-editor"); // for component registration

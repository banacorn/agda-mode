...
const mapDispatchToProps = (dispatch) => ({
    deactivateMiniEditor: () => {
        dispatch(actions_1.MINI_EDITOR.deactivate());
    },
    onResize: (offset) => {
    ...
    render() {
        ...
        return (React.createElement("section", { className: hideEverything },
            React.createElement("section", { className: "panel-heading agda-header-container" },
                ...
                React.createElement(Header_1.default, { toggleSettingsView: toggleSettingsView, mountAtPane: mountAtPane, mountAtBottom: mountAtBottom })),

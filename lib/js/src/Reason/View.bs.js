...
function make(param) {
  ...
  var inquireConnection = /* record */Block.record(["contents"], [(function (param) {
  ...
  var activateSettingsView = Util$AgdaMode.Handle[/* make */0](/* () */0);
  var navigateSettingsView = /* record */Block.record(["contents"], [(function (param) {
          return /* () */0;
        })]);
...
function mountPanel(self, mountTo) {
  ...
  if (match.tag) {
    if (mountTo) {
      ...
      return Curry._1(self[/* send */3], /* UpdateMountAt */Block.variant("UpdateMountAt", 7, [/* Bottom */Block.variant("Bottom", 0, [createElement(/* () */0)])]));
    }
  } else if (mountTo) {
    return Curry._1(self[/* send */3], /* UpdateMountAt */Block.variant("UpdateMountAt", 7, [/* Pane */Block.variant("Pane", 1, [createTab(/* () */0)])]));
  } else {
    return /* () */0;
  }
}
  ...
  if (typeof action === "number") {
    ...
    switch (action.tag | 0) {
      ...
      case 1 : 
          ...
          var init$2 = state[/* editors */5][/* connection */3];
          return /* Update */Block.variant("Update", 0, [/* record */Block.record([
                        "header",
                        "body",
                        "mountAt",
      ...
      case 3 : 
          var init$5 = state[/* editors */5];
          var init$6 = state[/* editors */5][/* connection */3];
          return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                    /* record */Block.record([
                        "header",
                        "body",
                        ...
                        Block.record([
                            ...
                            Block.record([
                                ...
                                action[0],
                                init$6[/* placeholder */1],
                                init$6[/* ref */2],
                                init$6[/* telePromise */3]
                              ])
                          ]),
                        state[/* mode */6]
                      ]),
      ...
      case 4 : 
          var init$7 = state[/* editors */5];
          var init$8 = state[/* editors */5][/* query */2];
          return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                    /* record */Block.record([
                        "header",
                        "body",
          ...
          return /* SideEffects */Block.variant("SideEffects", 1, [(function (self) {
                        ...
                        if (match !== undefined) {
                          if (open_) {
                            ...
                            return Curry._1(self[/* send */3], /* UpdateSettingsView */Block.variant("UpdateSettingsView", 6, [undefined]));
                          }
                        } else if (open_) {
                          var tab = Tab$AgdaMode.make(self[/* state */1][/* editors */5][/* source */1], (function (param) {
                                  ...
                                  var partial_arg = handles[/* navigateSettingsView */10];
                                  ReactDom.render(ReasonReact.element(undefined, undefined, Settings$AgdaMode.make(self[/* state */1][/* editors */5], (function (ref) {
                                                  return Curry._1(self[/* send */3], /* SetConnectionRef */Block.variant("SetConnectionRef", 1, [ref]));
                                                }), (function (param) {
                                                  partial_arg[0] = param;
                                                  return /* () */0;
                                                }), /* array */[])), element);
                                  return Util$AgdaMode.Handle[/* resolve */1](/* () */0, handles[/* activateSettingsView */9]);
                                }), undefined, (function (param) {
                                  Curry._1(self[/* send */3], /* ToggleSettingsTab */Block.variant("ToggleSettingsTab", 5, [false]));
                                  Util$AgdaMode.Handle[/* trigger */3](false, handles[/* activateSettingsView */9]);
                                  return /* () */0;
                                }), undefined, /* () */0);
                          return Curry._1(self[/* send */3], /* UpdateSettingsView */Block.variant("UpdateSettingsView", 6, [tab]));
                        } else {
                          return 0;
                        }
                      })]);
  ...
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                handles[/* updateMode */2][0] = (function (mode) {
                    return Curry._1(self[/* send */3], /* UpdateMode */Block.variant("UpdateMode", 11, [mode]));
                  });
                ...
                handles[/* updateHeader */0][0] = (function (header) {
                    return Curry._1(self[/* send */3], /* UpdateHeader */Block.variant("UpdateHeader", 9, [header]));
                  });
                handles[/* updateRawBody */1][0] = (function (rawBody) {
                    return Curry._1(self[/* send */3], /* UpdateRawBody */Block.variant("UpdateRawBody", 10, [rawBody]));
                  });
                handles[/* inquireConnection */5][0] = (function (value) {
                    Curry._1(self[/* send */3], /* InquireConnection */Block.variant("InquireConnection", 3, [value]));
                    var promise = Util$AgdaMode.TelePromise[/* make */2](/* () */0);
                    Curry._2(self[/* handle */0], (function (param, newSelf) {
                            Editors$AgdaMode.Connection[/* inquire */0](newSelf[/* state */1][/* editors */5]).then((function (answer) {
                ...
                handles[/* inquireQuery */6][0] = (function (placeholder, value) {
                    Curry._1(self[/* send */3], /* InquireQuery */Block.variant("InquireQuery", 4, [
                            placeholder,
                            value
                          ]));
                    var promise = Util$AgdaMode.TelePromise[/* make */2](/* () */0);
                    Curry._2(self[/* handle */0], (function (param, newSelf) {
                            Editors$AgdaMode.Query[/* inquire */0](newSelf[/* state */1][/* editors */5]).then((function (answer) {
                                      return Promise.resolve(Curry._1(promise[/* resolve */1], answer));
                                    })).catch((function (error) {
                                    return Promise.resolve(Curry._1(promise[/* reject */2], [
                                                    Util$AgdaMode.JSPromiseError,
                ...
                handles[/* destroy */11][0] = (function (param) {
                    console.log("destroy!");
                    return /* () */0;
                  });
                return Util$AgdaMode.Handle[/* onTrigger */4]((function (activate) {
                              return Curry._1(self[/* send */3], /* ToggleSettingsTab */Block.variant("ToggleSettingsTab", 5, [activate]));
            ...
            (function (self) {
                ...
                var partial_arg = handles[/* interceptAndInsertKey */7];
                var partial_arg$1 = handles[/* activateInputMethod */8];
                return React.createElement(React.Fragment, undefined, ReasonReact.element(undefined, undefined, Panel$AgdaMode.make(editors, element, (function (mountTo) {
                                      ...
                                      Editors$AgdaMode.Query[/* answer */1](result, editors);
                                      Curry._1(handles[/* activateInputMethod */8][0], false);
                                      Curry._1(self[/* send */3], /* Focus */Block.variant("Focus", 0, [/* Source */0]));
                                      return Curry._1(self[/* send */3], /* UpdateMode */Block.variant("UpdateMode", 11, [/* Display */0]));
                                    }), (function (focused) {
                                      return Curry._1(self[/* send */3], focused ? /* Focus */Block.variant("Focus", 0, [/* Query */1]) : /* Focus */Block.variant("Focus", 0, [/* Source */0]));
                                    }), (function () {
                                      Editors$AgdaMode.Query[/* reject */2](Editors$AgdaMode.QueryCancelled, editors);
                                      Curry._1(handles[/* activateInputMethod */8][0], false);
                                      Curry._1(self[/* send */3], /* Focus */Block.variant("Focus", 0, [/* Source */0]));
                                      return Curry._1(self[/* send */3], /* UpdateMode */Block.variant("UpdateMode", 11, [/* Display */0]));
                                    }), (function (ref) {
                                      return Curry._1(self[/* send */3], /* SetQueryRef */Block.variant("SetQueryRef", 2, [ref]));
                                      ...
                                      return Util$AgdaMode.Handle[/* onTrigger */4](__x, handles[/* activateSettingsView */9]);
                                    }), (function (status) {
                                      return Curry._1(self[/* send */3], /* ToggleSettingsTab */Block.variant("ToggleSettingsTab", 5, [status]));
                                    }), /* array */[])));
              }),
            (function (param) {

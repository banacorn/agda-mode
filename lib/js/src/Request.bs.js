  ...
  if (typeof request === "number") {
    ...
    switch (request.tag | 0) {
      ...
      case /* InferType */3 :
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_infer " + (String(normalization$prime$1) + (" " + (String(request[2]) + (" noRange \"" + (String(content$3) + "\" )"))))));
      ...
      case /* ModuleContents */5 :
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_show_module_contents " + (String(normalization$prime$3) + (" " + (String(request[2]) + (" noRange \"" + (String(content$5) + "\" )"))))));
      ...
      case /* ComputeNormalForm */7 :
          ...
          if (Util$AgdaMode.Version.gte(version, "2.5.2")) {
            return commonPart(/* NonInteractive */1) + ("( Cmd_compute " + (String(computeMode$prime) + (" " + (String(index$1) + (" noRange \"" + (String(content$7) + "\" )"))))));
          } else {
            return commonPart(/* NonInteractive */1) + ("( Cmd_compute " + (String(ignoreAbstract) + (" " + (String(index$1) + (" noRange \"" + (String(content$7) + "\" )"))))));
          }
      ...
      case /* Give */9 :
          var goal = request[0];
          var index$2 = goal[/* index */1];
          var content$9 = Goal$AgdaMode.getContent(goal);
          var range = buildRange(goal);
          if (Util$AgdaMode.Version.gte(version, "2.5.3")) {
            return commonPart(/* NonInteractive */1) + ("( Cmd_give WithoutForce " + (String(index$2) + (" " + (String(range) + (" \"" + (String(content$9) + "\" )"))))));
          } else {
            return commonPart(/* NonInteractive */1) + ("( Cmd_give " + (String(index$2) + (" " + (String(range) + (" \"" + (String(content$9) + "\" )"))))));
          }
      case /* Refine */10 :
          var goal$1 = request[0];
          var index$3 = goal$1[/* index */1];
          var content$10 = Goal$AgdaMode.getContent(goal$1);
          var range$1 = buildRange(goal$1);
          return commonPart(/* NonInteractive */1) + ("( Cmd_refine_or_intro False " + (String(index$3) + (" " + (String(range$1) + (" \"" + (String(content$10) + "\" )"))))));
      case /* Auto */11 :
          var goal$2 = request[0];
          var index$4 = goal$2[/* index */1];
          var content$11 = Goal$AgdaMode.getContent(goal$2);
          var range$2 = buildRange(goal$2);
          if (Util$AgdaMode.Version.gte(version, "2.6.0.1")) {
            return commonPart(/* NonInteractive */1) + ("( Cmd_autoOne " + (String(index$4) + (" " + (String(range$2) + (" \"" + (String(content$11) + "\" )"))))));
          } else {
            return commonPart(/* NonInteractive */1) + ("( Cmd_auto " + (String(index$4) + (" " + (String(range$2) + (" \"" + (String(content$11) + "\" )"))))));
          }
      case /* Case */12 :
          var goal$3 = request[0];
          var index$5 = goal$3[/* index */1];
          var content$12 = Goal$AgdaMode.getContent(goal$3);
          var range$3 = buildRange(goal$3);
          return commonPart(/* NonInteractive */1) + ("( Cmd_make_case " + (String(index$5) + (" " + (String(range$3) + (" \"" + (String(content$12) + "\" )"))))));
      case /* GoalType */13 :
          var normalization$prime$5 = Command$AgdaMode.Normalization.toString(request[0]);
          return commonPart(/* NonInteractive */1) + ("( Cmd_goal_type " + (String(normalization$prime$5) + (" " + (String(request[1]) + " noRange \"\" )"))));
      case /* Context */14 :
          var normalization$prime$6 = Command$AgdaMode.Normalization.toString(request[0]);
          return commonPart(/* NonInteractive */1) + ("( Cmd_context " + (String(normalization$prime$6) + (" " + (String(request[1]) + " noRange \"\" )"))));
      case /* GoalTypeAndContext */15 :
          var normalization$prime$7 = Command$AgdaMode.Normalization.toString(request[0]);
          return commonPart(/* NonInteractive */1) + ("( Cmd_goal_type_context " + (String(normalization$prime$7) + (" " + (String(request[1]) + " noRange \"\" )"))));
      case /* GoalTypeAndInferredType */16 :
          var goal$4 = request[1];
          var index$6 = goal$4[/* index */1];
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_goal_type_context_infer " + (String(normalization$prime$8) + (" " + (String(index$6) + (" noRange \"" + (String(content$13) + "\" )"))))));
      case /* GotoDefinition */17 :
          var content$14 = Parser$AgdaMode.userInput(request[0]);
          return commonPart(/* NonInteractive */1) + ("( Cmd_why_in_scope " + (String(request[1]) + (" noRange \"" + (String(content$14) + "\" )"))));
...
function toString(param) {
  if (typeof param === "number") {
    ...
    switch (param.tag | 0) {
      case /* WhyInScope */0 :
          return "WhyInScope \"" + (param[0] + ("\" (Goal " + (String(param[1][/* index */1]) + ")")));
      case /* WhyInScopeGlobal */1 :
          return "WhyInScope \"" + (param[0] + "\" (Global)");
      case /* SearchAbout */2 :
          return "SearchAbout \"" + (param[1] + ("\" (" + (Command$AgdaMode.Normalization.toString(param[0]) + ")")));
      case /* InferType */3 :
          return "InferType \"" + (param[1] + ("\" (Goal " + (String(param[2][/* index */1]) + (", " + (Command$AgdaMode.Normalization.toString(param[0]) + ")")))));
      case /* InferTypeGlobal */4 :
          return "InferType \"" + (param[1] + ("\" (Global, " + (Command$AgdaMode.Normalization.toString(param[0]) + ")")));
      case /* ModuleContents */5 :
          return "ModuleContents \"" + (param[1] + ("\" (Goal " + (String(param[2][/* index */1]) + (", " + (Command$AgdaMode.Normalization.toString(param[0]) + ")")))));
      case /* ModuleContentsGlobal */6 :
          return "ModuleContents \"" + (param[1] + ("\" (Global, " + (Command$AgdaMode.Normalization.toString(param[0]) + ")")));
      case /* ComputeNormalForm */7 :
          return "ComputeNormalForm \"" + (param[1] + ("\" (Goal " + (String(param[2][/* index */1]) + (", " + (Command$AgdaMode.ComputeMode.toString(param[0]) + ")")))));
      case /* ComputeNormalFormGlobal */8 :
          return "ComputeNormalForm \"" + (param[1] + ("\" (Global, " + (Command$AgdaMode.ComputeMode.toString(param[0]) + ")")));
      case /* Give */9 :
          return "Give (Goal " + (String(param[0][/* index */1]) + ")");
      case /* Refine */10 :
          return "Refine (Goal " + (String(param[0][/* index */1]) + ")");
      case /* Auto */11 :
          return "Auto (Goal " + (String(param[0][/* index */1]) + ")");
      case /* Case */12 :
          return "Case (Goal " + (String(param[0][/* index */1]) + ")");
      case /* GoalType */13 :
          return "GoalType (Goal " + (String(param[1][/* index */1]) + (", " + (Command$AgdaMode.Normalization.toString(param[0]) + ")")));
      case /* Context */14 :
          return "Context (Goal " + (String(param[1][/* index */1]) + (", " + (Command$AgdaMode.Normalization.toString(param[0]) + ")")));
      case /* GoalTypeAndContext */15 :
          return "GoalTypeAndContext (Goal " + (String(param[1][/* index */1]) + (", " + (Command$AgdaMode.Normalization.toString(param[0]) + ")")));
      case /* GoalTypeAndInferredType */16 :
          return "GoalTypeAndInferredType (Goal " + (String(param[1][/* index */1]) + (", " + (Command$AgdaMode.Normalization.toString(param[0]) + ")")));
      case /* GotoDefinition */17 :
          return "GotoDefinition \"" + (param[0] + ("\" (Goal " + (String(param[1][/* index */1]) + ")")));
      case /* GotoDefinitionGlobal */18 :

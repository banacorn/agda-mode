...
function connectWithAgdaPath(instance, path) {
  ...
  var getConnection = function (instance, metadata) {
    return $$Promise.flatMapError(Connection$AgdaMode.connect(metadata), (function (err) {
                  return $$Promise.flatMapOk($$Promise.flatMapOk(inquireAgdaPath(err, instance), (function (param) {
                                    return getMetadata(instance, param);
                                  })), (function (param) {
  ...
  return $$Promise.mapOk($$Promise.mapOk($$Promise.mapOk($$Promise.flatMapOk(getMetadata(instance, path), (function (param) {
                            return getConnection(instance, param);
                          })), (function (param) {

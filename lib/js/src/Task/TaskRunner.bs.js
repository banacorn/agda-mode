  ...
  var executeTask = function (task) {
    if (typeof task === "number") {
      ...
      switch (task.tag | 0) {
        ...
        case /* Inquire */3 :
            return handleCallback($$Promise.mapOk($$Promise.mapError(Curry._3(instance[/* view */2][/* inquire */4], task[0], task[1], task[2]), (function (param) {
                                  return /* Cancelled */0;
                                })), task[3]));
        case /* Editor */4 :
            return handleCallback($$Promise.mapOk($$Promise.mapError($$Promise.Js.toResult($$Promise.Js.fromBsPromise(instance[/* editors */1][/* source */1].save())), (function (param) {
                                  return /* Cancelled */0;
                                })), (function (param) {
                              return /* [] */0;
                            })));

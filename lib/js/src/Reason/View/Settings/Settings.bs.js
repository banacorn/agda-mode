...
function make(inquireConnection, onInquireConnection, connection, navigate, element, _children) {
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",
                                      ...
                                      className: "agda-settings-pages"
                                          ...
                                          className: at(/* Root */0, uri, /* :: */Block.simpleVariant("::", [
                                              ...
                                              onClick: (function (param) {
                                                ...
                                                }, "Protocol"))), ReasonReact.element(undefined, undefined, Settings__Connection$AgdaMode.make(inquireConnection, onInquireConnection, connection, uri !== /* Connection */1, /* array */[])))), Caml_option.valFromOption(element));
                } else {
                  return null;
                }
              }),

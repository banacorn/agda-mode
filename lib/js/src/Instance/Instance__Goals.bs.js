...
function destroyAll(instance) {
  Rebase.$$Array[/* forEach */8](Goal$AgdaMode.destroy, instance[/* goals */6]);
  instance[/* goals */6] = /* array */[];
  return /* () */0;
}
...
function getPreviousGoalPosition(instance) {
  ...
  Rebase.$$Array[/* forEach */8]((function (position) {
          if (position.isLessThan(cursor) && previousGoal[0] === undefined) {
...
function instantiateAll(indices, instance) {
  ...
  instance[/* goals */6] = Rebase.$$Array[/* map */0]((function (result) {

                ...
                if (value.tag) {
                  return React.createElement("li", {
                              className: "warning-error"
                                ...
                                }, "error"), ReactDOMRe.createElementVariadic("span", undefined, Rebase.$$Array[/* map */0]((function (token) {
                                        if (token.tag) {
                  ...
                  return React.createElement("li", {
                              className: "warning-error"
                                ...
                                }, "warning"), ReactDOMRe.createElementVariadic("span", undefined, Rebase.$$Array[/* map */0]((function (token) {
                                        if (token.tag) {
                                          return ReasonReact.element(undefined, undefined, Syntax__Range$AgdaMode.make(token[0], undefined, /* array */[]));
                                        } else {
                                          return token[0];

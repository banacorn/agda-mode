...
function mapStateToProps(state) {
    return Object.assign({ headerText: state.header.text, style: state.header.style, inputMethodActivated: state.inputMethod.activated, mountAt: state.view.mountAt, settingsView: state.view.settingsView, pending: state.protocol.pending, inputMethod: state.inputMethod }, state);
}

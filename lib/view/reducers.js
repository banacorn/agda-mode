...
var inputEditor = redux_actions_1.handleActions((_d = {},
    _d[actions_1.INPUT_EDITOR.ACTIVATE] = function (state, action) { return _.assign({}, state, {
        activated: true,
        placeholder: action.payload
    }); },
    _d[actions_1.INPUT_EDITOR.DEACTIVATE] = function (state, action) { return _.assign({}, state, {
        activated: false
    }); },
    _d

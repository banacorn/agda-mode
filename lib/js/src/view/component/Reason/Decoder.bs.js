...
function qName(param) {
  return Json_decode.andThen((function (names, _) {
...
function qName$1(json) {
  return /* QName */Block.simpleVariant("QName", [
            Json_decode.field("module", (function (param) {
                    return Json_decode.list(name$1, param);
                  }), json),
  ...
  return (function (param) {
      return Json_decode.andThen((function (kind, json) {
                    switch (kind) {
                      ...
                      case "Lam" : 
                          var partial_arg$3 = lamBinding(/* () */0);
                      ...
                      case "OpApp" : 
                          ...
                          return /* OpApp */Block.variant("OpApp", 6, [
                                    ...
                                    Json_decode.field("names", (function (param) {
                                            return Json_decode.array(name$1, param);
                                          }), json),
                                    Json_decode.field("args", (function (param) {
                      ...
                      case "Rec" : 
                          var partial_arg$8 = recordAssignment(/* () */0);
                    ...
                    switch (kind) {
                      ...
                      case "SectionApp" : 
                          return /* SectionApp */Block.variant("SectionApp", 0, [
                                    Json_decode.field("range", range, json),
                                    Json_decode.field("bindings", (function (param) {
                                            return Json_decode.list(typedBindings, param);
                                          }), json),
                                    Json_decode.field("expr", expr(/* () */0), json)
                                  ]);
                      default:
                    ...
                    switch (kind) {
                      ...
                      case "ModuleMacro" : 
                          return /* ModuleMacro */Block.variant("ModuleMacro", 20, [
                                    Json_decode.field("range", range, json),
                                    Json_decode.field("name", name, json),
                                    Json_decode.field("moduleApplication", moduleApplication(/* () */0), json),
                                    Json_decode.field("openShortHand", openShortHand, json),
                                    Json_decode.field("importDirective", importDirective, json)
                                  ]);
                      case "Mutual" : 
                      ...
                      case "Primitive" : 
                          ...
                          return /* Primitive */Block.variant("Primitive", 17, [
                                    Json_decode.field("range", range, json),
                                    Json_decode.field("typeSigs", (function (param) {
...
function elim() {
  return (function (param) {
      return Json_decode.andThen((function (kind, json) {
                    switch (kind) {
                      case "Apply" : 
                          var partial_arg = term(/* () */0);
                          return /* Apply */Block.variant("Apply", 0, [Json_decode.field("arg", (function (param) {
                                            return arg(partial_arg, param);
                                          }), json)]);
                      case "IApply" : 
                          return /* IApply */Block.variant("IApply", 2, [
                                    Json_decode.field("endpoint1", term(/* () */0), json),
                                    Json_decode.field("endpoint2", term(/* () */0), json),
                                    Json_decode.field("endpoint3", term(/* () */0), json)
                                  ]);
                      case "Proj" : 
  ...
  return (function (param) {
      return Json_decode.andThen((function (kind, json) {
                    switch (kind) {
                      ...
                      case "StuckOn" : 
                          return /* StuckOn */Block.simpleVariant("StuckOn", [Json_decode.field("elim", elim(/* () */0), json)]);
                      case "Underapplied" : 
...
function type_(json) {
  return /* record */Block.record([
            ...
            Json_decode.field("sort", sort(/* () */0), json),
            Json_decode.field("value", term(/* () */0), json)
          ]);
}
...
function rep(decodeFrom, decodeTo, json) {
  return /* record */Block.record([
            "internal",
            "concrete"
          ], [
            Json_decode.field("internal", decodeFrom, json),
            Json_decode.field("concrete", decodeTo, json)
          ]);
}

var partial_arg = expr(/* () */0);

var partial_arg$1 = term(/* () */0);

function repTerm(param) {
  return rep(partial_arg$1, partial_arg, param);
}

var partial_arg$2 = expr(/* () */0);

function repType(param) {
  return rep(type_, partial_arg$2, param);
}
                ...
                switch (kind) {
                  ...
                  case "CheckSectionApplication" : 
                      return /* CheckSectionApplication */Block.variant("CheckSectionApplication", 22, [
                                ...
                                Json_decode.field("modApp", moduleApplication(/* () */0), json)
                              ]);
                  case "CheckTargetType" : 
                      return /* CheckTargetType */Block.variant("CheckTargetType", 13, [
                                Json_decode.field("range", range, json),
                                Json_decode.field("infType", repType, json),
                                Json_decode.field("expType", repType, json)
                              ]);
  ...
  return Json_decode.andThen((function (kind, json) {
                switch (kind) {
                  case "ClashingDefinition" : 
                      return /* ClashingDefinition */Block.variant("ClashingDefinition", 6, [
                                Json_decode.field("definition", qName, json),
                                Json_decode.field("previouslyAt", range, json)
                              ]);
                  case "GenericError" : 
                      return /* GenericError */Block.variant("GenericError", 0, [Json_decode.field("message", Json_decode.string, json)]);
                  case "NoRHSRequiresAbsurdPattern" : 
                      var partial_arg = pattern(/* () */0);
                      return /* NoRHSRequiresAbsurdPattern */Block.variant("NoRHSRequiresAbsurdPattern", 7, [Json_decode.field("patterns", (function (param) {
                                        return Json_decode.list(partial_arg, param);
                                      }), json)]);
                  case "NotInScope" : 
                      return /* NotInScope */Block.variant("NotInScope", 8, [Json_decode.field("names", (function (param) {
                  ...
                  case "ShadowedModule" : 
                      return /* ShadowedModule */Block.variant("ShadowedModule", 2, [
                  ...
                  case "ShouldBeASort" : 
                      return /* ShouldBeASort */Block.variant("ShouldBeASort", 4, [Json_decode.field("type", repType, json)]);
                  case "ShouldBePi" : 
                      return /* ShouldBePi */Block.variant("ShouldBePi", 3, [Json_decode.field("type", repType, json)]);
                  case "ShouldEndInApplicationOfTheDatatype" : 
                      return /* ShouldEndInApplicationOfTheDatatype */Block.variant("ShouldEndInApplicationOfTheDatatype", 1, [Json_decode.field("type", repType, json)]);
                  case "UnequalTerms" : 
                      return /* UnequalTerms */Block.variant("UnequalTerms", 5, [
                                Json_decode.field("comparison", comparison, json),
                                Json_decode.field("term1", repTerm, json),
                                Json_decode.field("term2", repTerm, json),
                                Json_decode.field("type", repType, json),
                                Json_decode.field("reason", Json_decode.string, json)
                              ]);
                  default:
                    return /* UnregisteredTypeError */Block.variant("UnregisteredTypeError", 9, [json]);
                }
              }), (function (param) {
                return Json_decode.field("kind", Json_decode.string, param);
              }), param);
                ...
                switch (kind) {
                  ...
                  case "TypeError" : 
                      return /* TypeError */Block.variant("TypeError", 0, [
                                Json_decode.field("range", range, json),
                                Json_decode.field("call", call, json),
...
function where(param) {
  return Json_decode.andThen((function (kind, json) {
                switch (kind) {
                  case "ConArgType" : 
                      return /* ConArgType */Block.variant("ConArgType", 1, [Json_decode.field("name", qName, json)]);
                  case "DefArg" : 
                  ...
                  case "InDefOf" : 
                      return /* InDefOf */Block.variant("InDefOf", 4, [Json_decode.field("name", qName, json)]);
                  case "IndArgType" : 
                      return /* IndArgType */Block.variant("IndArgType", 2, [Json_decode.field("name", qName, json)]);
                  case "LeftOfArrow" : 
...
function candidate(json) {
  return /* record */Block.record([
            ...
            Json_decode.field("term", repTerm, json),
            Json_decode.field("type", repType, json),
      ...
      return Json_decode.andThen((function (kind, json) {
                    switch (kind) {
                      case "CheckFunDef" : 
                          ...
                          return /* CheckFunDef */Block.variant("CheckFunDef", 14, [
                                    Json_decode.field("name", qName, json),
                                    Json_decode.field("declarations", (function (param) {
                                            return Json_decode.list(partial_arg$1, param);
                                          }), json)
                      ...
                      case "CheckSizeLtSat" : 
                          return /* CheckSizeLtSat */Block.variant("CheckSizeLtSat", 12, [Json_decode.field("term", repTerm, json)]);
                      case "ElimCmp" : 
                          var partial_arg$2 = elim(/* () */0);
                          var partial_arg$3 = elim(/* () */0);
                      ...
                      case "FindInScope" : 
                          return /* FindInScope */Block.variant("FindInScope", 13, [
                      ...
                      case "Guarded" : 
                          return /* Guarded */Block.variant("Guarded", 10, [
                                    Json_decode.field("constraint", constraint_(/* () */0), json),
                                    Json_decode.field("problemId", Json_decode.$$int, json)
                                  ]);
                      case "HasBiggerSort" : 
                          return /* HasBiggerSort */Block.variant("HasBiggerSort", 7, [Json_decode.field("sort", sort(/* () */0), json)]);
                      case "HasPTSRule" : 
                          return /* HasPTSRule */Block.variant("HasPTSRule", 8, [
                                    Json_decode.field("sort", sort(/* () */0), json),
                                    Json_decode.field("binding", abs(sort(/* () */0)), json)
                                  ]);
                      case "IsEmpty" : 
                          return /* IsEmpty */Block.variant("IsEmpty", 11, [
                                    Json_decode.field("range", range, json),
                                    Json_decode.field("type", repType, json)
                                  ]);
                      case "LevelCmp" : 
                          return /* LevelCmp */Block.variant("LevelCmp", 6, [
                                    Json_decode.field("comparison", comparison, json),
                                    Json_decode.field("level1", level, json),
                                    Json_decode.field("level2", level, json)
                                  ]);
                      case "SortCmp" : 
                          return /* SortCmp */Block.variant("SortCmp", 5, [
                                    Json_decode.field("comparison", comparison, json),
                                    Json_decode.field("sort1", sort(/* () */0), json),
                                    Json_decode.field("sort2", sort(/* () */0), json)
                                  ]);
                      case "TelCmp" : 
                          return /* TelCmp */Block.variant("TelCmp", 4, [
                                    Json_decode.field("comparison", comparison, json),
                                    Json_decode.field("type1", repType, json),
                                    Json_decode.field("type2", repType, json),
                                    Json_decode.field("telescope1", (function (param) {
                                            return Json_decode.list(typedBindings, param);
                                          }), json),
                                    Json_decode.field("telescope2", (function (param) {
                                            return Json_decode.list(typedBindings, param);
                                          }), json)
                                  ]);
                      case "TypeCmp" : 
                      ...
                      case "UnBlock" : 
                          return /* UnBlock */Block.variant("UnBlock", 9, [Json_decode.field("metaId", Json_decode.$$int, json)]);
                      case "ValueCmp" : 
                      ...
                      case "ValueCmpOnFace" : 
                          return /* ValueCmpOnFace */Block.variant("ValueCmpOnFace", 1, [
                                    Json_decode.field("comparison", comparison, json),
                                    Json_decode.field("face", repTerm, json),
                                    Json_decode.field("type", repType, json),
                                    Json_decode.field("term1", repTerm, json),
                                    Json_decode.field("term2", repTerm, json)
                                  ]);
  ...
  return Json_decode.andThen((function (kind, json) {
                switch (kind) {
                  ...
                  case "ModuleDoesntExport" : 
                      var partial_arg$4 = importedName_(qName$1, (function (param) {
                              return Json_decode.list(name$1, param);
                            }));
...
function metas(json) {
  ...
  return /* record */Block.record([
            ...
            Json_decode.field("warnings", (function (param) {
                    return Json_decode.list(warning, param);
                  }), json),
            Json_decode.field("warnings", (function (param) {
                    return Json_decode.list(warning, param);
                  }), json)
...
var parseMetas = metas;

exports.Decode = Decode;
exports.parseError = parseError;
exports.parseMetas = parseMetas;
/*  Not a pure module */

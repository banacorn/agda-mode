...
class Connections extends React.Component {
    ...
    render() {
        ...
        const _a = this.props, { dispatch, connections, setupView } = _a, props = __rest(_a, ["dispatch", "connections", "setupView"]);
        ...
        return (React.createElement("section", Object.assign({}, props),
            React.createElement("section", { className: currentConnectionClassList },
                ...
                React.createElement(ConnectionItem_1.default, { phase: "connected", version: "Agda-2.5.2", uri: "path/to/agda" })),
            React.createElement("section", { className: "previous-connections" },
                ...
                React.createElement("ol", null,
                    React.createElement("li", null,
                        React.createElement(ConnectionItem_1.default, { phase: "connecting", version: "Agda-2.6-2ade23", uri: "path/to/agda" })),
                    React.createElement("li", null,
                        React.createElement(ConnectionItem_1.default, { phase: "connected", version: "Agda-2.6", uri: "path/to/agda" })),
                    React.createElement("li", null,
                        React.createElement(ConnectionItem_1.default, { phase: "disconnected", version: "Agda-2.6", uri: "path/to/agda" })),
                    React.createElement("li", null,
                        React.createElement(ConnectionItem_1.default, { phase: "disconnected", version: "Agda-2.5.2", uri: "path/to/agda" }))))));
    }
}

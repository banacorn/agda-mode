  ...
  return Json_decode.andThen((function (kind, json) {
                switch (kind) {
                  case "ClashingDefinition" : 
                      return /* ClashingDefinition */Block.variant("ClashingDefinition", 5, [
                  ...
                  case "NoRHSRequiresAbsurdPattern" : 
                      ...
                      return /* NoRHSRequiresAbsurdPattern */Block.variant("NoRHSRequiresAbsurdPattern", 6, [Json_decode.field("patterns", (function (param) {
                                        return Json_decode.list(partial_arg, param);
                                      }), json)]);
                  case "NotInScope" : 
                      return /* NotInScope */Block.variant("NotInScope", 7, [Json_decode.field("names", (function (param) {
                  ...
                  case "ShouldBeASort" : 
                      return /* ShouldBeASort */Block.variant("ShouldBeASort", 3, [Json_decode.field("type", repType, json)]);
                  case "ShouldBePi" : 
                      return /* ShouldBePi */Block.variant("ShouldBePi", 2, [Json_decode.field("type", repType, json)]);
                  ...
                  case "UnequalTerms" : 
                      return /* UnequalTerms */Block.variant("UnequalTerms", 4, [
                                Json_decode.field("comparison", comparison, json),
                  ...
                  default:
                    return /* UnregisteredTypeError */Block.variant("UnregisteredTypeError", 8, [json]);
                }
              }), (function (param) {
                return Json_decode.field("kind", Json_decode.string, param);
              }), param);

...
function InputMethod(Props) {
  ...
  var translation = Translator$AgdaMode.translate(toSequence(state[/* buffer */3]));
  ...
  var bufferClassName = Curry._1(Util$AgdaMode.ClassName[/* serialize */2], Util$AgdaMode.ClassName[/* addWhen */1]("hidden", isEmpty(state[/* buffer */3]), /* :: */Block.simpleVariant("::", [
              "inline-block",
              /* :: */Block.simpleVariant("::", [
                  "buffer",
                  /* [] */0
  ...
  return React.createElement("section", {
              className: className
                  ...
                  className: "keyboard"
                    ...
                    }, toSequence(state[/* buffer */3])), Block.spliceApply(React.createElement, [
                      "div",
                      {

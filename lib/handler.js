    ...
    switch (action.infoActionKind) {
        case 'AllGoals':
            if (action.content.length === 0)
                ...
                core.view.set('Goals', action.content, 3);
            break;
        case 'Error':
            core.view.set('Error', action.content, 1);
            break;
        case 'TypeChecking':
            core.view.set('Type Checking', action.content);
            break;
        case 'CurrentGoal':
            core.view.set('Current Goal', action.content, 4);
            break;
        case 'InferredType':
        ...
        case 'ModuleContents':
            ...
            break;
        case 'Context':
            core.view.set('Context', action.content, 3);
            break;
        case 'GoalTypeEtc':
            core.view.set('Goal Type and Context', action.content, 3);
            break;
        case 'NormalForm':
            core.view.set('Normal Form', action.content, 4);
            break;
        case 'Intro':
        ...
        case 'Auto':
            ...
            break;
        case 'Constraints':
            core.view.set('Constraints', action.content, 3);
            break;
        case 'ScopeInfo':

...
var component = ReasonReact.statelessComponent("MiniEditor");

function make$1($staropt$star, $staropt$star$1, hidden, $staropt$star$2, $staropt$star$3, $staropt$star$4, $staropt$star$5, $staropt$star$6, $staropt$star$7, children) {
  ...
  var onEditorRef = $staropt$star$7 !== undefined ? $staropt$star$7 : (function (param) {
        return /* () */0;
      });
  return ReasonReactCompat.wrapReactForReasonReact(MiniEditor, {
              value: value,

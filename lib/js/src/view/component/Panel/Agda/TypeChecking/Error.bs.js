  ...
  return Json_decode.andThen((function (kind, json) {
                switch (kind) {
                  case "Hidden" : 
                      return /* Hidden */0;
                  case "Instance" : 
                      return /* Instance */Block.simpleVariant("Instance", [overlappable(json)]);
                  case "NotHidden" : 
                      return /* NotHidden */1;
                  default:
...
function elim$prime(decoder) {
  return (function (param) {
      return Json_decode.andThen((function (kind, json) {
                    switch (kind) {
                      case "Apply" : 
                          return /* Apply */Block.variant("Apply", 0, [arg(decoder, json)]);
                      case "IApply" : 

...
function wire(self) {
  var logSExpression = Curry._1(Parser$AgdaMode.Incr[/* Event */0][/* flatMapOnResult */0], (function (expr) {
          Metadata$AgdaMode.logSExpression(expr)(self[/* metadata */0]);
          return /* OnResult */Caml_chrome_debugger.variant("OnResult", 0, [expr]);
        }));
  ...
  var logResponse = Curry._1(Parser$AgdaMode.Incr[/* Event */0][/* flatMapOnResult */0], (function (result) {
          Metadata$AgdaMode.logResponse(result)(self[/* metadata */0]);
          return /* OnResult */Caml_chrome_debugger.variant("OnResult", 0, [result]);
        }));

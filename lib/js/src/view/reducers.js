...
const body = redux_actions_1.handleActions({
    [actions_1.BODY.UPDATE_METAS]: (state, action) => (Object.assign({}, state, { metas: action.payload, emacsMetas: null, solutions: defaultState.body.solutions, error: null, emacsMessage: '', emacsError: null, plainText: defaultState.body.plainText })),
    [actions_1.BODY.UPDATE_EMACS_METAS]: (state, action) => (Object.assign({}, state, { metas: null, emacsMetas: action.payload, solutions: defaultState.body.solutions, error: null, emacsMessage: '', emacsError: null, plainText: defaultState.body.plainText })),
    [actions_1.BODY.UPDATE_ERROR]: (state, action) => (Object.assign({}, state, { metas: null, emacsMetas: defaultState.body.emacsMetas, solutions: defaultState.body.solutions, error: action.payload[0], emacsMessage: action.payload[1], emacsError: null, plainText: defaultState.body.plainText })),
    [actions_1.BODY.UPDATE_EMACS_ERROR]: (state, action) => (Object.assign({}, state, { metas: null, emacsMetas: defaultState.body.emacsMetas, solutions: defaultState.body.solutions, emacsError: action.payload, plainText: defaultState.body.plainText })),
    [actions_1.BODY.UPDATE_SOLUTIONS]: (state, action) => (Object.assign({}, state, { metas: null, emacsMetas: defaultState.body.emacsMetas, solutions: action.payload, error: null, emacsMessage: '', emacsError: null, plainText: defaultState.body.plainText })),
    [actions_1.BODY.UPDATE_PLAIN_TEXT]: (state, action) => (Object.assign({}, state, { metas: null, emacsMetas: defaultState.body.emacsMetas, solutions: defaultState.body.solutions, error: null, emacsMessage: '', emacsError: null, plainText: action.payload })),

...
Mocha$BsMocha.describe_only("View")(undefined, undefined, undefined, (function (param) {
        Promise$BsMocha.before(undefined)(undefined, undefined, undefined, Test__Util$AgdaMode.Package[/* activate */0]);
        return Mocha$BsMocha.describe("when activating agda-mode")(undefined, undefined, undefined, (function (param) {
                      return Promise$BsMocha.it("should mount the panel at the bottom")(undefined, undefined, undefined, (function (param) {
                                    return Test__Util$AgdaMode.openFile(Test__Util$AgdaMode.asset("Blank1.agda")).then((function (param) {

...
function activate(self) {
  return Curry._1(self[/* view */1][/* updateActivation */6][0], true);
}
...
function connect(self) {
  var queryConnection = function (error, self) {
    ...
    var p = Util$AgdaMode.$$Promise[/* then_ */6]((function (param) {
            Util$AgdaMode.Event[/* resolve */9](/* Connection */1, self[/* view */1][/* navigateSettingsView */15]);
            var promise = Util$AgdaMode.Event[/* once */8](self[/* view */1][/* onInquireConnection */9]);
            Util$AgdaMode.Event[/* resolve */9](/* tuple */[
                  error,
                  ""
                ], self[/* view */1][/* inquireConnection */8]);
            return promise;
          }), Util$AgdaMode.Event[/* once */8](self[/* view */1][/* onSettingsView */14]));
    Util$AgdaMode.Event[/* resolve */9](true, self[/* view */1][/* activateSettingsView */13]);
    return p;
  };
  ...
  if (match !== undefined) {
    ...
    return Util$AgdaMode.$$Promise[/* then_ */6](Connection$AgdaMode.wire, Util$AgdaMode.$$Promise[/* then_ */6]((function (param) {
                      ...
                      Util$AgdaMode.Event[/* resolve */9](connection, self$1[/* view */1][/* updateConnection */7]);
...
function deactivate(self) {
  return Curry._1(self[/* view */1][/* updateActivation */6][0], false);
}

function destroy(self) {
  deactivate(self);
  return Curry._1(self[/* view */1][/* destroy */16][0], /* () */0);
}
...
function prepareCommand(command, self) {
  ...
  } else if (command.tag === 8 && command[0] === 0) {
...
function dispatch(command, self) {
  return Util$AgdaMode.$$Promise[/* then_ */6]((function (prepared) {
                if (prepared !== undefined) {
                  ...
                  return Util$AgdaMode.$$Promise[/* resolve */1](Rebase.Option[/* some */11](Connection$AgdaMode.send(s, cmd[/* connection */0])));
                } else {
                  return Util$AgdaMode.$$Promise[/* resolve */1](undefined);
                }

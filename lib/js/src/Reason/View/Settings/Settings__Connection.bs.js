                                    ...
                                    className: "agda-settings-connection-dashboard"
                                        ...
                                        id: "agda-settings-connection-agda"
                                                ...
                                                agdaConnected ? agdaVersion : "unknown"
                                                          ...
                                                          Editors$AgdaMode.Connection[/* answer */1](result, editors);
                                                          Connection$AgdaMode.validateAndMake(result).then(Connection$AgdaMode.connect).then(Connection$AgdaMode.wire).then((function (conn) {
                                                                    console.log(conn);
                                                                    var match = conn[/* connection */1];
                                                                    if (match !== undefined) {
                                                                      match[/* stdin */1].write(Buffer.from("IOTCM \"/Users/banacorn/agda/test/A.agda\" NonInteractive Direct ( Cmd_load \"/Users/banacorn/agda/test/A.agda\" [])\n"));
                                                                    }

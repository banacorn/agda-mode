      ...
      if (match.tag) {
        ...
        return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                  /* record */Block.record([
                      ...
                      state[/* editors */5],
                      state[/* connectionEditorModel */6],
                      state[/* connectionEditorMessage */7],
                      state[/* connectionEditorRef */8],
                      state[/* mode */9]
                    ]),
                  (function (param) {
          ...
          return /* SideEffects */Block.variant("SideEffects", 1, [(function (self) {
                        ...
                        if (match !== undefined) {
                          ...
                          var tab = Tab$AgdaMode.make(self[/* state */1][/* editors */5][/* source */1], (function (param) {
                                  ...
                                  ReactDom.render(ReasonReact.element(undefined, undefined, Settings$AgdaMode.make(match[/* connectionEditorModel */6], match[/* connectionEditorMessage */7], (function (ref) {
                                                  return Curry._1(self[/* send */3], /* SetConnectionRef */Block.variant("SetConnectionRef", 0, [ref]));
                                                }), (function (__x) {
                                                  return Util$AgdaMode.Msg[/* recv */5](__x, handles[/* navigateSettingsView */10]);
                                                }), /* array */[])), element);
                                  return Util$AgdaMode.Msg[/* resolve */1](/* () */0, handles[/* activateSettingsView */9]);
                                }), undefined, (function (param) {
                                  Curry._1(self[/* send */3], /* ToggleSettingsTab */Block.variant("ToggleSettingsTab", 5, [false]));
                                  Util$AgdaMode.Msg[/* send */4](false, handles[/* activateSettingsView */9]);
                                  return /* () */0;
                                }), undefined, /* () */0);
...
function make$1(textEditor, handles, _children) {
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                Util$AgdaMode.Msg[/* recv */5]((function (param) {
                        Curry._1(self[/* send */3], /* InquireConnection */Block.variant("InquireConnection", 1, [
                                param[0],
                                param[1]
                              ]));
                        return Util$AgdaMode.Msg[/* handlePromise */3](MiniEditor$AgdaMode.Model[/* inquire */1](self[/* state */1][/* connectionEditorModel */6]), handles[/* inquireConnection */5]);
                ...
                Util$AgdaMode.Msg[/* recv */5]((function (param) {
                        ...
                        return Util$AgdaMode.Msg[/* handlePromise */3](MiniEditor$AgdaMode.Model[/* inquire */1](self[/* state */1][/* editors */5][/* query */2]), handles[/* inquireQuery */6]);
                      }), handles[/* inquireQuery */6]);
                handles[/* destroy */11][0] = (function (param) {
                    console.log("destroy!");
                    return /* () */0;
                  });
                return Util$AgdaMode.Msg[/* recv */5]((function (activate) {
            ...
            (function (self) {
                ...
                return React.createElement(React.Fragment, undefined, ReasonReact.element(undefined, undefined, Panel$AgdaMode.make(editors, element, (function (mountTo) {
                                      return Curry._1(self[/* send */3], /* MountTo */Block.variant("MountTo", 8, [mountTo]));
                                    }), match[/* body */1], match[/* header */0], mountAt, match[/* mode */9], hidden, (function (result) {
                                      MiniEditor$AgdaMode.Model[/* answer */2](result, editors[/* query */2]);
                                      Curry._1(handles[/* activateInputMethod */8][0], false);
                                      Curry._1(self[/* send */3], /* Focus */Block.variant("Focus", 2, [/* Source */0]));
                                      return Curry._1(self[/* send */3], /* UpdateMode */Block.variant("UpdateMode", 11, [/* Display */0]));
                                    }), (function (focused) {
                                      return Curry._1(self[/* send */3], focused ? /* Focus */Block.variant("Focus", 2, [/* Query */1]) : /* Focus */Block.variant("Focus", 2, [/* Source */0]));
                                    }), (function () {
                                      ...
                                      return Curry._1(self[/* send */3], /* SetQueryRef */Block.variant("SetQueryRef", 3, [ref]));
                                      ...
                                      return Util$AgdaMode.Msg[/* recv */5](__x, handles[/* activateSettingsView */9]);
                                    }), (function (status) {

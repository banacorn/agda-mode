...
function make(handles) {
  var activate = function (param) {
    return Channel$AgdaMode.send(/* () */0, handles[/* activatePanel */1]);
  };
  var deactivate = function (param) {
    return Channel$AgdaMode.send(/* () */0, handles[/* deactivatePanel */2]);
  };
  var toggleDocking = function (param) {
    return Channel$AgdaMode.send(/* () */0, handles[/* toggleDocking */3]);
  };
  var destroy = function (param) {
    Channel$AgdaMode.send(/* () */0, handles[/* deactivatePanel */2]);

...
function activate(instance) {
  return Event$AgdaMode.resolve(true, instance[/* view */1][/* activatePanel */5]);
}

function deactivate(instance) {
  return Event$AgdaMode.resolve(false, instance[/* view */1][/* activatePanel */5]);
}

function destroy(instance) {
  deactivate(instance);
  return Event$AgdaMode.resolve(/* () */0, instance[/* view */1][/* destroy */14]);
}
...
function connect(instance) {
  var inquireConnection = function (error, instance) {
    ...
    var promise = Async$AgdaMode.thenOk((function (param) {
              Event$AgdaMode.resolve(/* Connection */1, instance[/* view */1][/* navigateSettingsView */13]);
              var promise = Event$AgdaMode.once(instance[/* view */1][/* onInquireConnection */8]);
              Event$AgdaMode.resolve(/* tuple */[
                    error,
                    ""
                  ], instance[/* view */1][/* inquireConnection */7]);
              return promise;
            }))(Async$AgdaMode.mapError((function (param) {
                  return /* Cancelled */0;
                }))(Event$AgdaMode.once(instance[/* view */1][/* onSettingsView */12])));
    Event$AgdaMode.resolve(true, instance[/* view */1][/* activateSettingsView */11]);
    return promise;
  };
  ...
  if (match !== undefined) {
    ...
    return Async$AgdaMode.mapOk(Connection$AgdaMode.wire)(Async$AgdaMode.mapOk((function (param) {
                        ...
                        Event$AgdaMode.resolve(connection, instance$1[/* view */1][/* updateConnection */6]);
                        return connection;
                      }))(Async$AgdaMode.thenOk((function (param) {
                            return getConnection(instance, param);
                          }))(Async$AgdaMode.thenOk((function (param) {
    ...
    switch (command.tag | 0) {
      ...
      case 8 : 
          ...
          if (enabled) {
            switch (command[0]) {
              case 0 : 
                  Event$AgdaMode.resolve(true, instance[/* view */1][/* activatePanel */5]);
                  Event$AgdaMode.resolve(true, instance[/* view */1][/* activateInputMethod */15]);
                  break;
              case 1 : 
                  Event$AgdaMode.resolve("{", instance[/* view */1][/* interceptAndInsertKey */16]);
                  break;
              case 2 : 
                  Event$AgdaMode.resolve("[", instance[/* view */1][/* interceptAndInsertKey */16]);
                  break;
    ...
    switch (response.tag | 0) {
      ...
      case 2 : 
          ...
          if (displayImplicit || checked) {
            update("Status", /* PlainText */0, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, ["Typechecked: " + (Pervasives.string_of_bool(checked) + ("\nDisplay implicit arguments: " + Pervasives.string_of_bool(displayImplicit)))])]), instance[/* view */1]);
          }
          return Async$AgdaMode.resolve(/* () */0);
      case 3 : 
      ...
      case 8 : 
          ...
          return Response$AgdaMode.Info[/* handle */1](response[0], (function (x, y, z) {
                        return update(x, y, z, instance[/* view */1]);
                      }));
      default:
        console.log(response);
        return Async$AgdaMode.resolve(/* () */0);
  ...
  return (function (param) {
      return Async$AgdaMode.finalError((function (error) {
                    if (typeof error === "number") {
                      switch (error) {
                        case 0 : 
                            update("Query Cancelled", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [""])]), instance[/* view */1]);
                            return /* () */0;
                        case 1 : 
                            update("Goal not indexed", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, ["Please reload to re-index the goal"])]), instance[/* view */1]);
                            return /* () */0;
                        case 2 : 
                            update("Out of goal", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, ["Please place the cursor in a goal"])]), instance[/* view */1]);
                            return /* () */0;
                        
                      }
                    } else {
                      update("Connection-related Error", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [""])]), instance[/* view */1]);
                      return /* () */0;
                    }
                  }), param);
    });

...
function connectWithAgdaPath(instance, path) {
  ...
  return Async$AgdaMode.mapOk(Connection$AgdaMode.wire)(Async$AgdaMode.mapOk((function (param) {
                      ...
                      Event$AgdaMode.onOk((function (responses) {
                                Async$AgdaMode.thenOk(Curry._1(instance$1[/* handleResponses */10], instance$1))(Async$AgdaMode.mapError((function (e) {
                      ...
                      return connection;
                          ...
                          var instance$1 = instance;
                          var connection = param;
                          instance$1[/* connection */7] = connection;
...
function connect(instance) {
  var match = instance[/* connection */7];
  if (match !== undefined) {
...
function disconnect(instance) {
  ...
  if (match !== undefined) {
    ...
    instance[/* connection */7] = undefined;

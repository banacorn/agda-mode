...
function make(inquireConnection, onInquireConnection, navigate, _children) {
  return /* record */Block.record([
            ...
            (function (self) {
                return Util$AgdaMode.$$Promise[/* thenDrop */8]((function (uri) {
                            ...
                            }), Util$AgdaMode.Event[/* destroyWhen */6](self[/* onUnmount */4], Util$AgdaMode.Event[/* on */7](navigate)));
              }),
                                ...
                                className: "agda-settings-pages"
                                    ...
                                    className: at(/* Root */0, uri, /* :: */Block.simpleVariant("::", [
                                        ...
                                        onClick: (function (param) {
                                          ...
                                          }, "Protocol"))), ReasonReact.element(undefined, undefined, Settings__Connection$AgdaMode.make(inquireConnection, onInquireConnection, uri !== /* Connection */1, true, false, (function (prim) {
                                          console.log(prim);
                                          return /* () */0;

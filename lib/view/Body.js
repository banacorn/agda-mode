...
var mapDispatchToProps = function (dispatch) { return ({
    onMaxItemCountChange: function (count) {
        dispatch(actions_1.updateMaxItemCount(count));
    }
}); };
var Body = (function (_super) {
    ...
    Body.prototype.componentDidMount = function () {
        var _this = this;
        atom.config.observe('agda-mode.maxItemCount', function (newCount) {
            _this.props.onMaxItemCountChange(newCount);
        });
    };
    Body.prototype.render = function () {
        var _a = this.props, banner = _a.banner, body = _a.body, error = _a.error, plainText = _a.plainText, maxItemCount = _a.maxItemCount;
        var style = {
            maxHeight: (maxItemCount * 40 + 10) + "px"
        };
        return (React.createElement("section", {id: "agda-body", className: this.props.className, style: style}, 
                ...
                body.meta.map(function (item, i) {
                    return React.createElement("li", {className: "list-item body-item", key: i}, 
                        React.createElement("span", null, 
                            ...
                            " : "), 
                        React.createElement(Expr_1.default, null, item.type), 
                        React.createElement(Location_1.default, null, item.location));
                }), 
            ...
            error ? React.createElement(Error_1.default, {className: "error"}, error) : null, 

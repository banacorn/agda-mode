...
const body = redux_actions_1.handleActions({
    [actions_1.BODY.UPDATE_All_GOALS_WARNINGS]: (state, action) => (Object.assign({}, state, { allGoalsWarnings: action.payload })),
    [actions_1.BODY.UPDATE_ERROR]: (state, action) => (Object.assign({}, state, { error: action.payload[0] })),
    [actions_1.BODY.UPDATE_PLAIN_TEXT]: (state, action) => (Object.assign({}, state, { plainText: action.payload })),
    [actions_1.BODY.UPDATE_MAX_BODY_HEIGHT]: (state, action) => (Object.assign({}, state, { maxBodyHeight: action.payload })),
    [actions_1.BODY.UPDATE_RAW]: (state, action) => (Object.assign({}, state, { raw: action.payload })),
}, defaultState.body);
const emacs = redux_actions_1.handleActions({
    [actions_1.EMACS.UPDATE]: (state, action) => action.payload
}, defaultState.emacs);

...
function Root(Props) {
  ...
  Hook$AgdaMode.useEventListener(setSettingsActivation, events[/* activateSettingsView */2]);
  React.useEffect((function () {
          if (settingsView !== undefined) {
            if (settingsActivated) {
              Event$AgdaMode.emitOk(true, events[/* onSettingsView */1]);
              return undefined;
            } else {
              Tab$AgdaMode.kill(settingsView);
              Curry._1(setSettingsView, undefined);
              Event$AgdaMode.emitOk(false, events[/* onSettingsView */1]);
              return undefined;
            }
            ...
            var tab = Tab$AgdaMode.make(editors[/* source */1], (function (param) {
                    ...
                    return Event$AgdaMode.emitOk(true, events[/* onSettingsView */1]);
                  }), undefined, (function (param) {
                    Curry._1(setSettingsActivation, false);
                    return Event$AgdaMode.emitOk(false, events[/* onSettingsView */1]);
                  }), undefined, /* () */0);
  ...
  return React.createElement(React.Fragment, undefined, React.createElement(Channels$AgdaMode.Provider[/* make */0], {
                  ...
                  children: React.createElement(Type__View$AgdaMode.Mouse[/* Provider */1][/* make */0], {
                        value: (function ($$event) {
                            return Event$AgdaMode.emitOk($$event, events[/* onMouseEvent */5]);
                          }),

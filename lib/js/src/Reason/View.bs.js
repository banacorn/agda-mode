...
function make(editor, updateRawBody, updateHeader, updateMode, updateMountTo, queryGeneral, _children) {
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                return ReasonReact.element(undefined, undefined, Panel$AgdaMode.make(element, (function (mountTo) {
                                  return Curry._1(self[/* send */3], /* MountTo */Block.variant("MountTo", 2, [mountTo]));
                                ...
                                }), editors[/* general */2][/* placeholder */1], editors[/* general */2][/* value */0], /* array */[]));
              }),
            (function (param) {

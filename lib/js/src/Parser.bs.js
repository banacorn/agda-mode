...
function feed(input, self) {
  Rebase.$$Array[/* forEach */8]((function (line) {
          ...
          switch (next.tag | 0) {
            ...
            case 1 : 
                self[/* continuation */0][0] = next[0];
                return /* () */0;
            case 2 : 
                Curry._1(self[/* callback */1], /* OnResult */Caml_chrome_debugger.variant("OnResult", 0, [next[0]]));

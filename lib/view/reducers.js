...
var inputMethod = redux_actions_1.handleActions((_c = {},
    ...
    _c[actions_1.INPUT_METHOD.ENABLE_IN_MINI_EDITOR] = function (state, action) { return _.assign({}, state, {
...
var body = redux_actions_1.handleActions((_f = {},
    ...
    _f[actions_1.BODY.UPDATE_MAX_BODY_HEIGHT] = function (state, action) { return _.assign({}, state, {

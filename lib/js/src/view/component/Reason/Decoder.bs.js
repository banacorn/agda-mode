...
function typeError(param) {
  return Json_decode.andThen((function (kind, json) {
                switch (kind) {
                  case "AmbiguousName" : 
                      return /* AmbiguousName */Block.variant("AmbiguousName", 10, [
                  ...
                  case "NoSuchModule" : 
                      return /* NoSuchModule */Block.variant("NoSuchModule", 9, [Json_decode.field("module", qname, json)]);
                  case "NotInScope" : 
                  ...
                  default:
                    return /* UnregisteredTypeError */Block.variant("UnregisteredTypeError", 11, [json]);
                }
              }), (function (param) {
                return Json_decode.field("kind", Json_decode.string, param);
              }), param);

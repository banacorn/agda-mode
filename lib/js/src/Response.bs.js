...
function fromSExpression(tokens) {
  var err = /* Error */Block.variant("Error", 1, [Parser$AgdaMode.SExpression[/* toString */1](tokens)]);
  if (tokens.tag) {
    var xs = tokens[0];
        ...
        switch (match$1[0]) {
              ...
              if (match$2 !== undefined) {
                ...
                if (match$3.tag) {
                  ...
                  return Rebase.$$Option[/* mapOr */18]((function (x) {
                              ...
                              }), err, Rebase.$$Option[/* flatMap */5]((function (i) {
          ...
          case "agda2-goals-action" : 
              ...
              if (match$4 !== undefined) {
                return /* Ok */Block.variant("Ok", 0, [/* InteractionPoints */Block.variant("InteractionPoints", 4, [Rebase.$$Array[/* filterMap */23](Parser$AgdaMode.$$int, Parser$AgdaMode.SExpression[/* flatten */2](match$4))])]);
              } else {
                return err;
              }
                  ...
                  if (match$13.length !== 3) {
                    ...
                    if (match$14.tag) {
                      ...
                      if (match$15.tag) {
                        ...
                        return Rebase.$$Option[/* mapOr */18]((function (x) {
                                      return /* Ok */Block.variant("Ok", 0, [x]);
                                    }), err, Rebase.$$Option[/* flatMap */5]((function (index) {
...
function parse$1(raw) {
  ...
  var results = Rebase.$$Array[/* map */0]((function (param) {
          return partial_arg(fromSExpression, param);
        }), Parser$AgdaMode.SExpression[/* parseFile */5](raw));
  var errors = Rebase.$$Array[/* filterMap */23]((function (param) {
          if (param.tag) {
            return param[0];
          }
          
        }), results);
  if (Rebase.$$Array[/* length */16](errors) > 0) {
    return /* Error */Block.variant("Error", 1, [/* Response */Block.variant("Response", 0, [errors])]);
  } else {
    return /* Ok */Block.variant("Ok", 0, [Rebase.$$Array[/* filterMap */23](Rebase.$$Option[/* fromResult */12], results)]);
  }
}
...
exports.Token = Token;
exports.Info = Info;
exports.fromSExpression = fromSExpression;
exports.parse = parse$1;
/* Emacs__AllGoalsWarnings-AgdaMode Not a pure module */

...
function Settings__Connection(Props) {
  ...
  var editorRef = Resource$AgdaMode.make(undefined);
  var onSetPath = Event$AgdaMode.make(undefined);
  var handleAutoSearch = function (param) {
    var promise = Connection$AgdaMode.autoSearch("agda");
    $$Promise.getOk(promise, (function (path) {
            return $$Promise.getOk(Curry._1(editorRef.acquire, undefined), (function (editor) {
                          editor.setText(path);
  ...
  var focusOnPathEditor = function (editor) {
    ...
    editor.selectAll();
    return Curry._1(onSetPath.once, undefined);
  };
  Hook$AgdaMode.useChannel((function (param) {
          return $$Promise.flatMapOk(Curry._1(editorRef.acquire, undefined), focusOnPathEditor);
  ...
  return React.createElement("section", {
              className: className
                    ...
                    }), React.createElement("span", undefined, "Connection to Agda"), status), React.createElement("hr", undefined), React.createElement("h2", undefined, "Status"), connection !== undefined ? React.createElement(React.Fragment, undefined, React.createElement("p", undefined, "Path: " + connection.metadata.path), React.createElement("p", undefined, "Version: " + connection.metadata.version), React.createElement("p", undefined, "Supported protocol: " + Curry._1(Connection$AgdaMode.Metadata.Protocol.toString, connection.metadata.protocol))) : React.createElement(React.Fragment, undefined, React.createElement("p", undefined, "connection not established")), React.createElement("hr", undefined), React.createElement("h2", undefined, "Path"), React.createElement("p", undefined, React.createElement(MiniEditor$AgdaMode.make, {

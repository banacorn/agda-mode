...
var Term = /* module */Caml_chrome_debugger.localModule([
    "toString",
    "jump",
    "hover",
    "make"
...
var Expr = /* module */Caml_chrome_debugger.localModule([
    "toString",
    "parse",
    "make"
  ], [
...
var OutputConstraint = /* module */Caml_chrome_debugger.localModule([
    "toString",
    "parseOfType",
    "parseJustType",
    "parseJustSort",
...
var Labeled = /* module */Caml_chrome_debugger.localModule(["make"], [Emacs__Component$Labeled]);
...
var Output = /* module */Caml_chrome_debugger.localModule([
    "toString",
  ...
  return Rebase.$$Option[/* some */11](Rebase.$$Array[/* mapi */27]((function (token, i) {
                    ...
                    if (match !== 1) {
                      ...
                      return Rebase.$$Option[/* mapOr */18]((function (x) {
                                  ...
                                  }), /* Text */Caml_chrome_debugger.variant("Text", 0, [token]), Curry._1(Type__Location$AgdaMode.$$Range[/* parse */0], token));
                    }
...
var PlainText = /* module */Caml_chrome_debugger.localModule([
    "toString",
    "parse",
    "make"
  ], [
...
var WarningError = /* module */Caml_chrome_debugger.localModule([
    "toString",
    "parse",
    "parseWarning",
    "parseError",

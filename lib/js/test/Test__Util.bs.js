...
function compare(param) {
  var actual = param._1.trim();
  var expected = param._2.trim();
...
function getPanelContainers(param) {
  return Belt_Array.concat(getPanelContainersAtBottom(undefined), getPanelContainersAtPanes(undefined));
}
...
function getPanel(instance) {
  ...
  var panels = Belt_Array.concatMany(Belt_Array.map(getPanelContainers(undefined), (function (x) {
              return Belt_Array.keep(childHtmlElements(x), isTarget);
            })));
  var panel = Belt_Array.get(panels, 0);
  if (panel !== undefined) {
    return Promise.resolve(Caml_option.valFromOption(panel));
  } else {
    return Promise.reject({
                RE_EXN_ID: PanelNotFound
              });
  }
}
...
function activate(param) {
  ...
  return AgdaMode$AgdaMode.activate(undefined);
}
...
function after_each(param) {
  ...
  return resetConfig(undefined).then(destroyAllTextEditors).then(clearAllFiles);
}
...
function dispatch($$event, instance) {
  var onDispatch = $$Promise.Js.toBsPromise(Curry._1(instance.onDispatch.once, undefined));
  var result = atom.commands.dispatch(atom.views.getView(instance.editors.source), $$event);
  if (result !== undefined) {
    return Caml_option.valFromOption(result).then(function (param) {
                  return onDispatch;
                }).then(function (param) {
                return Promise.resolve(instance);
              });
...
function close$1(instance) {
  var onDestroy = $$Promise.Js.toBsPromise(Curry._1(instance.view.onDestroy.once, undefined));
...
function insert(key, instance) {
  var onChange = $$Promise.Js.toBsPromise(Curry._1(instance.view.onInputMethodChange.once, undefined));
  ...
  var backspaceUntilSuccess = function (param) {
    ...
    return instance.editors.source.save().then(function (param) {
                ...
                if (before !== after) {
                  ...
                  return backspaceUntilSuccess(undefined);
                }
              });
  };
  var onChange = $$Promise.Js.toBsPromise(Curry._1(instance.view.onInputMethodChange.once, undefined));
  return backspaceUntilSuccess(undefined).then(function (param) {
                return onChange;
              }).then(function (param) {
              return Promise.resolve(instance);
            });

...
function restoreCursorPosition(callback, instance) {
  ...
  return $$Promise.flatMap(Curry._1(callback, /* () */0), (function (result) {
                return $$Promise.map(handleOutOfGoal($$Promise.mapOk(getPointedGoalAt(originalPosition, instance), (function (goal) {

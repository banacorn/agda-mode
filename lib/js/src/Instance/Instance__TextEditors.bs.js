...
function startCheckpoint(command, instance) {
  ...
  instance[/* checkpointStack */3].push(checkpoint);
  if (Rebase.$$Array[/* length */16](instance[/* checkpointStack */3]) === 1) {
    instance[/* checkpointNeedReload */4] = typeof command === "number" ? (
...
function endCheckpoint(instance) {
  var checkpoint = instance[/* checkpointStack */3].pop();
  if (Rebase.$$Array[/* length */16](instance[/* checkpointStack */3]) === 0) {

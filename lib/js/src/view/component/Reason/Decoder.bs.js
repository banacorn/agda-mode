  ...
  return (function (param) {
      return Json_decode.andThen((function (kind, json) {
                    switch (kind) {
                      ...
                      case "Def" : 
                          var partial_arg$1 = elim_(term(/* () */0));
                      ...
                      case "MetaV" : 
                          var partial_arg$2 = elim_(term(/* () */0));
                      ...
                      case "Var" : 
                          var partial_arg$3 = elim_(term(/* () */0));
  ...
  return (function (param) {
      return Json_decode.andThen((function (kind, json) {
                    switch (kind) {
                      ...
                      case "StuckOn" : 
                          return /* StuckOn */Block.simpleVariant("StuckOn", [Json_decode.field("elim", elim_(term(/* () */0)), json)]);
                      case "Underapplied" : 

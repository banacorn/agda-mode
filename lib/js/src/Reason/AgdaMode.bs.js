...
function connect(self) {
  var queryConnection = function (message, self) {
    activate(self);
    var p = Util$AgdaMode.$$Promise[/* then_ */6]((function (param) {
            Util$AgdaMode.Event[/* resolve */9](/* Connection */1, self[/* view */1][/* navigateSettingsView */13]);
            ...
            return promise;
          }), Util$AgdaMode.Event[/* once */8](self[/* view */1][/* onSettingsView */12]));
    Util$AgdaMode.Event[/* resolve */9](true, self[/* view */1][/* activateSettingsView */11]);
    return p;
  };
  ...
  var getMetadata = function (self, path) {
    return Util$AgdaMode.$$Promise[/* catch */7]((function (err) {
                  return Util$AgdaMode.$$Promise[/* then_ */6]((function (param) {
                              ...
                              }), Connection$AgdaMode.handleValidationError((function (param) {
                                    switch (param.tag | 0) {
                                      case 0 : 
                                          return queryConnection("Path malformed:\n" + (String(param[1]) + ""), self);
                                      case 1 : 
                                          return queryConnection("The process is not responding", self);
                                      case 2 : 
                                          return queryConnection("Program at " + (String(param[0]) + (" not found:\n" + (String(param[1]) + ""))), self);
                                      case 3 : 
                                          return queryConnection("" + (String(param[1]) + ""), self);
                                      case 4 : 
                                          return queryConnection("Error from the stderr:\n" + (String(param[1]) + ""), self);
                                      case 5 : 
                                          return queryConnection("The given program is not agda:\n" + (String(param[1]) + ""), self);
    ...
    return Util$AgdaMode.$$Promise[/* then_ */6](Connection$AgdaMode.wire, Util$AgdaMode.$$Promise[/* then_ */6]((function (param) {
                      ...
                      return Util$AgdaMode.$$Promise[/* resolve */1](connection);
                              ...
                              return getMetadata(self, param);
                                  ...
                                  return Connection$AgdaMode.handleAutoSearchError((function (param) {
                                                if (param.tag) {
                                                  return queryConnection("Agda not found!\n" + (String(param[0]) + "\n              "), self);
                                                } else {
                                                  return queryConnection("Failed to search the path of Agda, as it\'s currently not supported on " + (String(param[0]) + ""), self);
                                                }
                                              }), param);
                                }), getAgdaPath(/* () */0))))));
  }
...
function destroy(self) {
  deactivate(self);
  return Curry._1(self[/* view */1][/* destroy */14][0], /* () */0);
}

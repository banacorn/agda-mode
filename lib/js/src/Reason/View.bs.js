...
function make(editor, updateRawBody, updateHeader, updateMode, updateMountTo, inquireQuery, interceptAndInsertKey, inputMethodHandle, _children) {
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",
            ...
            (function (self) {
                ...
                return React.createElement(React.Fragment, undefined, ReasonReact.element(undefined, undefined, Panel$AgdaMode.make(editor, element, (function (mountTo) {
                                    ...
                                    }), editor[/* query */2][/* placeholder */1], editor[/* query */2][/* value */0], interceptAndInsertKey, inputMethodHandle, /* array */[])));
              }),
            (function (param) {

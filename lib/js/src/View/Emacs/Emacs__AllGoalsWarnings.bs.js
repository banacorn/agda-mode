...
function Emacs__AllGoalsWarnings(Props) {
  ...
  return React.createElement(React.Fragment, undefined, Util$AgdaMode.React[/* manyIn */2]("ul")($$Array.map((function (value) {
                        return React.createElement(Emacs__Component$AgdaMode.Output[/* make */3], {
                                    value: value
                                  });
                      }), value[/* interactionMetas */1])), Util$AgdaMode.React[/* manyIn */2]("ul")($$Array.map((function (value) {
                        return React.createElement(Emacs__Component$AgdaMode.Output[/* make */3], {
                                    value: value
                                  });
                      }), value[/* hiddenMetas */2])), Util$AgdaMode.React[/* manyIn */2]("ul")($$Array.map((function (value) {
                        return React.createElement(Emacs__Component$AgdaMode.WarningError[/* make */3], {
                                    value: value
                                  });
                      }), value[/* warnings */3])), Util$AgdaMode.React[/* manyIn */2]("ul")($$Array.map((function (value) {
                        return React.createElement(Emacs__Component$AgdaMode.WarningError[/* make */3], {
                                    value: value
                                  });
                      }), value[/* errors */4])));

...
function mapStateToProps(state) {
    return Object.assign({ mountAtBottom: state.view.mountAt.current === 1 /* Bottom */ }, state);
}
    ...
    render() {
        ...
        return (React.createElement("section", { className: hideEverything },
            ...
            React.createElement("section", { className: 'agda-body-container' },
                React.createElement(view_1.default.EventContext.Consumer, null, emitter => (React.createElement(JSONBody, { raw: body.json, emacs: body.emacs, maxBodyHeight: body.maxBodyHeight, useJSON: core.connection.usesJSON(), hidden: 0 /* Display */ !== mode, mountAtBottom: mountAtBottom, emit: (ev, range) => {
                        switch (ev) {

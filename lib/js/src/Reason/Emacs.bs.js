...
function allGoalsWarnings(title, body) {
  ...
  var interactionMetas = Util$AgdaMode.Parser[/* parseArray */2](interactionMeta, preprocessed[/* metas */0]);
  var hiddenMetas = Util$AgdaMode.Parser[/* parseArray */2](hiddenMeta, preprocessed[/* metas */0]);
  return /* record */Block.record([
            "interactionMetas",
            "hiddenMetas",
            "warnings",

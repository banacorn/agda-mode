...
function toString(param) {
  if (param.tag) {
    return "Parse error code: R" + (String(param[0]) + (" \"" + (Parser__Type$AgdaMode.SExpression[/* toString */0](param[1]) + "\"")));
  } else {
...
var partial_arg$3 = Rebase.$$Array[/* filterMap */23];

var split = Curry._2(Rebase.Fn[/* >> */6], Curry._2(Rebase.Fn[/* >> */6], (function (param) {
...
var partial_arg$4 = Rebase.$$Array[/* map */0];

var splitAndTrim = Curry._2(Rebase.Fn[/* >> */6], split, (function (param) {
        return partial_arg$4((function (prim) {
                      return prim.trim();
                    }), param);
      }));

function onResult(x) {
  return /* OnResult */Caml_chrome_debugger.simpleVariant("OnResult", [x]);
}

function map(f, param) {
  if (param) {
    return /* OnResult */Caml_chrome_debugger.simpleVariant("OnResult", [Curry._1(f, param[0])]);
  } else {
    return /* OnFinish */0;
  }
}
...
var $$Event = /* module */Caml_chrome_debugger.localModule([
    "onResult",
    "map",
    "flatMap"
  ], [
...
function feed(self, input) {
  var $$continue = Rebase.$$Option[/* getOr */16](self[/* initialContinuation */0], self[/* continuation */1][0]);
  var match = Curry._1($$continue, input);
  switch (match.tag | 0) {
    case 0 : 
        return Curry._1(self[/* callback */2], /* OnResult */Caml_chrome_debugger.simpleVariant("OnResult", [/* Error */Caml_chrome_debugger.variant("Error", 1, [match[0]])]));
    case 1 : 
        self[/* continuation */1][0] = match[0];
        return /* () */0;
    case 2 : 
        Curry._1(self[/* callback */2], /* OnResult */Caml_chrome_debugger.simpleVariant("OnResult", [/* Ok */Caml_chrome_debugger.variant("Ok", 0, [match[0]])]));
        self[/* continuation */1][0] = undefined;
        return /* () */0;
...
function finish(self) {
  return Curry._1(self[/* callback */2], /* OnFinish */0);
}
...
function parse(input) {
  ...
  Rebase.$$Array[/* forEach */8]((function (line) {
          ...
          switch (match.tag | 0) {
            case 0 : 
                resultAccum[0].push(/* Error */Caml_chrome_debugger.variant("Error", 1, [match[0]]));
                return /* () */0;
            case 1 : 
        ...
        }), Curry._1(splitAndTrim, input));
  return resultAccum[0];
}

function makeIncr(callback) {
  return /* record */Caml_chrome_debugger.record(["contents"], [make(parseWithContinuation, callback)]);
}

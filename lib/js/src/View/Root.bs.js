...
function Root(Props) {
  ...
  Hook$AgdaMode.useChannel((function (param) {
          ...
          return Async$AgdaMode.resolve(getPanelContainerFromState(stateRef.current));
  ...
  var settingsView$1 = state[/* settingsView */1];

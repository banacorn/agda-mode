...
var Header = (function (_super) {
    ...
    Header.prototype.render = function () {
        ...
        var _b = this.props, mountAtPane = _b.mountAtPane, mountAtBottom = _b.mountAtBottom;
        var classes = classNames({
            hidden: inputMethodActivated || _.isEmpty(text)
        }, "text-" + toStyle(style));
        return (React.createElement("div", {className: "agda-header"}, 
            React.createElement("h1", {className: classes}, text), 
            React.createElement(Settings_1.default, {mountAtPane: mountAtPane, mountAtBottom: mountAtBottom})));
    };
    return Header;
}(React.Component));

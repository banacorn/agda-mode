...
function insertUntilSuccess(text, instance) {
  ...
  console.log("[ IM ][ insert listen ] " + before);
  editor.insertText(text);
  return editor.save().then((function (param) {
                var after = editor.getText();
                if (before !== after) {
                  console.log("[ IM ][ insert complete ] " + (before + (" => " + after)));
                  return Promise.resolve(instance);
                } else {
                  console.log("[ IM ][ insert failed ! ] ");
...
function backspace(instance) {
  var backspaceUntilSuccess = function (param) {
    ...
    console.log("[ IM ][ backspace listen ] " + before);
    ...
    return instance[/* editors */1][/* source */1].save().then((function (param) {
                  ...
                  if (before !== after) {
                    console.log("[ IM ][ backspace complete ] " + (before + (" => " + after)));
                    return Promise.resolve(/* () */0);
                  } else {
                    console.log("[ IM ][ backspace failed ! ] ");

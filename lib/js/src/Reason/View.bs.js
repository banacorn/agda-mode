    ...
    switch (action.tag | 0) {
      ...
      case 3 : 
          ...
          return /* SideEffects */Block.variant("SideEffects", 1, [(function (self) {
                        ...
                        if (match !== undefined) {
                          if (open_) {
                            return Util$AgdaMode.Event[/* resolve */9](true, handles[/* onSettingsView */12]);
                          } else {
                            Curry._1(match[/* kill */1], /* () */0);
                            Curry._1(self[/* send */3], /* UpdateSettingsView */Block.variant("UpdateSettingsView", 4, [undefined]));
                            return Util$AgdaMode.Event[/* resolve */9](false, handles[/* onSettingsView */12]);
                          }
                        } else if (open_) {
                          var tab = Tab$AgdaMode.make(self[/* state */1][/* editors */5][/* source */1], (function (param) {
                                  ...
                                  ReactDom.render(ReasonReact.element(undefined, undefined, Settings$AgdaMode.make(handles[/* inquireConnection */6], handles[/* onInquireConnection */7], handles[/* updateConnection */5], handles[/* navigateSettingsView */13], /* array */[])), element);
                                  return Util$AgdaMode.Event[/* resolve */9](true, handles[/* onSettingsView */12]);
...
function make$1(textEditor, handles, _children) {
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                handles[/* destroy */14][0] = (function (param) {
                    console.log("destroy!");
                    return /* () */0;
                  });
            ...
            (function (self) {
                ...
                var partial_arg = handles[/* interceptAndInsertKey */9];
                var partial_arg$1 = handles[/* activateInputMethod */10];
                return React.createElement(React.Fragment, undefined, ReasonReact.element(undefined, undefined, Panel$AgdaMode.make(editors, element, (function (mountTo) {
                                      ...
                                      Curry._1(handles[/* activateInputMethod */10][0], false);
                                      ...
                                      return /* () */0;
                                    }), handles[/* activateSettingsView */11], (function (status) {

...
function mountPanel(self, mountTo) {
  var createTab = function (param) {
    return Tab$AgdaMode.make(self[/* state */1][/* editor */5][/* source */1], (function (param) {
                  return "[Agda Mode] " + self[/* state */1][/* editor */5][/* source */1].getTitle();
      ...
      case 2 : 
          ...
          return /* SideEffects */Block.variant("SideEffects", 1, [(function (self) {
                        ...
                        if (match !== undefined) {
                          ...
                          var tab = Tab$AgdaMode.make(self[/* state */1][/* editor */5][/* source */1], (function (param) {
                                  return "[Settings] " + self[/* state */1][/* editor */5][/* source */1].getTitle();
                                }), (function (element, param, param$1) {
                                  ReactDom.render(ReasonReact.element(undefined, undefined, Settings$AgdaMode.make(/* array */[])), element);
                                  return /* () */0;
                                }), undefined, (function (param) {

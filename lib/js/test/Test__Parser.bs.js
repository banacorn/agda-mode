...
function singleRegressionTest(fileName, param) {
  ...
  var parsedOutput = Connection$AgdaMode.parseAgdaOutput(input, /* record */Caml_chrome_debugger.record(["contents"], [undefined]));
  var output = "";
  ...
  if (output === expectedOutput) {
    ...
    for(var i$1 = 0 ,i_finish$1 = splitExpected.length - 1 | 0; i$1 <= i_finish$1; ++i$1){
      ...
      if (a !== b) {
        var errorMsg = "Line " + (String(i$1) + (" differs. The parsed version is:\n" + (b + "\n")));

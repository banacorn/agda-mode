...
class Settings extends React.Component {
    ...
    render() {
        return (React.createElement("section", { className: "agda-settings" },
            React.createElement(Breadcrumb_1.default
            // className={this.notAt('Main')}
            , { 
                // className={this.notAt('Main')}
                back: this.props.navigate('Main'), path: this.props.path }),
            React.createElement("ul", { className: "agda-settings-menu" },
                React.createElement("li", { className: this.at('Main'), onClick: this.props.navigate('Connections') },

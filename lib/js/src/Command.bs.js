...
function serialize(self) {
  ...
  var buildRange = function (goal) {
    if (Util$AgdaMode.Version[/* gte */1](connection[/* metadata */0][/* version */2], "2.5.1")) {
  ...
  if (typeof command === "number") {
    switch (command) {
      case 0 : 
          if (Util$AgdaMode.Version[/* gte */1](connection[/* metadata */0][/* version */2], "2.5.0")) {
    ...
    switch (command.tag | 0) {
      ...
      case 7 : 
          ...
          if (Util$AgdaMode.Version[/* gte */1](connection[/* metadata */0][/* version */2], "2.5.2")) {
      ...
      case 9 : 
          ...
          if (Util$AgdaMode.Version[/* gte */1](connection[/* metadata */0][/* version */2], "2.5.3")) {

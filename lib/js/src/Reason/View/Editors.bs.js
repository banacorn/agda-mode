...
function getFocusedEditor(editors) {
  ...
  if (match) {
    var match$1 = editors[/* general */2][/* ref */2];
...
function queryGeneral(editors) {
  return Curry._1(editors[/* general */2][/* telePromise */3][/* wire */0], /* () */0);
}

function answerGeneral(editors) {
  return editors[/* general */2][/* telePromise */3][/* resolve */1];
}

function rejectGeneral(editors) {
  return editors[/* general */2][/* telePromise */3][/* reject */2];
}

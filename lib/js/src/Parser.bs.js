...
function feed(self, input) {
  ...
  switch (match.tag | 0) {
    case /* Error */0 :
        return Curry._1(self[/* callback */2], /* Yield */Caml_chrome_debugger.simpleVariant("Yield", [/* Error */Caml_chrome_debugger.variant("Error", 1, [match[0]])]));
    case /* Continue */1 :
        self[/* continuation */1][0] = match[0];
        return /* () */0;
    case /* Done */2 :
        Curry._1(self[/* callback */2], /* Yield */Caml_chrome_debugger.simpleVariant("Yield", [/* Ok */Caml_chrome_debugger.variant("Ok", 0, [match[0]])]));
...
function stop(self) {
  return Curry._1(self[/* callback */2], /* Stop */0);
}

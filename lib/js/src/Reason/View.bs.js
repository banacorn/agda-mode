  ...
  if (typeof action === "number") {
    if (action === 0) {
      ...
      return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                ...
                (function (self) {
                    return Editors$AgdaMode.focusQuery(self[/* state */1][/* editors */3]);
                  })
              ]);
    } else {
      ...
      return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                ...
                (function (self) {
                    return Editors$AgdaMode.focusSource(self[/* state */1][/* editors */3]);
                  })
              ]);
    }
  } else {
    switch (action.tag | 0) {
      case 0 : 
          ...
          var init$3 = state[/* editors */3][/* query */2];
      ...
      case 1 : 
          ...
          var init$5 = state[/* editors */3][/* query */2];
          return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                    /* record */Block.record([
                        "header",
                        "body",
      ...
      case 2 : 
          ...
          return /* SideEffects */Block.variant("SideEffects", 1, [(function (self) {
                        return mountPanel(self, state[/* editors */3][/* source */1], mountTo);
                      })]);
      case 3 : 
          return /* Update */Block.variant("Update", 0, [/* record */Block.record([
                        "header",
...
function jsActivateInputMethod(param) {
  return Curry._1(inputMethodHandle[0], true);
}

function jsDeactivateInputMethod(param) {
  return Curry._1(inputMethodHandle[0], false);
}
  ...
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                return Curry._1(queryGeneral, (function (placeholder, value) {
                              ...
                              Curry._2(self[/* handle */0], (function (param, newSelf) {
                                      Editors$AgdaMode.inquire(newSelf[/* state */1][/* editors */3]).then((function (answer) {
            ...
            (function (self) {
                ...
                return React.createElement(React.Fragment, undefined, ReasonReact.element(undefined, undefined, Panel$AgdaMode.make(editors, element, (function (mountTo) {
                                      ...
                                      Curry._1(Editors$AgdaMode.answer(editors), result);
                                      ...
                                      Curry._1(Editors$AgdaMode.reject(editors), Editors$AgdaMode.QueryCancelled);
                                      Curry._1(inputMethodHandle[0], false);
                                      Curry._1(self[/* send */3], /* FocusSource */1);
                                      return Curry._1(self[/* send */3], /* UpdateMode */Block.variant("UpdateMode", 6, [/* Display */0]));
                                    }), (function (ref) {
                                      return Curry._1(self[/* send */3], /* SetGeneralRef */Block.variant("SetGeneralRef", 0, [ref]));
                                    }), editors[/* query */2][/* placeholder */1], editors[/* query */2][/* value */0], (function (handle) {

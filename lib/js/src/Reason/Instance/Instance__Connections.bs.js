...
function getAgdaPath(instance) {
  ...
  return Async$AgdaMode.thenError((function (err) {
                  return inquireAgdaPath(/* AutoSearch */Block.variant("AutoSearch", 0, [err]), instance);
  ...
  var getMetadata = function (instance, pathAndParams) {
    return Async$AgdaMode.thenError((function (err) {
                    return Async$AgdaMode.thenOk((function (param) {
                                  ...
                                  }))(inquireAgdaPath(/* Validation */Block.variant("Validation", 1, [
                                      pathAndParams,
                                      err
                                    ]), instance));
    ...
    return Async$AgdaMode.thenError((function (err) {
                    ...
                    return Async$AgdaMode.thenOk((function (param) {
                                    return getConnection(instance, param);
                                        ...
                                        return getMetadata(instance, param);
                                      }))(inquireAgdaPath(/* Connection */Block.variant("Connection", 2, [err]), instance)));
...
function disconnect(instance) {
  ...
  if (match !== undefined) {
    ...
    return Event$AgdaMode.emitOk(undefined, instance[/* view */2][/* updateConnection */4]);
  } else {
    return /* () */0;
  }
}

...
class Protocol extends React.Component {
    ...
    render() {
        if (this.props.agda) {
            ...
            React.createElement("section", { className: classNames('agda-settings-protocol', this.props.className) },
                React.createElement("p", { className: 'background-message' }, "No Connection Established"));
        }
    }
}

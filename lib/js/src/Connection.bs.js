...
function resetLogEntries(self) {
  self[/* logs */4] = /* array */[];
  return /* () */0;
}

function createLogEntry(cmd, self) {
  var log_001 = /* response : record */Block.record([
      "rawText",
      "sexpression",
      "response"
    ], [
  ...
  self[/* logs */4].push(log);
  return /* () */0;
}

function updateLatestLogEntry(f, self) {
  var n = Rebase.$$Array[/* length */16](self[/* logs */4]);
  return Rebase.$$Option[/* forEach */8](f, Rebase.$$Array[/* get */17](self[/* logs */4], n - 1 | 0));
}

function logRawText(text) {
  return (function (param) {
      return updateLatestLogEntry((function (log) {
...
exports.$$Error = $$Error;
exports.Log = Log;
exports.resetLogEntries = resetLogEntries;
exports.createLogEntry = createLogEntry;
exports.updateLatestLogEntry = updateLatestLogEntry;

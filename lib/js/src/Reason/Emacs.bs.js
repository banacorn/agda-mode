...
function allGoalsWarnings(title, body) {
  ...
  var interactionMetas = Util$AgdaMode.Parser[/* parseArray */2](outputWithoutRange, preprocessed[/* metas */0].slice(0, indexOfHiddenMetas));
  var hiddenMetas = Util$AgdaMode.Parser[/* parseArray */2](outputWithRange, preprocessed[/* metas */0].slice(indexOfHiddenMetas));
  return /* record */Block.record([
            "interactionMetas",
            "hiddenMetas",
            "warnings",

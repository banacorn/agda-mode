    ...
    switch (command.tag | 0) {
      ...
      case 2 : 
          ...
          return Async$AgdaMode.thenOk((function (expr) {
                        ...
                        }))(inquire("Module contents [" + (Command$AgdaMode.Normalization[/* of_string */0](normalization$2) + "]"), "module name:", "", instance[/* view */1]));
      case 3 : 
          ...
          return handleOutOfGoal((function (param) {
                          return Async$AgdaMode.thenOk((function (expr) {
                                        ...
                                        }))(inquire("Compute normal form", "expression to normalize:", "", instance[/* view */1]));
                        }))(Async$AgdaMode.thenOk((function (param) {
                              var index = param[1];
                              var goal = param[0];
                              if (Goal$AgdaMode.isEmpty(goal)) {

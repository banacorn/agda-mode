...
var Position = /* module */Caml_chrome_debugger.localModule(["decode"], [decode]);
...
var Interval = /* module */Caml_chrome_debugger.localModule([
    "fuse",
    "toString",
    "toAtomRange",
    "decode"
...
function fuse$1(a, b) {
  var mergeTouching = function (l, e, s, r) {
    return Rebase.List[/* concat */11](Rebase.List[/* concat */11](l, /* :: */Caml_chrome_debugger.simpleVariant("::", [
  ...
  var outputLeftPrefix = function (s1, r1, s2, is2) {
    ...
    return Rebase.List[/* concat */11](Rebase.List[/* concat */11](/* :: */Caml_chrome_debugger.simpleVariant("::", [
                      s1,
                      /* [] */0

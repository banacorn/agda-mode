...
function parseAgdaOutput(continuation, stringAgdaSpatOut) {
  ...
  var toResponse = function (param) {
    if (param.tag) {
      ...
      return /* OnResult */Caml_chrome_debugger.variant("OnResult", 0, [param[0]]);
    }
  };
  var partial_arg = Rebase.Result[/* flatMap */6];
  var results = Rebase.$$Array[/* map */0](toResponse, Rebase.$$Array[/* map */0]((function (param) {
              return partial_arg(Response$AgdaMode.parse, param);
            }), Parser$AgdaMode.SExpression[/* parse2 */5](continuation, trimmed)));
  if (isEndOfResponse) {
    return Rebase.$$Array[/* concat */11](results, /* array */[/* OnFinish */0]);
  } else {
    return results;
  }
}
...
function wire(self) {
  ...
  var onData = function (chunk) {
    ...
    var result = parseAgdaOutput(continuation, rawText);
    Metadata$AgdaMode.logRawText(rawText)(self[/* metadata */0]);
    return Rebase.$$Array[/* forEach */8]((function (result) {
                  response(result);
                  if (typeof result === "number" || result.tag) {
                    return /* () */0;
                  } else {
                    return Metadata$AgdaMode.logResponse(result[0])(self[/* metadata */0]);
                  }
                }), result);
  };

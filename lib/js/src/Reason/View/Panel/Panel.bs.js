                ...
                return ReactDom.createPortal(ReasonReact.element(undefined, undefined, Curry._2(Type$AgdaMode.View[/* MouseEmitter */3][/* Provider */1][/* make */0], (function (ev) {
                                      return Curry._1(self[/* send */3], /* MouseEvent */Block.variant("MouseEvent", 3, [ev]));
                                          ...
                                          className: className
                                            ...
                                            }, ReasonReact.element(undefined, undefined, Body$AgdaMode.make(body, match[/* maxHeight */0], mode !== /* Display */0, mountAtBottom, /* array */[])), ReasonReact.element(undefined, undefined, MiniEditor$AgdaMode.make(editorValue, editorPlaceholder, mode !== /* Inquire */1, "agda", (function (result) {
                                                        return Event$AgdaMode.resolve(result, onInquireQuery);
                                                      }), Caml_option.some((function () {
                                                            Event$AgdaMode.reject(/* Cancelled */0, onInquireQuery);
                                                            return /* () */0;

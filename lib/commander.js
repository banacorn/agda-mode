...
class Commander {
    constructor(core) {
        ...
        this.startCheckpoint = (command) => (socket) => {
        ...
        this.nextGoal = (socket) => {
            return this.core.editor.jumpToNextGoal()
                .then(() => Promise.resolve([]));
        };
        this.previousGoal = (socket) => {
        ...
        this.inferType = (normalization) => (socket) => {
            return this.core.editor.goal.pointing()
                .then(goal => {
                // goal-specific
                if (goal.isEmpty()) {
        ...
        this.moduleContents = (normalization) => (socket) => {
        ...
        this.computeNormalForm = (computeMode) => (socket) => {
            return this.core.editor.goal.pointing()
                .then((goal) => {
                if (goal.isEmpty()) {
        ...
        this.goalType = (normalization) => (socket) => {
            return this.core.editor.goal.pointing()
        ...
        this.context = (normalization) => (socket) => {
            return this.core.editor.goal.pointing()
        ...
        this.goalTypeAndContext = (normalization) => (socket) => {
            return this.core.editor.goal.pointing()
        ...
        this.goalTypeAndInferredType = (normalization) => (socket) => {
            return this.core.editor.goal.pointing()
        ...
        this.inputSymbolInterceptKey = (kind, key) => (socket) => {

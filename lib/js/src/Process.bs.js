...
function run$1(pathAndParams, validator) {
  ...
  Child_process.exec(pathAndParams, (function (error, stdout, stderr) {
          ...
          var match = Curry._1(validator, stdout$1);
          if (match.tag) {
            return Curry._1(resolve, /* Error */Caml_chrome_debugger.variant("Error", 1, [/* WrongProcess */Caml_chrome_debugger.variant("WrongProcess", 4, [match[0]])]));
          } else {
            return Curry._1(resolve, /* Ok */Caml_chrome_debugger.variant("Ok", 0, [match[0]]));
          }
        }));
  return match[0];
}
...
function make(path, args) {
  ...
  var disconnect = function (param) {
    ...
    if (typeof match === "number") {
      ...
      return Curry._1(match[0].acquire, /* () */0);
    } else {
      var pending = Resource$AgdaMode.make(/* () */0);
      $$process$1.contents = /* Disconnecting */Caml_chrome_debugger.variant("Disconnecting", 1, [pending]);
      Curry._1(emitter.on, (function (param) {
              if (param.tag) {
                ...
                if (typeof tmp === "number" || tmp.tag !== /* ExitedByProcess */2) {
                  ...
                  Curry._1(emitter.destroy, /* () */0);
                  $$process$1.contents = /* Disconnected */0;
                  return Curry._1(pending.supply, /* () */0);
                }
              } else {
                return /* () */0;
              }
            }));
      match[0].kill("SIGTERM");
      return Curry._1(pending.acquire, /* () */0);
    }
  };

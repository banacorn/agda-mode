...
var Body = (function (_super) {
    ...
    Body.prototype.render = function () {
        ...
        var otherProps = _.omit(this.props, ['banner', 'body', 'error', 'plainText', 'maxBodyHeight', 'jumpToGoal', 'jumpToLocation', 'onMaxBodyHeightChange', 'className']);
        var classes = classNames(this.props.className, "native-key-bindings", 'agda-body');
        var style = {
            maxHeight: maxBodyHeight + "px"
        };
        return (React.createElement("section", __assign({className: classes, tabIndex: "-1", style: style}, otherProps), 
            ...
            error ? React.createElement(Error_1.default, null, error) : null, 

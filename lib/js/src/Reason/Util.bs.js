...
function resolve(x, self) {
  return Curry._1(self[/* promise */1][/* resolve */2], x);
}

function reject(x, self) {
  return Curry._1(self[/* promise */1][/* reject */3], x);
}

function handlePromise(x, self) {
  return Curry._1(self[/* promise */1][/* handlePromise */1], x);
}

function send(x, self) {
  Rebase.List[/* forEach */8]((function (handler) {
          return Curry._1(handler, x);
        }), self[/* ref */0][0]);
  return Curry._1(self[/* promise */1][/* wire */0], /* () */0);
}

function recv(handler, self) {
  self[/* ref */0][0] = /* :: */Block.simpleVariant("::", [
      handler,
      self[/* ref */0][0]
    ]);
  return /* () */0;
...
var Msg = /* module */Block.localModule([
    "make",
    "resolve",
    "reject",
    "handlePromise",

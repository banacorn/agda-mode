...
function inquireAgdaPath(error, instance) {
  ...
  var promise = Async$AgdaMode.thenOk((function (param) {
            ...
            View$AgdaMode.Handles[/* inquireConnection */11](instance[/* view */2]);
            View$AgdaMode.Handles[/* updateConnection */12](undefined, error, instance[/* view */2]);
            return promise;
          }))(View$AgdaMode.Handles[/* onOpenSettingsView */8](instance[/* view */2]));
  View$AgdaMode.Handles[/* activateSettingsView */13](instance[/* view */2]);
  return Async$AgdaMode.thenOk((function (param) {
                  if (param) {
                    return Async$AgdaMode.resolve(param[0]);
                  } else {
                    return inquireAgdaPath(error, instance);
                  }
                }))(promise);
}
  ...
  if (match !== undefined) {
    ...
    return Async$AgdaMode.mapOk(Connection$AgdaMode.wire)(Async$AgdaMode.mapOk((function (param) {
                        ...
                        return connection;
                            ...
                            View$AgdaMode.Handles[/* updateConnection */12](connection, undefined, instance$1[/* view */2]);
                            return connection;
                          }))(Async$AgdaMode.thenOk((function (param) {
                                return getConnection(instance, param);
...
function disconnect(instance) {
  ...
  if (match !== undefined) {
    ...
    return View$AgdaMode.Handles[/* updateConnection */12](undefined, undefined, instance[/* view */2]);
  } else {
    return /* () */0;
  }
}

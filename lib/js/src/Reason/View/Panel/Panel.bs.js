...
function make(editor, element, onMountAtChange, body, header, mountAt, mode, hidden, onEditorConfirm, onEditorFocused, onEditorCancel, onEditorRef, editorPlaceholder, editorValue, interceptAndInsertKey, activateInputMethod, activateSettingsView, onSettingsViewToggle, _children) {
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",
            ...
            (function (self) {
                ...
                if (element !== undefined) {
                  var className = Curry._1(Util$AgdaMode.React[/* toClassName */3], Util$AgdaMode.React[/* addClass */2]("hidden", hidden, /* [] */0));
                                        ...
                                        return Curry._1(self[/* send */3], /* MouseEvent */Block.variant("MouseEvent", 3, [ev]));
                                            ...
                                            className: className
                                                ...
                                                className: "panel-heading agda-header-container"
                                                          ...
                                                          return /* () */0;
                                                        }), mountAtBottom, /* array */[])), ReasonReact.element(undefined, undefined, InputMethod$AgdaMode.make(editor, interceptAndInsertKey, activateInputMethod, (function (activated) {

...
function typeError(param) {
  return Json_decode.andThen((function (kind, json) {
                switch (kind) {
                  ...
                  case "NotInScope" : 
                      return /* NotInScope */Block.variant("NotInScope", 6, [Json_decode.field("names", (function (param) {
                  ...
                  default:
                    return /* UnregisteredTypeError */Block.variant("UnregisteredTypeError", 7, [json]);
                }
              }), (function (param) {
                return Json_decode.field("kind", Json_decode.string, param);
              }), param);

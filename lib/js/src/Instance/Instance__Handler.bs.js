    ...
    switch (response.tag | 0) {
      ...
      case /* SolveAll */7 :
          ...
          return Async$AgdaMode.thenOk((function (param) {
                          ...
                          return Async$AgdaMode.resolve(/* () */0);
                        }))(Rebase.$$Array.reduce((function (promise, solution) {
                            return Async$AgdaMode.thenOk((function (param) {
                                            return Async$AgdaMode.thenOk((function (param) {
                                                            return Async$AgdaMode.resolve(/* () */0);
                                                          }))(solve(solution));
  ...
  if (typeof command === "number") {
    switch (command) {
      ...
      case /* QuerySymbol */17 :
          ...
          var getSymbol = Rebase.$$String.isEmpty(Rebase.$$String.trim(selected)) ? (Curry._1(instance[/* view */2][/* activate */0], /* () */0), Curry._1(instance[/* view */2][/* activate */0], /* () */0), Curry._3(instance[/* view */2][/* inquire */4], "Lookup Unicode Symbol Input Sequence", "symbol to lookup:", "")) : Async$AgdaMode.resolve(selected);
      ...
      case /* SearchAbout */0 :
          ...
          return Async$AgdaMode.thenOk((function (expr) {
                          return buff(/* SearchAbout */Caml_chrome_debugger.variant("SearchAbout", 2, [
                              ...
                              return /* Cancelled */0;
                            }))(Curry._3(instance[/* view */2][/* inquire */4], "Searching through definitions [" + (Command$AgdaMode.Normalization.toString(normalization) + "]"), "expression to infer:", "")));
      case /* InferType */1 :
          ...
          return Instance__TextEditors$AgdaMode.handleOutOfGoal((function (param) {
                          return Async$AgdaMode.thenOk((function (expr) {
                                          return buff(/* InferTypeGlobal */Caml_chrome_debugger.variant("InferTypeGlobal", 4, [
                                              ...
                                              return /* Cancelled */0;
                                            }))(Curry._3(instance[/* view */2][/* inquire */4], "Infer type [" + (Command$AgdaMode.Normalization.toString(normalization$1) + "]"), "expression to infer:", "")));
                        }))(Async$AgdaMode.thenOk((function (param) {
                              var index = param[1];
                              var goal = param[0];
                              if (Goal$AgdaMode.isEmpty(goal)) {
      ...
      case /* ModuleContents */2 :
          ...
          return Async$AgdaMode.thenOk((function (expr) {
                          return Instance__TextEditors$AgdaMode.handleOutOfGoal((function (param) {
                              ...
                              return /* Cancelled */0;
                            }))(Curry._3(instance[/* view */2][/* inquire */4], "Module contents [" + (Command$AgdaMode.Normalization.toString(normalization$2) + "]"), "module name:", "")));
...
function handleRemoteCommand(instance, handler, remote) {
  if (remote !== undefined) {
    var cmd = remote;
    Async$AgdaMode.mapOk((function (connection) {
              if (Command$AgdaMode.Remote.isLoad(cmd) && connection[/* resetLogOnLoad */5]) {

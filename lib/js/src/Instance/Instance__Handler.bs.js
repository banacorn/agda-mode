    ...
    switch (command) {
      case 0 : 
          return Async$AgdaMode.thenOk((function (param) {
                          ...
                          return Async$AgdaMode.thenOk((function (param) {
                                          Curry._1(instance[/* view */2][/* updateShouldDisplay */6], true);
      ...
      case 1 : 
          ...
          Curry._1(instance[/* view */2][/* updateShouldDisplay */6], false);
          ...
          if (Rebase.$$String[/* isEmpty */5](selectedText)) {
            return Async$AgdaMode.thenOk((function (expr) {
                            return Async$AgdaMode.thenOk((function (param) {
                                ...
                                return /* Cancelled */0;
                              }))(Curry._3(instance[/* view */2][/* inquire */4], "Scope info", "name:", "")));
          } else {
                          ...
                          if (Goal$AgdaMode.isEmpty(goal)) {
                            return Async$AgdaMode.thenOk((function (result) {
                                            ...
                                            return buff(/* Give */Caml_chrome_debugger.variant("Give", 9, [
                                                ...
                                                return /* Cancelled */0;
                                              }))(Curry._3(instance[/* view */2][/* inquire */4], "Give", "expression to give:", "")));
                          } else {
                            return buff(/* Give */Caml_chrome_debugger.variant("Give", 9, [
                                          goal,
                                          index
                          ...
                          if (Goal$AgdaMode.isEmpty(goal)) {
                            return Async$AgdaMode.thenOk((function (result) {
                                            ...
                                            return buff(/* Case */Caml_chrome_debugger.variant("Case", 12, [
                                                ...
                                                return /* Cancelled */0;
                                              }))(Curry._3(instance[/* view */2][/* inquire */4], "Case", "expression to case:", "")));
                          } else {
                            return buff(/* Case */Caml_chrome_debugger.variant("Case", 12, [
                                          goal,
                                          index
      ...
      case 17 : 
          ...
          var getSymbol = Rebase.$$String[/* isEmpty */5](Rebase.$$String[/* trim */8](selected)) ? (Curry._1(instance[/* view */2][/* updateShouldDisplay */6], true), Curry._1(instance[/* view */2][/* activate */0], /* () */0), Curry._3(instance[/* view */2][/* inquire */4], "Lookup Unicode Symbol Input Sequence", "symbol to lookup:", "")) : Async$AgdaMode.resolve(selected);
          Async$AgdaMode.finalOk((function (symbol) {
                  return Rebase.$$Option[/* forEach */8]((function (sequences) {
                                Curry._3(instance[/* view */2][/* display */3], "Input sequence for " + symbol, /* PlainText */0, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [Rebase.$$String[/* joinWith */11]("\n", Rebase.List[/* fromArray */12](sequences))])]));
                                return /* () */0;
      ...
      case 0 : 
          ...
          return Async$AgdaMode.thenOk((function (expr) {
                          return buff(/* SearchAbout */Caml_chrome_debugger.variant("SearchAbout", 2, [
                              ...
                              return /* Cancelled */0;
                            }))(Curry._3(instance[/* view */2][/* inquire */4], "Searching through definitions [" + (Command$AgdaMode.Normalization[/* toString */0](normalization) + "]"), "expression to infer:", "")));
      case 1 : 
          ...
          return Instance__TextEditors$AgdaMode.handleOutOfGoal((function (param) {
                          return Async$AgdaMode.thenOk((function (expr) {
                                          return buff(/* InferTypeGlobal */Caml_chrome_debugger.variant("InferTypeGlobal", 4, [
                                              ...
                                              return /* Cancelled */0;
                                            }))(Curry._3(instance[/* view */2][/* inquire */4], "Infer type [" + (Command$AgdaMode.Normalization[/* toString */0](normalization$1) + "]"), "expression to infer:", "")));
                        }))(Async$AgdaMode.thenOk((function (param) {
                              var index = param[1];
                              var goal = param[0];
                              if (Goal$AgdaMode.isEmpty(goal)) {
      ...
      case 2 : 
          ...
          return Async$AgdaMode.thenOk((function (expr) {
                          return Instance__TextEditors$AgdaMode.handleOutOfGoal((function (param) {
                              ...
                              return /* Cancelled */0;
                            }))(Curry._3(instance[/* view */2][/* inquire */4], "Module contents [" + (Command$AgdaMode.Normalization[/* toString */0](normalization$2) + "]"), "module name:", "")));
      case 3 : 
          ...
          return Instance__TextEditors$AgdaMode.handleOutOfGoal((function (param) {
                          return Async$AgdaMode.thenOk((function (expr) {
                                          return buff(/* ComputeNormalFormGlobal */Caml_chrome_debugger.variant("ComputeNormalFormGlobal", 8, [
                                              ...
                                              return /* Cancelled */0;
                                            }))(Curry._3(instance[/* view */2][/* inquire */4], "Compute normal form", "expression to normalize:", "")));
                        }))(Async$AgdaMode.thenOk((function (param) {
                              var index = param[1];
                              var goal = param[0];
                              if (Goal$AgdaMode.isEmpty(goal)) {
...
function dispatch(command, instance) {
  return Async$AgdaMode.passError((function (error) {
                  return Event$AgdaMode.emitError(error, instance[/* onDispatch */10]);
                }))(Async$AgdaMode.mapOk((function (param) {
                      return Event$AgdaMode.emitOk(/* () */0, instance[/* onDispatch */10]);
                    }))(Async$AgdaMode.wait((function (param) {

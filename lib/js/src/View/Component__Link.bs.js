  ...
  if (target_ !== undefined) {
    return React.createElement("span", {
                ...
                onClick: (function (param) {
                    if (jump) {
                      return Curry._1(emit, /* JumpToTarget */Caml_chrome_debugger.variant("JumpToTarget", 0, [target_]));
                    }
                    
                  }),
                onMouseOut: (function (param) {
                    if (hover) {
                      return Curry._1(emit, /* MouseOut */Caml_chrome_debugger.variant("MouseOut", 2, [target_]));
                    }
                    
                  }),
                onMouseOver: (function (param) {
                    if (hover) {
                      return Curry._1(emit, /* MouseOver */Caml_chrome_debugger.variant("MouseOver", 1, [target_]));
                    }

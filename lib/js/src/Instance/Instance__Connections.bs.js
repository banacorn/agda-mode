...
function inquireAgdaPath(error, instance) {
  return $$Promise.flatMap(Curry._1(instance[/* view */2][/* activate */0], /* () */0), (function (param) {
                return $$Promise.flatMap(Curry._1(instance[/* view */2][/* navigateSettings */12], /* Connection */1), (function (param) {
                              return $$Promise.flatMap(Curry._2(instance[/* view */2][/* updateConnection */13], undefined, error), (function (param) {
...
function getAgdaPath(instance) {
  ...
  return $$Promise.flatMapError(searchedPath, (function (err) {
                Curry._1(instance[/* onConnectionError */10][/* emit */1], err);
...
function persistConnection(instance, connection) {
  ...
  return $$Promise.map(Curry._2(instance[/* view */2][/* updateConnection */13], connection, undefined), (function (param) {

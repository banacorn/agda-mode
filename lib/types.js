...
(function (View) {
    ...
    (function (ErrorType) {
        ...
        ErrorType[ErrorType["RHSOmitted"] = 3] = "RHSOmitted";
        ErrorType[ErrorType["MissingType"] = 4] = "MissingType";
        ErrorType[ErrorType["MultipleDefinition"] = 5] = "MultipleDefinition";
        ErrorType[ErrorType["MissingDefinition"] = 6] = "MissingDefinition";
        ErrorType[ErrorType["Termination"] = 7] = "Termination";
        ErrorType[ErrorType["ConstructorTarget"] = 8] = "ConstructorTarget";
        ErrorType[ErrorType["FunctionType"] = 9] = "FunctionType";
        ErrorType[ErrorType["ModuleMismatch"] = 10] = "ModuleMismatch";
        ErrorType[ErrorType["Parse"] = 11] = "Parse";
        ErrorType[ErrorType["Unparsed"] = 12] = "Unparsed";

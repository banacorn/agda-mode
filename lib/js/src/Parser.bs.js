...
function flatMapOnResult(f, param) {
...
var $$Event = /* module */Caml_chrome_debugger.localModule(["flatMapOnResult"], [flatMapOnResult]);
...
function feed(self, input) {
  ...
  switch (match.tag | 0) {
    case 0 : 
        return Curry._1(self[/* callback */2], /* OnError */Caml_chrome_debugger.variant("OnError", 1, [match[0]]));
    case 1 : 
        self[/* continuation */1][0] = match[0];
        return /* () */0;
    case 2 : 
        Curry._1(self[/* callback */2], /* OnResult */Caml_chrome_debugger.variant("OnResult", 0, [match[0]]));

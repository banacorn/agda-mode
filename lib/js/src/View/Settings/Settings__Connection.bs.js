...
function Settings__Connection(Props) {
  ...
  var handleAutoSearch = function (param) {
    return Async$AgdaMode.finalError((function (err) {
                  return Curry._1(setAutoSearchError, (function (param) {
                                return /* AutoSearchError */Block.variant("AutoSearchError", 0, [err]);
                              }));
  ...
  var handleConnect = function (path) {
    Curry._1(setConnectPath, (function (param) {
            return path;
          }));
    Curry._1(setAutoSearchError, (function (param) {
            return undefined;
          }));
    return Event$AgdaMode.emitOk(path, onInquireConnection);
  };
  React.useEffect((function () {
          var editorModel = MiniEditor$AgdaMode.Model[/* make */0](/* () */0);
          return Event$AgdaMode.pipe(onInquireConnection, editorModel[/* result */3]);
        }), /* array */[]);
  React.useEffect((function () {
  ...
  if (connection !== undefined) {
    var conn = connection;
    var match$3 = conn[/* metadata */0][/* protocol */3];
  ...
  return React.createElement("section", {
              className: className
                      ...
                      onEditorRef: (function (ref) {
                          return Curry._1(setEditorRef, (function (param) {
                                        return Caml_option.some(ref);
                                      }));
                        })
...
function make(inquireConnection, onInquireConnection, connection, error, hidden, children) {
  return ReasonReactCompat.wrapReactForReasonReact(Settings__Connection, {
...
var make$1 = Settings__Connection;

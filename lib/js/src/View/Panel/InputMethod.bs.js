            ...
            return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                      ...
                      (function (self) {
                          ...
                          var markersDisposables = Rebase.$$Option[/* map */0]((function (marker) {
                                  ...
                                  garbages.add(marker.onDidChange(Curry._1(self[/* handle */0], (function (param, param$1) {
...
function make(editors, interceptAndInsertKey, activateInputMethod, onActivationChange, isActive, _children) {
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",
                            ...
                            className: className
                                ...
                                className: "keyboard"
                                    ...
                                    className: "keys btn-group btn-group-sm"
                                        ...
                                        }), translation[/* keySuggestions */2]))), ReasonReact.element(undefined, undefined, CandidateSymbols$AgdaMode.Jsx2[/* make */1](isActive, translation[/* candidateSymbols */3], (function (replace) {

...
function Settings__Connection(Props) {
  ...
  var handleAutoSearch = function (param) {
    return Async$AgdaMode.finalError((function (err) {
                  return Curry._1(setAutoSearchError, /* AutoSearchError */Block.variant("AutoSearchError", 0, [err]));
  ...
  if (connection !== undefined) {
    var conn = connection;
    var match$3 = conn[/* log */4][/* metadata */0][/* protocol */3];
    tmp = React.createElement(React.Fragment, undefined, React.createElement("p", undefined, "Path: " + conn[/* log */4][/* metadata */0][/* path */0]), React.createElement("p", undefined, "Version: " + conn[/* log */4][/* metadata */0][/* version */2]), React.createElement("p", undefined, "Supported protocol: " + (
  ...
  return React.createElement("section", {
              className: className
                      ...
                      value: connection !== undefined ? connection[/* log */4][/* metadata */0][/* path */0] : "",

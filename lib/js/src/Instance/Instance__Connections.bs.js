...
function inquireAgdaPath(error, instance) {
  ...
  return Async$AgdaMode.then_((function (param) {
                  Curry._1(instance[/* view */2][/* navigateSettings */14], /* Connection */1);
                  Curry._2(instance[/* view */2][/* updateConnection */17], undefined, error);
                  return Curry._1(instance[/* view */2][/* inquireConnection */19], /* () */0);
                }), (function (param) {
                  return Async$AgdaMode.reject(/* Cancelled */0);
                }))(Curry._1(instance[/* view */2][/* openSettings */16], /* () */0));
}
...
function persistConnection(instance, connection) {
  ...
  Curry._2(instance[/* view */2][/* updateConnection */17], connection, undefined);
  return connection;
}
...
function disconnect(instance) {
  ...
  if (match !== undefined) {
    ...
    return Curry._2(instance[/* view */2][/* updateConnection */17], undefined, undefined);
  } else {
    return /* () */0;
  }
}

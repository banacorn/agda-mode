...
function typeError(param) {
  return Json_decode.andThen((function (kind, json) {
                switch (kind) {
                  ...
                  case "NotInScope" : 
                      return /* NotInScope */Block.variant("NotInScope", 4, [Json_decode.field("names", (function (param) {
                  ...
                  case "UnequalTerms" : 
                      return /* UnequalTerms */Block.variant("UnequalTerms", 3, [
                                Json_decode.field("comparison", comparison, json),
                  ...
                  default:
                    return /* UnregisteredTypeError */Block.variant("UnregisteredTypeError", 5, [json]);
                }
              }), (function (param) {
                return Json_decode.field("kind", Json_decode.string, param);
              }), param);

...
function connect(instance) {
  ...
  if (match !== undefined) {
    ...
    return Async$AgdaMode.mapOk(Connection$AgdaMode.wire)(Async$AgdaMode.mapOk((function (param) {
                        ...
                        Event$AgdaMode.onOk((function (error) {
                                  display("Error from Agda", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* Error */Block.variant("Error", 6, [error])]), instance$1[/* view */2]);
                                  return /* () */0;
...
function handleCommandError(instance) {
  return Async$AgdaMode.thenError((function (error) {
                if (typeof error === "number") {
                  ...
                  display("Parse Errors", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [intro + message])]), instance[/* view */2]);
                }
                return Async$AgdaMode.resolve(/* () */0);
              }));
}
...
function dispatch(command, instance) {
  return Async$AgdaMode.thenOk((function (result) {
                  var parseErrors = Rebase.$$Array[/* filterMap */23]((function (param) {
                          if (param.tag) {
                            return param[0];
                          }
                          
                        }), result);
                  if (Rebase.$$Array[/* length */16](parseErrors) > 0) {
                    return Async$AgdaMode.reject(/* ParseError */Block.variant("ParseError", 0, [parseErrors]));
                  } else {

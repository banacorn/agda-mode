    ...
    render() {
        ...
        return (React.createElement("section", { className: this.props.className },
            ...
            React.createElement("ol", null, this.props.state.connections.map((conn) => {
                return React.createElement(ConnectionItem_1.default, { key: conn.guid, uri: conn.uri, version: conn.version.sem, pinned: this.props.state.pinned === conn.guid, current: this.props.state.current === conn.guid, onConnect: () => {

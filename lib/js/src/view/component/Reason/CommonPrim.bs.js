...
function make$2($staropt$star, value, children) {
  ...
  return /* record */Block.record([
            ...
            (function () {
                ...
                var name = value[0];
                if (name !== undefined) {
                  return parensIf(prec > 0, React.createElement(React.Fragment, undefined, name[1] + "=", Curry._2(children, 0, value$1)));
                } else {
...
var NamedArg = /* module */Block.localModule(["namedArg"], [namedArg]);

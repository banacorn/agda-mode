...
function make(editors, element, onMountAtChange, body, header, mountAt, mode, hidden, settingsView, onInquireQuery, onEditorRef, editorPlaceholder, editorValue, interceptAndInsertKey, activateInputMethod, onSettingsViewToggle, _children) {
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",

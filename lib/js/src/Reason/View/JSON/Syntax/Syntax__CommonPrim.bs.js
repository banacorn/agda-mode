...
function make(relevance, _children) {
...
function make$1($staropt$star, $staropt$star$1, $staropt$star$2, children) {
  var hiding = $staropt$star !== undefined ? $staropt$star : /* NotHidden */1;
  var parens = $staropt$star$2 !== undefined ? $staropt$star$2 : id;
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",
...
function make$2($staropt$star, value, children) {
  ...
  return /* record */Block.record([
            ...
            (function (_self) {
                ...
                var name = value[0];
                if (name !== undefined) {
                  var elem = Util$AgdaMode.React[/* sepBy */0](" ", /* :: */Block.simpleVariant("::", [
                          name[1],
                          /* :: */Block.simpleVariant("::", [
                              "=",
                              /* :: */Block.simpleVariant("::", [

...
var textEditorID = Curry._2(Rebase.Fn[/* >> */6], (function (prim) {
        return prim.id;
      }), (function (prim) {
        return String(prim);
      }));
...
function getThen(f, textEditor) {
  return Rebase.$$Option[/* forEach */8](f, Js_dict.get(instances, Curry._1(textEditorID, textEditor)));
}
...
function size(param) {
  return Rebase.$$Array[/* length */16](Object.keys(instances));
}

var Instances = /* module */Caml_chrome_debugger.localModule([
    "textEditorID",
    "get",
    "getThen",
    "add",
...
function onEditorActivationChange(param) {
  ...
  subscriptions.add(atom.workspace.onDidChangeActiveTextEditor((function (next) {
              var partial_arg = Curry._2(Rebase.Fn[/* >> */6], Instance$AgdaMode.deactivate, (function (prim) {
                      return /* () */0;
                    }));
              ...
              if (next !== undefined) {
                ...
                getThen(Curry._2(Rebase.Fn[/* >> */6], Instance$AgdaMode.activate, (function (prim) {
                            return /* () */0;
                          })), nextEditor);
...
function onTriggerCommand(param) {
  return Rebase.$$Array[/* forEach */8]((function (command) {
                subscriptions.add(atom.commands.add("atom-text-editor", "agda-mode:" + command, (function (_event) {
                            console.log("[ AgdaMode ][ command ] " + command);
                            console.log("[ AgdaMode ][ event ] ", _event);
                            console.log("[ AgdaMode ][ active ] ", atom.views.getView(atom.workspace.getActiveTextEditor()));
                            console.log("[ AgdaMode ][ all ] ", Rebase.$$Array[/* map */0]((function (prim) {
                                        return atom.views.getView(prim);
                                      }), atom.workspace.getTextEditors()));
                            console.log("[ AgdaMode ][ all sizE ] ", Rebase.$$Array[/* length */16](atom.workspace.getTextEditors()));
                            return Rebase.$$Option[/* forEach */8]((function (instance) {
                                          console.log("[ AgdaMode ] " + command);
                                          ...
                                          return /* () */0;
                                              ...
                                              console.log("[ AgdaMode ][ got instance ]");
                                              return x;
                                            }), Rebase.$$Option[/* flatMap */5](get, Rebase.$$Option[/* map */0]((function (x) {
                                                      console.log("[ AgdaMode ][ got active text editor ]");
                                                      return x;
...
function onUndo(param) {
  subscriptions.add(atom.commands.add("atom-text-editor", "core:undo", (function ($$event) {
              ...
              return Rebase.$$Option[/* forEach */8](Instance$AgdaMode.dispatchUndo, Rebase.$$Option[/* flatMap */5](get, activated));
            })));
  return /* () */0;
}

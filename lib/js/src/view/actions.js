...
var BODY;
(function (BODY) {
    BODY.UPDATE_EMACS_METAS = 'BODY.UPDATE_EMACS_METAS';
    BODY.UPDATE_METAS = 'BODY.UPDATE_METAS';
...
exports.updateEmacsMetas = redux_actions_1.createAction(BODY.UPDATE_EMACS_METAS);
exports.updateMetas = redux_actions_1.createAction(BODY.UPDATE_METAS);

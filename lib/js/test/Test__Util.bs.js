...
var PanelContainerNotFound = Caml_exceptions.create("Test__Util-AgdaMode.View.PanelContainerNotFound");

function getPanelContainerAtBottom(param) {
  ...
  if (match !== undefined) {
    ...
    return Promise.reject(PanelContainerNotFound);
  }
}
...
function getPanelAtBottom(instance) {
  ...
  return getPanelContainerAtBottom(/* () */0).then((function (container) {
                var panels = Rebase.$$Array[/* filter */10]((function (elem) {
                        return elem.id === targetID;
                      }), Curry._1(childHtmlElements, container));

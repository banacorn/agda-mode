...
function handleCommandError(instance) {
  return Async$AgdaMode.thenError((function (error) {
                if (typeof error === "number") {
                  ...
                  View$AgdaMode.Handles[/* display */5]("Connection-related Error: " + match[0], /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [match[1]])]), instance[/* view */2]);
                } else {
                  var match$1 = error[0];
                  if (match$1.tag) {
  ...
  if (typeof response === "number") {
    switch (response) {
      ...
      case 2 : 
          ...
          return Async$AgdaMode.resolve(/* () */0);
      case 3 : 
          View$AgdaMode.Handles[/* display */5]("Status", /* Warning */4, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, ["Done aborting"])]), instance[/* view */2]);
          return Async$AgdaMode.resolve(/* () */0);
    ...
    switch (response.tag | 0) {
      ...
      case 9 : 
          ...
          if (response[0] >= 2) {
            ...
            View$AgdaMode.Handles[/* display */5]("Type-checking", /* PlainText */0, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [message])]), instance[/* view */2]);
          }
          return Async$AgdaMode.resolve(/* () */0);
    ...
    switch (command) {
      case 0 : 
          return Async$AgdaMode.thenOk((function (param) {
                          ...
                          View$AgdaMode.Handles[/* updateShouldDisplay */9](true, instance[/* view */2]);
                          View$AgdaMode.Handles[/* display */5]("Loading ...", /* PlainText */0, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [""])]), instance[/* view */2]);
      ...
      case 1 : 
          ...
          Instance__Highlightings$AgdaMode.destroyAll(instance);
          View$AgdaMode.Handles[/* deactivate */3](instance[/* view */2]);
          instance[/* isLoaded */0] = false;
          View$AgdaMode.Handles[/* updateShouldDisplay */9](false, instance[/* view */2]);
...
function dispatch(command, instance) {
  return Async$AgdaMode.pass((function (param) {
                  View$AgdaMode.Handles[/* updateIsPending */8](false, instance[/* view */2]);
                  return /* () */0;
                }))(Async$AgdaMode.thenOk((function (param) {
                      return handleRemoteCommand(instance, param);
                    }))(Async$AgdaMode.pass((function (param) {
                          View$AgdaMode.Handles[/* updateIsPending */8](true, instance[/* view */2]);
                          return /* () */0;

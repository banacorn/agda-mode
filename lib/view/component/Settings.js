...
var Settings = (function (_super) {
    ...
    Settings.prototype.render = function () {
        ...
        var _a = this.props, mountAtPane = _a.mountAtPane, mountAtBottom = _a.mountAtBottom, toggleDevView = _a.toggleDevView;
        ...
        return (React.createElement("ul", {className: "agda-settings"}, 
            React.createElement("li", null, 
                React.createElement("button", {className: devViewClassList, onClick: toggleDevView}, 

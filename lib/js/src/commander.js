...
class Commander {
    constructor(core) {
        ...
        this.dispatch = (command) => {
            ...
            if (needNoConnection) {
                return this.dispatchCommand(command)(null)
                    ...
                    this.core.view.setPlainText('Query cancelled', '', 4 /* Warning */);
                })
        ...
        this.searchAbout = (normalization) => (command, connection) => {
            return this.core.view.query(`Searching through definitions ${toDescription(normalization)}`, [], 0 /* PlainText */, 'expression to infer:')
        ...
        this.give = (command, connection) => {
            return this.core.editor.goal.pointing()
                ...
                .catch(Err.OutOfGoalError, () => {
                this.core.view.setPlainText('Out of goal', '`Give` is a goal-specific command, please place the cursor in a goal', 3 /* Error */);
                return [];
            });
        };
        this.refine = (command, connection) => {
            return this.core.editor.goal.pointing()
                ...
                .catch(Err.OutOfGoalError, () => {
                this.core.view.setPlainText('Out of goal', '`Refine` is a goal-specific command, please place the cursor in a goal', 3 /* Error */);
                return [];
            });
        };
        this.auto = (command, connection) => {
            return this.core.editor.goal.pointing()
                ...
                .catch(Err.OutOfGoalError, () => {
                this.core.view.setPlainText('Out of goal', '`Auto` is a goal-specific command, please place the cursor in a goal', 3 /* Error */);
                return [];
            });
        };
        this.case = (command, connection) => {
            return this.core.editor.goal.pointing()
                ...
                .catch(Err.OutOfGoalError, () => {
                this.core.view.setPlainText('Out of goal', '`Case` is a goal-specific command, please place the cursor in a goal', 3 /* Error */);
                return [];
            });
        };
        this.goalType = (normalization) => (command, connection) => {
            return this.core.editor.goal.pointing()
                ...
                .catch(Err.OutOfGoalError, () => {
                this.core.view.setPlainText('Out of goal', '"Goal Type" is a goal-specific command, please place the cursor in a goal', 3 /* Error */);
                return [];
            });
        };
        this.context = (normalization) => (command, connection) => {
            return this.core.editor.goal.pointing()
                ...
                .catch(Err.OutOfGoalError, () => {
                this.core.view.setPlainText('Out of goal', '"Context" is a goal-specific command, please place the cursor in a goal', 3 /* Error */);
                return [];
            });
        };
        this.goalTypeAndContext = (normalization) => (command, connection) => {
            return this.core.editor.goal.pointing()
                ...
                .catch(Err.OutOfGoalError, () => {
                this.core.view.setPlainText('Out of goal', '"Goal Type & Context" is a goal-specific command, please place the cursor in a goal', 3 /* Error */);
                return [];
            });
        };
        this.goalTypeAndInferredType = (normalization) => (command, connection) => {
            return this.core.editor.goal.pointing()
                ...
                .catch(Err.OutOfGoalError, () => {
                this.core.view.setPlainText('Out of goal', '"Goal Type & Inferred Type" is a goal-specific command, please place the cursor in a goal', 3 /* Error */);
                return [];
            });
        };
        this.inputSymbol = () => {
            if (atom.config.get('agda-mode.inputMethod')) {
                if (!this.loaded) {
                    ...
                    this.core.view.mountPanel(currentMountingPosition);
                    this.core.view.activatePanel();
                    this.core.view.setPlainText('Not loaded', '', 0 /* PlainText */);
                }
        ...
        this.querySymbol = () => {
            ...
            if (selectedText.length > 0) {
                ...
                this.core.view.setPlainText(`Input sequence for ${symbol}`, sequences.toString(), 0 /* PlainText */);
                return Promise.resolve([]);
            }
            else {

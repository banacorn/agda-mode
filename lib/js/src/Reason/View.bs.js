...
var InputMethod$AgdaMode = require("./View/InputMethod.bs.js");
...
function mountPanel(self, editor, mountTo) {
  ...
  if (typeof match === "number") {
    switch (mountTo) {
      case 0 : 
          return Curry._1(self[/* send */3], /* UpdateMountAt */Block.variant("UpdateMountAt", 3, [/* Bottom */Block.variant("Bottom", 0, [createElement(/* () */0)])]));
      case 1 : 
          return Curry._1(self[/* send */3], /* UpdateMountAt */Block.variant("UpdateMountAt", 3, [/* Pane */Block.variant("Pane", 1, [createTab(/* () */0)])]));
      case 2 : 
          return /* () */0;
  ...
  if (typeof action === "number") {
    if (action === 0) {
      ...
      return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                ...
                (function (self) {
                    return Editors$AgdaMode.focusGeneral(self[/* state */1][/* editors */3]);
                  })
              ]);
    } else {
      var init$1 = state[/* editors */3];
      return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                /* record */Block.record([
                    "header",
                    "body",
                ...
                (function (self) {
                    return Editors$AgdaMode.focusMain(self[/* state */1][/* editors */3]);
                  })
              ]);
    }
  } else {
    switch (action.tag | 0) {
      case 0 : 
          var init$2 = state[/* editors */3];
          var init$3 = state[/* editors */3][/* general */2];
      ...
      case 1 : 
          var init$4 = state[/* editors */3];
          var init$5 = state[/* editors */3][/* general */2];
          return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                    /* record */Block.record([
                        "header",
                        "body",
      ...
      case 2 : 
          ...
          return /* SideEffects */Block.variant("SideEffects", 1, [(function (self) {
                        return mountPanel(self, state[/* editors */3][/* main */1], mountTo);
                      })]);
      case 3 : 
          return /* Update */Block.variant("Update", 0, [/* record */Block.record([
                        "header",
...
function jsInterceptAndInsertKey($$char) {
  return Curry._1(interceptAndInsertKey[0], $$char);
}

function jsActivateInputMethod(param) {
  return Curry._1(activateInputMethod[0], /* () */0);
}
  ...
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                element = typeof mountAt === "number" ? undefined : (
                    mountAt.tag ? Js_primitive.some(mountAt[0][/* element */0]) : Js_primitive.some(mountAt[0])
                  );
                return React.createElement(React.Fragment, undefined, ReasonReact.element(undefined, undefined, Panel$AgdaMode.make(element, (function (mountTo) {
                                      return Curry._1(self[/* send */3], /* MountTo */Block.variant("MountTo", 2, [mountTo]));
                                    }), match[/* body */1], match[/* header */0], mountAt, match[/* mode */4], (function (result) {
                                      Curry._1(Editors$AgdaMode.answerGeneral(editors), result);
                                      Curry._1(self[/* send */3], /* FocusMain */1);
                                      return Curry._1(self[/* send */3], /* UpdateMode */Block.variant("UpdateMode", 6, [/* Display */0]));
                                    }), (function () {
                                      return Curry._1(self[/* send */3], /* FocusGeneral */0);
                                    }), (function () {
                                    ...
                                    }), editors[/* general */2][/* placeholder */1], editors[/* general */2][/* value */0], /* array */[])), ReasonReact.element(undefined, undefined, InputMethod$AgdaMode.make(editors, (function (handle) {
                                      interceptAndInsertKey[0] = handle;
                                      return /* () */0;
                                    }), (function (handle) {
                                      activateInputMethod[0] = handle;
                                      return /* () */0;
                                    }), /* array */[])));
              }),
            (function (param) {
...
exports.interceptAndInsertKey = interceptAndInsertKey;
exports.activateInputMethod = activateInputMethod;
exports.jsInterceptAndInsertKey = jsInterceptAndInsertKey;
exports.jsActivateInputMethod = jsActivateInputMethod;

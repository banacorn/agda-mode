...
class Editor {
    ...
    warnOutOfGoal() {
        this.core.view.setPlainText('Out of goal', 'For this command, please place the cursor in a goal', 4 /* Warning */);
    }
    warnEmptyGoal(error) {
        this.core.view.setPlainText('No content', error.message, 4 /* Warning */);
    }
    //////////////////
    //  Filesystem  //
    //////////////////

...
function Settings__Connection(Props) {
  ...
  var handleAutoSearch = function (param) {
    ...
    $$Promise.getOk(promise, (function (path) {
            return $$Promise.getOk(Curry._1(editorRef[/* acquire */0], /* () */0), (function (editor) {
                          editor.setText(path);
                          return /* () */0;
                        }));
          }));
  ...
  var focusOnPathEditor = function (editor) {
    ...
    editor.selectAll();
    return Curry._1(onSetPath[/* once */2], /* () */0);
  };
  Hook$AgdaMode.useChannel((function (param) {
          return $$Promise.flatMapOk(Curry._1(editorRef[/* acquire */0], /* () */0), focusOnPathEditor);
  ...
  return React.createElement("section", {
              className: className
                      ...
                      onConfirm: (function (path) {
                          ...
                          return Curry._1(onSetPath[/* emit */1], /* Ok */Caml_chrome_debugger.variant("Ok", 0, [path]));
                        }),
                      onEditorRef: (function (x) {
                          return Curry._1(editorRef[/* supply */1], /* Ok */Caml_chrome_debugger.variant("Ok", 0, [x]));
                        })

  ...
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                return React.createElement(React.Fragment, undefined, ReasonReact.element(undefined, undefined, Curry._2(Type__View$AgdaMode.MouseEmitter[/* Provider */1][/* make */0], (function (ev) {
                                    ...
                                    ReasonReact.element(undefined, undefined, Settings$AgdaMode.make(handles[/* inquireConnection */5], handles[/* onInquireConnection */6], match[/* connection */6], handles[/* navigateSettingsView */11], settingsElement, /* array */[]))
                                  ])));
              }),
            initialState,

...
function parseAgdaOutput(parser, stringAgdaSpatOut) {
  var isStartOfResponse = Rebase.$$String[/* startsWith */3]("Agda2> ", stringAgdaSpatOut);
  var isEndOfResponse = Rebase.$$String[/* endsWith */4]("Agda2> ", stringAgdaSpatOut);
  var trimmed = isStartOfResponse ? (
      isEndOfResponse ? stringAgdaSpatOut.substring(7, Rebase.$$String[/* length */1](stringAgdaSpatOut) - 7 | 0) : stringAgdaSpatOut.substring(7, Rebase.$$String[/* length */1](stringAgdaSpatOut))
    ) : (
      isEndOfResponse ? stringAgdaSpatOut.substring(0, Rebase.$$String[/* length */1](stringAgdaSpatOut) - 7 | 0) : stringAgdaSpatOut
    );

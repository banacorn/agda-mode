...
function ofType_001(captured) {
  return Js_option.andThen((function (term) {
                return Js_option.andThen((function (type_) {
                              return Js_option.andThen((function (term$prime) {
                                            return Js_option.andThen((function (type_$prime) {
                                                          return /* OfType */Block.variant("OfType", 0, [
                                                                    term$prime,
                                                                    type_$prime
                                                                  ]);
                                                        }), Util$AgdaMode.Re_[/* parse */1](exprs, type_));
                                          }), Util$AgdaMode.Re_[/* parse */1](exprs, term));
...
function justType_001(captured) {
  return Js_option.andThen((function (type_) {
                return Js_option.andThen((function (type_$prime) {
                              return /* JustType */Block.variant("JustType", 1, [type_$prime]);
                            }), Util$AgdaMode.Re_[/* parse */1](exprs, type_));
              }), Caml_array.caml_array_get(captured, 1));
}
...
function justSort_001(captured) {
  return Js_option.andThen((function (sort) {
                return Js_option.andThen((function (sort$prime) {
                              return /* JustSort */Block.variant("JustSort", 2, [sort$prime]);
                            }), Util$AgdaMode.Re_[/* parse */1](exprs, sort));
              }), Caml_array.caml_array_get(captured, 1));
}
...
var others = /* String */Block.variant("String", 1, [(function (raw) {
        return Js_option.andThen((function (raw$prime) {

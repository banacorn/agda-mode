  ...
  React.useEffect((function () {
          ...
          if (typeof match === "number") {
            if (match === 0) {
              ...
              console.log("[ IM ][ reality ][ Stuck ]");
              Curry._1(setChangeLog, /* Stuck */3);
              Curry._1(send, /* Deactivate */1);
            }
          } else if (match.tag) {
            var buffer = match[0];
            console.log("[ IM ][ reality ][ Rewrite ] " + Buffer$AgdaMode.toString(buffer));
            ...
            console.log("[ IM ][ reality ][ Noop ] " + Buffer$AgdaMode.toString(buffer$1));

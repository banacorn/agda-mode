...
function run(instance, errorHandler, tasks) {
  var runTask = function (task) {
    switch (task.tag | 0) {
      ...
      case /* SendRequest */2 :
          var request = task[0];
          console.log("[ request ]", Request$AgdaMode.toString(request));
          return $$Promise.map(Instance__Handler$AgdaMode.handleCommandError($$Promise.tapError($$Promise.mapOk($$Promise.flatMap($$Promise.flatMapOk($$Promise.flatMap(packRequest(request, instance), (function (x) {

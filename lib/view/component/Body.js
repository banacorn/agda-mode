...
class Body extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("section", { className: classes, tabIndex: -1, style: style },
            React.createElement("ul", { className: "list-group" }, body.goalAndHave.map((item, i) => React.createElement("li", { className: "list-item special-item", key: i },
            ...
            React.createElement("ul", { className: "list-group" },
                body.goals.map((item, i) => React.createElement("li", { className: "list-item body-item", key: i },
                    ...
                    React.createElement("div", { className: "item-body" },
                        React.createElement(Expr_1.default, { emitter: emitter }, item.type)))),
                body.judgements.map((item, i) => React.createElement("li", { className: "list-item body-item", key: i },
                    React.createElement("div", { className: "item-heading" },
                    ...
                    React.createElement("div", { className: "item-body" },
                        React.createElement(Expr_1.default, { emitter: emitter }, item.type)))),
                body.terms.map((item, i) => React.createElement("li", { className: "list-item body-item", key: i },
                    React.createElement("div", { className: "item-body" },
                        React.createElement(Expr_1.default, { emitter: emitter }, item.expr)))),
                body.metas.map((item, i) => React.createElement("li", { className: "list-item body-item", key: i },
                    React.createElement("div", { className: "item-heading" },
                ...
                body.sorts.map((item, i) => React.createElement("li", { className: "list-item body-item", key: i },
                    React.createElement("div", { className: "item-heading" },

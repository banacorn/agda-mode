...
function sepBy(sep, item) {
  if (item) {
    ...
    var x = item[0];
    if (xs) {
      return manyIn("span")(Rebase.$$Array[/* fromList */13](/* :: */Caml_chrome_debugger.simpleVariant("::", [
                        x,
...
var ClassName = /* module */Caml_chrome_debugger.localModule([
    "add",
    "addWhen",
    "serialize"
  ], [
...
var Resource = /* module */Caml_chrome_debugger.localModule(["make"], [make]);

...
var Promise$AgdaMode = require("./Util/Promise.bs.js");
...
function addFromFile(filepath, instance) {
  ...
  return Promise$AgdaMode.$$catch((function (err) {
                console.log(err);
                console.log("cannot read the indirect highlighting file: " + filepath);
                return Promise$AgdaMode.resolve(/* () */0);
              }), Promise$AgdaMode.then_((function (content) {
...
function connect(instance) {
  var inquireConnection = function (error, instance) {
    activate(instance);
    var promise = Promise$AgdaMode.then_((function (param) {
  ...
  var getAgdaPath = function (param) {
    ...
    if (Rebase.$$String[/* isEmpty */5](storedPath)) {
      ...
      return Promise$AgdaMode.resolve(/* Ok */Block.variant("Ok", 0, [storedPath]));
    }
  };
  var getMetadata = function (instance, path) {
    return Promise$AgdaMode.thenError((function (err) {
                    return Promise$AgdaMode.thenOk((function (param) {
  ...
  var getConnection = function (instance, metadata) {
    return Promise$AgdaMode.thenError((function (err) {
                    return Promise$AgdaMode.thenOk((function (param) {
                                  ...
                                  }))(Promise$AgdaMode.thenOk((function (param) {
                                        return getMetadata(instance, param);
  ...
  if (match !== undefined) {
    return Promise$AgdaMode.resolve(/* Ok */Block.variant("Ok", 0, [match]));
  } else {
    return Promise$AgdaMode.mapOk(Connection$AgdaMode.wire)(Promise$AgdaMode.mapOk((function (param) {
                        ...
                        return connection;
                            ...
                            return getConnection(instance, param);
                                ...
                                return getMetadata(instance, param);
                              }))(Promise$AgdaMode.thenError((function (err) {
...
function cultivateCommand(command, instance) {
  var cultivate = function (command, instance) {
    return Promise$AgdaMode.mapError((function (param) {
                    return /* Cancelled */0;
                  }))(Promise$AgdaMode.mapOk((function (connection) {
                        return /* record */Block.record([
                                  "connection",
                                  "filepath",
                                  "command"
  ...
  if (typeof command === "number") {
    switch (command) {
      case 0 : 
          return Promise$AgdaMode.then_((function (param) {
      ...
      case 1 : 
          ...
          return Promise$AgdaMode.resolve(/* Ok */Block.variant("Ok", 0, [undefined]));
      case 2 : 
          disconnect(instance);
          return cultivate(/* Load */0, instance);
      case 13 : 
          ...
          if (pointed !== undefined) {
            ...
            if (match !== undefined) {
              ...
              if (Goal$AgdaMode.isEmpty(goal)) {
                return Promise$AgdaMode.thenOk((function (result) {
                                Goal$AgdaMode.setContent(result, goal);
                                return cultivate(/* Give */Block.variant("Give", 0, [
                                              goal,
                                              index
                                            ]), instance);
                              }))(Promise$AgdaMode.mapError((function (param) {
                                    return /* Cancelled */0;
              ...
              return Promise$AgdaMode.resolve(/* Error */Block.variant("Error", 1, [/* GoalNotIndexed */1]));
            }
          } else {
            updateView(/* record */Block.record([
                    "text",
            ...
            return Promise$AgdaMode.resolve(/* Error */Block.variant("Error", 1, [/* OutOfGoal */2]));
          }
      case 14 : 
...
function dispatch(command, instance) {
  return Promise$AgdaMode.then_((function (cultivated) {
                if (cultivated.tag) {
                  console.log(cultivated[0]);
                  return Promise$AgdaMode.resolve(undefined);
                } else {
                  var match = cultivated[0];
                  if (match !== undefined) {
                    var cmd = match;
                    var s = Command$AgdaMode.Cultivated[/* serialize */0](cmd);
                    return Promise$AgdaMode.map(Rebase.Option[/* some */11], Connection$AgdaMode.send(s, cmd[/* connection */0]));
                  } else {
                    return Promise$AgdaMode.resolve(undefined);
                  }
                }

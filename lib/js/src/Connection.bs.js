...
function connect(metadata) {
  ...
  return $$Promise.mapError(($$process.on("error", (function (exn) {
                        ...
                        return Curry._1(resolve, /* Error */Caml_chrome_debugger.variant("Error", 1, [/* ShellError */Caml_chrome_debugger.variant("ShellError", 0, [exn])]));
                      })).on("close", (function (code, signal) {
                      disconnect(/* ClosedByProcess */Caml_chrome_debugger.variant("ClosedByProcess", 1, [
                              code,
                              signal
                            ]), connection);
                      return Curry._1(resolve, /* Error */Caml_chrome_debugger.variant("Error", 1, [/* ClosedByProcess */Caml_chrome_debugger.variant("ClosedByProcess", 1, [
                                        code,
                                        signal
                                      ])]));

...
var component$1 = ReasonReact.statelessComponent("Named");

function make$1($staropt$star, value, child, _) {
            ...
            (function () {
                ...
                if (name !== undefined) {
                  return parensIf(prec > 0, /* array */[
                              name[1] + "=",
                              Curry._2(child, 0, value$1)
                            ]);
                } else {
                  return Curry._2(child, prec, value$1);
                }
              }),
...
var component$2 = ReasonReact.statelessComponent("Arg");

function make$2($staropt$star, value, child, _) {
  var prec = $staropt$star !== undefined ? $staropt$star : 0;
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            ...
            (function () {
                ...
                return ReasonReact.element(undefined, undefined, make(argInfo[/* hiding */0], undefined, localParens, /* array */[Curry._2(child, p, value[1])]));
              }),

      ...
      switch (task.tag | 0) {
        ...
        case /* Goals */5 :
            ...
            if (typeof match === "number") {
              ...
              var handler = match[1];
              return $$Promise.flatMap(handleError($$Promise.map($$Promise.mapOk(Instance__TextEditors$AgdaMode.getPointedGoal(instance), match[0]), (function (others) {
                                    if (others.tag) {
                                      var match = others[0];
              ...
              return $$Promise.flatMap(handleError($$Promise.mapOk(Instance__TextEditors$AgdaMode.getPointedGoal(instance), match[0])), executeTasks);
            }

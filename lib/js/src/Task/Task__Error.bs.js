...
function handle(errors) {
    ...
    if (errors === /* Cancelled */0) {
      ...
      return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                /* Display */Caml_chrome_debugger.variant("Display", 2, [
                    "Out of goal",
                    /* Error */1,
                    /* Emacs */Caml_chrome_debugger.simpleVariant("Emacs", [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, ["Please place the cursor in a goal"])])
                  ]),
                /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* WithInstance */Caml_chrome_debugger.variant("WithInstance", 0, [(function (instance) {
                            Editors$AgdaMode.Focus.on(/* Source */0, instance.editors);
  ...
  if (errors.tag) {
    var match = Connection$AgdaMode.$$Error.toString(errors[0]);
    return /* :: */Caml_chrome_debugger.simpleVariant("::", [
              /* Display */Caml_chrome_debugger.variant("Display", 2, [
                  "Connection-related Error: " + match[0],
                  /* Error */1,
                  /* Emacs */Caml_chrome_debugger.simpleVariant("Emacs", [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [match[1]])])
                ]),
              /* :: */Caml_chrome_debugger.simpleVariant("::", [
                  /* WithInstance */Caml_chrome_debugger.variant("WithInstance", 0, [(function (instance) {
                          Editors$AgdaMode.Focus.on(/* Source */0, instance.editors);
            ...
            /* WithConnection */Caml_chrome_debugger.variant("WithConnection", 1, [(function (conn) {
                    ...
                    return Task$AgdaMode.$$return(/* :: */Caml_chrome_debugger.simpleVariant("::", [
                                  /* Display */Caml_chrome_debugger.variant("Display", 2, [
                                      "Parse Error",
                                      /* Error */1,
                                      /* Emacs */Caml_chrome_debugger.simpleVariant("Emacs", [/* ParseError */Caml_chrome_debugger.variant("ParseError", 7, [conn])])
                                    ]),
                                  /* [] */0
                                ]));
                  })]),

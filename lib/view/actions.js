...
(function (INPUT_EDITOR) {
    ...
    INPUT_EDITOR.FOCUS = 'INPUT_EDITOR.FOCUS';
    INPUT_EDITOR.FOCUSED = 'INPUT_EDITOR.FOCUSED';
    INPUT_EDITOR.BLUR = 'INPUT_EDITOR.BLUR';
    INPUT_EDITOR.BLURRED = 'INPUT_EDITOR.BLURRED';
...
exports.focusInputEditor = redux_actions_1.createAction(INPUT_EDITOR.FOCUS);
exports.focusedInputEditor = redux_actions_1.createAction(INPUT_EDITOR.FOCUSED);
exports.blurInputEditor = redux_actions_1.createAction(INPUT_EDITOR.BLUR);
exports.blurredInputEditor = redux_actions_1.createAction(INPUT_EDITOR.BLURRED);

  ...
  return Async$AgdaMode.mapError((function (err) {
                  ...
                  return /* () */0;
                      ...
                      Rebase.$$Array[/* forEach */8]((function (annotation) {
                            ...
                            }), Rebase.$$Array[/* filter */10](Highlighting$AgdaMode.Annotation[/* shouldHighlight */4], Rebase.$$Array[/* flatMap */5]((function (x) {
                                      return x;
                                    }), Rebase.$$Array[/* map */0]((function (tokens) {
                                          if (tokens.tag) {
                                            return Highlighting$AgdaMode.Annotation[/* parseIndirectHighlightings */3](tokens[0]);
                                          } else {
                                            return /* array */[];
                                          }
                                        }), Rebase.$$Array[/* filterMap */23](Rebase.$$Option[/* fromResult */12], Parser$AgdaMode.SExpression[/* parse */6](content.toString()))))));

...
function typeError(param) {
  return Json_decode.andThen((function (kind, json) {
                switch (kind) {
                  ...
                  case "ShouldBeASort" : 
                      return /* ShouldBeASort */Block.variant("ShouldBeASort", 4, [Json_decode.field("type", expr(/* () */0), json)]);
                  case "ShouldBePi" : 
                      return /* ShouldBePi */Block.variant("ShouldBePi", 3, [Json_decode.field("type", expr(/* () */0), json)]);
                  case "ShouldEndInApplicationOfTheDatatype" : 
                      return /* ShouldEndInApplicationOfTheDatatype */Block.variant("ShouldEndInApplicationOfTheDatatype", 1, [Json_decode.field("type", expr(/* () */0), json)]);
                  case "UnequalTerms" : 
  ...
  return (function (param) {
      return Json_decode.andThen((function (kind, json) {
                    switch (kind) {
                      ...
                      case "CheckSizeLtSat" : 
                          return /* CheckSizeLtSat */Block.variant("CheckSizeLtSat", 12, [Json_decode.field("term", expr(/* () */0), json)]);
                      case "ElimCmp" : 
                          var partial_arg$2 = elim(/* () */0);
                          var partial_arg$3 = elim(/* () */0);

      ...
      case 4 : 
          ...
          if (pointed$4 !== undefined) {
            ...
            if (match$4 !== undefined) {
              return buff(/* GoalType */Block.variant("GoalType", 4, [
                            command[0],
                            match$4
                          ]), instance);
            } else {
      ...
      case 5 : 
          ...
          if (pointed$5 !== undefined) {
            ...
            if (match$5 !== undefined) {
              return buff(/* Context */Block.variant("Context", 5, [
                            command[0],
                            match$5
                          ]), instance);
            } else {
      ...
      case 6 : 
          ...
          if (pointed$6 !== undefined) {
            ...
            if (match$6 !== undefined) {
              return buff(/* GoalTypeAndContext */Block.variant("GoalTypeAndContext", 6, [
                            command[0],
                            match$6
                          ]), instance);
            } else {
      ...
      case 7 : 
          ...
          if (pointed$7 !== undefined) {
            ...
            if (match$7 !== undefined) {
              return buff(/* GoalTypeAndInferredType */Block.variant("GoalTypeAndInferredType", 7, [
                            command[0],
                            goal$4,
                            match$7
                          ]), instance);

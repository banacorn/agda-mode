...
function make(editors, element, onMountAtChange, body, header, mountAt, mode, hidden, onInquireQuery, onEditorRef, editorPlaceholder, editorValue, interceptAndInsertKey, activateInputMethod, activateSettingsView, onSettingsViewToggle, _children) {
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",
                ...
                return ReactDom.createPortal(React.createElement("section", {
                                className: className
                                    ...
                                    className: "panel-heading agda-header-container"
                                            ...
                                            }), /* array */[])), ReasonReact.element(undefined, undefined, Dashboard$AgdaMode.make(header, match[/* inputMethodActivated */2], match[/* isPending */1], mountAt, onMountAtChange, onSettingsViewToggle, activateSettingsView, /* array */[]))), React.createElement("section", tmp, ReasonReact.element(undefined, undefined, Body$AgdaMode.make(body, mode !== /* Display */0, /* array */[])), ReasonReact.element(undefined, undefined, MiniEditor$AgdaMode.make(editorValue, editorPlaceholder, mode !== /* Inquire */1, "agda", (function (result) {

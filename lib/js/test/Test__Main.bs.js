...
Mocha$BsMocha.describe("Instances")(undefined, undefined, undefined, (function (param) {
        Promise$BsMocha.it_skip("should have no instances before opening any files")(undefined, undefined, undefined, (function (param) {
                return Promise.resolve(Test__Util$AgdaMode.Assert[/* equal */0](undefined, 0, AgdaMode$AgdaMode.Instances[/* size */8](/* () */0)));
              }));
        Promise$BsMocha.it("should respect the number of opened .agda file")(undefined, undefined, undefined, (function (param) {
                return Curry._1(Test__Util$AgdaMode.$$File[/* openAsset */1], "Temp.agda").then((function (editor) {
                                Test__Util$AgdaMode.Assert[/* equal */0](undefined, 1, AgdaMode$AgdaMode.Instances[/* size */8](/* () */0));
                                var pane = atom.workspace.getActivePane();
                                return pane.destroyItem(editor, true);
                              })).then((function (destroyed) {
                              Test__Util$AgdaMode.Assert[/* equal */0](undefined, AgdaMode$AgdaMode.Instances[/* size */8](/* () */0), destroyed ? 0 : 1);
        ...
        Promise$BsMocha.it("should respect the number of opened .lagda file")(undefined, undefined, undefined, (function (param) {
                return Curry._1(Test__Util$AgdaMode.$$File[/* openAsset */1], "Blank2.lagda").then((function (editor) {
                              ...
                              Test__Util$AgdaMode.Assert[/* equal */0](undefined, destroyed ? 0 : 1, AgdaMode$AgdaMode.Instances[/* size */8](/* () */0));
                              return Promise.resolve(/* () */0);
                            }));
              }));
        return Promise$BsMocha.it("should include '.agda' in the classlist")(undefined, undefined, undefined, (function (param) {
                      return Curry._1(Test__Util$AgdaMode.$$File[/* openAsset */1], "Temp.agda").then((function (editor) {
                                    Test__Util$AgdaMode.Assert[/* yes */1](atom.views.getView(editor).classList.contains("agda"));
                                    return Promise.resolve(/* () */0);
                                  }));
                    }));
      }));

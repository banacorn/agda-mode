...
class Panel extends React.Component {
    render() {
        ...
        switch (this.props.mode) {
            ...
            case 1 /* Query */:
                body =
                    React.createElement(MiniEditor_1.default, { placeholder: this.props.query.placeholder, "data-grammar": "source agda", ref: (ref) => {
                            if (ref)
                ...
                break;
            case 2 /* InquireConnection */:
                body =
                    React.createElement("div", null,
                        React.createElement("p", null, "Unable to find Agda on your machine, please enter the path of Agda manually."),
                        React.createElement(MiniEditor_1.default, { value: this.props.query.value, onConfirm: (path) => {

...
function make(editors, element, onMountAtChange, body, header, mountAt, mode, onEditorConfirm, onEditorFocus, onEditorCancel, onEditorRef, editorPlaceholder, editorValue, interceptAndInsertKey, activateInputMethod, _children) {
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",
            ...
            (function (self) {
                ...
                if (element !== undefined) {
                  return ReactDom.createPortal(React.createElement("section", undefined, React.createElement("section", {
                                    ...
                                    }, ReasonReact.element(undefined, undefined, Body$AgdaMode.make(body, mode !== /* Display */0, mountAtBottom, /* array */[])), ReasonReact.element(undefined, undefined, MiniEditor$AgdaMode.make(editorValue, editorPlaceholder, mode !== /* Query */1, "agda", onEditorConfirm, Js_primitive.some(onEditorCancel), Js_primitive.some(onEditorFocus), undefined, onEditorRef, /* array */[])))), Js_primitive.valFromOption(element));
                } else {
                  return null;
                }
              }),

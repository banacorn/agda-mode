...
function mountSettings(editors, handles, open_, self) {
  ...
  if (match !== undefined) {
    if (open_) {
      Event$AgdaMode.emitOk(true, handles[/* onSettingsView */15]);
    } else {
      ...
      Event$AgdaMode.emitOk(false, handles[/* onSettingsView */15]);
    }
    return undefined;
  } else {
    if (open_) {
      var tab = Tab$AgdaMode.make(editors[/* source */1], (function (param) {
              ...
              return Event$AgdaMode.emitOk(true, handles[/* onSettingsView */15]);
            }), undefined, (function (param) {
              Curry._1(self[/* send */0], /* ToggleSettingsTab */Caml_chrome_debugger.variant("ToggleSettingsTab", 0, [false]));
              return Event$AgdaMode.emitOk(false, handles[/* onSettingsView */15]);
            }), undefined, /* () */0);
    ...
    switch (action) {
      ...
      case 1 : 
          ...
          if (match$1.tag) {
            ...
            return /* UpdateWithSideEffects */Caml_chrome_debugger.variant("UpdateWithSideEffects", 1, [
                      ...
                      (function (param) {
                          Event$AgdaMode.emitOk(element, handles[/* onActivatePanel */4]);
                          return undefined;
                        })
                    ]);
          }
      case 2 : 
          return /* UpdateWithSideEffects */Caml_chrome_debugger.variant("UpdateWithSideEffects", 1, [
                    ...
                    (function (param) {
                        Event$AgdaMode.emitOk(/* () */0, handles[/* onDeactivatePanel */5]);
                        return undefined;
                      })
                  ]);
...
function Root(Props) {
  ...
  Hook$AgdaMode.useEventListener((function (param) {
          ...
          return Event$AgdaMode.emitOk(/* tuple */[
                      param[1],
                      param[2]
                    ], handles[/* inquireQuery */12]);
        }), handles[/* inquire */1]);
  Hook$AgdaMode.useEventListener((function (param) {
          return Curry._1(send, /* ToggleDocking */0);
        }), handles[/* toggleDocking */2]);
  Hook$AgdaMode.useEventListener(match$6[1], handles[/* updateIsPending */7]);
  Hook$AgdaMode.useEventListener(match$5[1], handles[/* updateShouldDisplay */8]);
  Hook$AgdaMode.useEventListener((function (param) {
          Curry._1(setMode, /* Display */0);
          return Editors$AgdaMode.Focus[/* on */1](/* Source */0, editors);
        }), handles[/* onInquireQuery */13]);
  Hook$AgdaMode.useEventListener((function (param) {
          return /* () */0;
        }), handles[/* destroy */17]);
  Hook$AgdaMode.useEventListener((function (activate) {
          return Curry._1(send, /* ToggleSettingsTab */Caml_chrome_debugger.variant("ToggleSettingsTab", 0, [activate]));
        }), handles[/* activateSettingsView */14]);
  Hook$AgdaMode.useEventListener(match$7[1], handles[/* updateConnection */9]);
  ...
  return React.createElement(React.Fragment, undefined, React.createElement(Type__View$AgdaMode.Mouse[/* Provider */1][/* make */0], {
                  value: (function ($$event) {
                      return Event$AgdaMode.emitOk($$event, handles[/* onMouseEvent */20]);
                    }),
                  children: React.createElement(Type__View$AgdaMode.Debug[/* Provider */3][/* make */0], {
                        ...
                        children: null
                            ...
                            isPending: match$6[0],
                            isActive: isActive,
                            onInquireQuery: handles[/* onInquireQuery */13],
                            ...
                            editorPlaceholder: "",
                            editorValue: "",
                            interceptAndInsertKey: handles[/* interceptAndInsertKey */19],
                            activateInputMethod: handles[/* activateInputMethod */18],
                            ...
                            onInputMethodActivationChange: handles[/* onInputMethodActivationChange */6]
                          }), React.createElement(Settings$AgdaMode.make, {
                            inquireConnection: handles[/* inquireConnection */10],
                            onInquireConnection: handles[/* onInquireConnection */11],
                            connection: match$8[0],
                            connectionError: match$8[1],
                            navigate: handles[/* navigateSettingsView */16],
                            debug: match$1[0],

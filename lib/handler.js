    ...
    switch (action.infoActionKind) {
        case 'AllGoals':
            if (action.content.length === 0) {
                ...
                core.view.setJudgements('Goals', parser_1.parseContent(action.content));
            }
            break;
        case 'Error':
            core.commander.pendingQueue.reject();
        ...
        case 'ModuleContents':
            ...
            break;
        case 'Context':
            core.view.setJudgements('Context', parser_1.parseContent(action.content));
            break;
        case 'GoalTypeEtc':
            core.view.setJudgements('Goal Type and Context', parser_1.parseContent(action.content));
            break;
        case 'NormalForm':

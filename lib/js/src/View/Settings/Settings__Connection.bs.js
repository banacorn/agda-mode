...
function Settings__Connection(Props) {
  ...
  if (connection !== undefined) {
    var conn = connection;
    tmp = React.createElement(React.Fragment, undefined, React.createElement("p", undefined, "Path: " + conn[/* metadata */0][/* path */0]), React.createElement("p", undefined, "Version: " + conn[/* metadata */0][/* version */2]), React.createElement("p", undefined, "Supported protocol: " + Curry._1(Connection$AgdaMode.Metadata.Protocol.toString, conn[/* metadata */0][/* protocol */3])));
  } else {

      ...
      if (match$1.tag) {
        ...
        switch (match$1[0]) {
          ...
          case "agda2-highlight-add-annotations" : 
              var annotations = Rebase.$$Array[/* filterMap */23](Rebase.Option[/* fromResult */12], Rebase.$$Array[/* map */0](Highlighting$AgdaMode.Annotation[/* parse */0], xs.slice(2)));
...
function handle$1(instance, response) {
  ...
  if (typeof response === "number") {
    if (response === 1) {
      return Instance$AgdaMode.Highlightings[/* destroyAll */1](instance);
    } else {
      return /* () */0;
    }
  } else {
    switch (response.tag | 0) {
      case 0 : 
          Instance$AgdaMode.Highlightings[/* destroyAll */1](instance);
          return Rebase.$$Array[/* forEach */8]((function (annotation) {
                        return Instance$AgdaMode.Highlightings[/* add */0](annotation, instance);
                      }), Rebase.$$Array[/* filter */10]((function (annotation) {
                            if (annotation[/* types */2].includes("unsolvedmeta")) {
                              return true;
                            } else {
                              return annotation[/* types */2].includes("terminationproblem");
                            }
                          }), response[1]));
      case 3 : 
      ...
      case 4 : 
          return Instance$AgdaMode.Goals[/* instantiateAll */1](response[0], instance);
      case 8 : 

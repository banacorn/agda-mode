...
function make($staropt$star, $staropt$star$1, hidden, $staropt$star$2, $staropt$star$3, $staropt$star$4, $staropt$star$5, $staropt$star$6, $staropt$star$7, _children) {
  ...
  var onCancel = $staropt$star$4 !== undefined ? Js_primitive.valFromOption($staropt$star$4) : (function () {
        return /* () */0;
      });
  var onFocus = $staropt$star$5 !== undefined ? Js_primitive.valFromOption($staropt$star$5) : (function () {
        return /* () */0;
      });
  var onBlur = $staropt$star$6 !== undefined ? Js_primitive.valFromOption($staropt$star$6) : (function () {
        return /* () */0;
      });
  ...
  return /* record */Block.record([
            ...
            (function (self) {
                var className = Curry._1(Util$AgdaMode.React[/* toClassName */3], Util$AgdaMode.React[/* addClass */2]("hidden", hidden, /* :: */Block.simpleVariant("::", [
                            "mini-editor",
                            /* [] */0
                          ])));
...
var jsComponent = ReasonReact.wrapReasonForJs(component, (function (jsProps) {
        return make(jsProps.value, jsProps.placeholder, jsProps.hidden, jsProps.grammar, jsProps.onConfirm, Js_primitive.some(jsProps.onCancel), Js_primitive.some(jsProps.onFocus), Js_primitive.some(jsProps.onBlur), jsProps.editorRef, /* array */[]);
      }));

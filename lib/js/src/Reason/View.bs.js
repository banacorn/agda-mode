...
function inquireConnection(handles) {
  return Event$AgdaMode.emitOk(/* () */0, handles[/* inquireConnection */5]);
}
...
function mountSettings(editors, handles, open_, self) {
  var match = self[/* state */1][/* settingsView */5];
  if (match !== undefined) {
    if (open_) {
  ...
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                return Event$AgdaMode.destroyWhen(self[/* onUnmount */4], Event$AgdaMode.onOk((function (param) {
                                    return Curry._1(self[/* send */3], /* UpdateConnection */Block.variant("UpdateConnection", 6, [
                                                  param[0],
                                                  param[1]
                                                ]));
                                  }))(handles[/* updateConnection */4]));
            ...
            (function (self) {
                ...
                var settingsView = match[/* settingsView */5];
                ...
                return React.createElement(React.Fragment, undefined, ReasonReact.element(undefined, undefined, Curry._2(Type__View$AgdaMode.MouseEmitter[/* Provider */1][/* make */0], (function (ev) {
                                    ...
                                    ReasonReact.element(undefined, undefined, Panel$AgdaMode.make(editors, panelElement, (function (mountTo) {
                                              ...
                                              }), match[/* body */1], match[/* header */0], mountAt, match[/* mode */8], hidden, handles[/* onInquireQuery */8], (function (ref) {
                                    ...
                                    ReasonReact.element(undefined, undefined, Settings$AgdaMode.make(handles[/* inquireConnection */5], handles[/* onInquireConnection */6], match[/* connection */6], match[/* connectionError */7], handles[/* navigateSettingsView */11], settingsElement, /* array */[]))
                                  ])));
              }),
            initialState,

...
function next(self, reality) {
  ...
  if (reality === surface) {
    if (Translator$AgdaMode.translate(sequence)[/* further */1] && reality !== "\\") {
      return /* Noop */Block.variant("Noop", 0, [self]);
    } else {
      return /* Stuck */0;
    }
    ...
    if (match !== undefined) {
      ...
      if (insertedChar === symbol) {
        ...
        return /* Rewrite */Block.variant("Rewrite", 1, [/* record */Block.record([
                      "symbol",
                      "tail"
                    ], [
                      /* tuple */[
...
function reducer(editor, action, state) {
  if (typeof action === "number") {
    ...
    switch (action.tag | 0) {
      ...
      case 1 : 
          var match$2 = next(state[/* buffer */2], action[1]);
...
function InputMethod(Props) {
  ...
  var translation = Translator$AgdaMode.translate(toSequence(state[/* buffer */2]));
  ...
  var bufferClassName = Curry._1(Util$AgdaMode.ClassName[/* serialize */2], Util$AgdaMode.ClassName[/* addWhen */1]("hidden", isEmpty(state[/* buffer */2]), /* :: */Block.simpleVariant("::", [
              "inline-block",
              /* :: */Block.simpleVariant("::", [
                  "buffer",
                  /* [] */0
  ...
  return React.createElement("section", {
              className: className
                  ...
                  className: "keyboard"
                    ...
                    }, toSequence(state[/* buffer */2])), Block.spliceApply(React.createElement, [
                      "div",
                      {

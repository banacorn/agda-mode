...
function preprocess(string) {
  ...
  if (result.substring(0, 13) === "cannot read: ") {
    return /* Error */Caml_chrome_debugger.variant("Error", 1, [result.slice(12)]);
  } else if (Rebase.$$String[/* startsWith */3]("((last", result)) {
    var index = result.indexOf("(agda");
    return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [result.substring(index, Rebase.$$String[/* length */1](result) - 1 | 0)]);
  } else {
    return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [result]);
  }
}

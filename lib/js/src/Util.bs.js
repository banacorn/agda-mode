...
function sepBy(sep, item) {
  if (item) {
    ...
    var x = item[0];
    if (xs) {
      return manyIn("span")(Rebase.$$Array[/* fromList */13](/* :: */Block.simpleVariant("::", [
                        x,
  ...
  return Rebase.$$Array[/* reduce */3]((function (acc, x) {
                ...
                if (acc.tag) {
                  ...
                  if (x.tag) {
                    ...
                    xs.push(x[0]);
                    return /* Ok */Block.variant("Ok", 0, [xs]);
                  }
                }
                if (exit === 1) {
                  if (x.tag) {
                    return /* Error */Block.variant("Error", 1, [x[0]]);
                  } else {
                    return /* Error */Block.variant("Error", 1, [acc[0]]);
                  }
                }
                
              }), /* Ok */Block.variant("Ok", 0, [/* array */[]]), xs);
}

var Result = /* module */Block.localModule(["every"], [every]);
...
var Version = /* module */Block.localModule([
    "compare",
    "gte"
  ], [
    compare,
...
var Pretty = /* module */Block.localModule([
    "list",
    "array"
  ], [
    list,

...
function inquireAgdaPath(error, instance) {
  return $$Promise.flatMap(Curry._1(instance[/* view */1][/* activate */0], /* () */0), (function (param) {
                return $$Promise.flatMap(Curry._1(instance[/* view */1][/* navigateSettings */12], /* Connection */1), (function (param) {
                              return $$Promise.flatMap(Curry._2(instance[/* view */1][/* updateConnection */13], undefined, error), (function (param) {

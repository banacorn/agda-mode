...
module.exports =
    ...
    commands: [
        ...
        'agda-mode:infer-type-no-normalization'
        'agda-mode:infer-type-full-normalization'
        'agda-mode:module-contents'
        'agda-mode:module-contents-no-normalization'
        'agda-mode:module-contents-full-normalization'
        ...
        'agda-mode:case'
        'agda-mode:goal-type'
        'agda-mode:goal-type-no-normalization'
        'agda-mode:goal-type-full-normalization'
        'agda-mode:context'
        'agda-mode:context-no-normalization'
        'agda-mode:context-full-normalization'
        'agda-mode:goal-type-and-context'
        'agda-mode:goal-type-and-context-no-normalization'
        'agda-mode:goal-type-and-context-full-normalization'
        'agda-mode:goal-type-and-inferred-type'
        'agda-mode:goal-type-and-inferred-type-no-normalization'
        'agda-mode:goal-type-and-inferred-type-full-normalization'

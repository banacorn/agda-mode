...
var Call$AgdaMode = require("./Call.bs.js");
...
function make(value, rawString, _) {
  return /* record */Block.record([
            ...
            (function () {
                switch (value.tag | 0) {
                  case 0 : 
                      var call = value[1];
                      return React.createElement("section", undefined, ReasonReact.element(undefined, undefined, Syntax__Range$AgdaMode.make(value[0], undefined, /* array */[])), ReasonReact.element(undefined, undefined, TypeError$AgdaMode.make(value[2], rawString, /* array */[])), call !== undefined ? ReasonReact.element(undefined, undefined, Call$AgdaMode.make(call, /* array */[])) : React.createElement(React.Fragment, undefined));
                  case 1 : 
                  case 2 : 

...
function inquireAgdaPath(error, instance) {
  View$AgdaMode.activate(instance[/* view */2]);
  var promise = Async$AgdaMode.thenOk((function (param) {
            View$AgdaMode.navigateSettingsView(/* Connection */1, instance[/* view */2]);
            var promise = View$AgdaMode.onInquireConnection(instance[/* view */2]);
            View$AgdaMode.inquireConnection(instance[/* view */2]);
            View$AgdaMode.updateConnection(undefined, error, instance[/* view */2]);
            return promise;
          }))(View$AgdaMode.onOpenSettingsView(instance[/* view */2]));
  View$AgdaMode.activateSettingsView(instance[/* view */2]);
  return promise;
}
...
function connectWithAgdaPath(instance, path) {
  ...
  return Async$AgdaMode.mapOk(Connection$AgdaMode.wire)(Async$AgdaMode.mapOk((function (param) {
                      ...
                      return connection;
                          ...
                          View$AgdaMode.updateConnection(connection, undefined, instance$1[/* view */2]);
                          return connection;
                        }))(Async$AgdaMode.thenOk((function (param) {
                              return getConnection(instance, param);
...
function disconnect(instance) {
  ...
  if (match !== undefined) {
    ...
    return View$AgdaMode.updateConnection(undefined, undefined, instance[/* view */2]);
  } else {
    return /* () */0;
  }
}

...
Mocha$BsMocha.describe_skip("when loading files")(undefined, undefined, undefined, (function (param) {
        return Mocha$BsMocha.describe("when parsing responses from Agda")(undefined, undefined, undefined, (function (param) {
                      return Promise$BsMocha.it("should succeed")(undefined, undefined, undefined, (function (param) {
                                    var path = Test__Util$AgdaMode.Path[/* asset */2]("Algebra.agda");
                                    return Test__Util$AgdaMode.$$File[/* open_ */0](path).then((function (editor) {
                                                  var instance = Instance$AgdaMode.make(editor);
                                                  return Async$AgdaMode.thenOk((function (param) {
                                                                  return Async$AgdaMode.mapError((function (error) {
                                                                                  Assert$BsMocha.fail(error);
                                                                                  return /* () */0;
                                                                                }))(Async$AgdaMode.thenOk((function (param) {
                                                                                      Curry._1(Test__Util$AgdaMode.Assert[/* ok */4], /* () */0);
                                                                ...
                                                                }))(Async$AgdaMode.mapError(Assert$BsMocha.fail)(Async$AgdaMode.mapOk((function (param) {

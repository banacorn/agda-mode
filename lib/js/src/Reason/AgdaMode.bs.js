...
function queryConnection(message, self) {
  ...
  return Util$AgdaMode.Msg[/* send */4](true, self[/* view */1][/* activateSettingsView */9]).then((function (param) {
                Util$AgdaMode.Msg[/* send */4](/* Connection */1, self[/* view */1][/* navigateSettingsView */10]);
...
function connect(self) {
  var handleAutoSearchExn = function (match) {
  ...
  if (match !== undefined) {
    ...
    return getAgdaPath(/* () */0).catch((function (err) {
                            ...
                            if (match !== undefined) {
                              ...
                              if (match$1.tag) {
                                ...
                                return queryConnection("Failed to search the path of Agda, as it\'s currently not supported on " + (String(match$1[0]) + ""), self);
                              }
                            } else {

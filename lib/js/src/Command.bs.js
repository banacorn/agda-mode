...
var Normalization = /* module */Caml_chrome_debugger.localModule(["toString"], [toString]);
...
var ComputeMode = /* module */Caml_chrome_debugger.localModule([
    "toString",
    "ignoreAbstract"
  ], [
    toString$1,
...
var Primitive = /* module */Caml_chrome_debugger.localModule(["parse"], [parse]);
...
function toAgdaReadableString(cmd) {
  ...
  var buildRange = function (goal) {
    if (Util$AgdaMode.Version[/* gte */2](version, "2.5.1")) {
  ...
  if (typeof command === "number") {
    switch (command) {
      case 0 : 
          if (Util$AgdaMode.Version[/* gte */2](version, "2.5.0")) {
    ...
    switch (command.tag | 0) {
      ...
      case 7 : 
          ...
          if (Util$AgdaMode.Version[/* gte */2](version, "2.5.2")) {
      ...
      case 9 : 
          ...
          if (Util$AgdaMode.Version[/* gte */2](version, "2.5.3")) {
      ...
      case 11 : 
          ...
          if (Util$AgdaMode.Version[/* gte */2](version, "2.6.0.1")) {
...
var Remote = /* module */Caml_chrome_debugger.localModule([
    "toAgdaReadableString",
    "isLoad",
    "toString"
  ], [
    toAgdaReadableString,

...
const body = redux_actions_1.handleActions({
    [actions_1.BODY.UPDATE_All_GOALS_WARNINGS]: (state, action) => (Object.assign({}, state, { emacs: defaultState.body.emacs, allGoalsWarnings: action.payload, error: defaultState.body.error, plainText: defaultState.body.plainText })),
    [actions_1.BODY.UPDATE_EMACS_All_GOALS_WARNINGS]: (state, action) => (Object.assign({}, state, { emacs: {
        ...
        }, allGoalsWarnings: defaultState.body.allGoalsWarnings, error: defaultState.body.error, plainText: defaultState.body.plainText })),
    ...
    [actions_1.BODY.UPDATE_EMACS_SOLUTIONS]: (state, action) => (Object.assign({}, state, { emacs: {
            allGoalsWarnings: defaultState.body.emacs.allGoalsWarnings,
            goalTypeContext: defaultState.body.emacs.goalTypeContext,
            constraints: defaultState.body.emacs.constraints,
    ...
    [actions_1.BODY.UPDATE_ERROR]: (state, action) => (Object.assign({}, state, { emacs: defaultState.body.emacs, allGoalsWarnings: defaultState.body.allGoalsWarnings, error: action.payload[0], plainText: defaultState.body.plainText })),
    [actions_1.BODY.UPDATE_PLAIN_TEXT]: (state, action) => (Object.assign({}, state, { emacs: defaultState.body.emacs, allGoalsWarnings: defaultState.body.allGoalsWarnings, error: defaultState.body.error, plainText: action.payload })),

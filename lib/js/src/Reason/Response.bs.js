...
function handle$1(instance, response) {
  ...
  if (typeof response === "number") {
    if (response === 1) {
      return Instance$AgdaMode.Highlightings[/* destroyAll */2](instance);
    } else {
    ...
    switch (response.tag | 0) {
      case 0 : 
          return Rebase.$$Array[/* forEach */8]((function (annotation) {
                        return Instance$AgdaMode.Highlightings[/* add */0](annotation, instance);
                      }), Rebase.$$Array[/* filter */10](Highlighting$AgdaMode.Annotation[/* shouldHighlight */3], response[1]));
      case 1 : 
          var filepath = response[0];
          return Promise$AgdaMode.$$finally((function (param) {
                        Fs.unlink(filepath, (function (param) {
                                return /* () */0;
                              }));
                        return /* () */0;
                      }), Instance$AgdaMode.Highlightings[/* addFromFile */1](filepath, instance));
      case 2 : 
      ...
      case 4 : 
          return Instance$AgdaMode.Goals[/* instantiateAll */2](response[0], instance);
      case 5 : 
          var give = response[1];
          var match = Instance$AgdaMode.Goals[/* find */1](response[0], instance);
          if (match !== undefined) {
            var goal = match;
            ...
            return Goal$AgdaMode.destroy(goal);
          } else {
            return /* () */0;
          }
      case 6 : 
          ...
          if (pointed !== undefined) {
            var goal$1 = pointed;
            if (response[0]) {
              return Goal$AgdaMode.writeLambda(lines, goal$1);
            } else {
              return Goal$AgdaMode.writeLines(lines, goal$1);
            }
          } else {
            updateView(/* record */Block.record([
                    ...
                    "Out of goal",
                    1
                  ]), /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, ["`Case` is a goal-specific command, please place the cursor in a goal"])]));
            return /* () */0;
          }
      case 8 : 

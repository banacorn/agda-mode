...
var Term = (function (_super) {
    ...
    Term.prototype.render = function () {
        ...
        switch (this.props.kind) {
            ...
            case 'meta': return React.createElement("span", {className: "text-highlight meta"}, this.props.children);
            case 'sort': return React.createElement("span", {className: "text-highlight sort"}, this.props.children);
        }
    };
    return Term;
}(React.Component));

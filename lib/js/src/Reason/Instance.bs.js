...
function handleResponseInfo(info, instance) {
  if (typeof info === "number") {
    return View$AgdaMode.update("Compilation Done!", /* Success */3, /* Nothing */0, instance[/* view */1]);
  } else {
    switch (info.tag | 0) {
      case 0 : 
          var match = info[0];
          if (match !== undefined) {
            return View$AgdaMode.update("Constraints", /* Info */2, /* Emacs */Block.variant("Emacs", 0, [/* Constraints */Block.variant("Constraints", 3, [match])]), instance[/* view */1]);
          } else {
            return View$AgdaMode.update("No Constraints", /* Success */3, /* Nothing */0, instance[/* view */1]);
          }
      case 1 : 
          var payload = info[0];
          return View$AgdaMode.update(payload[/* title */0], /* Info */2, /* Emacs */Block.variant("Emacs", 0, [/* AllGoalsWarnings */Block.variant("AllGoalsWarnings", 0, [payload])]), instance[/* view */1]);
      case 2 : 
          return View$AgdaMode.update("Time", /* PlainText */0, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [info[0]])]), instance[/* view */1]);
      case 3 : 
          return View$AgdaMode.update("Error", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* Error */Block.variant("Error", 6, [info[0]])]), instance[/* view */1]);
      case 4 : 
          return View$AgdaMode.update("Intro", /* PlainText */0, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [info[0]])]), instance[/* view */1]);
      case 5 : 
          return View$AgdaMode.update("Auto", /* PlainText */0, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [info[0]])]), instance[/* view */1]);
      case 6 : 
          return View$AgdaMode.update("Module Contents", /* Info */2, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [info[0]])]), instance[/* view */1]);
      case 7 : 
          return View$AgdaMode.update("Searching about ...", /* PlainText */0, /* Emacs */Block.variant("Emacs", 0, [/* SearchAbout */Block.variant("SearchAbout", 5, [info[0]])]), instance[/* view */1]);
      case 8 : 
          return View$AgdaMode.update("Scope info", /* Info */2, /* Emacs */Block.variant("Emacs", 0, [/* WhyInScope */Block.variant("WhyInScope", 4, [info[0]])]), instance[/* view */1]);
      case 9 : 
          return View$AgdaMode.update("Normal form", /* Info */2, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [info[0]])]), instance[/* view */1]);
      case 10 : 
          return View$AgdaMode.update("Goal type", /* Info */2, /* Emacs */Block.variant("Emacs", 0, [/* GoalTypeContext */Block.variant("GoalTypeContext", 1, [info[0]])]), instance[/* view */1]);
      case 11 : 
          return View$AgdaMode.update("Current goal", /* Info */2, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [info[0]])]), instance[/* view */1]);
      case 12 : 
          return View$AgdaMode.update("Inferred type", /* Info */2, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [info[0]])]), instance[/* view */1]);
      case 13 : 
          return View$AgdaMode.update("Context", /* Info */2, /* Emacs */Block.variant("Emacs", 0, [/* Context */Block.variant("Context", 2, [info[0]])]), instance[/* view */1]);
      case 14 : 
          return View$AgdaMode.update("Helper function", /* Info */2, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [info[0]])]), instance[/* view */1]);
      case 15 : 
          return View$AgdaMode.update("Version", /* Info */2, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [info[0]])]), instance[/* view */1]);
...
function handleResponse(response, instance) {
  var textEditor = instance[/* editors */0][/* source */1];
  var filePath = textEditor.getPath();
  var textBuffer = textEditor.getBuffer();
...
function dispatch(command, instance) {
  return Async$AgdaMode.thenOk((function (result) {
                  ...
                  return Async$AgdaMode.mapOk((function (param) {
                                  return /* () */0;
                                }))(Async$AgdaMode.all(Rebase.$$Array[/* map */0]((function (response) {
                                        return recoverCursor((function (param) {
                                                      return handleResponse(response, instance);
                                                    }), instance);
                                      }), responses)));

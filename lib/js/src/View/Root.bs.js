...
function Root(Props) {
  ...
  Hook$AgdaMode.useChannel(Curry._2(Rebase.Fn[/* >> */6], match$6[1], Async$AgdaMode.resolve), channels[/* updateIsPending */5]);
  Hook$AgdaMode.useChannel(Curry._2(Rebase.Fn[/* >> */6], match$5[1], Async$AgdaMode.resolve), channels[/* updateShouldDisplay */6]);
  ...
  Hook$AgdaMode.useEventListener((function (activate) {
        ...
        }), handles[/* activateSettingsView */4]);
  Hook$AgdaMode.useEventListener(match$7[1], handles[/* updateConnection */1]);

...
function createForBottom(param) {
  ...
  if (container !== undefined) {
    return /* Bottom */Caml_chrome_debugger.variant("Bottom", 0, [Caml_option.valFromOption(container)]);
  } else {
    return /* Bottom */Caml_chrome_debugger.variant("Bottom", 0, [createBottomPanelContainer(undefined)]);
  }
}

function fromMountingPoint(element) {
  if (element.tag) {
    return Tab$AgdaMode.getElement(element[0]);
  } else {
    return element[0];
  }
}
...
function Panel(Props) {
  ...
  var mountPanel = function (editors$1, mountingTarget) {
    ...
    if (match.tag) {
      ...
      return Curry._1(setMountingPoint, /* Pane */Caml_chrome_debugger.variant("Pane", 1, [createTab(undefined)]));
    } else {
      return ;
    }
  };
                  ...
                  id: id
                      ...
                      className: "panel-heading agda-header-container"
                          ...
                          onConfirm: (function (result) {
                              return Curry._1(onInquireQuery.emit, /* Ok */Caml_chrome_debugger.variant("Ok", 0, [result]));
                            }),
                          onCancel: (function (param) {
                              Curry._1(onInquireQuery.emit, /* Error */Caml_chrome_debugger.variant("Error", 1, [/* Cancelled */0]));

...
function activate(self) {
  return Curry._1(self[/* view */1][/* updateMountTo */3][0], /* ToBottom */0);
}

function deactivate(self) {
  return Curry._1(self[/* view */1][/* updateMountTo */3][0], /* ToNowhere */2);
}
...
function interceptAndInsertKey(self, key) {
  return Curry._1(self[/* view */1][/* interceptAndInsertKey */5][0], key);
}

function inputMethodHandle(self, activate) {
  return Curry._1(self[/* view */1][/* inputMethodHandle */6][0], activate);
}
...
function inquireQuery(self, placeholder, value) {
  return Curry._2(self[/* view */1][/* inquireQuery */4][0], placeholder, value);
}
...
function jsInquireQuery(textEditor, placeholder, value) {
  var match = lookup(textEditor);
  if (match !== undefined) {
    inquireQuery(match, placeholder, value);
    return /* () */0;
  } else {
    console.log("cannot jsInquireQuery, does not exist: " + textEditor.getPath());
    return /* () */0;
  }
}

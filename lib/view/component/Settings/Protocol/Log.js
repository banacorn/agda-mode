...
function ReqRes(props) {
    return (React.createElement("li", { className: 'agda-settings-protocol-log-item' }, JSON.stringify(props.reqRes.request.parsed.header.kind)));
}
function Log(props) {
    return (React.createElement("section", { className: 'agda-settings-protocol-log' },
        React.createElement("ol", null, props.log.map((reqRes, i) => React.createElement(ReqRes, { key: i, reqRes: reqRes })))));
}
exports.default = Log;

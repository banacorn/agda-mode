    ...
    switch (action.tag | 0) {
      ...
      case 2 : 
          ...
          return /* SideEffects */Block.variant("SideEffects", 1, [(function (self) {
                        ...
                        if (match !== undefined) {
                          if (open_) {
                            return Event$AgdaMode.resolve(true, handles[/* onSettingsView */10]);
                          } else {
                            Curry._1(match[/* kill */1], /* () */0);
                            Curry._1(self[/* send */3], /* UpdateSettingsView */Block.variant("UpdateSettingsView", 3, [undefined]));
                            return Event$AgdaMode.resolve(false, handles[/* onSettingsView */10]);
                          }
                        } else if (open_) {
  ...
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                Event$AgdaMode.destroyWhen(self[/* onUnmount */4], Event$AgdaMode.onOk((function (param) {
                              ...
                              Curry._1(self[/* send */3], /* UpdateHeader */Block.variant("UpdateHeader", 6, [param[0]]));
                              return Event$AgdaMode.resolve(/* tuple */[
                                          param[1],
                                          param[2]

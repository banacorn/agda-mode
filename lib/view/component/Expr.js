...
class Expr extends React.Component {
    render() {
        ...
        return (React.createElement("span", Object.assign({ className: "expr" }, otherProps), expressions.map((expr, i) => React.createElement(Term, { kind: expr.kind, key: i, jumpToGoal: (index) => {

...
var mapDispatchToProps = function (dispatch) { return ({
    replaceSymbol: function (symbol) {
        dispatch(actions_1.replaceSymbol(symbol));
    }
}); };
var CandidateSymbols = (function (_super) {
    ...
    CandidateSymbols.prototype.render = function () {
        ...
        return (React.createElement("div", {id: "candidate-symbols", className: "btn-group btn-group-sm"}, 
            frameLeft.map(function (key) { return React.createElement("button", {className: "btn", key: key}, key); }), 
            React.createElement("button", {className: "btn selected", key: selected}, selected), 
            frameRight.map(function (key) { return React.createElement("button", {className: "btn", key: key}, key); })));
    };

...
function make(inquireConnection, navigate, _children) {
  return /* record */Block.record([
            ...
            (function (self) {
                return Util$AgdaMode.$$Promise[/* thenDrop */8]((function (uri) {
                              Curry._1(self[/* send */3], /* Navigate */Block.simpleVariant("Navigate", [uri]));
                              return Util$AgdaMode.Msg[/* resolve */1](/* () */0, navigate);
                            }), Util$AgdaMode.Msg[/* recv */5](self[/* onUnmount */4], navigate));
              }),
                                ...
                                className: "agda-settings-pages"
                                    ...
                                    className: at(/* Root */0, uri, /* :: */Block.simpleVariant("::", [
                                        ...
                                        onClick: (function (param) {
                                          ...
                                          }, "Protocol"))), ReasonReact.element(undefined, undefined, Settings__Connection$AgdaMode.make(inquireConnection, uri !== /* Connection */1, true, false, (function (prim) {
                                          console.log(prim);
                                          return /* () */0;

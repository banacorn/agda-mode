...
function InputMethod(Props) {
            ...
            switch (buffer.TAG | 0) {
              ...
              case /* Backspace */1 :
                  ...
                  Curry._1(send, {
                        TAG: 0,
                        _0: buffer._0,
                        [Symbol.for("name")]: "UpdateBuffer"
                      });
                  break;
              case /* Rewrite */2 :
                  var buffer$1 = buffer._0;
  ...
  React.useEffect((function () {
          ...
          if (atom.inDevMode()) {
            Curry._1(debugDispatch, {
                  _0: {
                    activated: state.activated,
                    markers: markers,
                    buffer: state.buffer
                  },
                  [Symbol.for("name")]: "UpdateInputMethod"
                });
          }

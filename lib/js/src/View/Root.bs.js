...
function Root(Props) {
  ...
  var settingsURI = match[0];
  var settingsViewRef = React.useRef(undefined);
  var settingsElement = Rebase.$$Option[/* map */0](Tab$AgdaMode.getElement, settingsViewRef.current);
  var update = function (param) {
    if (param !== undefined) {
      ...
      return Curry._1(setSettingsURI, undefined);
    }
  };
  ...
  var settingsActivated = settingsURI !== undefined;
  var uri = settingsURI !== undefined ? settingsURI : /* Root */0;

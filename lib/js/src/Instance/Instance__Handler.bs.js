...
function handleCommandError(instance) {
  return Async$AgdaMode.thenError((function (error) {
                if (typeof error === "number") {
                  switch (error) {
                    case 0 : 
                        Curry._3(instance[/* view */2][/* display */5], "Query Cancelled", /* Error */1, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [""])]));
                        break;
                    case 1 : 
                        Curry._3(instance[/* view */2][/* display */5], "Goal not indexed", /* Error */1, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, ["Please reload to re-index the goal"])]));
                        break;
                    case 2 : 
                        Curry._3(instance[/* view */2][/* display */5], "Out of goal", /* Error */1, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, ["Please place the cursor in a goal"])]));
                        break;
                    
                  }
                } else if (error.tag) {
                  var match = Connection$AgdaMode.$$Error[/* toString */0](error[0]);
                  Curry._3(instance[/* view */2][/* display */5], "Connection-related Error: " + match[0], /* Error */1, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [match[1]])]));
                } else {
                  var errors = error[0];
                  Rebase.$$Option[/* forEach */8]((function (conn) {
                          ...
                          return Curry._3(instance[/* view */2][/* display */5], "Parse Error", /* Error */1, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* ParseError */Caml_chrome_debugger.variant("ParseError", 7, [conn[/* metadata */0]])]));
  ...
  if (typeof response === "number") {
    switch (response) {
      ...
      case 2 : 
          ...
          return Async$AgdaMode.resolve(/* () */0);
      case 3 : 
          Curry._3(instance[/* view */2][/* display */5], "Status", /* Warning */4, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, ["Done aborting"])]));
          return Async$AgdaMode.resolve(/* () */0);
    ...
    switch (response.tag | 0) {
      ...
      case 2 : 
          ...
          if (displayImplicit || checked) {
            Curry._3(instance[/* view */2][/* display */5], "Status", /* PlainText */0, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, ["Typechecked: " + (Pervasives.string_of_bool(checked) + ("\nDisplay implicit arguments: " + Pervasives.string_of_bool(displayImplicit)))])]));
          }
          return Async$AgdaMode.resolve(/* () */0);
      case 3 : 
      ...
      case 7 : 
          ...
          return Async$AgdaMode.thenOk((function (param) {
                          ...
                          if (size === 0) {
                            Curry._3(instance[/* view */2][/* display */5], "No solutions found", /* PlainText */0, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [""])]));
                          } else {
                            Curry._3(instance[/* view */2][/* display */5], String(size) + " goals solved", /* Success */3, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [""])]));
                          }
                          return Async$AgdaMode.resolve(/* () */0);
      ...
      case 9 : 
          ...
          if (response[0] >= 2) {
            ...
            Curry._3(instance[/* view */2][/* display */5], "Type-checking", /* PlainText */0, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [message])]));
          }
          return Async$AgdaMode.resolve(/* () */0);
  ...
  var buff = function (command, instance) {
    return Async$AgdaMode.mapError((function (param) {
                    return /* Cancelled */0;
                        ...
                        Curry._3(instance[/* view */2][/* display */5], "Loading ...", /* PlainText */0, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [""])]));
  ...
  if (typeof command === "number") {
    switch (command) {
      case 0 : 
          return Async$AgdaMode.thenOk((function (param) {
                          ...
                          return Async$AgdaMode.thenOk((function (param) {
                                          ...
                                          Curry._3(instance[/* view */2][/* display */5], "Connecting ...", /* PlainText */0, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [""])]));
      ...
      case 10 : 
          ...
          return Async$AgdaMode.resolve(undefined);
      case 11 : 
          Curry._1(instance[/* view */2][/* toggleDocking */18], /* () */0);
          return Async$AgdaMode.resolve(undefined);
      case 12 : 
      ...
      case 17 : 
          ...
          Async$AgdaMode.finalOk((function (symbol) {
                  return Rebase.$$Option[/* forEach */8]((function (sequences) {
                                return Curry._3(instance[/* view */2][/* display */5], "Input sequence for " + symbol, /* PlainText */0, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [Rebase.$$String[/* joinWith */11]("\n", Rebase.List[/* fromArray */12](sequences))])]));
      ...
      case 18 : 
          if (instance[/* isLoaded */0]) {
            ...
            return Async$AgdaMode.thenOk((function (param) {
                          ...
                          }))(handleCommandError(instance)(Curry._2(instance[/* dispatch */9], /* Load */0, instance)));
          }
      ...
      case 0 : 
          ...
          return Async$AgdaMode.thenOk((function (expr) {
                          return buff(/* SearchAbout */Caml_chrome_debugger.variant("SearchAbout", 2, [
                              ...
                              return /* Cancelled */0;
                            }))(Curry._3(instance[/* view */2][/* inquire */6], "Searching through definitions [" + (Command$AgdaMode.Normalization[/* toString */0](normalization) + "]"), "expression to infer:", "")));
      case 1 : 
          ...
          return Instance__TextEditors$AgdaMode.handleOutOfGoal((function (param) {
                          return Async$AgdaMode.thenOk((function (expr) {
                                          return buff(/* InferTypeGlobal */Caml_chrome_debugger.variant("InferTypeGlobal", 4, [
                                              ...
                                              return /* Cancelled */0;
                                            }))(Curry._3(instance[/* view */2][/* inquire */6], "Infer type [" + (Command$AgdaMode.Normalization[/* toString */0](normalization$1) + "]"), "expression to infer:", "")));
                        }))(Async$AgdaMode.thenOk((function (param) {
                              var index = param[1];
                              var goal = param[0];
                              if (Goal$AgdaMode.isEmpty(goal)) {
      ...
      case 2 : 
          ...
          return Async$AgdaMode.thenOk((function (expr) {
                          return Instance__TextEditors$AgdaMode.handleOutOfGoal((function (param) {
                              ...
                              return /* Cancelled */0;
                            }))(Curry._3(instance[/* view */2][/* inquire */6], "Module contents [" + (Command$AgdaMode.Normalization[/* toString */0](normalization$2) + "]"), "module name:", "")));
      case 3 : 
      ...
      case 8 : 
          ...
          if (enabled) {
            ...
            switch (command[0]) {
              ...
              case 1 : 
                  Curry._1(instance[/* view */2][/* interceptAndInsertKey */11], "{");
                  return Async$AgdaMode.resolve(undefined);
              case 2 : 
                  Curry._1(instance[/* view */2][/* interceptAndInsertKey */11], "[");
                  return Async$AgdaMode.resolve(undefined);
...
function dispatch(command, instance) {
  return Async$AgdaMode.mapOk((function (param) {
                  return Event$AgdaMode.emitOk(/* () */0, instance[/* onDispatch */10]);

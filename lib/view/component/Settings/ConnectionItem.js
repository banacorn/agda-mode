        ...
        return (React.createElement("li", { className: classNames({
            ...
            React.createElement("header", { className: "compact" },
                ...
                React.createElement("div", { className: "connection-dashboard" },
                    this.props.connected && React.createElement("span", { className: "connection-status" }, "CONNECTED"),
                    this.props.selected && !this.props.connected && React.createElement("span", { className: "connection-status" }, "APPOINTED"),

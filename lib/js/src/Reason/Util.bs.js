...
var $$Promise$1 = /* module */Block.localModule(["map"], [map]);
...
var TelePromise = /* module */Block.localModule(["make"], [make$1]);
...
function send(x, self) {
  var promise = Curry._1(self[/* promise */1][/* wire */0], /* () */0);
...
function recv(onUnmount, handler, self) {
  self[/* ref */0][0] = /* :: */Block.simpleVariant("::", [
      handler,
      self[/* ref */0][0]
    ]);
  return Curry._1(onUnmount, (function (param) {
                self[/* ref */0][0] = /* [] */0;
                return /* () */0;
              }));
}

...
function make(editor, element, onMountAtChange, body, header, mountAt, mode, onEditorConfirm, onEditorFocused, onEditorCancel, onEditorRef, editorPlaceholder, editorValue, interceptAndInsertKey, inputMethodHandle, settingsViewHandle, onSettingsViewToggle, _children) {
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",
                  ...
                  return ReactDom.createPortal(ReasonReact.element(undefined, undefined, Curry._2(Type$AgdaMode.Interaction[/* MouseEmitter */2][/* Provider */1][/* make */0], (function (ev) {
                                        return Curry._1(self[/* send */3], /* MouseEvent */Block.variant("MouseEvent", 3, [ev]));
                                                ...
                                                className: "panel-heading agda-header-container"
                                                        ...
                                                        }), /* array */[])), ReasonReact.element(undefined, undefined, Dashboard$AgdaMode.make(header, match[/* inputMethodActivated */2], match[/* isPending */1], mountAt, onMountAtChange, onSettingsViewToggle, settingsViewHandle, /* array */[]))), React.createElement("section", {

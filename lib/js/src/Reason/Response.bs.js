...
function handle(instance, info) {
  var update = function (header, body) {
    ...
    return Util$AgdaMode.Event[/* resolve */9](body, instance[/* view */1][/* updateRawBody */1]);
  };
    ...
    switch (info.tag | 0) {
      case 0 : 
          ...
          if (match !== undefined) {
            return update(/* record */Block.record([
                          ...
                          "Constraints",
                          2
                        ]), /* RawEmacs */Block.variant("RawEmacs", 0, [/* Constraints */Block.variant("Constraints", 3, [match])]));
          } else {
            return update(/* record */Block.record([
                          "text",
                          "style"
      ...
      case 1 : 
          ...
          return update(/* record */Block.record([
                        ...
                        payload[/* title */0],
                        2
                      ]), /* RawEmacs */Block.variant("RawEmacs", 0, [/* AllGoalsWarnings */Block.variant("AllGoalsWarnings", 0, [payload])]));
      case 2 : 
          return update(/* record */Block.record([
                        "text",
                        "style"
                        ...
                        "Time",
                        0
                      ]), /* RawEmacs */Block.variant("RawEmacs", 0, [/* PlainText */Block.variant("PlainText", 7, [info[0]])]));
      case 3 : 
          return update(/* record */Block.record([
                        "text",
                        "style"
                        ...
                        "Error",
                        1
                      ]), /* RawEmacs */Block.variant("RawEmacs", 0, [/* Error */Block.variant("Error", 6, [info[0]])]));
      case 4 : 
          return update(/* record */Block.record([
                        "text",
                        "style"
      ...
      case 7 : 
          return update(/* record */Block.record([
                        ...
                        "Searching about ...",
                        0
                      ]), /* RawEmacs */Block.variant("RawEmacs", 0, [/* SearchAbout */Block.variant("SearchAbout", 5, [info[0]])]));
      case 8 : 
          return update(/* record */Block.record([
                        "text",
                        "style"
                        ...
                        "Scope info",
                        2
                      ]), /* RawEmacs */Block.variant("RawEmacs", 0, [/* WhyInScope */Block.variant("WhyInScope", 4, [info[0]])]));
      case 9 : 
          return update(/* record */Block.record([
                        "text",
                        "style"
      ...
      case 10 : 
          return update(/* record */Block.record([
                        ...
                        "Goal type",
                        2
                      ]), /* RawEmacs */Block.variant("RawEmacs", 0, [/* GoalTypeContext */Block.variant("GoalTypeContext", 1, [info[0]])]));
      case 11 : 
          return update(/* record */Block.record([
                        "text",
                        "style"
      ...
      case 13 : 
          return update(/* record */Block.record([
                        ...
                        "Context",
                        2
                      ]), /* RawEmacs */Block.variant("RawEmacs", 0, [/* Context */Block.variant("Context", 2, [info[0]])]));
      case 14 : 
          return update(/* record */Block.record([
                        "text",
                        "style"

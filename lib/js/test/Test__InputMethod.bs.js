...
var Translator$AgdaMode = require("../src/View/Panel/Translator.bs.js");
...
Mocha$BsMocha.describe("Input Method")(undefined, undefined, undefined, (function (param) {
        Mocha$BsMocha.describe("View")(undefined, undefined, undefined, (function (param) {
                Promise$BsMocha.after_each(undefined)(undefined, undefined, undefined, Test__Util$AgdaMode.Package[/* after_each */5]);
        ...
        Mocha$BsMocha.describe_only("Typing")(undefined, undefined, undefined, (function (param) {
                Promise$BsMocha.before_each(undefined)(undefined, undefined, undefined, Test__Util$AgdaMode.Package[/* before_each */4]);
                Promise$BsMocha.after_each(undefined)(undefined, undefined, undefined, Test__Util$AgdaMode.Package[/* after_each */5]);
                ...
                Promise$BsMocha.it("should result in \"ƛ\" after typing \"lambdabar\"")(undefined, undefined, undefined, (function (param) {
                        ...
                        return Test__Util$AgdaMode.openAndLoad("Temp.agda").then((function (param) {
                                      ...
                                      return Test__Util$AgdaMode.Keyboard[/* insert */2]("l", instance).then((function (param) {
                                                                    return Test__Util$AgdaMode.Keyboard[/* insert */2]("a", instance);
                                                                  })).then((function (param) {
                                                                  return Test__Util$AgdaMode.Keyboard[/* insert */2]("m", instance);
                                                                })).then((function (param) {
                                                                return Test__Util$AgdaMode.Keyboard[/* insert */2]("b", instance);
                                                              })).then((function (param) {
                                                              return Test__Util$AgdaMode.Keyboard[/* insert */2]("d", instance);
                                                            })).then((function (param) {
                                                            return Test__Util$AgdaMode.Keyboard[/* insert */2]("a", instance);
                                                          })).then((function (param) {
                                                          return Test__Util$AgdaMode.Keyboard[/* insert */2]("b", instance);
                                                      ...
                                                      return Test__Util$AgdaMode.Keyboard[/* insert */2]("r", instance);
                                                    })).then((function (param) {
                              ...
                              Promise$BsMocha.it("should deactivate when stuck (\"Gl \")")(undefined, undefined, undefined, (function (param) {
                                      ...
                                      return Test__Util$AgdaMode.openAndLoad("Temp.agda").then((function (param) {
                                                    ...
                                                    return Test__Util$AgdaMode.Keyboard[/* insert */2]("G", instance).then((function (param) {
                                                                    ...
                                                                    return Test__Util$AgdaMode.Keyboard[/* insert */2](" ", instance);
                                                                  })).then((function (param) {
                                                                  Test__Util$AgdaMode.Assert[/* equal */0](undefined, "λ ", instance[/* editors */1][/* source */1].getText());
                                                                  return Promise.resolve(/* () */0);
                                                                }));
                              ...
                              return Promise$BsMocha.it("should deactivate after typing \"ENTER\" (\"Gl\" + \"ENTER\")")(undefined, undefined, undefined, (function (param) {
                                            ...
                                            return Test__Util$AgdaMode.openAndLoad("Temp.agda").then((function (param) {
                                                          ...
                                                          return Test__Util$AgdaMode.Keyboard[/* insert */2]("G", instance).then((function (param) {
                                                                          ...
                                                                          return Test__Util$AgdaMode.Keyboard[/* insert */2]("\n", instance);
                                                                        })).then((function (param) {

  ...
  if (typeof command === "number") {
    ...
    switch (command.tag | 0) {
      ...
      case 5 : 
          var index = command[1];
          var goal = command[0];
          var content$5 = Goal$AgdaMode.getContent(goal);
          var range = buildRange(goal);
          if (Semver.gte(connection[/* metadata */0][/* version */1], "2.5.3")) {
            return commonPart(/* NonInteractive */1) + ("( Cmd_give WithoutForce " + (String(index) + (" " + (String(range) + (" \"" + (String(content$5) + "\" )"))))));
          } else {
            return commonPart(/* NonInteractive */1) + ("( Cmd_give " + (String(index) + (" " + (String(range) + (" \"" + (String(content$5) + "\" )"))))));
          }
      case 6 : 
          var goal$1 = command[0];
          var content$6 = Goal$AgdaMode.getContent(goal$1);
          var range$1 = buildRange(goal$1);
          return commonPart(/* NonInteractive */1) + ("( Cmd_refine_or_intro False " + (String(command[1]) + (" " + (String(range$1) + (" \"" + (String(content$6) + "\" )"))))));
      case 7 : 
          var goal$2 = command[0];
          var content$7 = Goal$AgdaMode.getContent(goal$2);
          var range$2 = buildRange(goal$2);
          return commonPart(/* NonInteractive */1) + ("( Cmd_auto " + (String(command[1]) + (" " + (String(range$2) + (" \"" + (String(content$7) + "\" )"))))));
      case 8 : 
          var goal$3 = command[0];
          var content$8 = Goal$AgdaMode.getContent(goal$3);
          var range$3 = buildRange(goal$3);
          return commonPart(/* NonInteractive */1) + ("( Cmd_make_case " + (String(command[1]) + (" " + (String(range$3) + (" \"" + (String(content$8) + "\" )"))))));
      case 9 : 
          var normalization$prime$3 = of_string(command[0]);
          return commonPart(/* NonInteractive */1) + ("( Cmd_goal_type " + (String(normalization$prime$3) + (" " + (String(command[1]) + " noRange \"\" )"))));
      case 10 : 
          var normalization$prime$4 = of_string(command[0]);
          return commonPart(/* NonInteractive */1) + ("( Cmd_context " + (String(normalization$prime$4) + (" " + (String(command[1]) + " noRange \"\" )"))));
      case 11 : 
          var normalization$prime$5 = of_string(command[0]);
          return commonPart(/* NonInteractive */1) + ("( Cmd_goal_type_context " + (String(normalization$prime$5) + (" " + (String(command[1]) + " noRange \"\" )"))));
      case 12 : 
          var content$9 = Goal$AgdaMode.getContent(command[1]);
          var normalization$prime$6 = of_string(command[0]);
          return commonPart(/* NonInteractive */1) + ("( Cmd_goal_type_context_infer " + (String(normalization$prime$6) + (" " + (String(command[2]) + (" noRange \"" + (String(content$9) + "\" )"))))));

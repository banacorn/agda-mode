...
function mountingElement(state) {
...
var initialState_000 = /* mountAt : Bottom */Caml_chrome_debugger.variant("Bottom", 0, [createBottomPanel(/* () */0)]);
...
function mountPanel(editors, mountTo, self) {
  ...
  if (match.tag) {
    if (!mountTo) {
      ...
      Curry._1(self[/* send */0], /* UpdateMountAt */Caml_chrome_debugger.variant("UpdateMountAt", 2, [/* Bottom */Caml_chrome_debugger.variant("Bottom", 0, [createBottomPanel(/* () */0)])]));
    }
...
function mountSettings(editors, handles, open_, self) {
  ...
  if (match !== undefined) {
    if (open_) {
      Event$AgdaMode.emitOk(true, handles[/* onSettingsView */14]);
    } else {
      ...
      Event$AgdaMode.emitOk(false, handles[/* onSettingsView */14]);
    }
    return undefined;
  } else {
    if (open_) {
      var tab = Tab$AgdaMode.make(editors[/* source */1], (function (param) {
              ...
              return Event$AgdaMode.emitOk(true, handles[/* onSettingsView */14]);
            }), undefined, (function (param) {
              Curry._1(self[/* send */0], /* ToggleSettingsTab */Caml_chrome_debugger.variant("ToggleSettingsTab", 0, [false]));
              return Event$AgdaMode.emitOk(false, handles[/* onSettingsView */14]);
            }), undefined, /* () */0);
...
function Root(Props) {
  ...
  React.useEffect((function () {
          Curry._1(handles[/* activatePanel */3][/* supply */1], (function (param) {
                  Curry._1(send, /* Activate */1);
                  var state = stateRef.current;
                  if (state[/* isActive */1]) {
                    return Async$AgdaMode.resolve(mountingElement(state));
                  } else {
  ...
  React.useEffect((function () {
          Curry._1(handles[/* deactivatePanel */4][/* supply */1], (function (param) {
  ...
  Hook$AgdaMode.useDidUpdateEffect2((function (param) {
          if (state[/* isActive */1]) {
            Event$AgdaMode.emitOk(mountingElement(state), onPanelActivated);
          } else {
  ...
  Hook$AgdaMode.useEventListener((function (param) {
          ...
          return Event$AgdaMode.emitOk(/* tuple */[
                      param[1],
                      param[2]
                    ], handles[/* inquireQuery */11]);
        }), handles[/* inquire */1]);
  Hook$AgdaMode.useEventListener((function (param) {
          return Curry._1(send, /* ToggleDocking */0);
        }), handles[/* toggleDocking */2]);
  Hook$AgdaMode.useEventListener(match$6[1], handles[/* updateIsPending */6]);
  Hook$AgdaMode.useEventListener(match$5[1], handles[/* updateShouldDisplay */7]);
  Hook$AgdaMode.useEventListener((function (param) {
          Curry._1(setMode, /* Display */0);
          return Editors$AgdaMode.Focus[/* on */1](/* Source */0, editors);
        }), handles[/* onInquireQuery */12]);
  Hook$AgdaMode.useEventListener((function (param) {
          return /* () */0;
        }), handles[/* destroy */16]);
  ...
  Hook$AgdaMode.useEventListener(match$7[1], handles[/* updateConnection */8]);
  ...
  return React.createElement(React.Fragment, undefined, React.createElement(Type__View$AgdaMode.Mouse[/* Provider */1][/* make */0], {
                  value: (function ($$event) {
                      return Event$AgdaMode.emitOk($$event, handles[/* onMouseEvent */19]);
                    }),
                  children: React.createElement(Type__View$AgdaMode.Debug[/* Provider */3][/* make */0], {
                        ...
                        children: null
                            ...
                            isPending: match$6[0],
                            isActive: isActive,
                            onInquireQuery: handles[/* onInquireQuery */12],
                            ...
                            editorPlaceholder: "",
                            editorValue: "",
                            interceptAndInsertKey: handles[/* interceptAndInsertKey */18],
                            activateInputMethod: handles[/* activateInputMethod */17],
                            ...
                            onInputMethodActivationChange: handles[/* onInputMethodActivationChange */5]
                          }), React.createElement(Settings$AgdaMode.make, {
                            inquireConnection: handles[/* inquireConnection */9],
                            onInquireConnection: handles[/* onInquireConnection */10],
                            connection: match$8[0],
                            connectionError: match$8[1],
                            navigate: handles[/* navigateSettingsView */15],
                            debug: match$1[0],
...
exports.mountingElement = mountingElement;

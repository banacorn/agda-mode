...
function emitOk(x, self) {
  return Rebase.$$Array[/* forEach */8]((function (listener) {
                return Curry._1(listener[/* resolve */0], /* Ok */Caml_chrome_debugger.variant("Ok", 0, [x]));
              }), Js_dict.values(self[/* listeners */1]));
}

function emitError(x, self) {
  return Rebase.$$Array[/* forEach */8]((function (listener) {
                return Curry._1(listener[/* resolve */0], /* Error */Caml_chrome_debugger.variant("Error", 1, [x]));
              }), Js_dict.values(self[/* listeners */1]));
}

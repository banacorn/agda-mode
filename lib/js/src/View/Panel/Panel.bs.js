...
function createForBottom(param) {
  ...
  var partial_arg = Rebase.$$Array.filterMap;
...
function Panel(Props) {
  ...
  Hook$AgdaMode.useChannel((function (param) {
          ...
          return $$Promise.tapOk(Curry._1(onInquireQuery[/* once */2], /* () */0), (function (param) {
                        Curry._1(setMode, /* Display */0);
  ...
  Hook$AgdaMode.useChannel(Curry._2(Rebase.Fn.$great$great, match$7[1], $$Promise.resolved), channels[/* updateIsPending */6]);
  React.useEffect((function () {
          return Curry._1(onInputMethodChange[/* on */3], (function (state) {
  ...
  Hook$AgdaMode.useChannel((function (param) {
          ...
          return $$Promise.resolved(fromMountingPoint(mountingPointRef.current));
                  ...
                  id: id
                      ...
                      className: "panel-heading agda-header-container"
                          ...
                          onConfirm: (function (result) {
                              return Curry._1(onInquireQuery[/* emit */1], /* Ok */Caml_chrome_debugger.variant("Ok", 0, [result]));
                            }),
                          onCancel: (function (param) {
                              Curry._1(onInquireQuery[/* emit */1], /* Error */Caml_chrome_debugger.variant("Error", 1, [/* Cancelled */0]));
                              return /* () */0;
                            }),

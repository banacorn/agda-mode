...
var PROTOCOL;
(function (PROTOCOL) {
    PROTOCOL.ADD_REQUEST = 'PROTOCOL.ADD_REQUEST';
    PROTOCOL.ADD_RESPONSE = 'PROTOCOL.ADD_RESPONSE';
    PROTOCOL.CLEAR_ALL = 'PROTOCOL.CLEAR_ALL';
    PROTOCOL.TOGGLE_ACCUMULATE = 'PROTOCOL.TOGGLE_ACCUMULATE';
    PROTOCOL.TOGGLE_LSP = 'PROTOCOL.TOGGLE_LSP';
    PROTOCOL.addRequest = redux_actions_1.createAction(PROTOCOL.ADD_REQUEST);
    PROTOCOL.addResponse = redux_actions_1.createAction(PROTOCOL.ADD_RESPONSE);
    PROTOCOL.clearAll = redux_actions_1.createAction(PROTOCOL.CLEAR_ALL);
    PROTOCOL.toggleAccumulate = redux_actions_1.createAction(PROTOCOL.TOGGLE_ACCUMULATE);

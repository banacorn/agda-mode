...
function Settings__InputMethod$SymbolLookup(Props) {
  ...
  var onChange = function (param) {
    ...
    if (editor !== undefined) {
      return Curry._1(setInput, Caml_option.valFromOption(editor).getText());
    }
...
function Settings__InputMethod$ExtendKeymap$ExtensionItem(Props) {
  ...
  React.useEffect((function () {
          if (modifying) {
            var editor = editorRef.current;
            if (editor !== undefined) {
              atom.views.getView(Caml_option.valFromOption(editor)).focus();
            }
...
function Settings__InputMethod$ExtendKeymap(Props) {
  var match = Hook$AgdaMode.useState(Curry._1(Extension$AgdaMode.readKeymap, undefined));
  var setKeymap = match[1];
  var forceUpdate = function (param) {
    return Curry._1(setKeymap, Curry._1(Extension$AgdaMode.readKeymap, undefined));
  };
  ...
  var resetToDefault = React.useCallback((function (param) {
          Extension$AgdaMode.resetToDefault(undefined);
          return Curry._1(setKeymap, Curry._1(Extension$AgdaMode.readKeymap, undefined));
        }), []);

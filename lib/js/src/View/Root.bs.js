...
function Root(Props) {
  ...
  Hook$AgdaMode.useChannel((function (param) {
          var targetID = "agda-mode:" + Editors$AgdaMode.getID(editors);
          var container = getPanelContainerFromState(state);
          var partial_arg = Rebase.$$Array[/* filter */10];
          var partial_arg$1 = Rebase.$$Array[/* filterMap */23];
          var panel = Rebase.$$Option[/* flatMap */5]((function (xs) {
                  return Rebase.$$Array[/* get */17](xs, 0);
                }), Rebase.$$Option[/* map */0]((function (param) {
                      return partial_arg((function (elem) {
                                    return elem.id === targetID;
                                  }), param);
                    }), Rebase.$$Option[/* map */0](Curry._2(Rebase.Fn[/* >> */6], Curry._2(Rebase.Fn[/* >> */6], (function (prim) {
                                  return prim.childNodes;
                                }), (function (prim) {
                                  return Array.prototype.slice.call(prim);
                                })), (function (param) {
                              return partial_arg$1(Webapi__Dom__HtmlElement.ofNode, param);
                            })), Webapi__Dom__HtmlElement.ofElement(container))));
          Rebase.$$Option[/* forEach */8]((function (elem) {

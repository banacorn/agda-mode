...
function toString(self) {
  ...
  return "Annotation " + (String(self[/* start */0]) + (" " + (String(self[/* end_ */1]) + (" " + (Util$AgdaMode.Pretty[/* list */0](Rebase.List[/* fromArray */12](self[/* types */2])) + tmp)))));
}
                ...
                return Rebase.$$Option[/* flatMap */5]((function (start) {
                              return Rebase.$$Option[/* flatMap */5]((function (end_) {
                                            return /* record */Caml_chrome_debugger.record([
                                                      ...
                                                      start,
                                                      end_,
                                                      Parser$AgdaMode.SExpression[/* flatten */2](types),
                                                      undefined
                                                    ]);
                ...
                return Rebase.$$Option[/* flatMap */5]((function (start) {
                              return Rebase.$$Option[/* flatMap */5]((function (end_) {
                                            return /* record */Caml_chrome_debugger.record([
                                                      ...
                                                      start,
                                                      end_,
                                                      Parser$AgdaMode.SExpression[/* flatten */2](types$1),
                                                      undefined
                                                    ]);
                                      ...
                                      return Rebase.$$Option[/* flatMap */5]((function (end_) {
                                                    return Rebase.$$Option[/* flatMap */5]((function (index) {
                                                                  return /* record */Caml_chrome_debugger.record([
                                                                            ...
                                                                            start,
                                                                            end_,
                                                                            Parser$AgdaMode.SExpression[/* flatten */2](types$2),
                                                                            /* tuple */[
                                                                              filepath,
                                                                              index
                                                                            ]
...
var Annotation = /* module */Caml_chrome_debugger.localModule([
    "toString",
    "parse",

...
function make(header, hidden, isPending, mountAt, onMountChange, settingsViewOn, onSettingsViewToggle, _children) {
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                var toggleMountingPosition = Util$AgdaMode.toClassName(Util$AgdaMode.addClass("activated", mountAt === /* Pane */1, /* :: */Block.simpleVariant("::", [
                            "no-btn",
                            /* [] */0
                          ])));
                return React.createElement("div", {
                            className: classList
                                ...
                                className: "agda-dashboard"
                                        ...
                                        onClick: (function (param) {
                                            var match = mountAt === /* Pane */1;
                                            if (match) {
                                              return Curry._1(onMountChange, /* Bottom */0);
                                            } else {
                                              return Curry._1(onMountChange, /* Pane */1);
                                            }
                                          })
                                      }, React.createElement("span", {

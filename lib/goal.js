...
var Goal = (function () {
    ...
    Goal.prototype.writeLambda = function (contents) {
        var _this = this;
        var textBuffer = this.editor.getBuffer();
        var beforeRange = new Atom.Range(textBuffer.getFirstPosition(), this.range.start);
        var afterRange = new Atom.Range(this.range.end, textBuffer.getEndPosition());
    ...
    Goal.prototype.getContent = function () {
        var range = this.range.translate(new Atom.Point(0, 2), new Atom.Point(0, -2));
        var rawContent = this.editor.getTextInBufferRange(range);
    ...
    Goal.prototype.selectContent = function () {
        var indexWidth = this.index === -1 ? 1 : this.index.toString().length;
        var range = this.range.translate(new Atom.Point(0, 3), new Atom.Point(0, -(3 + indexWidth)));

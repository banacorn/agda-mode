  ...
  if (typeof request === "number") {
    ...
    switch (request.tag | 0) {
      case /* WhyInScope */0 :
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_why_in_scope " + (String(request[1]) + (" noRange \"" + (String(content) + "\" )"))));
      ...
      case /* Refine */10 :
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_refine_or_intro False " + (String(request[1]) + (" " + (String(range$1) + (" \"" + (String(content$10) + "\" )"))))));
      case /* Auto */11 :
          var index$2 = request[1];
      ...
      case /* Case */12 :
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_make_case " + (String(request[1]) + (" " + (String(range$3) + (" \"" + (String(content$12) + "\" )"))))));
      case /* GoalType */13 :
      ...
      case /* GoalTypeAndInferredType */16 :
          var content$13 = Goal$AgdaMode.getContent(request[1]);
          var normalization$prime$8 = Command$AgdaMode.Normalization.toString(request[0]);
          return commonPart(/* NonInteractive */1) + ("( Cmd_goal_type_context_infer " + (String(normalization$prime$8) + (" " + (String(request[2]) + (" noRange \"" + (String(content$13) + "\" )"))))));
...
function toString(param) {
  if (typeof param === "number") {
    ...
    switch (param.tag | 0) {
      ...
      case /* InferType */3 :
          return "InferType \"" + (param[1] + ("\" (Goal " + (String(param[2]) + (", " + (Command$AgdaMode.Normalization.toString(param[0]) + ")")))));
      case /* InferTypeGlobal */4 :
          return "InferType \"" + (param[1] + ("\" (Global, " + (Command$AgdaMode.Normalization.toString(param[0]) + ")")));
      case /* ModuleContents */5 :
          return "ModuleContents \"" + (param[1] + ("\" (Goal " + (String(param[2]) + (", " + (Command$AgdaMode.Normalization.toString(param[0]) + ")")))));
      case /* ModuleContentsGlobal */6 :
          return "ModuleContents \"" + (param[1] + ("\" (Global, " + (Command$AgdaMode.Normalization.toString(param[0]) + ")")));
      case /* ComputeNormalForm */7 :
          return "ComputeNormalForm \"" + (param[1] + ("\" (Goal " + (String(param[2]) + (", " + (Command$AgdaMode.ComputeMode.toString(param[0]) + ")")))));
      case /* ComputeNormalFormGlobal */8 :
      ...
      case /* GoalType */13 :
          return "GoalType (Goal " + (String(param[1]) + (", " + (Command$AgdaMode.Normalization.toString(param[0]) + ")")));
      case /* Context */14 :
          return "Context (Goal " + (String(param[1]) + (", " + (Command$AgdaMode.Normalization.toString(param[0]) + ")")));
      case /* GoalTypeAndContext */15 :
          return "GoalTypeAndContext (Goal " + (String(param[1]) + (", " + (Command$AgdaMode.Normalization.toString(param[0]) + ")")));
      case /* GoalTypeAndInferredType */16 :
          return "GoalTypeAndInferredType (Goal " + (String(param[2]) + (", " + (Command$AgdaMode.Normalization.toString(param[0]) + ")")));
      case /* GotoDefinition */17 :

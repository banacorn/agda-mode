...
function make($staropt$star, $staropt$star$1, hidden, $staropt$star$2, $staropt$star$3, $staropt$star$4, $staropt$star$5, $staropt$star$6, $staropt$star$7, _) {
  ...
  var onConfirm = $staropt$star$3 !== undefined ? $staropt$star$3 : (function () {
        return /* () */0;
      });
  var onCancel = $staropt$star$4 !== undefined ? $staropt$star$4 : (function () {
        return /* () */0;
      });
  var onFocus = $staropt$star$5 !== undefined ? $staropt$star$5 : (function () {
        return /* () */0;
      });
  var onBlur = $staropt$star$6 !== undefined ? $staropt$star$6 : (function () {
        return /* () */0;
      });
  var editorRef = $staropt$star$7 !== undefined ? $staropt$star$7 : (function () {
        return /* () */0;
      });
  ...
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                if (match !== undefined) {
                  ...
                  disposables.add(atom.commands.add(atom.views.getView(editor), "core:confirm", (function () {
                              return Curry._1(onConfirm, editor.getText());
                            })));
                  disposables.add(atom.commands.add(atom.views.getView(editor), "core:cancel", (function () {
...
var jsComponent = ReasonReact.wrapReasonForJs(component, (function (jsProps) {
        return make(jsProps.value, jsProps.placeholder, jsProps.hidden, jsProps.grammar, jsProps.onConfirm, jsProps.onCancel, jsProps.onFocus, jsProps.onBlur, jsProps.editorRef, /* array */[]);
      }));

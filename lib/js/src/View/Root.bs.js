...
function Root(Props) {
  ...
  Hook$AgdaMode.useEventListener(setActivation, handles[/* activateSettingsView */4]);
  ...
  React.useEffect((function () {
          if (view !== undefined) {
            if (activated) {
              ...
              Curry._1(view[/* kill */1], /* () */0);
              Curry._1(setView, undefined);
  ...
  Hook$AgdaMode.useChannel(Curry._2(Rebase.Fn[/* >> */6], match$9[1], Async$AgdaMode.resolve), channels[/* updateShouldDisplay */6]);
  ...
  var hidden;
  hidden = mountAt.tag ? false : !(isActive && match$9[0]);

...
export namespace INPUT_METHOD {
 ...
 export const activateInputMethod = createAction<void, INPUT_METHOD.ACTIVATE>(INPUT_METHOD.ACTIVATE);
 export const deactivateInputMethod = createAction<void, INPUT_METHOD.DEACTIVATE>(INPUT_METHOD.DEACTIVATE);

...
var View = (function () {
    ...
    View.prototype.createPaneItem = function (path) {
        ...
        paneItem['getURI'] = function () { return ("agda-mode://" + _this.core.editor.id); };
        //
        ...
        if (!this.state().mounted) {
            ...
            switch (mountAt) {
                case 1 /* Bottom */:
                    ...
                    break;
                case 0 /* Pane */:
                    var uri = "agda-mode://" + this.core.editor.id;
                    ...
                    atom.workspace.open(uri, {
                        ...
                        if (pane) {
                            _this.paneItemSubscriptions.add(pane.onWillDestroyItem(function (event) {
                                if (event.item.getURI() === "agda-mode://" + _this.core.editor.id) {

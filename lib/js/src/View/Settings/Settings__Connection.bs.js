...
function Settings__Connection(Props) {
  ...
  var handleAutoSearch = function (param) {
    return Async$AgdaMode.finalError((function (err) {
                  return Curry._1(setAutoSearchError, /* AutoSearchError */Caml_chrome_debugger.variant("AutoSearchError", 0, [err]));
  ...
  var className = Curry._1(Util$AgdaMode.ClassName[/* serialize */2], Util$AgdaMode.ClassName[/* addWhen */1]("inquiring", !connected, Util$AgdaMode.ClassName[/* addWhen */1]("hidden", hidden, /* :: */Caml_chrome_debugger.simpleVariant("::", [

...
function makeExpr(value, _) {
  return /* record */Block.record([
            ...
            (function () {
                switch (value.tag | 0) {
                  case 0 : 
                      return ReasonReact.element(undefined, undefined, C$AgdaMode.QName[/* make */5](value[0], /* array */[]));
                  case 1 : 
                  ...
                  case 6 : 
                      var func = value[1];
                      var ms = C$AgdaMode.QName[/* moduleParts */3](func);
                      var match$3 = C$AgdaMode.QName[/* unqualify */2](func);
                      var xs;
                      ...
                      var qualify = function (ms, rest) {
                        var __x = List.map((function (value) {
                                return ReasonReact.element(undefined, undefined, C$AgdaMode.Name[/* make */4](value, /* array */[]));
                              }), ms);
                        ...
                        if (xs) {
                          ...
                          if (match) {
                            return /* :: */Block.simpleVariant("::", [
                                      /* tuple */[
                                        qualify(ms, ReasonReact.element(undefined, undefined, C$AgdaMode.Name[/* make */4](/* Name */Block.variant("Name", 0, [
                                                        /* NoRange */0,
                                                        /* :: */Block.simpleVariant("::", [
                      ...
                      return Util$AgdaMode.sepBy(" ", merge(/* [] */0, prOp(ms, xs, value[3])));
                  case 7 : 
                      return Util$AgdaMode.sepBy(" | ", List.map((function (value) {
                                        return ReasonReact.element(undefined, undefined, makeExpr(value, /* array */[]));
                                      }), /* :: */Block.simpleVariant("::", [

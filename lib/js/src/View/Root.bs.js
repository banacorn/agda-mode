...
function Root(Props) {
  ...
  Hook$AgdaMode.useChannel((function (address) {
          if (address !== undefined) {
            var match = settingsViewRef.current;
            if (match !== undefined) {
              return $$Promise.resolved(undefined);
            }
            var resource = Resource$AgdaMode.make(undefined);
            var tab = Tab$AgdaMode.make(editors.source, (function (param) {
                    ...
                    return Curry._1(resource.supply, undefined);
            ...
            return Curry._1(resource.acquire, undefined);
          }
          var tab$1 = settingsViewRef.current;
          if (tab$1 !== undefined) {
            Tab$AgdaMode.kill(tab$1);
...
function initialize(editors) {
  ...
  var events = Events$AgdaMode.make(undefined);
  var channels = Channels$AgdaMode.make(undefined);

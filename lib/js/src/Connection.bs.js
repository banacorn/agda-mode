...
function parseAgdaOutput(stringAgdaSpatOut, continuation) {
  ...
  var results = Rebase.$$Array[/* map */0]((function (line) {
          ...
          switch (match.tag | 0) {
            ...
            case 2 : 
                ...
                var returnValue;
                returnValue = match$1.tag ? /* Error */Caml_chrome_debugger.variant("Error", 0, [match$1[0]]) : /* Data */Caml_chrome_debugger.variant("Data", 1, [match$1[0]]);
  ...
  if (isEndOfResponse) {
    return Rebase.$$Array[/* concat */11](results, /* array */[/* End */0]);
  } else {
    return results;
  }
}
...
function wire(self) {
  ...
  var onData = function (chunk) {
    ...
    var result = parseAgdaOutput(rawText, continuation);

...
function make(editor, updateRawBody, updateHeader, updateMode, updateMountTo, inquireQuery, interceptAndInsertKey, inputMethodHandle$2, _children) {
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",
            ...
            (function (self) {
                ...
                return React.createElement(React.Fragment, undefined, ReasonReact.element(undefined, undefined, Panel$AgdaMode.make(editor, element, (function (mountTo) {
                                    ...
                                    }), editor[/* query */2][/* placeholder */1], editor[/* query */2][/* value */0], interceptAndInsertKey, inputMethodHandle$2, /* array */[])));
              }),
            (function (param) {
...
function initialize(editor) {
  var element = document.createElement("article");
  ReactDom.render(ReasonReact.element(undefined, undefined, make(editor, updateRawBody$1, updateHeader$1, updateMode$1, updateMountTo$1, inquireQuery$1, interceptAndInsertKey$1, inputMethodHandle$1, /* array */[])), element);
  return collection;
}

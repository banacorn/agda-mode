...
function parseAgdaOutput(stringAgdaSpatOut) {
  ...
  var toResponse = function (param) {
    if (param.tag) {
      return /* ResError */Caml_chrome_debugger.variant("ResError", 0, [param[0]]);
    } else {
      return /* ResData */Caml_chrome_debugger.variant("ResData", 1, [param[0]]);
    }
  };
  ...
  if (isEndOfResponse) {
    return Rebase.$$Array[/* concat */11](results, /* array */[/* ResEnd */0]);
  } else {
    return results;
  }
}

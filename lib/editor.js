...
const Range_1 = require("./view/component/Panel/Body/Range");
...
class Editor {
    ...
    jumpToRange(range) {
        this.focus();
        const atomRange = Range_1.default.toAtomRanges(range)[0];
        if (range.source) {
            // global
...
class MouseHighlightManager {
    ...
    mark(agdaRange) {
        const range = Range_1.default.toAtomRanges(agdaRange)[0];
        if (range) {

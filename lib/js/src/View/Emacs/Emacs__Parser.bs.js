  ...
  return Parser$AgdaMode.captures((function (captured) {
                return Rebase.$$Option[/* flatMap */5]((function (type_) {
                              return Rebase.$$Option[/* flatMap */5]((function (term) {
                                          ...
                                          }), Parser$AgdaMode.at(1, expr, captured));
                            }), Parser$AgdaMode.at(2, expr, captured));
              }), partial_arg$1, param);
}

var partial_arg$2 = (/^Type ((?:\n|.)+)/);

function justType(param) {
  return Parser$AgdaMode.captures((function (captured) {
...
var partial_arg$3 = (/^Sort ((?:\n|.)+)/);

function justSort(param) {
  return Parser$AgdaMode.captures((function (captured) {
...
function outputConstraint(param) {
  return Parser$AgdaMode.choice(partial_arg$4, param);
}

function outputWithoutRange(raw) {
  return Rebase.$$Option[/* map */0]((function (x) {
                return /* Output */Block.simpleVariant("Output", [
                          x,
                          undefined
                        ]);
              }), outputConstraint(raw));
}

var partial_arg$5 = (/((?:\n|.)*\S+)\s*\[ at ([^\]]+) \]/);

function outputWithRange(param) {
  return Parser$AgdaMode.captures((function (captured) {
                return Rebase.$$Option[/* map */0]((function (oc) {
                              var r = Rebase.$$Option[/* flatMap */5](range, Rebase.$$Option[/* flatten */20](Rebase.$$Array[/* get */17](captured, 2)));
                              return /* Output */Block.simpleVariant("Output", [
                                        oc,
                                        r
                                      ]);
                            }), Rebase.$$Option[/* flatMap */5](outputConstraint, Rebase.$$Option[/* flatten */20](Rebase.$$Array[/* get */17](captured, 1))));
              }), partial_arg$5, param);
}
...
function output(raw) {
  ...
  if (hasRange) {
    return Curry._1(outputWithRange, raw);
  } else {
    return outputWithoutRange(raw);
  }
}
  ...
  return Rebase.$$Option[/* some */11](Rebase.$$Array[/* mapi */27]((function (token, i) {
                    ...
                    if (match !== 1) {
                      ...
                      return Rebase.$$Option[/* mapOr */18]((function (x) {
                                  ...
                                  }), /* Text */Block.variant("Text", 0, [token]), range(token));
                    }
...
function warningOrErrors(isWarning, raw) {
...
function warning(param) {
  return warningOrErrors(true, param);
}

function error(param) {
  return warningOrErrors(false, param);
}

var partial_arg$6 = Util$AgdaMode.Dict[/* split */1];

function partiteMetas(param) {
  return partial_arg$6("metas", (function (rawMetas) {
                var metas = unindent(rawMetas);
                var indexOfHiddenMetas = Rebase.$$Option[/* map */0]((function (prim) {
                        return prim[0];
                      }), Rebase.$$Array[/* findIndex */29]((function (s) {
                            return Rebase.$$Option[/* isSome */13](Curry._1(outputWithRange, s));
                          }), metas));
  ...
  return (function (param) {
      return partial_arg(key, (function (raw) {
                    ...
                    var markWarningStart = function (line) {
                      return Rebase.$$Option[/* isSome */13](range(line));
                    };
...
function goalTypeContext(raw) {
  ...
  var goal = Rebase.$$Option[/* map */0]((function (x) {
          return /* Goal */Block.simpleVariant("Goal", [x]);
              ...
              return expr(Rebase.$$String[/* joinWith */11]("\n", Rebase.List[/* fromArray */12](line)).slice(5));
...
function context(raw) {
  ...
  return Rebase.$$Array[/* filterMap */23]((function (x) {
                return x;
              }), Rebase.$$Array[/* map */0](output, lines));
}
...
function error$1(raw) {
  ...
  return Rebase.$$Option[/* mapOr */18]((function (metas) {
                return Rebase.$$Array[/* filterMap */23]((function (x) {
                              return x;
                            }), Rebase.$$Array[/* map */0](error, metas));
  ...
  var ranges = Rebase.$$Array[/* filterMap */23]((function (x) {
          return x;
              ...
              if (match !== 1) {
                ...
                return Rebase.$$Option[/* flatMap */5](range, token);
              }
            }), raw.split((/its definition at (\S+\:(?:\d+\,\d+\-\d+\,\d+|\d+\,\d+\-\d+))/g))));
  return /* tuple */[
          Rebase.$$Option[/* getOr */16](/* array */[], plainText(raw)),
          ranges
        ];
}
...
function searchAbout(raw) {
  ...
  var outputs = Rebase.$$Array[/* filterMap */23]((function (x) {
          return x;
        }), Rebase.$$Array[/* map */0](output, unindent(Rebase.$$Array[/* map */0]((function (s) {
                      return s.slice(2);
                    }), lines.slice(1)))));
  return /* tuple */[
          target,

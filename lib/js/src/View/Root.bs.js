...
function Root(Props) {
  ...
  Hook$AgdaMode.useChannel((function (param) {
          ...
          return Async$AgdaMode.pass((function (param) {
                        ...
                        }))(Event$AgdaMode.once(handles[/* onInquire */5]));
        }), handles[/* inquire */4]);
  ...
  return React.createElement(React.Fragment, undefined, React.createElement(Type__View$AgdaMode.Mouse[/* Provider */1][/* make */0], {
                  ...
                  children: React.createElement(Type__View$AgdaMode.Debug[/* Provider */3][/* make */0], {
                        ...
                        children: null
                            ...
                            isActive: isActive,
                            panelRef: panelRef,
                            onInquireQuery: handles[/* onInquire */5],
                            ...
                            onInputMethodActivationChange: handles[/* onInputMethodActivationChange */17],
                            onInputMethodChange: handles[/* onInputMethodChange */18],

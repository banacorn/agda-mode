...
function autoSearch(param) {
  return new Promise((function (resolve, reject) {
                ...
                if (exit === 1) {
                  ...
                  Child_process.exec("which agda", (function (error, stdout, stderr) {
...
function validateAndMake(path) {
  ...
  return new Promise((function (resolve, reject) {
                if (Rebase.$$String[/* isEmpty */5](path)) {
                  reject([
                        ValidationExn,
                        /* PathMalformed */Block.variant("PathMalformed", 0, ["the path must not be empty"])
                      ]);
                }
                var hangTimeout = setTimeout((function (param) {
                        return reject([
                ...
                Child_process.exec(parsedPath, (function (error, stdout, stderr) {
                        ...
                        if (!Rebase.$$String[/* isEmpty */5](stderr$prime)) {
                          reject([
                                ValidationExn,
                                /* ProcessError */Block.variant("ProcessError", 3, [stderr$prime])
                              ]);
                        }
...
function wire(self) {
  var match = self[/* connection */1];
  if (match !== undefined) {
    var connection = match;
    var response = function (data) {
      console.log(data);
      var match = Rebase.$$Array[/* get */17](connection[/* queue */2], 0);
      if (match !== undefined) {
        Curry._1(match[/* resolve */1], data);
        connection[/* queue */2].pop();
        return /* () */0;
      } else {
        console.log("WTF!!");
        return /* () */0;
    ...
    connection[/* stdout */0].on("data", onData);
  }

...
function make(param) {
  return /* record */Block.record([
            ...
            "",
            undefined,
            Util$AgdaMode.Event[/* make */1](/* () */0)
          ]);
}

function inquire(self) {
  return Util$AgdaMode.Event[/* once */8](self[/* result */3]);
}

function answer(x, self) {
  return Util$AgdaMode.Event[/* resolve */9](/* Ok */Block.variant("Ok", 0, [x]), self[/* result */3]);
}

function reject(x, self) {
  return Util$AgdaMode.Event[/* resolve */9](/* Error */Block.variant("Error", 1, [x]), self[/* result */3]);
}

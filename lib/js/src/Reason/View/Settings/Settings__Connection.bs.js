...
function make(inquireConnection, hidden, querying, checked, toggleAgdaConnection, agdaConnected, agdaPath, agdaVersion, supportedProtocol, _children) {
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",
            ...
            (function (self) {
                return Util$AgdaMode.Msg[/* recv */5](self[/* onUnmount */4], (function (param) {
                              Curry._1(self[/* send */3], /* Inquire */Block.simpleVariant("Inquire", [
                                      param[0],
                                      param[1]
                                    ]));
                              return Util$AgdaMode.Msg[/* handlePromise */3](MiniEditor$AgdaMode.Model[/* inquire */1](self[/* state */1][/* editorModel */2][0]), inquireConnection);
                            }), inquireConnection);
              }),

...
function Root(Props) {
  ...
  Hook$AgdaMode.useEventListener(match$6[1], handles[/* updateIsPending */4]);
  Hook$AgdaMode.useEventListener(match$5[1], handles[/* updateShouldDisplay */5]);
  Hook$AgdaMode.useEventListener((function (param) {
          Curry._1(setMode, /* Display */0);
  ...
  Hook$AgdaMode.useEventListener(match$7[1], handles[/* updateConnection */6]);

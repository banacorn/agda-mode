...
function eventTargetEditor($$event) {
  ...
  var targetedEditors = Rebase.$$Array[/* filter */10](Curry._2(Rebase.Fn[/* >> */6], Curry._2(Rebase.Fn[/* >> */6], (function (prim) {
  ...
  return Rebase.$$Array[/* get */17](targetedEditors, 0);
}
  ...
  return Rebase.$$Array[/* forEach */8]((function (command) {
                subscriptions.add(atom.commands.add("atom-text-editor", "agda-mode:" + command, (function ($$event) {
                            return Rebase.$$Option[/* forEach */8]((function (instance) {
                                          ...
                                          return /* () */0;
                                        }), Rebase.$$Option[/* flatMap */5](get, eventTargetEditor($$event)));
                          })));
                return /* () */0;

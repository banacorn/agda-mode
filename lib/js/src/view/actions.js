...
(function (BODY) {
    ...
    BODY.UPDATE_JSON = 'BODY.UPDATE_JSON';
    BODY.UPDATE_EMACS = 'BODY.UPDATE_EMACS';
})(BODY = exports.BODY || (exports.BODY = {}));
exports.updateMaxBodyHeight = redux_actions_1.createAction(BODY.UPDATE_MAX_BODY_HEIGHT);
exports.updateJSON = redux_actions_1.createAction(BODY.UPDATE_JSON);
exports.updateEmacs = redux_actions_1.createAction(BODY.UPDATE_EMACS);

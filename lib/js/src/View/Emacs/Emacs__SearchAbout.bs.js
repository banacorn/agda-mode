...
function parse(raw) {
  ...
  var outputs = Rebase.$$Array[/* filterMap */23]((function (x) {
          return x;
        }), Rebase.$$Array[/* map */0](Emacs__Component$AgdaMode.Output[/* parse */3], Emacs__Parser$AgdaMode.unindent(Rebase.$$Array[/* map */0]((function (s) {
                      return s.slice(2);
                    }), lines.slice(1)))));
  return /* tuple */[
          target,
...
function Emacs__SearchAbout(Props) {
  ...
  if (match$1) {
    ...
    return React.createElement(React.Fragment, undefined, React.createElement("p", undefined, "Definitions about " + (target + ":")), (function (eta) {
                    return Curry._2(arg, undefined, eta);
                  })(Rebase.$$Array[/* map */0]((function (value) {

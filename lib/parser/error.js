...
var libraryNotFound = parsimmon_1.seq(libraryNotFoundItem.many()).map(function (result) {
    return {
...
var errorParser = parsimmon_1.alt(notInScope, typeMismatch, definitionTypeMismatch, badConstructor, rhsOmitted, missingType, multipleDefinition, missingDefinition, termination, constructorTarget, functionType, moduleMismatch, parse, caseSingleHole, patternMatchOnNonDatatype, libraryNotFound, unparsed);

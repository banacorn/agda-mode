...
function registerCommands() {
    commands.forEach(function (command) {
        subscriptions.add(atom.commands.add('atom-text-editor', command, function () {
...
function registerEditorActivation() {
    ...
    subscriptions.add(atom.workspace.onDidChangeActivePaneItem(function (nextEditor) {
        if (nextEditor) {
...
function activate(state) {
    ...
    subscriptions.add(atom.workspace.observeTextEditors(function (editor) {
        ...
        editorSubscriptions.add(editor.onDidChangePath(function () {
            // agda => not agda

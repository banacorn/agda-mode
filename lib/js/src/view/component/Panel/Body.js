...
class Body extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("section", { className: classes, tabIndex: -1, style: style },
            ...
            error &&
                React.createElement(view_1.default.EventContext.Consumer, null, emitter => (React.createElement(Error, { error: error, emacsMessage: emacsMessage, emit: emitter.emit }))),

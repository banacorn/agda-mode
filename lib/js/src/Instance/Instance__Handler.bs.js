  ...
  return Async$AgdaMode.thenError((function (error) {
                if (typeof error === "number") {
                  ...
                  if (match$1.tag) {
                    ...
                    Curry._3(instance[/* view */2][/* display */5], "Parse Error", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [message])]));
                  } else {
                    ...
                    Curry._3(instance[/* view */2][/* display */5], "Parse Error", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [intro + message$1])]));
                  }
                }
...
function handleLocalCommand(command, instance) {
  ...
  if (typeof command === "number") {
    switch (command) {
      ...
      case 17 : 
          var selected = Editors$AgdaMode.getSelectedTextNode(instance[/* editors */1]);
          ...
          Async$AgdaMode.finalOk((function (symbol) {
                  var partial_arg = QueryJs.default;
      ...
      case 8 : 
          ...
          if (enabled) {
            ...
            switch (command[0]) {
              case 0 : 
                  Curry._1(instance[/* view */2][/* activate */0], /* () */0);
                  Curry._1(instance[/* view */2][/* activateInputMethod */9], /* () */0);
                  break;
              case 1 : 

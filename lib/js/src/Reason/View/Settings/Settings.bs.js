...
function make(editors, onConnectionEditorRef, navigate, _children) {
                                ...
                                className: "agda-settings-pages"
                                    ...
                                    className: at(/* Root */0, uri, /* :: */Block.simpleVariant("::", [
                                        ...
                                        onClick: (function (param) {
                                          ...
                                          }, "Protocol"))), ReasonReact.element(undefined, undefined, Settings__Connection$AgdaMode.make(editors, onConnectionEditorRef, uri !== /* Connection */1, true, false, (function (prim) {
                                          console.log(prim);
                                          return /* () */0;

...
export default class Commander {
        ...
        if(this.loaded || _.includes(exception, command.kind)) {
            this.dispatchCommand(command)
                .catch(QueryCancelledError, () => {
                    this.core.viewLegacy.set("Query cancelled", [], View.Type.Warning);
                })
    ...
    whyInScope(): Promise<CommandResult> {
        return this.core.viewLegacy.query("Scope info", [], View.Type.PlainText, "name:")
            .then((expr) => {
    ...
    inferType(normalization: Normalization): Promise<CommandResult> {
        return this.core.textBuffer.getCurrentGoal()
            .then((goal) => {
                // goal-specific
                if (goal.isEmpty()) {
                    return this.core.viewLegacy.query(`Infer type ${toDescription(normalization)}`, [], View.Type.Value, "expression to infer:")
    ...
    moduleContents(normalization: Normalization): Promise<CommandResult> {
        return this.core.viewLegacy.query(`Module contents ${toDescription(normalization)}`, [], View.Type.PlainText, "module name:")
            .then((expr) => {
                return this.core.textBuffer.getCurrentGoal()
    ...
    computeNormalForm(): Promise<CommandResult> {
        return this.core.textBuffer.getCurrentGoal()
            .then((goal) => {
                if (goal.isEmpty()) {
                    return this.core.viewLegacy.query(`Compute normal form`, [], View.Type.Value, "expression to normalize:")
    ...
    computeNormalFormIgnoreAbstract(): Promise<CommandResult> {
        return this.core.textBuffer.getCurrentGoal()
            .then((goal) => {
                if (goal.isEmpty()) {
                    return this.core.viewLegacy.query(`Compute normal form (ignoring abstract)`, [], View.Type.Value, "expression to normalize:")
    ...
    give(): Promise<CommandResult> {
        return this.core.textBuffer.getCurrentGoal()
            .then((goal) => {
                if (goal.isEmpty()) {
                    return this.core.viewLegacy.query("Give", [], View.Type.PlainText, "expression to give:")
            ...
            .catch(OutOfGoalError, () => {
                this.core.viewLegacy.set("Out of goal", ["\"Give\" is a goal-specific command, please place the cursor in a goal"], View.Type.Error);
            })
    ...
    refine(): Promise<CommandResult> {
        return this.core.textBuffer.getCurrentGoal()
            ...
            .catch(OutOfGoalError, () => {
                this.core.viewLegacy.set("Out of goal", ["\"Refine\" is a goal-specific command, please place the cursor in a goal"], View.Type.Error);
            })
    ...
    auto(): Promise<CommandResult> {
        return this.core.textBuffer.getCurrentGoal()
            ...
            .catch(OutOfGoalError, () => {
                this.core.viewLegacy.set("Out of goal", ["\"Auto\" is a goal-specific command, please place the cursor in a goal"], View.Type.Error);
            })
    ...
    case(): Promise<CommandResult> {
        return this.core.textBuffer.getCurrentGoal()
            .then((goal) => {
                if (goal.isEmpty()) {
                    return this.core.viewLegacy.query("Case", [], View.Type.PlainText, "the argument to case:")
                        .then(goal.setContent);
                } else {
                    return goal;
                }
            ...
            .catch(OutOfGoalError, () => {
                this.core.viewLegacy.set("Out of goal", ["\"Case\" is a goal-specific command, please place the cursor in a goal"], View.Type.Error);
            })
    ...
    goalType(normalization: Normalization): Promise<CommandResult> {
        return this.core.textBuffer.getCurrentGoal()
            ...
            .catch(OutOfGoalError, () => {
                this.core.viewLegacy.set("Out of goal", ["\"Goal Type\" is a goal-specific command, please place the cursor in a goal"], View.Type.Error);
            })
    ...
    context(normalization: Normalization): Promise<CommandResult> {
        return this.core.textBuffer.getCurrentGoal()
            ...
            .catch(OutOfGoalError, () => {
                this.core.viewLegacy.set("Out of goal", ["\"Context\" is a goal-specific command, please place the cursor in a goal"], View.Type.Error);
            })
    ...
    goalTypeAndContext(normalization: Normalization): Promise<CommandResult> {
        return this.core.textBuffer.getCurrentGoal()
            ...
            .catch(OutOfGoalError, () => {
                this.core.viewLegacy.set("Out of goal", ["\"Goal Type & Context\" is a goal-specific command, please place the cursor in a goal"], View.Type.Error);
            })
    ...
    goalTypeAndInferredType(normalization: Normalization): Promise<CommandResult> {
        return this.core.textBuffer.getCurrentGoal()
            ...
            .catch(OutOfGoalError, () => {
                this.core.viewLegacy.set("Out of goal", ["\"Goal Type & Inferred Type\" is a goal-specific command, please place the cursor in a goal"], View.Type.Error);
            })
    ...
    inputSymbol(): Promise<CommandResult> {
        if (atom.config.get("agda-mode.inputMethod")) {
            if (!this.loaded) {
                this.core.atomPanel.show();
                this.core.viewLegacy.set("Not loaded", [], View.Type.Warning);
            }

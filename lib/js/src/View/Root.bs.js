...
function mountSettings(editors, handles, open_, self) {
  ...
  if (match !== undefined) {
    if (open_) {
      Event$AgdaMode.emitOk(true, handles[/* onSettingsView */13]);
    } else {
      ...
      Event$AgdaMode.emitOk(false, handles[/* onSettingsView */13]);
    }
    return undefined;
  } else {
    if (open_) {
      var tab = Tab$AgdaMode.make(editors[/* source */1], (function (param) {
              ...
              return Event$AgdaMode.emitOk(true, handles[/* onSettingsView */13]);
            }), undefined, (function (param) {
              Curry._1(self[/* send */0], /* ToggleSettingsTab */Caml_chrome_debugger.variant("ToggleSettingsTab", 0, [false]));
              return Event$AgdaMode.emitOk(false, handles[/* onSettingsView */13]);
            }), undefined, /* () */0);
...
function Root(Props) {
  ...
  Hook$AgdaMode.useEventListener(match$6[1], handles[/* updateIsPending */5]);
  Hook$AgdaMode.useEventListener(match$5[1], handles[/* updateShouldDisplay */6]);
  Hook$AgdaMode.useEventListener((function (param) {
          Curry._1(setMode, /* Display */0);
          return Editors$AgdaMode.Focus[/* on */1](/* Source */0, editors);
        }), handles[/* onInquireQuery */11]);
  Hook$AgdaMode.useEventListener((function (param) {
          return /* () */0;
        }), handles[/* destroy */15]);
  Hook$AgdaMode.useEventListener((function (activate) {
          return Curry._1(send, /* ToggleSettingsTab */Caml_chrome_debugger.variant("ToggleSettingsTab", 0, [activate]));
        }), handles[/* activateSettingsView */12]);
  ...
  return React.createElement(React.Fragment, undefined, React.createElement(Type__View$AgdaMode.Mouse[/* Provider */1][/* make */0], {
                  value: (function ($$event) {
                      return Event$AgdaMode.emitOk($$event, handles[/* onMouseEvent */18]);
                    }),
                  children: React.createElement(Type__View$AgdaMode.Debug[/* Provider */3][/* make */0], {
                        ...
                        children: null
                            ...
                            isPending: match$6[0],
                            isActive: isActive,
                            onInquireQuery: handles[/* onInquireQuery */11],
                            ...
                            editorPlaceholder: "",
                            editorValue: "",
                            interceptAndInsertKey: handles[/* interceptAndInsertKey */17],
                            activateInputMethod: handles[/* activateInputMethod */16],
                            ...
                            navigate: handles[/* navigateSettingsView */14],
                            debug: match$1[0],

                    ...
                    switch (kind) {
                      ...
                      case "Pi" : 
                          return /* Pi */Block.variant("Pi", 14, [
                                    Json_decode.field("telescope", (function (param) {
                ...
                switch (kind) {
                  ...
                  case "CheckClause" : 
                      return /* CheckClause */Block.variant("CheckClause", 0, [
                                ...
                                Json_decode.field("clause", lhs, json)
                              ]);
                  ...
                  case "CheckPatternShadowing" : 
                      return /* CheckPatternShadowing */Block.variant("CheckPatternShadowing", 6, [Json_decode.field("clause", lhs, json)]);
                  case "CheckPragma" : 
...
function typeError(param) {
  return Json_decode.andThen((function (kind, json) {
                switch (kind) {
                  ...
                  case "NotInScope" : 
                      return /* NotInScope */Block.variant("NotInScope", 5, [Json_decode.field("names", (function (param) {
                  ...
                  default:
                    return /* UnregisteredTypeError */Block.variant("UnregisteredTypeError", 6, [json]);
                }
              }), (function (param) {
                return Json_decode.field("kind", Json_decode.string, param);
              }), param);

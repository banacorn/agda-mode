...
function allGoalsWarnings(title, body) {
  ...
  var partiteMetas = function (param) {
  ...
  var dictionary = partiteWarningsOrErrors("errors")(partiteWarningsOrErrors("warnings")(Curry._1(partiteMetas, partiteAllGoalsWarnings(title, body))));

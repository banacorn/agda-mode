...
var Body = (function (_super) {
    ...
    Body.prototype.render = function () {
        var _a = this.props, banner = _a.banner, body = _a.body, error = _a.error, plainText = _a.plainText, maxBodyHeight = _a.maxBodyHeight, mountAtBottom = _a.mountAtBottom;
            ...
            React.createElement("ul", {className: "list-group"}, 
                ...
                body.meta.map(function (item, i) {
                    return React.createElement("li", {className: "list-item body-item", key: i}, 
                        ...
                        React.createElement("div", {className: "item-body"}, 
                            React.createElement(Expr_1.default, null, item.type), 
                            React.createElement(Location_1.default, {abbr: true}, item.location)));
                }), 

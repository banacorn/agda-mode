...
function typeError(param) {
  return Json_decode.andThen((function (kind, json) {
                switch (kind) {
                  case "AmbiguousName" : 
                      return /* AmbiguousName */Block.variant("AmbiguousName", 11, [
                  ...
                  case "ModuleArityMismatch" : 
                      return /* ModuleArityMismatch */Block.variant("ModuleArityMismatch", 7, [
                                Json_decode.field("module", qname, json),
                  ...
                  case "NoRHSRequiresAbsurdPattern" : 
                      ...
                      return /* NoRHSRequiresAbsurdPattern */Block.variant("NoRHSRequiresAbsurdPattern", 8, [Json_decode.field("patterns", (function (param) {
                                        return Json_decode.list(partial_arg, param);
                                      }), json)]);
                  case "NoSuchModule" : 
                      return /* NoSuchModule */Block.variant("NoSuchModule", 10, [Json_decode.field("module", qname, json)]);
                  case "NotInScope" : 
                      return /* NotInScope */Block.variant("NotInScope", 9, [Json_decode.field("names", (function (param) {
                  ...
                  default:
                    return /* UnregisteredTypeError */Block.variant("UnregisteredTypeError", 12, [json]);
                }
              }), (function (param) {
                return Json_decode.field("kind", Json_decode.string, param);
              }), param);

...
function handleResponse(response, self) {
  if (typeof response === "number" || response.tag !== 4) {
    console.log(response);
    return /* () */0;
  } else {
    Rebase.$$Array[/* forEach */8](Goal$AgdaMode.destroy, self[/* goals */2]);
    self[/* goals */2] = /* array */[];
    var filePath = self[/* editors */0][/* source */1].getPath();
    var source = self[/* editors */0][/* source */1].getText();
    var textBuffer = self[/* editors */0][/* source */1].getBuffer();
    var fileType = Goal$AgdaMode.FileType[/* parse */0](filePath);
    var result = Goal$AgdaMode.Hole[/* parse */6](source, response[0], fileType);
    self[/* goals */2] = Rebase.$$Array[/* map */0]((function (result) {
            ...
            self[/* editors */0][/* source */1].setTextInBufferRange(range, result[/* content */3]);
            return Goal$AgdaMode.make(self[/* editors */0][/* source */1], result[/* index */0], result[/* modifiedRange */1]);
          }), result);
    return /* () */0;
  }
}
  ...
  return Rebase.$$Array[/* forEach */8]((function (command) {
                subscriptions.add(atom.commands.add("atom-text-editor", "agda-mode:" + command, (function (_event) {
                            return Rebase.Option[/* forEach */8]((function (self) {
                                          ...
                                          var partial_arg = Rebase.Option[/* forEach */8];
                                          return Util$AgdaMode.$$Promise[/* thenDrop */8]((function (param) {
                                                        return partial_arg((function (x) {
                                                                      return Rebase.$$Array[/* forEach */8]((function (line) {
                                                                                    return Rebase.Result[/* forEach */9]((function (res) {
                                                                                                  return handleResponse(res, self);
                                                                                                }), Rebase.Result[/* flatMap */6](Response$AgdaMode.parse, Emacs__Parser$AgdaMode.SExpression[/* parse */4](line.trim())));
                                                                                  }), Rebase.$$Array[/* filterMap */23]((function (x) {
                                                                                        return x;
                                                                                      }), x.split((/\r\n|\n/))));
                                                                    }), param);
                                                      }), Instance$AgdaMode.dispatch(Command$AgdaMode.Bare[/* parse */0](command), self));

...
var $$String = /* module */Block.localModule(["toCharArray"], [toCharArray]);
...
function make(param) {
  ...
  var acquire = function (param) {
    ...
    if (match !== undefined) {
      return Promise.resolve(Js_primitive.valFromOption(match));
    } else {
  ...
  var supply = function (x) {
    resource[0] = Js_primitive.some(x);
...
function make$1(param) {
  ...
  var wire = function (param) {
    return new Promise((function (resolve, reject) {
                  resolver[0] = Js_primitive.some(resolve);
                  rejecter[0] = Js_primitive.some(reject);
                  return /* () */0;
                }));
  };
  var resolve = function (value) {
    ...
    if (match !== undefined) {
      return Js_primitive.valFromOption(match)(value);
    } else {
      return /* () */0;
    }
  };
  var reject = function (exn) {
    ...
    if (match !== undefined) {
      return Js_primitive.valFromOption(match)(exn);
    } else {
      return /* () */0;
    }
  };

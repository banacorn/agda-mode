...
function Emacs__AllGoalsWarnings(Props) {
  ...
  return React.createElement(React.Fragment, undefined, React.createElement("ul", undefined, $$Array.mapi((function (i, value) {
                        return React.createElement(Emacs__Component$AgdaMode.Output.make, {
                                    value: value,
                                    key: String(i)
                                  });
                      }), value.interactionMetas)), React.createElement("ul", undefined, $$Array.mapi((function (i, value) {
                        return React.createElement(Emacs__Component$AgdaMode.Output.make, {
                                    value: value,
                                    key: String(i)
                                  });
                      }), value.hiddenMetas)), React.createElement("ul", undefined, $$Array.mapi((function (i, value) {
                        return React.createElement(Emacs__Component$AgdaMode.WarningError.make, {
                                    value: value,
                                    key: String(i)
                                  });
                      }), value.warnings)), React.createElement("ul", undefined, $$Array.mapi((function (i, value) {
                        return React.createElement(Emacs__Component$AgdaMode.WarningError.make, {
                                    value: value,
                                    key: String(i)
                                  });

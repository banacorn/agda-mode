...
function Settings__Log$Entry(Props) {
  ...
  var errors = Rebase.$$Array.map((function (text) {
...
function Settings__Log(Props) {
  ...
  var entries = Rebase.$$Array.map((function (entry) {

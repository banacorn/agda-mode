...
function make(param) {
  var onEditorsUpdate = Util$AgdaMode.Event[/* make */1](/* () */0);
  var getEditors = Util$AgdaMode.Event[/* make */1](/* () */0);
    ...
    switch (action.tag | 0) {
      case 0 : 
          ...
          return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                    ...
                    (function (self) {
                        Util$AgdaMode.Event[/* resolve */9](self[/* state */1][/* editors */5], handles[/* onEditorsUpdate */0]);
      ...
      case 1 : 
          ...
          return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                    ...
                    (function (self) {
                        return Util$AgdaMode.Event[/* resolve */9](self[/* state */1][/* editors */5], handles[/* onEditorsUpdate */0]);
                      })
                  ]);
      case 2 : 
      ...
      case 3 : 
          ...
          return /* SideEffects */Block.variant("SideEffects", 1, [(function (self) {
                        ...
                        if (match !== undefined) {
                          if (open_) {
                            return Util$AgdaMode.Event[/* resolve */9](true, handles[/* onSettingsView */14]);
                          } else {
                            Curry._1(match[/* kill */1], /* () */0);
                            Curry._1(self[/* send */3], /* UpdateSettingsView */Block.variant("UpdateSettingsView", 4, [undefined]));
                            return Util$AgdaMode.Event[/* resolve */9](false, handles[/* onSettingsView */14]);
                          }
                        } else if (open_) {
                          var tab = Tab$AgdaMode.make(self[/* state */1][/* editors */5][/* source */1], (function (param) {
                                  ...
                                  ReactDom.render(ReasonReact.element(undefined, undefined, Settings$AgdaMode.make(handles[/* inquireConnection */8], handles[/* onInquireConnection */9], handles[/* updateConnection */7], handles[/* navigateSettingsView */15], /* array */[])), element);
                                  return Util$AgdaMode.Event[/* resolve */9](true, handles[/* onSettingsView */14]);
  ...
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                return Util$AgdaMode.Event[/* destroyWhen */6](self[/* onUnmount */4], Util$AgdaMode.Event[/* on */7]((function (activate) {
                                ...
                                }), handles[/* activateSettingsView */13]));
              }),
            ...
            (function (self) {
                ...
                var partial_arg = handles[/* interceptAndInsertKey */11];
                var partial_arg$1 = handles[/* activateInputMethod */12];
                return React.createElement(React.Fragment, undefined, ReasonReact.element(undefined, undefined, Panel$AgdaMode.make(editors, element, (function (mountTo) {
                                      ...
                                      Curry._1(handles[/* activateInputMethod */12][0], false);
                                      ...
                                      return /* () */0;
                                    }), handles[/* activateSettingsView */13], (function (status) {
...
function initialize(textEditor) {
  var element = document.createElement("article");
  var handles = make(/* () */0);
  var component = ReasonReact.element(undefined, undefined, make$1(textEditor, handles, /* array */[]));

    ...
    function Process(core) {
        ...
        this.load = function () {
            return _this.wireAgdaProcess().then(function (agdaProcess) {
                ...
                var args = _this.getProgramArgs();
                args.push("-V");
                _this.core.viewLegacy.set("Agda Parse Error", [
                    ("Arguments passed to Agda: \"" + args.join(" ") + "\""),
                    "Message from agda:"
                ].concat(error.message), 1 /* Error */);
            });
        };
        this.quit = function () {
        ...
        this.info = function () {
            ...
            _this.core.viewLegacy.set("Info", [
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    agdaProcess.stdout
                        ...
                        try {
                            ...
                            console.log(error);
                            // show some message
                            _this.core.viewLegacy.set("Agda Parse Error", ["Message from agda:"].concat(data.toString()), 1 /* Error */);
                        }
                    });
                });
            });

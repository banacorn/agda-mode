...
function make(editor, message, onConnectionEditorRef, hidden, querying, checked, toggleAgdaConnection, agdaConnected, agdaPath, agdaVersion, supportedProtocol, _children) {
                            ...
                            className: className
                                    ...
                                    className: "agda-settings-connection-dashboard"
                                        ...
                                        id: "agda-settings-connection-agda"
                                              ...
                                              )), React.createElement("p", undefined, "Supported protocol: " + supportedProtocol), React.createElement("p", undefined, ReasonReact.element(undefined, undefined, MiniEditor$AgdaMode.make(editor[/* value */0], "path to Agda", false, undefined, (function (result) {
                                                          atom.config.set("agda-mode.agdaPath", result);
                                                          return MiniEditor$AgdaMode.Model[/* answer */2](result, editor);

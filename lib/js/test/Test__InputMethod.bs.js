...
Mocha$BsMocha.describe("Input Method")(undefined, undefined, undefined, (function (param) {
        ...
        return Mocha$BsMocha.describe("View")(undefined, undefined, undefined, (function (param) {
                      Promise$BsMocha.after_each(undefined)(undefined, undefined, undefined, Test__Util$AgdaMode.Package[/* cleanup */4]);
                      Promise$BsMocha.it("should notify when triggered")(undefined, undefined, undefined, (function (param) {
                              return Test__Util$AgdaMode.openAndLoad("Temp.agda").then((function (instance) {
                      ...
                      return Promise$BsMocha.it("should notify when triggered")(undefined, undefined, undefined, (function (param) {
                                    ...
                                    return Test__Util$AgdaMode.openAndLoad("Temp.agda").then((function (param) {
                                                  ...
                                                  var onDispatch = Async$AgdaMode.toPromise(Event$AgdaMode.once(instance[/* view */2][/* onInputMethodActivationChange */12]));
                                                  Test__Util$AgdaMode.Keyboard[/* insert */1]("G", instance);
                                                  Test__Util$AgdaMode.Keyboard[/* insert */1]("l", instance);
                                                  return Test__Util$AgdaMode.Keyboard[/* dispatch */0]("escape", instance).then((function (param) {
                                                                  return onDispatch;
                                                                })).then((function (activated) {
                                                                Assert$BsMocha.equal(undefined, activated, false);

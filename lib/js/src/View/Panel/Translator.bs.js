...
function translate(input) {
  var shiftRight = function (xs) {
    var length = Rebase.$$Array[/* length */16](xs);
    var last = Rebase.$$Array[/* get */17](xs, length - 1 | 0);
    if (last !== undefined) {
      var result = Rebase.$$Array[/* concat */11](Rebase.$$Array[/* slice */25](0, length - 1 | 0, xs), /* array */[Caml_option.valFromOption(last)]);
      console.log(result);
      return result;
    } else {
      return /* array */[];
  ...
  if (match !== undefined) {
    ...
    switch (input) {
      case "^l" : 
      case "^r" : 
          candidateSymbols = shiftRight(trie[/* symbol */0]);
          break;
      default:
        candidateSymbols = trie[/* symbol */0];
    }
    return /* record */Caml_chrome_debugger.record([
              "symbol",
              "further",

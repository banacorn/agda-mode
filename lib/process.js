...
class Process {
        ...
        this.load = () => {
            return this.wireAgdaProcess().then((agdaProcess) => {
                ...
                this.core.view.set('Agda Parse Error', [
                    ...
                    `Message from agda:`
                ].concat(error.message), types_1.View.Style.Error);
            });
        };
        this.quit = () => {
    ...
    queryExecutablePathUntilSuccess(error) {
        ...
        if (error instanceof error_1.AutoExecPathSearchError) {
            ...
            type = types_1.View.Style.Warning;
                ...
                return new Promise((resolve, reject) => {
                    ...
                    agdaProcess.stdout
                        ...
                        try {
                            ...
                            console.log(error);
                            // show some message
                            this.core.view.set('Agda Parse Error', [`Message from agda:`].concat(data.toString()), types_1.View.Style.Error);
                        }
                    });
                });
            });

...
function make(header, hidden, isPending, mountAt, onMountAtChange, onSettingsViewToggle, settingsViewHandle, _children) {
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",
            ...
            (function (self) {
                Curry._1(settingsViewHandle, (function (open_) {
            ...
            (function (self) {
                ...
                var settingsViewClassList = Curry._1(Util$AgdaMode.React[/* toClassName */3], Util$AgdaMode.React[/* addClass */2]("activated", self[/* state */1][/* settingsView */2], /* :: */Block.simpleVariant("::", [
                            "no-btn",
                            /* [] */0
                          ])));
                var tmp;

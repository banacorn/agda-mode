                    ...
                    /* WithInstance */Caml_chrome_debugger.variant("WithInstance", 0, [(function (instance) {
                            ...
                            $$Promise.getOk(getSymbol, (function (symbol) {
                                    return Rebase.$$Option.forEach((function (sequences) {
                                                  Curry._3(instance.view.display, "Input sequence for " + symbol, /* PlainText */0, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [Rebase.$$String.joinWith("\n", Rebase.List.fromArray(sequences))])]));
                                                  return /* () */0;

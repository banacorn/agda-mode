                  ...
                  switch (call.tag | 0) {
                    case 0 : 
                        return React.createElement("span", undefined, "when checking that the clause ", Util$AgdaMode.sepBy(React.createElement("br", undefined), List.map((function (value) {
                                            ...
                                            }), call[1])), " has type ", ReasonReact.element(undefined, undefined, Concrete$AgdaMode.Expr[/* make */0](call[0][/* concrete */1], /* array */[])));
                    case 1 : 
                    ...
                    case 13 : 
                        return React.createElement("span", undefined, "when checking that the inferred type of an application ", React.createElement("br", undefined), ReasonReact.element(undefined, undefined, Concrete$AgdaMode.Expr[/* make */0](call[1][/* concrete */1], /* array */[])), React.createElement("br", undefined), "matches the expected type ", React.createElement("br", undefined), ReasonReact.element(undefined, undefined, Concrete$AgdaMode.Expr[/* make */0](call[2][/* concrete */1], /* array */[])));
                    case 16 : 

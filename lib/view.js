...
class View {
    ...
    renderSettingsView() {
        ...
        ReactDOM.render(React.createElement(react_redux_1.Provider, { store: this.store },
            React.createElement(Settings_1.default, null)), this.settingsViewElement);
    }
    getEditor() {
        return this.editor;
    }
    ...
    set(header, payload, type = 0 /* PlainText */) {
        ...
        this.store.dispatch(actions_2.HEADER.update({
            text: header,
            style: type
        }));
    ...
    query(header = '', message = [], type = 0 /* PlainText */, placeholder = '', inputMethodOn = true) {
        ...
        this.store.dispatch(actions_2.MINI_EDITOR.activate(placeholder));
        this.store.dispatch(actions_2.HEADER.update({
            text: header,
            style: type
        }));

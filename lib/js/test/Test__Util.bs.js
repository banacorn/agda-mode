...
function dispatch($$event, instance) {
  var onDispatch = $$Promise.Js.toBsPromise(Curry._1(instance[/* onDispatch */10][/* once */2], /* () */0));
...
function close$1(instance) {
  var onDestroy = $$Promise.Js.toBsPromise(Curry._1(instance[/* view */2][/* onDestroy */7][/* once */2], /* () */0));
...
function insertUntilSuccess(text, instance) {
  var editor = instance[/* editors */1][/* source */1];
...
function insert(key, instance) {
  var onChange = $$Promise.Js.toBsPromise(Curry._1(instance[/* view */2][/* onInputMethodChange */11][/* once */2], /* () */0));
...
function backspace(instance) {
  var backspaceUntilSuccess = function (param) {
    var before = instance[/* editors */1][/* source */1].getText();
    instance[/* editors */1][/* source */1].backspace();
    return instance[/* editors */1][/* source */1].save().then((function (param) {
                  var after = instance[/* editors */1][/* source */1].getText();
                  if (before !== after) {
                    return Promise.resolve(/* () */0);
                  } else {
                    instance[/* editors */1][/* source */1].setText(before);

            ...
            React.createElement("form", null,
                React.createElement("ul", { className: 'agda-settings-connection-dashboard' },
                    ...
                    React.createElement("li", { className: classNames({ hidden: !this.props.connection.languageServerEnabled }) },
                        ...
                        React.createElement("div", null,
                            React.createElement("p", null,
                                React.createElement("input", { value: atom.config.get('agda-mode.languageServerPath'), defaultChecked: this.languageServerConnected(), className: 'input-text native-key-bindings', type: 'text', placeholder: 'path to Agda Language Server', disabled: querying })),
                            React.createElement("p", null,

...
function Emacs__SearchAbout(Props) {
  ...
  if (Rebase.$$Array.length(outputs) === 0) {
    ...
    return React.createElement(React.Fragment, undefined, React.createElement("p", undefined, "Definitions about " + (target + ":")), Util$AgdaMode.React.manyIn(Rebase.$$Array.map((function (value) {

...
function createBottomPanelContainer(param) {
...
var initialState_000 = /* mountAt : Bottom */Caml_chrome_debugger.variant("Bottom", 0, [createBottomPanelContainer(/* () */0)]);
...
function mountPanel(editors, mountTo, self) {
  ...
  if (match.tag) {
    if (!mountTo) {
      ...
      Curry._1(self[/* send */0], /* UpdateMountAt */Caml_chrome_debugger.variant("UpdateMountAt", 2, [/* Bottom */Caml_chrome_debugger.variant("Bottom", 0, [createBottomPanelContainer(/* () */0)])]));
    }
...
exports.$$Event = $$Event;
exports.createBottomPanelContainer = createBottomPanelContainer;

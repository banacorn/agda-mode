...
Mocha$BsMocha.describe("Instances")(undefined, undefined, undefined, (function (param) {
        Promise$BsMocha.it_skip("should have no instances before opening any files")(undefined, undefined, undefined, (function (param) {
                return Promise.resolve(Test__Util$AgdaMode.Assert.equal(undefined, 0, AgdaMode$AgdaMode.Instances.size(undefined)));
              }));
        Promise$BsMocha.it("should respect the number of opened .agda file")(undefined, undefined, undefined, (function (param) {
                return Test__Util$AgdaMode.$$File.openAsset("Temp.agda").then(function (editor) {
                              Test__Util$AgdaMode.Assert.equal(undefined, 1, AgdaMode$AgdaMode.Instances.size(undefined));
                              var pane = atom.workspace.getActivePane();
                              return pane.destroyItem(editor, true);
                            }).then(function (destroyed) {
                            Test__Util$AgdaMode.Assert.equal(undefined, AgdaMode$AgdaMode.Instances.size(undefined), destroyed ? 0 : 1);
                            return Promise.resolve(undefined);
                          });
              }));
        Promise$BsMocha.it("should respect the number of opened .lagda file")(undefined, undefined, undefined, (function (param) {
                return Test__Util$AgdaMode.$$File.openAsset("Blank2.lagda").then(function (editor) {
                              Test__Util$AgdaMode.Assert.equal(undefined, 1, AgdaMode$AgdaMode.Instances.size(undefined));
                              var pane = atom.workspace.getActivePane();
                              return pane.destroyItem(editor, true);
                            }).then(function (destroyed) {
                            Test__Util$AgdaMode.Assert.equal(undefined, destroyed ? 0 : 1, AgdaMode$AgdaMode.Instances.size(undefined));
                            return Promise.resolve(undefined);
                          });
              }));

...
function make(onMountAtChange, body, header, mountAt, mode, _children) {
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",
            ...
            (function (self) {
                ...
                return React.createElement("section", undefined, React.createElement("section", {
                              ...
                              }, ReasonReact.element(undefined, undefined, Body$AgdaMode.make(body, mode !== /* Display */0, mountAtBottom, /* array */[]))));
              }),
            initialState,

...
function handleCommandError(instance) {
  return Async$AgdaMode.thenError((function (error) {
                if (typeof error === "number") {
                  switch (error) {
                    case 0 : 
                        View$AgdaMode.display("Query Cancelled", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [""])]), instance[/* view */2]);
                        break;
                    case 1 : 
                        View$AgdaMode.display("Goal not indexed", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, ["Please reload to re-index the goal"])]), instance[/* view */2]);
                        break;
                    case 2 : 
                        View$AgdaMode.display("Out of goal", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, ["Please place the cursor in a goal"])]), instance[/* view */2]);
                        break;
                    
                  }
                } else if (error.tag) {
                  var match = Connection$AgdaMode.$$Error[/* toString */0](error[0]);
                  View$AgdaMode.display("Connection-related Error: " + match[0], /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [match[1]])]), instance[/* view */2]);
                } else {
                  var match$1 = error[0];
                  if (match$1.tag) {
                    var message = "when trying to parse the following text:\n" + match$1[0];
                    View$AgdaMode.display("Parse Error", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [message])]), instance[/* view */2]);
                  } else {
                    var errors = match$1[0];
                    var intro = String(Rebase.$$Array[/* length */16](errors)) + " errors arisen when trying to parse the following text responses from agda:\n\n";
                    var message$1 = Rebase.$$String[/* joinWith */11]("\n\n", Rebase.List[/* fromArray */12](errors));
                    View$AgdaMode.display("Parse Error", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [intro + message$1])]), instance[/* view */2]);
                  }
                }
  ...
  if (typeof response === "number") {
    switch (response) {
      ...
      case 2 : 
          ...
          return Async$AgdaMode.resolve(/* () */0);
      case 3 : 
          View$AgdaMode.display("Status", /* Warning */4, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, ["Done aborting"])]), instance[/* view */2]);
          return Async$AgdaMode.resolve(/* () */0);
    ...
    switch (response.tag | 0) {
      ...
      case 2 : 
          ...
          if (displayImplicit || checked) {
            View$AgdaMode.display("Status", /* PlainText */0, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, ["Typechecked: " + (Pervasives.string_of_bool(checked) + ("\nDisplay implicit arguments: " + Pervasives.string_of_bool(displayImplicit)))])]), instance[/* view */2]);
          }
          return Async$AgdaMode.resolve(/* () */0);
      case 3 : 
      ...
      case 6 : 
          ...
          if (pointed !== undefined) {
            ...
            return Curry._2(instance[/* dispatch */7], /* Load */0, instance);
          } else {
      ...
      case 7 : 
          var solve = function (param) {
            ...
            if (match !== undefined) {
              ...
              return Curry._2(instance[/* dispatch */7], /* Give */13, instance);
            } else {
              return Async$AgdaMode.resolve(/* () */0);
            }
          };
          return Rebase.$$Array[/* reduce */3]((function (promise, solution) {
                        return Async$AgdaMode.thenOk((function (param) {
                                        return Async$AgdaMode.thenOk((function (param) {
                                                        return Async$AgdaMode.resolve(/* () */0);
                                                      }))(solve(solution));
                                      }))(promise);
                      }), Async$AgdaMode.resolve(/* () */0), response[0]);
      case 8 : 
          Event$AgdaMode.emitOk(true, instance[/* view */2][/* activatePanel */3]);
          var match$1 = Response$AgdaMode.Info[/* handle */1](response[0]);
          return View$AgdaMode.display(match$1[0], match$1[1], match$1[2], instance[/* view */2]);
      case 9 : 
          var message = response[1];
          if (response[0] >= 2) {
            RunningInfo$AgdaMode.add(Parser$AgdaMode.agdaOutput(message), instance[/* runningInfo */6]);
          } else {
            View$AgdaMode.display("Type-checking", /* PlainText */0, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [message])]), instance[/* view */2]);
          }
          return Async$AgdaMode.resolve(/* () */0);
  ...
  if (typeof command === "number") {
    switch (command) {
      case 0 : 
          return Async$AgdaMode.thenOk((function (param) {
                          ...
                          View$AgdaMode.updateShouldDisplay(true, instance[/* view */2]);
                          View$AgdaMode.display("Loading ...", /* PlainText */0, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [""])]), instance[/* view */2]);
      ...
      case 1 : 
          ...
          Instance__Highlightings$AgdaMode.destroyAll(instance);
          View$AgdaMode.deactivate(instance[/* view */2]);
          instance[/* isLoaded */0] = false;
          View$AgdaMode.updateShouldDisplay(false, instance[/* view */2]);
      ...
      case 10 : 
          ...
          return Async$AgdaMode.resolve(undefined);
      case 11 : 
          View$AgdaMode.toggleDocking(instance[/* view */2]);
          return Async$AgdaMode.resolve(undefined);
      case 12 : 
          ...
          if (Rebase.$$String[/* isEmpty */5](selectedText)) {
            return Async$AgdaMode.thenOk((function (expr) {
                            return Async$AgdaMode.thenOk((function (param) {
                                ...
                                return /* Cancelled */0;
                              }))(View$AgdaMode.inquire("Scope info", "name:", "", instance[/* view */2])));
          } else {
                          ...
                          if (Goal$AgdaMode.isEmpty(goal)) {
                            return Async$AgdaMode.thenOk((function (result) {
                                            ...
                                            return buff(/* Give */Block.variant("Give", 9, [
                                                ...
                                                return /* Cancelled */0;
                                              }))(View$AgdaMode.inquire("Give", "expression to give:", "", instance[/* view */2])));
                          } else {
                            return buff(/* Give */Block.variant("Give", 9, [
                                          goal,
                                          index
                          ...
                          if (Goal$AgdaMode.isEmpty(goal)) {
                            return Async$AgdaMode.thenOk((function (result) {
                                            ...
                                            return buff(/* Case */Block.variant("Case", 12, [
                                                ...
                                                return /* Cancelled */0;
                                              }))(View$AgdaMode.inquire("Case", "expression to case:", "", instance[/* view */2])));
                          } else {
                            return buff(/* Case */Block.variant("Case", 12, [
                                          goal,
                                          index
      ...
      case 18 : 
          if (instance[/* isLoaded */0]) {
            ...
            return Async$AgdaMode.thenOk((function (param) {
                          ...
                          }))(handleCommandError(instance)(Curry._2(instance[/* dispatch */7], /* Load */0, instance)));
          }
    ...
    switch (command.tag | 0) {
      case 0 : 
          ...
          return Async$AgdaMode.thenOk((function (expr) {
                          return buff(/* SearchAbout */Block.variant("SearchAbout", 2, [
                              ...
                              return /* Cancelled */0;
                            }))(View$AgdaMode.inquire("Searching through definitions [" + (Command$AgdaMode.Normalization[/* of_string */0](normalization) + "]"), "expression to infer:", "", instance[/* view */2])));
      case 1 : 
          ...
          return Instance__TextEditors$AgdaMode.handleOutOfGoal((function (param) {
                          return Async$AgdaMode.thenOk((function (expr) {
                                          return buff(/* InferTypeGlobal */Block.variant("InferTypeGlobal", 4, [
                                              ...
                                              return /* Cancelled */0;
                                            }))(View$AgdaMode.inquire("Infer type [" + (Command$AgdaMode.Normalization[/* of_string */0](normalization$1) + "]"), "expression to infer:", "", instance[/* view */2])));
                        }))(Async$AgdaMode.thenOk((function (param) {
                              var index = param[1];
                              var goal = param[0];
                              if (Goal$AgdaMode.isEmpty(goal)) {
      ...
      case 2 : 
          ...
          return Async$AgdaMode.thenOk((function (expr) {
                          return Instance__TextEditors$AgdaMode.handleOutOfGoal((function (param) {
                              ...
                              return /* Cancelled */0;
                            }))(View$AgdaMode.inquire("Module contents [" + (Command$AgdaMode.Normalization[/* of_string */0](normalization$2) + "]"), "module name:", "", instance[/* view */2])));
      case 3 : 
          ...
          return Instance__TextEditors$AgdaMode.handleOutOfGoal((function (param) {
                          return Async$AgdaMode.thenOk((function (expr) {
                                          return buff(/* ComputeNormalFormGlobal */Block.variant("ComputeNormalFormGlobal", 8, [
                                              ...
                                              return /* Cancelled */0;
                                            }))(View$AgdaMode.inquire("Compute normal form", "expression to normalize:", "", instance[/* view */2])));
                        }))(Async$AgdaMode.thenOk((function (param) {
                              var index = param[1];
                              var goal = param[0];
                              if (Goal$AgdaMode.isEmpty(goal)) {
      ...
      case 8 : 
          ...
          if (enabled) {
            Event$AgdaMode.emitOk(true, instance[/* view */2][/* updateShouldDisplay */5]);
            switch (command[0]) {
              case 0 : 
                  Event$AgdaMode.emitOk(true, instance[/* view */2][/* activatePanel */3]);
                  Event$AgdaMode.emitOk(true, instance[/* view */2][/* activateInputMethod */15]);
                  break;
              case 1 : 
                  Event$AgdaMode.emitOk("{", instance[/* view */2][/* interceptAndInsertKey */16]);
                  break;
              case 2 : 
                  Event$AgdaMode.emitOk("[", instance[/* view */2][/* interceptAndInsertKey */16]);
                  break;
      ...
      case 9 : 
          ...
          if (match.tag) {
            ...
            if (range) {
              var match$1 = range[0];
              shouldJump = match$1 !== undefined ? match$1 === filePath : true;
            } else {
              shouldJump = false;
            }
            if (shouldJump) {
                          ...
                          if (param$1.tag) {
                            ...
                            if (match) {
                              ...
                              if (match$1.tag) {
                                ...
                                if (match$2.tag) {
                                  parseErrors[0] = Rebase.$$Array[/* concat */11](/* array */[match$2[0]], parseErrors[0]);
                                  return /* () */0;
                                } else {
                                  parseErrors[0] = Rebase.$$Array[/* concat */11](match$2[0], parseErrors[0]);
                                  return /* () */0;
                                }
                              } else {
                                var responses = match$1[0];
                                var results = Instance__TextEditors$AgdaMode.recoverCursor((function (param) {
                                        return Rebase.$$Array[/* map */0]((function (param) {
                                                      return handleResponse(instance, param);
                                                    }), responses);
                                      }), instance);
                                handleResults[0] = Rebase.$$Array[/* concat */11](results, handleResults[0]);
                                return /* () */0;
                              }
                            } else if (Rebase.$$Array[/* length */16](parseErrors[0]) > 0) {
                              Curry._1(reject$prime$1, /* ParseError */Block.variant("ParseError", 0, [/* Response */Block.variant("Response", 0, [parseErrors[0]])]));
                              return /* () */0;
                            } else {
                              Async$AgdaMode.mapOk((function (param) {
...
function dispatch(command, instance) {
  return Async$AgdaMode.pass((function (param) {
                  View$AgdaMode.updateIsPending(false, instance[/* view */2]);
                  return /* () */0;
                }))(Async$AgdaMode.thenOk((function (param) {
                      return handleRemoteCommand(instance, param);
                    }))(Async$AgdaMode.pass((function (param) {
                          View$AgdaMode.updateIsPending(true, instance[/* view */2]);
                          return /* () */0;

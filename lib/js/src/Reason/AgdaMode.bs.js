...
function queryConnection(message, self) {
  activate(self);
  console.log("queryConnection");
  Util$AgdaMode.Event[/* resolve */9](true, self[/* view */1][/* activateSettingsView */10]);
  return Util$AgdaMode.$$Promise[/* then_ */6]((function (param) {
                Util$AgdaMode.Event[/* resolve */9](/* Connection */1, self[/* view */1][/* navigateSettingsView */12]);
                Util$AgdaMode.Event[/* resolve */9](/* tuple */[
                      message,
                      ""
                    ], self[/* view */1][/* inquireConnection */5]);
                return Util$AgdaMode.$$Promise[/* then_ */6]((function (x) {
                              console.log("!!!!");
                              console.log(x);
                              return Util$AgdaMode.$$Promise[/* resolve */1](x);
                            }), Util$AgdaMode.Event[/* once */8](self[/* view */1][/* onInquireConnection */6]));
              }), Util$AgdaMode.Event[/* once */8](self[/* view */1][/* onSettingsView */11]));
}
...
function connect(self) {
  ...
  if (match !== undefined) {
    ...
    return getAgdaPath(/* () */0).catch((function (param) {
                        ...
                        })).then(Connection$AgdaMode.validateAndMake).then(Connection$AgdaMode.connect).then(Connection$AgdaMode.wire).then((function (connection) {
...
function destroy(self) {
  deactivate(self);
  return Curry._1(self[/* view */1][/* destroy */13][0], /* () */0);
}

            ...
            (function () {
                ...
                switch (typeError.tag | 0) {
                  ...
                  case 3 : 
                      ...
                      return React.createElement("div", undefined, "Duplicate definition of module ", ReasonReact.element(undefined, undefined, C$AgdaMode.Name[/* make */4](typeError[1], /* array */[])), React.createElement("br", undefined), "Previous definition of " + (type_ + "module "), ReasonReact.element(undefined, undefined, C$AgdaMode.QName[/* make */5](typeError[0], /* array */[])));
                  case 4 : 
                  ...
                  case 7 : 
                      return React.createElement("div", undefined, "Multiple definitions of ", ReasonReact.element(undefined, undefined, C$AgdaMode.QName[/* make */5](typeError[0], /* array */[])), React.createElement("br", undefined), "Previous definition at ", ReasonReact.element(undefined, undefined, Range$AgdaMode.make(typeError[1], undefined, /* array */[])));
                  case 8 : 
                      var tel = typeError[2];
                      var moduleName = typeError[0];
                      if (tel !== undefined) {
                        return React.createElement("div", undefined, "The arguments to ", ReasonReact.element(undefined, undefined, C$AgdaMode.QName[/* make */5](moduleName, /* array */[])), " do not fit the telescope ", React.createElement("br", undefined), ReasonReact.element(undefined, undefined, Concrete$AgdaMode.Telescope[/* make */0](tel, /* array */[])));
                      } else {
                        return React.createElement("div", undefined, "The module ", ReasonReact.element(undefined, undefined, C$AgdaMode.QName[/* make */5](moduleName, /* array */[])), " is not parameterized, but is being applied to arguments");
                      }
                  case 9 : 
                  ...
                  case 10 : 
                      ...
                      var pair = function (param) {
                        ...
                        return React.createElement("li", undefined, ReasonReact.element(undefined, undefined, C$AgdaMode.QName[/* make */5](name, /* array */[])), " is not in scope", shouldRender ? React.createElement("p", undefined, colon ? React.createElement(React.Fragment, undefined, "did you forget space around the ':'?") : null, arrow ? React.createElement(React.Fragment, undefined, "did you forget space around the '->'?") : null, hasSuggestions ? React.createElement(React.Fragment, undefined, "did you mean ", Util$AgdaMode.sepBy(" or ", List.map((function (value) {
                                                          return ReasonReact.element(undefined, undefined, C$AgdaMode.QName[/* make */5](value, /* array */[]));
                                                        }), suggestions)), " ?") : null) : null);
                      };
                      return ReactDOMRe.createElementVariadic("ul", undefined, $$Array.of_list(List.map(pair, typeError[0])));
                  case 11 : 
                      return React.createElement("div", undefined, "No such module ", ReasonReact.element(undefined, undefined, C$AgdaMode.QName[/* make */5](typeError[0], /* array */[])));
                  case 12 : 
                      return React.createElement("div", undefined, "Ambiguous name ", ReasonReact.element(undefined, undefined, C$AgdaMode.QName[/* make */5](typeError[0], /* array */[])), ".", React.createElement("br", undefined), "It could refer to any one of ", React.createElement("br", undefined), ReactDOMRe.createElementVariadic("ul", undefined, $$Array.of_list(List.map((function (value) {
                                                return React.createElement("li", undefined, "    ", ReasonReact.element(undefined, undefined, C$AgdaMode.QName[/* make */5](value, /* array */[])));
                                              }), typeError[1]))));
                  case 13 : 

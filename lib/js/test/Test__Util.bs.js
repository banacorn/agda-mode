...
function close$1(instance) {
  var onDestroy = Async$AgdaMode.toPromise(Event$AgdaMode.once(instance[/* view */2][/* onDestroy */7]));
...
function insert(key, instance) {
  var onChange = Async$AgdaMode.toPromise(Event$AgdaMode.once(instance[/* view */2][/* onInputMethodChange */11]));

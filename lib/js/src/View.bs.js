...
function make(events, channels) {
  ...
  var onMouseEvent = events[/* onMouseEvent */7];
  ...
  var onInputMethodChange = events[/* onInputMethodChange */6];
  var navigateSettings = function (where) {
    return Event$AgdaMode.emitOk(where, events[/* navigateSettingsView */5]);
  };
  var activateSettings = function (param) {
    return Event$AgdaMode.emitOk(true, events[/* activateSettingsView */4]);
  };
  var openSettings = function (param) {
    var promise = Event$AgdaMode.once(events[/* onSettingsView */2]);
    Event$AgdaMode.emitOk(true, events[/* activateSettingsView */4]);
    return promise;
  };
  ...
  var onInquireConnection = events[/* onInquireConnection */1];
  var inquireConnection = function (param) {
    var promise = Event$AgdaMode.once(onInquireConnection);
    Event$AgdaMode.emitOk(/* () */0, events[/* inquireConnection */3]);
    return promise;
  };

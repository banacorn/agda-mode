...
var partial_arg$1 = Rebase.$$Array.map;

var partial_arg$2 = Rebase.Fn.id;

var partial_arg$3 = Rebase.$$Array.filterMap;
...
function feed(self, input) {
  var $$continue = Rebase.$$Option.getOr(self[/* initialContinuation */0], self[/* continuation */1][0]);
...
function parse(input) {
  ...
  Rebase.$$Array.forEach((function (line) {
          var $$continue = Rebase.$$Option.getOr(parseWithContinuation, continuation[0]);

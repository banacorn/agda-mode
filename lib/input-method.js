        ...
        this.dispatchEvent = function (event) {
            if (!_this.mute) {
                ...
                if (rangeNew.isEmpty()) {
                    ...
                    var _a = translate(_this.rawInput), translation_1 = _a.translation, further = _a.further, keySuggestions = _a.keySuggestions, candidateSymbols = _a.candidateSymbols;
                    if (translation_1) {
                    ...
                    var _b = translate(_this.rawInput), translation = _b.translation, further = _b.further, keySuggestions = _b.keySuggestions, candidateSymbols = _b.candidateSymbols;
                    _this.core.view.inputMethodInput = {
                        rawInput: _this.rawInput,
                        keySuggestions: keySuggestions,
                        candidateSymbols: candidateSymbols
    ...
    InputMethod.prototype.activate = function () {
        ...
        if (!this.activated) {
            ...
            this.core.view.inputMethodInput = {
                rawInput: "",
                keySuggestions: getKeySuggestions(keymap_1.default).sort(),
                candidateSymbols: []
            };
        }
        else {

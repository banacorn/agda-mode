...
`
// <atom-text-editor placeholder="{{placeholder}}" v-show="queryMode" class="editor mini" tabindex="-1" mini="" data-grammar="text plain null-grammar" data-encoding="utf8"></atom-text-editor>

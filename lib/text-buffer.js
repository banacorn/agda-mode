...
var TextBuffer = (function () {
    ...
    TextBuffer.prototype.warnOutOfGoal = function () {
        this.core.viewLegacy.set("Out of goal", ["For this command, please place the cursor in a goal"], 2 /* Warning */);
    };
    TextBuffer.prototype.warnEmptyGoal = function (error) {
        this.core.viewLegacy.set("No content", [error.message], 2 /* Warning */);
    };
    ...
    TextBuffer.prototype.nextGoal = function () {
        ...
        return Promise.resolve({ status: "Issued", command: "NextGoal" });
    };
    TextBuffer.prototype.previousGoal = function () {
        ...
        return Promise.resolve({ status: "Issued", command: "PreviousGoal" });
    };

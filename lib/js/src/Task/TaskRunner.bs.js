...
function sendRequest(instance, request) {
  ...
  $$Promise.getOk($$Promise.tapError(Instance__Connections$AgdaMode.connect(instance), (function (e) {
          ...
          if (Request$AgdaMode.isLoad(request) && connection[/* resetLogOnLoad */3]) {
            Connection$AgdaMode.resetLog(connection);
          }
          Log$AgdaMode.createEntry(request, connection[/* log */5]);
          var version = connection[/* metadata */0][/* version */2];
  ...
  var executeTask = function (task) {
    if (typeof task === "number") {
      switch (task) {
        ...
        case /* Activate */1 :
            return $$Promise.map(Curry._1(instance[/* view */1][/* activate */0], /* () */0), (function (param) {
                          return /* array */[];
                        }));
        case /* Deactivate */2 :
            return $$Promise.map(Curry._1(instance[/* view */1][/* deactivate */1], /* () */0), (function (param) {
                          return /* array */[];
                        }));
      ...
      switch (task.tag | 0) {
        ...
        case /* Display */2 :
            return $$Promise.map(Curry._3(instance[/* view */1][/* display */3], task[0], task[1], task[2]), (function (param) {
                          return /* array */[];
                        }));
        case /* Inquire */3 :
            return handleCallback($$Promise.mapOk($$Promise.mapError(Curry._3(instance[/* view */1][/* inquire */4], task[0], task[1], task[2]), (function (param) {
                                  return /* Cancelled */0;
                                })), task[3]));
        case /* Editor */4 :
            return handleCallback($$Promise.mapOk($$Promise.mapError($$Promise.Js.toResult($$Promise.Js.fromBsPromise(instance[/* editors */0][/* source */1].save())), (function (param) {
                                  return /* Cancelled */0;
                                })), (function (param) {
                              return /* [] */0;
                            })));
...
function dispatchCommand(command, instance) {
  ...
  var before = function (param) {
    ...
    return Curry._1(instance[/* view */1][/* updateIsPending */5], true);
  };
  var after = function (param) {
    Instance__TextEditors$AgdaMode.endCheckpoint(instance);
    return Curry._1(instance[/* view */1][/* updateIsPending */5], false);
  };

...
function toString(self) {
  ...
  return "Annotation " + (String(self[/* start */0]) + (" " + (String(self[/* end_ */1]) + (" " + (Util$AgdaMode.Pretty.list(Rebase.List.fromArray(self[/* types */2])) + tmp)))));
}
        ...
        case 3 :
            ...
            if (match.tag) {
              ...
              if (match$1.tag) {
                ...
                var types = xs[2];
                return Rebase.$$Option.flatMap((function (start) {
                              return Rebase.$$Option.flatMap((function (end_) {
                                            return /* record */Caml_chrome_debugger.record([
                                                      ...
                                                      start,
                                                      end_,
                                                      Parser$AgdaMode.SExpression.flatten(types),
                                                      undefined
                                                    ]);
                ...
                return Rebase.$$Option.flatMap((function (start) {
                              return Rebase.$$Option.flatMap((function (end_) {
                                            return /* record */Caml_chrome_debugger.record([
                                                      ...
                                                      start,
                                                      end_,
                                                      Parser$AgdaMode.SExpression.flatten(types$1),
                                                      undefined
                                                    ]);
                  ...
                  if (match$7.length !== 3) {
                    ...
                    if (match$8.tag) {
                      ...
                      if (match$9.tag) {
                        ...
                        return Rebase.$$Option.flatMap((function (start) {
                                      return Rebase.$$Option.flatMap((function (end_) {
                                                    return Rebase.$$Option.flatMap((function (index) {
                                                                  return /* record */Caml_chrome_debugger.record([
                                                                            "start",
                                                                            "end_",
                                                                            "types",
                                                                            ...
                                                                            start,
                                                                            end_,
                                                                            Parser$AgdaMode.SExpression.flatten(types$2),
                                                                            /* tuple */[
                                                                              filepath,
                                                                              index
                                                                            ]
...
function parseDirectHighlightings(tokens) {
  return Rebase.$$Array.filterMap((function (x) {
                return x;
              }), Rebase.$$Array.map(parse, tokens.slice(2)));
}

function parseIndirectHighlightings(tokens) {
  return Rebase.$$Array.filterMap((function (x) {
                return x;
              }), Rebase.$$Array.map(parse, tokens.slice(1)));
}

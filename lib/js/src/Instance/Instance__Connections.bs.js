...
function inquireAgdaPath(error, instance) {
  ...
  return Async$AgdaMode.then_((function (param) {
                  Curry._1(instance[/* view */2][/* navigateSettings */13], /* Connection */1);
                  Curry._2(instance[/* view */2][/* updateConnection */16], undefined, error);
                  return Curry._1(instance[/* view */2][/* inquireConnection */18], /* () */0);
                }), (function (param) {
                  return Async$AgdaMode.reject(/* Cancelled */0);
                }))(Curry._1(instance[/* view */2][/* openSettings */15], /* () */0));
}
...
function getAgdaPath(instance) {
  ...
  return Async$AgdaMode.thenError((function (err) {
                ...
                }))(Rebase.$$String[/* isEmpty */5](storedPath) || storedPath === "." ? Connection$AgdaMode.autoSearch("agda") : Async$AgdaMode.resolve(storedPath));
}
...
function persistConnection(instance, connection) {
  ...
  Curry._2(instance[/* view */2][/* updateConnection */16], connection, undefined);
  return connection;
}
...
function disconnect(instance) {
  ...
  if (match !== undefined) {
    ...
    return Curry._2(instance[/* view */2][/* updateConnection */16], undefined, undefined);
  } else {
    return /* () */0;
  }
}

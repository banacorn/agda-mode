...
var Info = /* module */Caml_chrome_debugger.localModule([
    "toString",
    "parse"
  ], [
    toString,
...
function toString$1(param) {
  if (typeof param === "number") {
    ...
    switch (param.tag | 0) {
      case 0 : 
          if (param[0]) {
            return "HighlightingInfoDirect Keep " + Util$AgdaMode.Pretty[/* array */1](Rebase.$$Array[/* map */0](Highlighting$AgdaMode.Annotation[/* toString */0], param[1]));
          } else {
            return "HighlightingInfoDirect Remove " + Util$AgdaMode.Pretty[/* array */1](Rebase.$$Array[/* map */0](Highlighting$AgdaMode.Annotation[/* toString */0], param[1]));
          }
      case 1 : 
      ...
      case 4 : 
          return "InteractionPoints " + Util$AgdaMode.Pretty[/* array */1](Rebase.$$Array[/* map */0]((function (prim) {
                            return String(prim);
                          }), param[0]));
      case 5 : 
          var match = param[1];
      ...
      case 6 : 
          if (param[0]) {
            return "MakeCase ExtendedLambda " + Util$AgdaMode.Pretty[/* array */1](param[1]);
          } else {
            return "MakeCase Function " + Util$AgdaMode.Pretty[/* array */1](param[1]);
          }
      case 7 : 
          return "SolveAll " + Util$AgdaMode.Pretty[/* array */1](Rebase.$$Array[/* map */0]((function (param) {
        ...
        switch (match$1[0]) {
          ...
          case "agda2-goals-action" : 
              ...
              if (match$4 !== undefined) {
                return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [/* InteractionPoints */Caml_chrome_debugger.variant("InteractionPoints", 4, [Rebase.$$Array[/* filterMap */23](Parser$AgdaMode.$$int, Parser$AgdaMode.SExpression[/* flatten */2](match$4))])]);
              } else {
                return /* Error */Caml_chrome_debugger.variant("Error", 1, [/* Response */Caml_chrome_debugger.variant("Response", 1, [
                              5,
                              tokens
          ...
          case "agda2-highlight-add-annotations" : 
              var annotations = Highlighting$AgdaMode.Annotation[/* parseDirectHighlightings */2](xs);
          ...
          case "agda2-make-case-action" : 
              ...
              if (match$9 !== undefined) {
                return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [/* MakeCase */Caml_chrome_debugger.variant("MakeCase", 6, [
                              /* Function */0,
                              Parser$AgdaMode.SExpression[/* flatten */2](match$9)
                            ])]);
              } else {
                return /* Error */Caml_chrome_debugger.variant("Error", 1, [/* Response */Caml_chrome_debugger.variant("Response", 1, [
                              8,
          ...
          case "agda2-make-case-action-extendlam" : 
              ...
              if (match$10 !== undefined) {
                return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [/* MakeCase */Caml_chrome_debugger.variant("MakeCase", 6, [
                              /* ExtendedLambda */1,
                              Parser$AgdaMode.SExpression[/* flatten */2](match$10)
                            ])]);
              } else {
                return /* Error */Caml_chrome_debugger.variant("Error", 1, [/* Response */Caml_chrome_debugger.variant("Response", 1, [
                              9,
          ...
          case "agda2-solveAll-action" : 
              ...
              if (match$16 !== undefined) {
                var tokens$1 = Parser$AgdaMode.SExpression[/* flatten */2](match$16);

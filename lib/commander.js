...
var Commander = (function () {
    ...
    Commander.prototype.whyInScope = function () {
        var _this = this;
        this.core.view.setContent("Scope info", [], 0 /* PlainText */, "name:");
    ...
    Commander.prototype.inferType = function (normalization) {
        ...
        return this.core.textBuffer.getCurrentGoal()
            ...
            // goal-specific
            if (goal.isEmpty()) {
                _this.core.view.setContent("Infer type " + toDescription(normalization), [], 4 /* Value */, "expression to infer:");
    ...
    Commander.prototype.moduleContents = function (normalization) {
        var _this = this;
        this.core.view.setContent("Module contents " + toDescription(normalization), [], 0 /* PlainText */, "module name:");
        return this.core.view.query()
            .then(function (expr) {
            return _this.core.textBuffer.getCurrentGoal()
    ...
    Commander.prototype.computeNormalForm = function () {
        var _this = this;
        this.core.view.setContent("Compute normal form", [], 4 /* Value */, "expression to normalize:");
        return this.core.view.query()
            .then(function (expr) {
            return _this.core.textBuffer.getCurrentGoal()
    ...
    Commander.prototype.computeNormalFormIgnoreAbstract = function () {
        var _this = this;
        this.core.view.setContent("Compute normal form (ignoring abstract)", [], 4 /* Value */, "expression to normalize:");
        return this.core.view.query()
            .then(function (expr) {
            return _this.core.textBuffer.getCurrentGoal()
    ...
    Commander.prototype.give = function () {
        ...
        return this.core.textBuffer.getCurrentGoal()
            .then(function (goal) {
            if (goal.isEmpty()) {
                _this.core.view.setContent("Give", [], 0 /* PlainText */, "expression to give:");
    ...
    Commander.prototype.case = function () {
        ...
        return this.core.textBuffer.getCurrentGoal()
            .then(function (goal) {
            if (goal.isEmpty()) {
                _this.core.view.setContent("Case", [], 0 /* PlainText */, "expression to case:");
                return _this.core.view.query()
                    .then(function (expr) {
                    goal.setContent(expr);
                    return goal;
    ...
    Commander.prototype.inputSymbol = function () {
        if (atom.config.get("agda-mode.inputMethod")) {
            if (!this.loaded) {
                this.core.atomPanel.show();
                this.core.view.setContent("Not loaded", [], 2 /* Warning */);
            }

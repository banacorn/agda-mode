    ...
    if (hasWarnings) {
      if (hasErrors) {
        return /* record */Block.record([
                  ...
                  concatLines(shitpile.slice(0, indexOfWarnings)),
      ...
      return /* record */Block.record([
                ...
                concatLines(shitpile.slice(0, indexOfErrors)),
                [],
                shitpile.slice(indexOfErrors + 1 | 0)
              ]);
    } else {
...
function allGoalsWarnings(title, body) {
  ...
  return /* record */Block.record([
            ...
            metas,
            $$String.concat("", $$Array.to_list(preprocessed[/* warnings */1])),
            $$String.concat("", $$Array.to_list(preprocessed[/* errors */2]))
          ]);
}

...
function connect(instance) {
  var inquireConnection = function (error, instance) {
    activate(instance);
    var promise = Util$AgdaMode.$$Promise[/* then_ */6]((function (param) {
  ...
  var getAgdaPath = function (param) {
    ...
    if (Rebase.$$String[/* isEmpty */5](storedPath)) {
      ...
      return Util$AgdaMode.$$Promise[/* resolve */1](/* Ok */Block.variant("Ok", 0, [storedPath]));
    }
  };
  var getMetadata = function (instance, path) {
    return Util$AgdaMode.$$Promise[/* thenError */13]((function (err) {
                    return Util$AgdaMode.$$Promise[/* thenOk */11]((function (param) {
  ...
  var getConnection = function (instance, metadata) {
    return Util$AgdaMode.$$Promise[/* thenError */13]((function (err) {
                    return Util$AgdaMode.$$Promise[/* thenOk */11]((function (param) {
                                  ...
                                  }))(Util$AgdaMode.$$Promise[/* thenOk */11]((function (param) {
                                        return getMetadata(instance, param);
  ...
  if (match !== undefined) {
    return Util$AgdaMode.$$Promise[/* resolve */1](/* Ok */Block.variant("Ok", 0, [match]));
  } else {
    return Util$AgdaMode.$$Promise[/* mapOk */10](Connection$AgdaMode.wire)(Util$AgdaMode.$$Promise[/* mapOk */10]((function (param) {
                        ...
                        return connection;
                            ...
                            return getConnection(instance, param);
                                ...
                                return getMetadata(instance, param);
                              }))(Util$AgdaMode.$$Promise[/* thenError */13]((function (err) {
...
function cultivateCommand(command, instance) {
  var cultivate = function (command, instance) {
    return Util$AgdaMode.$$Promise[/* mapError */12]((function (param) {
                    return /* Cancelled */0;
                  }))(Util$AgdaMode.$$Promise[/* mapOk */10]((function (connection) {
                        return /* record */Block.record([
                                  "connection",
                                  "filepath",
                                  "command"
  ...
  if (typeof command === "number") {
    switch (command) {
      ...
      case 1 : 
          ...
          return Util$AgdaMode.$$Promise[/* resolve */1](/* Ok */Block.variant("Ok", 0, [undefined]));
      case 2 : 
          disconnect(instance);
          return cultivate(/* Load */0, instance);
      case 13 : 
          ...
          if (pointed !== undefined) {
            ...
            if (match !== undefined) {
              ...
              if (Goal$AgdaMode.isEmpty(goal)) {
                return Util$AgdaMode.$$Promise[/* thenOk */11]((function (result) {
                                Goal$AgdaMode.setContent(result, goal);
                                return cultivate(/* Give */Block.simpleVariant("Give", [
                                              goal,
                                              index
                                            ]), instance);
                              }))(Util$AgdaMode.$$Promise[/* mapError */12]((function (param) {
                                    return /* Cancelled */0;
              ...
              return Util$AgdaMode.$$Promise[/* resolve */1](/* Error */Block.variant("Error", 1, [/* GoalNotIndexed */1]));
            }
          } else {
            updateView(/* record */Block.record([
                    "text",
            ...
            return Util$AgdaMode.$$Promise[/* resolve */1](/* Error */Block.variant("Error", 1, [/* OutOfGoal */2]));
          }
      default:
        return cultivate(/* Load */0, instance);
    }
...
function dispatch(command, instance) {
  return Util$AgdaMode.$$Promise[/* then_ */6]((function (cultivated) {
                if (cultivated.tag) {

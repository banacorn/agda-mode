...
function queryConnection(message, self) {
  ...
  Util$AgdaMode.$$Promise[/* thenDrop */8]((function (x) {
          console.log("!!!!");
          console.log(x);
          return /* () */0;
        }), Util$AgdaMode.Event[/* on */6](self[/* view */1][/* onInquireConnection */6])[1]);
  Util$AgdaMode.Msg[/* send */1](true, self[/* view */1][/* activateSettingsView */10]);
  return Util$AgdaMode.$$Promise[/* then_ */6]((function (param) {
                Util$AgdaMode.Msg[/* send */1](/* Connection */1, self[/* view */1][/* navigateSettingsView */12]);
                Util$AgdaMode.Msg[/* send */1](/* tuple */[
                      message,
                      ""
                    ], self[/* view */1][/* inquireConnection */5]);
                return Util$AgdaMode.$$Promise[/* resolve */1]("haha");
              }), Util$AgdaMode.Msg[/* once */3](self[/* view */1][/* onSettingsView */11]));
}

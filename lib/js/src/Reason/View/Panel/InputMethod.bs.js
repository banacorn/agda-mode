...
function markerOnDidChange(editor, $$event, self) {
  ...
  var textBuffer = Editor$AgdaMode.Focus[/* get */0](editor).getBuffer();
  if (rangeNew.isEmpty()) {
...
function insertActualBuffer(editors, $$char, _self) {
  var editor = Editor$AgdaMode.Focus[/* get */0](editors);
...
function reducer(editor, onActivationChange, action, state) {
      ...
      case 0 : 
          ...
          if (match) {
            ...
            return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                      ...
                      (function (self) {
                          var focusedEditor = Editor$AgdaMode.Focus[/* get */0](editor);
                          ...
                          var markersDisposable = Rebase.Option[/* map */0]((function (marker) {
                                  return marker.onDidChange(Curry._1(self[/* handle */0], (function (param, param$1) {
                                                    return markerOnDidChange(editor, param, param$1);
                                                  })));
      ...
      case 1 : 
          ...
          if (match$1) {
            return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                      ...
                      (function (_self) {
                          atom.views.getView(Editor$AgdaMode.Focus[/* get */0](editor)).classList.remove("agda-mode-input-method-activated");
    ...
    switch (action.tag | 0) {
      ...
      case 2 : 
          ...
          return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                    ...
                    (function (param) {
                        return insertActualBuffer(editor, $$char, param);
                      })
                  ]);
      case 3 : 
          var $$char$1 = action[0];
          ...
          return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                    ...
                    (function (self) {
                        insertActualBuffer(editor, $$char$1, self);
          ...
          return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                    ...
                    (function (_self) {
                        return Rebase.$$Array[/* forEach */8]((function (marker) {
                                      Editor$AgdaMode.Focus[/* get */0](editor).getBuffer().setTextInRange(marker.getBufferRange(), string);
                                      return /* () */0;
                                    }), state[/* markers */2]);
                      })
                  ]);
...
function make(editor, interceptAndInsertKey, activationHandle, onActivationChange, _children) {
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",
            ...
            (function (self) {
                ...
                Curry._1(activationHandle, (function (activate) {
            ...
            (function (param, param$1) {
                return reducer(editor, onActivationChange, param, param$1);
              }),

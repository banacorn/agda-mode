...
function reducer(editor, action, state) {
  if (typeof action === "number") {
    if (action === 0) {
      ...
      var match$1 = Buffer$AgdaMode.isEmpty(state[/* buffer */2]);
      if (match) {
        if (match$1) {
    ...
    switch (action.tag | 0) {
      ...
      case 4 : 
          ...
          return /* UpdateWithSideEffects */Caml_chrome_debugger.variant("UpdateWithSideEffects", 1, [
                    ...
                    (function (param) {
                        rewriteTextBuffer(editor, state[/* markers */1], string$1);
                        return undefined;
                      })
                  ]);
  ...
  return React.createElement("section", {
              className: className
                  ...
                  chooseSymbol: (function (symbol) {
                      return Curry._1(send, /* RewriteAndDeactivate */Caml_chrome_debugger.variant("RewriteAndDeactivate", 4, [symbol]));
                    })
                }));
}

...
function errorToHeader(error) {
  switch (error.tag | 0) {
    case 0 : 
        return "Type Error: " + typeErrorToHeader(error[1]);
    case 1 : 
        return "Exception";
    case 2 : 
        return "IOException";
                ...
                switch (decodedError.tag | 0) {
                  case 0 : 
                      return React.createElement("section", {
                                  className: "error"
                                }, ReasonReact.element(undefined, undefined, Range$AgdaMode.make(decodedError[0], emit, undefined, /* array */[])), ReasonReact.element(undefined, undefined, TypeError$AgdaMode.make(decodedError[1], emacsMessage, /* array */[])));
                  case 1 : 
                  case 2 : 
                      return React.createElement("section", {
                                  className: "error"

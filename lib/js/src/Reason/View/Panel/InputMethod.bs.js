...
function markerOnDidChange($$event, self) {
  ...
  if (rangeNew.isEmpty()) {
    ...
    if (surfaceBuffer !== self[/* state */1][/* buffer */5][/* surface */0]) {
      if (comparison === -1) {
        var $$char = textBuffer.getTextInRange(rangeNew).substr(-1);
        Curry._1(self[/* send */3], /* Insert */Block.variant("Insert", 0, [$$char]));
      }
      if (comparison === 1) {
...
function reducer(onActivationChange, action, state) {
  if (typeof action === "number") {
          ...
          if (match) {
            return /* SideEffects */Block.variant("SideEffects", 1, [(function (self) {
                          if (Rebase.$$String[/* isEmpty */5](state[/* buffer */5][/* underlying */1])) {
                            ...
                            return Curry._1(self[/* send */3], /* InsertSurfaceBuffer */Block.variant("InsertSurfaceBuffer", 2, ["\\"]));
                          }
                        })]);
          } else {
    ...
    switch (action.tag | 0) {
      case 0 : 
          var $$char = action[0];
          var input$1 = state[/* buffer */5][/* underlying */1] + $$char;
          ...
          if (match$2 !== undefined) {
            ...
            return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                      ...
                      (function (self) {
                          Curry._1(self[/* send */3], /* RewriteSurfaceBuffer */Block.variant("RewriteSurfaceBuffer", 3, [symbol]));
      ...
      case 2 : 
          ...
          return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                    ...
                    (function (param) {
                        return insertActualBuffer($$char$1, param);
                      })
                  ]);
      case 3 : 
          var string = action[0];
  ...
  return /* record */Block.record([
            ...
            (function (self) {
                Curry._1(interceptAndInsertKey, (function ($$char) {
                        Curry._1(self[/* send */3], /* InsertSurfaceBuffer */Block.variant("InsertSurfaceBuffer", 2, [$$char]));
                        return Curry._1(self[/* send */3], /* Insert */Block.variant("Insert", 0, [$$char]));
                      }));
            ...
            (function (self) {
                ...
                var bufferClassName = Curry._1(Util$AgdaMode.React[/* toClassName */3], Util$AgdaMode.React[/* addClass */2]("hidden", Rebase.$$String[/* isEmpty */5](buffer[/* surface */0]), /* :: */Block.simpleVariant("::", [
                            "inline-block",
                            /* :: */Block.simpleVariant("::", [
                                "buffer",
                                /* [] */0
                                    ...
                                    className: "keys btn-group btn-group-sm"
                                          ...
                                          return React.createElement("button", {
                                                      ...
                                                      onClick: (function (param) {
                                                          Curry._1(self[/* send */3], /* Insert */Block.variant("Insert", 0, [key]));
                                                          return Curry._1(self[/* send */3], /* InsertSurfaceBuffer */Block.variant("InsertSurfaceBuffer", 2, [key]));
                                                        })
                                                    }, key);
                                      ...
                                      if (replace !== undefined) {
                                        return Curry._1(self[/* send */3], /* InsertSurfaceBuffer */Block.variant("InsertSurfaceBuffer", 2, [replace]));
                                      } else {
                                        return /* () */0;
                                      }
                                    }), (function (symbol) {
                                      Curry._1(self[/* send */3], /* InsertSurfaceBuffer */Block.variant("InsertSurfaceBuffer", 2, [symbol]));
                                      return Curry._1(self[/* send */3], /* Deactivate */1);
                                    }), /* array */[])));
              }),
            (function (param) {

...
function allGoalsWarnings(title, body) {
  var metas = allGoalsWarningsOld(title, body)[/* metas */0];
  var partial_arg = (/((?:\n|.)*\S+)\s*\[ at (.+):(?:(\d+)\,(\d+)\-(\d+)\,(\d+)|(\d+)\,(\d+)\-(\d+)) \]/);
  var partial_arg$1 = Util$AgdaMode.Re_[/* captures */0];
  var hiddenMetas = List.map((function (result) {
          console.log(result);
          Caml_format.caml_int_of_string(Js_option.$$default(Js_option.$$default("0", Caml_array.caml_array_get(result, 7)), Caml_array.caml_array_get(result, 3)));
          Caml_format.caml_int_of_string(Js_option.$$default(Js_option.$$default("0", Caml_array.caml_array_get(result, 7)), Caml_array.caml_array_get(result, 5)));
          Caml_format.caml_int_of_string(Js_option.$$default(Js_option.$$default("0", Caml_array.caml_array_get(result, 8)), Caml_array.caml_array_get(result, 4)));
          Caml_format.caml_int_of_string(Js_option.$$default(Js_option.$$default("0", Caml_array.caml_array_get(result, 9)), Caml_array.caml_array_get(result, 6)));
          return 3;
        }), Util$AgdaMode.Array_[/* catMaybes */0]($$Array.map((function (param) {
                  return partial_arg$1(partial_arg, param);
                }), metas)));
  console.log(hiddenMetas);
  return /* () */0;
}

...
function insert(key, instance) {
  ...
  var insertUntilSuccess = function (text) {
    ...
    return instance[/* editors */1][/* source */1].save().then((function (param) {
                  ...
                  if (before !== after) {
                    ...
                    console.log("!!! reinserting ", text, before);
                    instance[/* editors */1][/* source */1].setText(before);
                    return insertUntilSuccess(text);
                  }
                }));
  };
  console.log("[ IM ][ before insertion ]", instance[/* editors */1][/* source */1].getText());
  console.log("[ IM ][ inserting ]", key);
  return insertUntilSuccess(key).then((function (param) {

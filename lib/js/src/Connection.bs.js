...
function validateAndMake(pathAndParams) {
  ...
  return Async$AgdaMode.mapError((function (e) {
                  if (typeof e === "number") {
                    console.log("[ProcessHanging]");
                  } else {
                    switch (e.tag | 0) {
                      case 0 : 
                          console.log("[PathMalformed]", e[0]);
                          break;
                      case 1 : 
                          console.log("[NotFound]", e[0]);
                          break;
                      case 2 : 
                          console.log("[ShellError]", e[0]);
                          break;
                      case 3 : 
                          console.log("[ProcessError]", e[0]);
                          break;
                      case 4 : 
                          console.log("[IsNotAgda]", e[0]);
                          break;

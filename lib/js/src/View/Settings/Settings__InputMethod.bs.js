...
function Settings__InputMethod$SymbolLookup(Props) {
  ...
  var candidateSymbols = Util$AgdaMode.React.manyIn("div")(Rebase.$$Array.map((function (symbol) {
...
function Settings__InputMethod$KeySequenceLookup(Props) {
  ...
  var results = Util$AgdaMode.React.manyIn("span")(Rebase.$$Array.map((function (sequence) {
  ...
  return React.createElement("li", {
              ...
              onMouseOver: onMouseOver
                  ...
                  className: "symbols"
                    ...
                    }, Util$AgdaMode.React.manyIn(React.Fragment)(Rebase.$$Array.map((function (symbol) {
                                return React.createElement("kbd", {
                                            className: "inline-block highlight"
                                          }, symbol);
...
function Settings__InputMethod$ExtendKeymap(Props) {
  ...
  var items = Util$AgdaMode.React.manyIn2("ul", {
          id: "extensions"

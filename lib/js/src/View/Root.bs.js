...
function Root(Props) {
  ...
  Hook$AgdaMode.useChannel(Curry._2(Rebase.Fn[/* >> */6], match$6[1], Async$AgdaMode.resolve), handles[/* updateIsPending */6]);
  Hook$AgdaMode.useChannel(Curry._2(Rebase.Fn[/* >> */6], match$5[1], Async$AgdaMode.resolve), handles[/* updateShouldDisplay */7]);

  ...
  return Async$AgdaMode.thenError((function (error) {
                if (typeof error === "number") {
                  ...
                  Rebase.$$Option[/* forEach */8]((function (conn) {
                          ...
                          return Curry._3(instance[/* view */2][/* display */5], "Parse Error", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* ParseError */Block.variant("ParseError", 7, [conn[/* log */5]])]));
...
function handleRemoteCommand(instance, remote) {
  if (remote !== undefined) {
    var cmd = remote;
    Async$AgdaMode.mapOk((function (connection) {
              if (Command$AgdaMode.Remote[/* isLoad */1](cmd) && connection[/* resetLogOnLoad */6]) {

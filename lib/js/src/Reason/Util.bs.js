...
function resolve(x, self) {
  return Curry._1(self[/* promise */1][/* resolve */1], x);
}

function reject(x, self) {
  return Curry._1(self[/* promise */1][/* reject */2], x);
}

function trigger(x, self) {
...
function onTrigger(handler, self) {

...
exports.give = (goal) => sendCommand('NonInteractive', `Cmd_give ${goal.index} ${buildRange(goal)} \"${goal.getContent()}\"`);
exports.refine = (goal) => sendCommand('NonInteractive', `Cmd_refine_or_intro False ${goal.index} ${buildRange(goal)} \"${goal.getContent()}\"`);
exports.auto = (goal) => sendCommand('NonInteractive', `Cmd_auto ${goal.index} ${buildRange(goal)} \"${goal.getContent()}\"`);
exports.makeCase = (goal) => sendCommand('NonInteractive', `Cmd_make_case ${goal.index} ${buildRange(goal)} \"${goal.getContent()}\"`);

...
function parseAgdaOutput(parser, stringAgdaSpatOut) {
  ...
  var trimmedBack;
  if (Rebase.$$String[/* endsWith */4]("Agda2>", stringAgdaSpatOut)) {
    chunkEnded = true;
    trimmedBack = stringAgdaSpatOut.substring(0, Rebase.$$String[/* length */1](stringAgdaSpatOut) - 6 | 0);
  } else if (Rebase.$$String[/* endsWith */4]("Agda2> ", stringAgdaSpatOut)) {
    chunkEnded = true;
    trimmedBack = stringAgdaSpatOut.substring(0, Rebase.$$String[/* length */1](stringAgdaSpatOut) - 7 | 0);
  } else {
    trimmedBack = stringAgdaSpatOut;
  }
  var match = Rebase.$$String[/* startsWith */3]("Agda2>", trimmedBack);
  var trimmedBoth = match ? trimmedBack.substring(6, Rebase.$$String[/* length */1](trimmedBack)) : trimmedBack;
  var partial_arg = parser[0];
  var partial_arg$1 = Parser$AgdaMode.Incr[/* feed */2];
  Rebase.$$Array[/* forEach */8]((function (param) {
          return partial_arg$1(partial_arg, param);
        }), Curry._1(Parser$AgdaMode.split, trimmedBoth));
  if (chunkEnded) {

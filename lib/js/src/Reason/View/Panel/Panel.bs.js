...
function make(editors, element, onMountAtChange, body, header, mountAt, mode, hidden, onInquireQuery, onEditorFocused, onEditorRef, editorPlaceholder, editorValue, interceptAndInsertKey, activateInputMethod, activateSettingsView, onSettingsViewToggle, _children) {
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",
                ...
                return ReactDom.createPortal(ReasonReact.element(undefined, undefined, Curry._2(Type$AgdaMode.View[/* MouseEmitter */3][/* Provider */1][/* make */0], (function (ev) {
                                      return Curry._1(self[/* send */3], /* MouseEvent */Block.variant("MouseEvent", 3, [ev]));
                                          ...
                                          className: className
                                            ...
                                            }, ReasonReact.element(undefined, undefined, Body$AgdaMode.make(body, match[/* maxHeight */0], mode !== /* Display */0, mountAtBottom, /* array */[])), ReasonReact.element(undefined, undefined, MiniEditor$AgdaMode.make(editorValue, editorPlaceholder, mode !== /* Query */1, "agda", (function (result) {
                                                        return Util$AgdaMode.Event[/* resolve */9](/* Ok */Block.variant("Ok", 0, [result]), onInquireQuery);
                                                      }), Caml_option.some((function () {
                                                            Util$AgdaMode.Event[/* resolve */9](/* Error */Block.variant("Error", 1, [/* Cancelled */0]), onInquireQuery);
                                                            return /* () */0;
                                                          })), Caml_option.some((function () {

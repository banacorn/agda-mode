...
var readKeymap = Curry._2(Rebase.Fn[/* >> */6], Curry._2(Rebase.Fn[/* >> */6], readConfig, parse), (function (param) {
        return partial_arg$2(partial_arg$1, param);
      }));

function lookup(key) {
  return Rebase.$$Option[/* getOr */16](/* array */[], Js_dict.get(Curry._1(readKeymap, /* () */0), key));
}
...
function add(key, symbols) {
  ...
  if (match !== undefined) {
    keymap[key] = Rebase.$$Array[/* concat */11](match, symbols);
  } else {
    keymap[key] = symbols;
  }

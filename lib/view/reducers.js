...
const body = redux_actions_1.handleActions({
    [actions_1.BODY.UPDATE_BODY]: (state, action) => (Object.assign({}, state, { body: action.payload, solutions: defaultState.body.solutions, error: null, emacsError: null, plainText: defaultState.body.plainText })),
    ...
    [actions_1.BODY.UPDATE_SOLUTIONS]: (state, action) => (Object.assign({}, state, { body: defaultState.body.body, solutions: action.payload, error: null, emacsError: null, plainText: defaultState.body.plainText })),
    [actions_1.BODY.UPDATE_PLAIN_TEXT]: (state, action) => (Object.assign({}, state, { body: defaultState.body.body, solutions: defaultState.body.solutions, error: null, emacsError: null, plainText: action.payload })),

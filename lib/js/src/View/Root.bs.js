...
function mountSettings(editors, handles, open_, self) {
  var match = self[/* state */1][/* settingsView */3];
  if (match !== undefined) {
    if (open_) {
...
function Root(Props) {
  ...
  var match$5 = Hook$AgdaMode.useState(/* tuple */[
        undefined,
        undefined
      ]);
  ...
  Hook$AgdaMode.useEventListener(match$4[1], handles[/* updateIsPending */4]);
  Hook$AgdaMode.useEventListener((function (shouldDisplay) {
          return Curry._1(send, /* UpdateIsLoadedOrIsTyping */Block.variant("UpdateIsLoadedOrIsTyping", 4, [shouldDisplay]));
  ...
  Hook$AgdaMode.useEventListener(match$5[1], handles[/* updateConnection */6]);
  var settingsView = state[/* settingsView */3];
  ...
  var hidden;
  hidden = mountAt.tag ? false : !(isActive && state[/* shouldDisplay */2]);
  return React.createElement(React.Fragment, undefined, React.createElement(make, {
                  ...
                  children: null
                      ...
                      editorPlaceholder: editors[/* query */2][/* placeholder */1],
                      editorValue: editors[/* query */2][/* value */0],
                      ...
                      connection: match$6[0],
                      connectionError: match$6[1],

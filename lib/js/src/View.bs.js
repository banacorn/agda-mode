...
function make(handles) {
  ...
  var destroy = function (param) {
    ...
    return Event$AgdaMode.emitOk(/* () */0, handles[/* destroy */15]);
  };
  var onDestroy = function (param) {
    return Event$AgdaMode.once(handles[/* destroy */15]);
  };
  var updateShouldDisplay = function (shouldDisplay) {
    Event$AgdaMode.emitOk(shouldDisplay, handles[/* updateShouldDisplay */6]);
    return /* () */0;
  };
  ...
  var inquire = function (text, placeholder, value) {
    var promise = Event$AgdaMode.once(handles[/* onInquireQuery */11]);
  ...
  var updateIsPending = function (isPending) {
    return Event$AgdaMode.emitOk(isPending, handles[/* updateIsPending */5]);
  };
  var onMouseEvent = handles[/* onMouseEvent */18];
  var activateInputMethod = function (activate) {
    return Event$AgdaMode.emitOk(activate, handles[/* activateInputMethod */16]);
  };
  var interceptAndInsertKey = function (symbol) {
    return Event$AgdaMode.emitOk(symbol, handles[/* interceptAndInsertKey */17]);
  };
  var navigateSettings = function (where) {
    return Event$AgdaMode.emitOk(where, handles[/* navigateSettingsView */14]);
  };
  var activateSettings = function (param) {
    return Event$AgdaMode.emitOk(true, handles[/* activateSettingsView */12]);
  };
  var openSettings = function (param) {
    var promise = Event$AgdaMode.once(handles[/* onSettingsView */13]);
    Event$AgdaMode.emitOk(true, handles[/* activateSettingsView */12]);
    return promise;
  };

...
function connectWithAgdaPath(instance, path) {
  ...
  return Async$AgdaMode.mapOk(Connection$AgdaMode.wire)(Async$AgdaMode.mapOk((function (param) {
                      ...
                      Event$AgdaMode.onOk((function (res) {
                                ...
                                return /* () */0;
                              }))(connection[/* errorEmitter */2]);
                      return connection;
                    }))(Async$AgdaMode.mapOk((function (param) {
                          var instance$1 = instance;
                          var connection = param;
                          instance$1[/* connection */6] = connection;
                          var path = Rebase.$$String[/* joinWith */11](" ", Rebase.List[/* fromArray */12](Rebase.$$Array[/* concat */11](connection[/* log */4][/* metadata */0][/* args */1], /* array */[connection[/* log */4][/* metadata */0][/* path */0]])));

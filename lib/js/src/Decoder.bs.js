...
function parseWarning(json) {
  return /* OverlappingTokensWarning */Block.simpleVariant("OverlappingTokensWarning", [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
}
...
function declarationWarning(param) {
  return Json_decode.andThen((function (kind, json) {
                switch (kind) {
                  case "EmptyAbstract" : 
                      return /* EmptyAbstract */Block.variant("EmptyAbstract", 0, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                  case "EmptyInstance" : 
                      return /* EmptyInstance */Block.variant("EmptyInstance", 1, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                  case "EmptyMacro" : 
                      return /* EmptyMacro */Block.variant("EmptyMacro", 2, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                  case "EmptyMutual" : 
                      return /* EmptyMutual */Block.variant("EmptyMutual", 3, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                  case "EmptyPostulate" : 
                      return /* EmptyPostulate */Block.variant("EmptyPostulate", 4, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                  case "EmptyPrivate" : 
                      return /* EmptyPrivate */Block.variant("EmptyPrivate", 5, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                  case "InvalidCatchallPragma" : 
                      return /* InvalidCatchallPragma */Block.variant("InvalidCatchallPragma", 6, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                  case "InvalidNoPositivityCheckPragma" : 
                      return /* InvalidNoPositivityCheckPragma */Block.variant("InvalidNoPositivityCheckPragma", 7, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                  case "InvalidNoUniverseCheckPragma" : 
                      return /* InvalidNoUniverseCheckPragma */Block.variant("InvalidNoUniverseCheckPragma", 8, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                  case "InvalidTerminationCheckPragma" : 
                      return /* InvalidTerminationCheckPragma */Block.variant("InvalidTerminationCheckPragma", 9, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                  ...
                  case "PragmaNoTerminationCheck" : 
                      return /* PragmaNoTerminationCheck */Block.variant("PragmaNoTerminationCheck", 13, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                  ...
                  case "UselessAbstract" : 
                      return /* UselessAbstract */Block.variant("UselessAbstract", 17, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                  case "UselessInstance" : 
                      return /* UselessInstance */Block.variant("UselessInstance", 18, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                  case "UselessPrivate" : 
                      return /* UselessPrivate */Block.variant("UselessPrivate", 19, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                  default:
  ...
  return (function (param) {
      return Json_decode.andThen((function (kind, json) {
                    switch (kind) {
                      ...
                      case "Prop" : 
                          return /* Prop */Block.variant("Prop", 16, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                      case "PropN" : 
                      ...
                      case "Set" : 
                          return /* Set */Block.variant("Set", 15, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                      case "SetN" : 
...
function pattern(param) {
  return (function (param) {
      return Json_decode.andThen((function (kind, json) {
                    switch (kind) {
                      case "AbsurdP" : 
                          return /* AbsurdP */Block.variant("AbsurdP", 9, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                      case "AppP" : 
                      ...
                      case "EllipsisP" : 
                          return /* EllipsisP */Block.variant("EllipsisP", 15, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                      case "EqualP" : 
                      ...
                      case "QuoteP" : 
                          return /* QuoteP */Block.variant("QuoteP", 1, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                      case "RawAppP" : 
                      ...
                      case "WildP" : 
                          return /* WildP */Block.variant("WildP", 8, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                      case "WithP" : 
  ...
  return (function (param) {
      return Json_decode.andThen((function (kind, json) {
                    switch (kind) {
                      ...
                      case "CatchallPragma" : 
                          return /* CatchallPragma */Block.variant("CatchallPragma", 22, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                      case "CompilePragma" : 
                      ...
                      case "ImpossiblePragma" : 
                          return /* ImpossiblePragma */Block.variant("ImpossiblePragma", 18, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                      ...
                      case "NoPositivityCheckPragma" : 
                          return /* NoPositivityCheckPragma */Block.variant("NoPositivityCheckPragma", 24, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                      case "NoUniverseCheckPragma" : 
                          return /* NoUniverseCheckPragma */Block.variant("NoUniverseCheckPragma", 26, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                      case "OptionsPragma" : 
...
function call(param) {
  return Json_decode.andThen((function (kind, json) {
                switch (kind) {
                  ...
                  case "SetRange" : 
                      return /* SetRange */Block.variant("SetRange", 27, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                  default:
...
function error(param) {
  return Json_decode.andThen((function (kind, json) {
                switch (kind) {
                  ...
                  case "PatternError" : 
                      return /* PatternError */Block.variant("PatternError", 3, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */4], json)]);
                  case "TypeError" : 

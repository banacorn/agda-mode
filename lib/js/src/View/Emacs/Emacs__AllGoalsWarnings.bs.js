...
function Emacs__AllGoalsWarnings(Props) {
  ...
  return React.createElement(React.Fragment, undefined, Util$AgdaMode.React.manyIn($$Array.map((function (value) {
                        return React.createElement(Emacs__Component$AgdaMode.Output.make, {
                                    value: value
                                  });
                      }), value.interactionMetas), "ul"), Util$AgdaMode.React.manyIn($$Array.map((function (value) {
                        return React.createElement(Emacs__Component$AgdaMode.Output.make, {
                                    value: value
                                  });
                      }), value.hiddenMetas), "ul"), Util$AgdaMode.React.manyIn($$Array.map((function (value) {
                        return React.createElement(Emacs__Component$AgdaMode.WarningError.make, {
                                    value: value
                                  });
                      }), value.warnings), "ul"), Util$AgdaMode.React.manyIn($$Array.map((function (value) {
                        return React.createElement(Emacs__Component$AgdaMode.WarningError.make, {
                                    value: value
                                  });
                      }), value.errors), "ul"));

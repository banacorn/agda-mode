...
function typeError(param) {
  return Json_decode.andThen((function (kind, json) {
                switch (kind) {
                  ...
                  case "NotInScope" : 
                      return /* NotInScope */Block.variant("NotInScope", 3, [Json_decode.field("names", (function (param) {
                  ...
                  case "ShouldBePi" : 
                      return /* ShouldBePi */Block.variant("ShouldBePi", 1, [Json_decode.field("type", repType, json)]);
                  case "UnequalTerms" : 
                      return /* UnequalTerms */Block.variant("UnequalTerms", 2, [
                                Json_decode.field("comparison", comparison, json),
                  ...
                  default:
                    return /* UnregisteredTypeError */Block.variant("UnregisteredTypeError", 4, [json]);
                }
              }), (function (param) {
                return Json_decode.field("kind", Json_decode.string, param);
              }), param);

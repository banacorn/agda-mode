...
function make(inquireConnection, onInquireConnection, connection, hidden, _children) {
  return /* record */Block.record([
            ...
            (function (self) {
                return Util$AgdaMode.Event[/* destroyWhen */6](self[/* onUnmount */4], Util$AgdaMode.Event[/* on */7]((function (param) {
                                  Curry._1(self[/* send */3], /* Inquire */Block.simpleVariant("Inquire", [
                                          param[0],
                                          param[1]
                                        ]));
                                  return Promise$AgdaMode.thenDrop((function (value) {
                                                return Util$AgdaMode.Event[/* resolve */9](value, onInquireConnection);
            ...
            (function (self) {
                ...
                if (connection !== undefined) {
                  var conn = connection;
                  var match$1 = conn[/* metadata */0][/* protocol */2];
                  tmp = React.createElement(React.Fragment, undefined, React.createElement("p", undefined, "Connection: established"), React.createElement("p", undefined, "Path: " + conn[/* metadata */0][/* path */0]), React.createElement("p", undefined, "Version: " + conn[/* metadata */0][/* version */1]), React.createElement("p", undefined, "Supported protocol: " + (
                                    ...
                                    className: "agda-settings-connection-dashboard"
                                        ...
                                        id: "agda-settings-connection-agda"
                                                ...
                                                className: "input-label"
                                                  ...
                                                  }))), React.createElement("div", undefined, tmp, React.createElement("p", undefined, ReasonReact.element(undefined, undefined, MiniEditor$AgdaMode.make(match[/* value */4], "path to Agda", false, undefined, (function (result) {

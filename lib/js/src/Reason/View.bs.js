          ...
          return /* SideEffects */Block.variant("SideEffects", 1, [(function (self) {
                        ...
                        if (match !== undefined) {
                          ...
                          var tab = Tab$AgdaMode.make(self[/* state */1][/* editors */5][/* source */1], (function (param) {
                                  ...
                                  return Curry._1(handles[/* activateSettingsView */9][0], false);
                                }), undefined, /* () */0);
...
function make$1(textEditor, handles, _children) {
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                handles[/* destroy */10][0] = (function (param) {
                    console.log("destroy!");
                    return /* () */0;
                  });
                handles[/* activateSettingsView */9][0] = (function (activate) {
            ...
            (function (self) {
                ...
                var partial_arg$2 = handles[/* activateSettingsView */9];

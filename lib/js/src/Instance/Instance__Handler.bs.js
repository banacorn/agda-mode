...
function handleCommandError(instance) {
  return Async$AgdaMode.thenError((function (error) {
                if (typeof error === "number") {
                  switch (error) {
                    case 0 : 
                        Curry._3(instance[/* view */2][/* display */5], "Query Cancelled", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 8, [""])]));
                        break;
                    case 1 : 
                        Curry._3(instance[/* view */2][/* display */5], "Goal not indexed", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 8, ["Please reload to re-index the goal"])]));
                        break;
                    case 2 : 
                        Curry._3(instance[/* view */2][/* display */5], "Out of goal", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 8, ["Please place the cursor in a goal"])]));
                        break;
                    
                  }
                } else if (error.tag) {
                  var match = Connection$AgdaMode.$$Error[/* toString */0](error[0]);
                  Curry._3(instance[/* view */2][/* display */5], "Connection-related Error: " + match[0], /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 8, [match[1]])]));
                } else {
                  var errors = error[0];
                  Rebase.$$Option[/* forEach */8]((function (conn) {
                          Rebase.$$Array[/* forEach */8]((function (e) {
                                  return Log$AgdaMode.logError(e)(conn[/* log */4]);
                                }), errors);
                          return Curry._3(instance[/* view */2][/* display */5], "Parse Error", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* ParseError */Block.variant("ParseError", 7, [conn[/* log */4]])]));
    ...
    switch (info.tag | 0) {
      ...
      case 2 : 
          return /* tuple */[
                  "Time",
                  /* PlainText */0,
                  /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 8, [info[0]])])
                ];
      case 3 : 
          return /* tuple */[
                  "Error",
  ...
  if (typeof response === "number") {
    switch (response) {
      ...
      case 2 : 
          ...
          return Async$AgdaMode.resolve(/* () */0);
      case 3 : 
          Curry._3(instance[/* view */2][/* display */5], "Status", /* Warning */4, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 8, ["Done aborting"])]));
          return Async$AgdaMode.resolve(/* () */0);
    ...
    switch (response.tag | 0) {
      ...
      case 2 : 
          ...
          if (displayImplicit || checked) {
            Curry._3(instance[/* view */2][/* display */5], "Status", /* PlainText */0, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 8, ["Typechecked: " + (Pervasives.string_of_bool(checked) + ("\nDisplay implicit arguments: " + Pervasives.string_of_bool(displayImplicit)))])]));
          }
          return Async$AgdaMode.resolve(/* () */0);
      case 3 : 
      ...
      case 7 : 
          ...
          return Async$AgdaMode.thenOk((function (param) {
                          ...
                          if (size === 0) {
                            Curry._3(instance[/* view */2][/* display */5], "No solutions found", /* PlainText */0, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 8, [""])]));
                          } else {
                            Curry._3(instance[/* view */2][/* display */5], String(size) + " goals solved", /* Success */3, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 8, [""])]));
                          }
                          return Async$AgdaMode.resolve(/* () */0);
      ...
      case 9 : 
          ...
          if (response[0] >= 2) {
            ...
            Curry._3(instance[/* view */2][/* display */5], "Type-checking", /* PlainText */0, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 8, [message])]));
          }
          return Async$AgdaMode.resolve(/* () */0);
  ...
  var buff = function (command, instance) {
    return Async$AgdaMode.mapError((function (param) {
                    return /* Cancelled */0;
                        ...
                        Curry._3(instance[/* view */2][/* display */5], "Loading ...", /* PlainText */0, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 8, [""])]));
                        return /* record */Block.record([
                                  "version",
                                  "filepath",
                                  "command"
                                ], [
                                  connection[/* log */4][/* metadata */0][/* version */2],
    ...
    switch (command) {
      case 0 : 
          return Async$AgdaMode.thenOk((function (param) {
                          ...
                          Curry._3(instance[/* view */2][/* display */5], "Connecting ...", /* PlainText */0, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 8, [""])]));
      ...
      case 17 : 
          ...
          Async$AgdaMode.finalOk((function (symbol) {
                  return Rebase.$$Option[/* forEach */8]((function (sequences) {
                                return Curry._3(instance[/* view */2][/* display */5], "Input sequence for " + symbol, /* PlainText */0, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 8, [Rebase.$$String[/* joinWith */11]("\n", Rebase.List[/* fromArray */12](sequences))])]));
...
function handleRemoteCommand(instance, remote) {
  if (remote !== undefined) {
    ...
    Async$AgdaMode.mapOk((function (connection) {
              ...
              return Log$AgdaMode.createEntry(cmd[/* command */2], connection[/* log */4]);
            }))(Instance__Connections$AgdaMode.get(instance));

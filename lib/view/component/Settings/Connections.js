    ...
    render() {
        ...
        return (React.createElement("section", { className: this.props.className },
            ...
            React.createElement("ol", null, this.props.state.connectionInfos.map((connInfo) => {
                return React.createElement(ConnectionItem_1.default, { key: connInfo.guid, location: connInfo.agda.location, protocol: connInfo.languageServer ? 'LSP' : 'Vanilla', version: connInfo.agda.version.raw, selected: this.props.state.selected === connInfo.guid, connected: this.props.state.connected === connInfo.guid, erred: _.includes(this.props.state.erred, connInfo.guid), onSelect: () => {

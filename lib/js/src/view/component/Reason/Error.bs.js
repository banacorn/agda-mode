                ...
                switch (decodedError.tag | 0) {
                  case 0 : 
                      return ReasonReact.element(undefined, undefined, Curry._2(Context$AgdaMode.Emitter[/* Provider */1][/* make */0], emit, /* array */[React.createElement("section", {
                                            className: "error"
                                          }, ReasonReact.element(undefined, undefined, Range$AgdaMode.make(decodedError[0], undefined, /* array */[])), ReasonReact.element(undefined, undefined, TypeError$AgdaMode.make(decodedError[2], emacsMessage, /* array */[])), ReasonReact.element(undefined, undefined, Call$AgdaMode.make(decodedError[1], /* array */[])))]));
                  case 1 : 
                  case 2 : 

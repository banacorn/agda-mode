...
function warningOrErrors(isWarning) {
  return /* String */Block.variant("String", 1, [(function (raw) {
                var lines = raw.split("\n");
                var partial_arg = Util$AgdaMode.Parser[/* parse */1];
                var range$prime = Rebase.Option[/* flatMap */5]((function (param) {
                        return partial_arg(range, param);
                      }), Rebase.$$Array[/* get */17](lines, 0));
                var body = Rebase.$$Array[/* mapi */27]((function (token, i) {
                        var match = i % 2;
                        if (match !== 0) {
                          if (match !== 1) {
                            throw [
                      ...
                      }), Rebase.$$String[/* joinWith */11]("\n", Rebase.List[/* fromArray */12](lines.slice(1))).split((/(\S+\:(?:\d+\,\d+\-\d+\,\d+|\d+\,\d+\-\d+))/)));
                return Rebase.Option[/* map */0]((function (r) {
                              if (isWarning) {
                                return /* Warning */Block.variant("Warning", 0, [
                                          r,
                                          body
                                        ]);
                              } else {
                                return /* Error */Block.variant("Error", 1, [
                                          r,
                                          body
                                        ]);
                              }
  ...
  return (function (param) {
      return partial_arg(key, (function (raw) {
                    ...
                    var hasDelimeter = Rebase.Option[/* isSome */13](Rebase.Option[/* flatMap */5]((function (param) {
                                return Js_primitive.null_to_opt(param.match(partial_arg));
...
function allGoalsWarnings(title, body) {
  ...
  var warnings = Rebase.Option[/* mapOr */18]((function (entries) {
        ...
        }), /* array */[], Js_primitive.undefined_to_opt(dictionary["warnings"]));
  var errors = Rebase.Option[/* mapOr */18]((function (entries) {
          return Util$AgdaMode.Parser[/* parseArray */2](error, entries);
        }), /* array */[], Js_primitive.undefined_to_opt(dictionary["errors"]));
...
function error$1(raw) {
  ...
  return Rebase.Option[/* mapOr */18]((function (metas) {
              ...
              }), /* array */[], Js_primitive.undefined_to_opt(__x["errors"]));
}

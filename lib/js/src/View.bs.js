...
function makeHandles(param) {
  var activatePanel = Resource$AgdaMode.make(/* () */0);
  var deactivatePanel = Resource$AgdaMode.make(/* () */0);
...
function make(handles) {
  var activate = function (param) {
    return Channel$AgdaMode.send(/* () */0, handles[/* activatePanel */3]);
  };
  var deactivate = function (param) {
    return Channel$AgdaMode.send(/* () */0, handles[/* deactivatePanel */4]);
  };
  var destroy = function (param) {
    Channel$AgdaMode.send(/* () */0, handles[/* deactivatePanel */4]);

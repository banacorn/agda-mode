...
class View {
    constructor(core) {
        ...
        // view pane item
        this.viewPaneItem = new pane_item_1.default(this.editors.main.getModel(), 'view');
        ...
        this.settingsViewPaneItem = new pane_item_1.default(this.editors.main.getModel(), 'settings', () => {
    ...
    renderPanel() {
        ...
        ReactDOM.render(React.createElement(react_redux_1.Provider, { store: this.store },
            React.createElement(Panel_1.default, { core: this.core, emitter: this.emitter })), this.panelViewElement);
    }
    renderSettingsView() {

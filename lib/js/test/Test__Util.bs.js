...
function readGoldenFiles(dirname) {
  var readFile = Util.promisify((function (prim, prim$1) {
          Fs.readFile(prim, prim$1);
          return /* () */0;
        }));
  return getGoldenFilepaths(dirname).then((function (paths) {
                  return Promise.all(Rebase.$$Array[/* map */0]((function (path) {
                                    return Promise.all(/* array */[
                                                  readFile(path + ".in"),
                                                  readFile(path + ".out")
                                                ]).then((function (param) {
                ...
                return Promise.resolve(Rebase.$$Array[/* filterMap */23](Rebase.Fn[/* id */0], pairs));
              }));
}
...
function parseAsResponseAndCompare(param) {
  var actual = parseAsResponse(param[0]);
...
exports.readGoldenFiles = readGoldenFiles;

  ...
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                return React.createElement(React.Fragment, undefined, ReasonReact.element(undefined, undefined, Curry._2(Type__View$AgdaMode.MouseEmitter[/* Provider */1][/* make */0], (function (ev) {
                                    ...
                                    ReasonReact.element(undefined, undefined, Panel$AgdaMode.Jsx2[/* make */1](editors, panelElement, (function (mountTo) {
                                    ...
                                    ReasonReact.element(undefined, undefined, Settings$AgdaMode.Jsx2[/* make */1](handles[/* inquireConnection */7], handles[/* onInquireConnection */8], match[/* connection */8], match[/* connectionError */9], handles[/* navigateSettingsView */13], settingsElement, /* array */[]))
                                  ])));
              }),
            initialState,

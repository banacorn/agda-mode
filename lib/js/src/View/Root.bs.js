...
function mountSettings(editors, view, open_, self) {
  var match = self[/* state */1][/* settingsView */7];
  if (match !== undefined) {
    if (open_) {
      return Event$AgdaMode.emitOk(true, view[/* onSettingsView */12]);
    } else {
      Curry._1(match[/* kill */1], /* () */0);
      Curry._1(self[/* send */3], /* UpdateSettingsView */Block.variant("UpdateSettingsView", 3, [undefined]));
      return Event$AgdaMode.emitOk(false, view[/* onSettingsView */12]);
    }
  } else if (open_) {
...
function reducer(editors, view, action, state) {
    ...
    switch (action.tag | 0) {
      ...
      case 2 : 
          ...
          return /* SideEffects */Block.variant("SideEffects", 1, [(function (param) {
                        return mountSettings(editors, view, open_, param);
                      })]);
      case 3 : 
          return /* Update */Block.variant("Update", 0, [/* record */Block.record([
                        "header",
      ...
      case 12 : 
          var $$event = action[0];
          return /* SideEffects */Block.variant("SideEffects", 1, [(function (param) {
                        return Event$AgdaMode.emitOk($$event, view[/* onMouseEvent */17]);
                      })]);
...
function make(editors, view, _children) {
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",
            ...
            (function (self) {
                ...
                return React.createElement(React.Fragment, undefined, ReasonReact.element(undefined, undefined, Curry._2(Type__View$AgdaMode.MouseEmitter[/* Provider */1][/* make */0], (function (ev) {
                                    ...
                                    ReasonReact.element(undefined, undefined, Panel$AgdaMode.make(editors, panelElement, (function (mountTo) {
                                              ...
                                              }), match[/* body */1], match[/* header */0], mountAt, match[/* mode */10], hidden, settingsView, match[/* isPending */6], isActive, view[/* onInquireQuery */10], (function (ref) {
                                                return Curry._1(self[/* send */3], /* SetQueryRef */Block.variant("SetQueryRef", 1, [ref]));
                                              }), editors[/* query */2][/* placeholder */1], editors[/* query */2][/* value */0], view[/* interceptAndInsertKey */16], view[/* activateInputMethod */15], (function (status) {
                                                return Curry._1(self[/* send */3], /* ToggleSettingsTab */Block.variant("ToggleSettingsTab", 2, [status]));
                                              }), /* array */[])),
                                    ReasonReact.element(undefined, undefined, Settings$AgdaMode.make(view[/* inquireConnection */7], view[/* onInquireConnection */8], match[/* connection */8], match[/* connectionError */9], view[/* navigateSettingsView */13], settingsElement, /* array */[]))
                                  ])));
              }),
            initialState,
            component[/* retainedProps */11],
            (function (param, param$1) {
                return reducer(editors, view, param, param$1);
              }),
...
function initialize(editors) {
  var element = document.createElement("article");
  var view = View$AgdaMode.make(/* () */0);
  var component = ReasonReact.element(undefined, undefined, make(editors, view, /* array */[]));

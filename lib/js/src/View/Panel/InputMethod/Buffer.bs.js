...
function next(self, reality) {
  ...
  if (reality === surface) {
    if (Translator$AgdaMode.translate(sequence)[/* further */1] && reality !== "\\") {
      return /* Noop */Caml_chrome_debugger.variant("Noop", 0, [self]);
    } else {
      return /* Complete */0;
    }
    ...
    if (match !== undefined) {
      ...
      if (insertedChar === symbol) {
        if (insertedChar === "\\") {
          ...
          return /* Noop */Caml_chrome_debugger.variant("Noop", 0, [/* record */Caml_chrome_debugger.record([
                        "symbol",
                        "tail"
                      ], [
                        /* tuple */[
        ...
        return /* Rewrite */Caml_chrome_debugger.variant("Rewrite", 1, [/* record */Caml_chrome_debugger.record([
                      "symbol",
                      "tail"
                    ], [
                      /* tuple */[

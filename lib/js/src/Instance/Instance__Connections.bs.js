...
function inquireAgdaPath(error, instance) {
  ...
  var promise = Async$AgdaMode.thenOk((function (param) {
            View$AgdaMode.Handles[/* navigateSettingsView */11](/* Connection */1, instance[/* view */2]);
            var promise = View$AgdaMode.Handles[/* onInquireConnection */12](instance[/* view */2]);
            View$AgdaMode.Handles[/* inquireConnection */13](instance[/* view */2]);
            View$AgdaMode.Handles[/* updateConnection */14](undefined, error, instance[/* view */2]);
            return promise;
          }))(View$AgdaMode.Handles[/* onOpenSettingsView */10](instance[/* view */2]));
  View$AgdaMode.Handles[/* activateSettingsView */15](instance[/* view */2]);
  return promise;
}
...
function connectWithAgdaPath(instance, path) {
  ...
  return Async$AgdaMode.mapOk(Connection$AgdaMode.wire)(Async$AgdaMode.mapOk((function (param) {
                      ...
                      return connection;
                          ...
                          View$AgdaMode.Handles[/* updateConnection */14](connection, undefined, instance$1[/* view */2]);
                          return connection;
                        }))(Async$AgdaMode.thenOk((function (param) {
                              return getConnection(instance, param);
...
function disconnect(instance) {
  ...
  if (match !== undefined) {
    ...
    return View$AgdaMode.Handles[/* updateConnection */14](undefined, undefined, instance[/* view */2]);
  } else {
    return /* () */0;
  }
}

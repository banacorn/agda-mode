...
function make($staropt$star, $staropt$star$1, hidden, $staropt$star$2, $staropt$star$3, $staropt$star$4, $staropt$star$5, $staropt$star$6, $staropt$star$7, _children) {
  ...
  var onCancel = $staropt$star$4 !== undefined ? $staropt$star$4 : (function (param) {
        return /* () */0;
      });
  var onFocus = $staropt$star$5 !== undefined ? $staropt$star$5 : (function (param) {
        return /* () */0;
      });
  var onBlur = $staropt$star$6 !== undefined ? $staropt$star$6 : (function (param) {
        return /* () */0;
      });

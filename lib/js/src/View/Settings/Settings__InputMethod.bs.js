...
function Settings__InputMethod$SymbolLookup(Props) {
  ...
  var candidateSymbols = Util$AgdaMode.React.manyIn(Rebase.$$Array.map((function (symbol) {
              return React.createElement("kbd", {
                          className: "inline-block highlight"
                        }, symbol);
            }), translation.candidateSymbols), "div");
...
function Settings__InputMethod$KeySequenceLookup(Props) {
  ...
  var results = Util$AgdaMode.React.manyIn(Rebase.$$Array.map((function (sequence) {
  ...
  return React.createElement("li", {
              ...
              onMouseOver: onMouseOver
                  ...
                  className: "symbols"
                    ...
                    }, Util$AgdaMode.React.manyIn(Rebase.$$Array.map((function (symbol) {
                                return React.createElement("kbd", {
                                            className: "inline-block highlight"
                                          }, symbol);
                              }), symbols), React.Fragment)), React.createElement(MiniEditor$AgdaMode.make, {
                      value: symbolsString,
...
function Settings__InputMethod$ExtendKeymap(Props) {
  ...
  var items = Util$AgdaMode.React.manyIn2(Rebase.$$Array.map((function (param) {
              return React.createElement(Settings__InputMethod$ExtendKeymap$ExtensionItem, {
                          sequence: param[0],
                          symbols: param[1],
                          onChange: onChange
                        });
            }), Js_dict.entries(match[0])), "ul", {
        id: "extensions"
      });

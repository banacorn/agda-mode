...
const connection = redux_actions_1.handleActions({
    ...
    [actions_1.CONNECTION.CONNECT]: (state, action) => (Object.assign({}, state, { current: action.payload })),
    [actions_1.CONNECTION.DISCONNECT]: (state, action) => (Object.assign({}, state, { current: undefined })),

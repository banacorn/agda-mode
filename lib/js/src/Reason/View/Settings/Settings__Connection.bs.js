  ...
  if (typeof action === "number") {
    if (action !== 0) {
      return /* SideEffects */Block.variant("SideEffects", 1, [(function (param) {
                    return Event$AgdaMode.emitOk(/* Disconnect */0, onInquireConnection);
                  })]);
    } else {
      return /* NoUpdate */0;
    }
  ...
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                return Event$AgdaMode.destroyWhen(self[/* onUnmount */4], Event$AgdaMode.onOk((function (param) {
                                    return Curry._1(self[/* send */3], /* Inquire */Block.simpleVariant("Inquire", [
                                                  param[0],
                                                  param[1]
                                                ]));
                                  }))(inquireConnection));
                                                ...
                                                className: "input-label"
                                                    ...
                                                    onChange: (function ($$event) {
                                                        if ($$event.target.checked) {
                                                          ...
                                                          return Curry._1(self[/* send */3], /* Disconnect */1);
                                                        }
                                                      })

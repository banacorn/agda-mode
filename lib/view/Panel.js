...
var Panel = (function (_super) {
    ...
    Panel.prototype.render = function () {
        var _this = this;
        var _a = this.props, core = _a.core, onMiniEditorMount = _a.onMiniEditorMount, jumpToGoal = _a.jumpToGoal;
        ...
        return (React.createElement("section", {className: hideEverything}, 
            ...
            React.createElement("section", {className: "panel-body"}, 
                ...
                React.createElement(Body_1.default, {className: hideBody, jumpToGoal: jumpToGoal}))));
    };
    return Panel;
}(React.Component));

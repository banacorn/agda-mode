...
function make(editor, onOpen, onKill, onClose, onDidChangeActive, param) {
  ...
  var previouslyActivatedItem = atom.workspace.getActivePane().getActiveItem();
  var itemURI = "agda-mode://" + editor.getPath();
  var itemOpener = makeOpener(editor);
  subscriptions.add(atom.workspace.addOpener((function (_uri) {
              return itemOpener;
            })));
  atom.workspace.open(itemURI, itemOptions).then((function (newItem) {
          ...
          if (onOpen !== undefined) {
            Curry._3(onOpen, itemOpener.element, newItem, previouslyActivatedItem);
          }
  ...
  return /* record */Block.record([
            ...
            (function (param) {
                Curry._1(itemResource[/* acquire */0], /* () */0).then((function (item) {
                        ...
                        return Promise.resolve(atom.workspace.paneForItem(item).destroyItem(item));
                      }));
                return /* () */0;
              }),
            (function (param) {
                Curry._1(itemResource[/* acquire */0], /* () */0).then((function (item) {
                        return Promise.resolve((atom.workspace.paneForItem(item).activateItem(item), /* () */0));
                      }));
                return /* () */0;
              })
          ]);

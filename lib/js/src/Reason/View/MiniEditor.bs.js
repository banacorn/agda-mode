  ...
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                if (match !== undefined) {
                  ...
                  var disposable = new Atom.CompositeDisposable();
                  disposable.add(atom.commands.add(atom.views.getView(editor), "core:confirm", (function (_, _$1, _$2) {
                              return Curry._1(onConfirm, editor.getText());
                            })));
                  disposable.add(atom.commands.add(atom.views.getView(editor), "core:cancel", (function (_, _$1, _$2) {

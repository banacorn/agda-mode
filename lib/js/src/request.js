...
function buildRange(conn, goal) {
    ...
    if (semver.gte(conn.version.sem, '5.1.0')) {
...
exports.load = buildRequest('NonInteractive', (conn) => {
    ...
    if (semver.gte(conn.version.sem, '5.0.0'))
...
exports.computeNormalForm = (computeMode, expr, goal) => buildRequest('NonInteractive', conn => {
    if (semver.gte(conn.version.sem, '5.2.0')) {
...
exports.give = (goal) => buildRequest('NonInteractive', conn => {
    if (semver.gte(conn.version.sem, '5.3.0')) {
...
exports.auto = (goal) => buildRequest('NonInteractive', conn => {
    if (semver.gte(conn.version.sem, '6.0.0')) {

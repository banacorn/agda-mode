...
function make(onMountAtChange, body, header, mountAt, mode, query, onUpdateEditors, editors, _children) {
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",
            ...
            (function (self) {
                ...
                return React.createElement("section", undefined, React.createElement("section", {
                              ...
                              }, ReasonReact.element(undefined, undefined, Body$AgdaMode.make(body, mode !== /* Display */0, mountAtBottom, /* array */[])), ReasonReact.element(undefined, undefined, MiniEditor$AgdaMode.make(query[/* value */1], query[/* placeholder */0], mode !== /* Query */1, "agda", (function (result) {
                                          return /* () */0;
                                        }), undefined, Js_primitive.some((function () {
                                              var init = editors[/* general */1];
                                              return Curry._1(onUpdateEditors, /* record */Block.record([
                                                            "main",
                                                            "general"
                                                          ], [
                                                            editors[/* main */0],

...
function Dashboard(Props) {
  ...
  var classList = Curry._1(Util$AgdaMode.ClassName[/* serialize */2], Util$AgdaMode.ClassName[/* addWhen */1]("hidden", hidden, /* :: */Caml_chrome_debugger.simpleVariant("::", [
              "agda-header",
              /* [] */0
            ])));
  ...
  var spinnerClassList = Curry._1(Util$AgdaMode.ClassName[/* serialize */2], Util$AgdaMode.ClassName[/* addWhen */1]("pending", isPending, /* :: */Caml_chrome_debugger.simpleVariant("::", [
              "loading",
  ...
  var settingsViewClassList = Curry._1(Util$AgdaMode.ClassName[/* serialize */2], Util$AgdaMode.ClassName[/* addWhen */1]("activated", settingsOn, /* :: */Caml_chrome_debugger.simpleVariant("::", [
              "no-btn",
              /* [] */0
            ])));
  var tmp;
  tmp = mountAt.tag ? true : false;
  var toggleMountingPosition = Curry._1(Util$AgdaMode.ClassName[/* serialize */2], Util$AgdaMode.ClassName[/* addWhen */1]("activated", tmp, /* :: */Caml_chrome_debugger.simpleVariant("::", [
              "no-btn",
              /* [] */0
            ])));

...
function activate(instance) {
  return Event$AgdaMode.resolve(true, instance[/* view */1][/* activatePanel */3]);
}

function deactivate(instance) {
  return Event$AgdaMode.resolve(false, instance[/* view */1][/* activatePanel */3]);
}

function destroy(instance) {
  deactivate(instance);
  return Event$AgdaMode.resolve(/* () */0, instance[/* view */1][/* destroy */12]);
}
...
function connect(instance) {
  var inquireConnection = function (error, instance) {
    ...
    var promise = Async$AgdaMode.thenOk((function (param) {
              Event$AgdaMode.resolve(/* Connection */1, instance[/* view */1][/* navigateSettingsView */11]);
    ...
    Event$AgdaMode.resolve(true, instance[/* view */1][/* activateSettingsView */9]);
    return promise;
  };
  ...
  if (match !== undefined) {
    ...
    return Async$AgdaMode.mapOk(Connection$AgdaMode.wire)(Async$AgdaMode.mapOk((function (param) {
                        ...
                        Event$AgdaMode.resolve(connection, instance$1[/* view */1][/* updateConnection */4]);
                        return connection;
                      }))(Async$AgdaMode.thenOk((function (param) {
                            return getConnection(instance, param);
                          }))(Async$AgdaMode.thenOk((function (param) {
...
function toggleDocking(handles) {
  Event$AgdaMode.resolve(/* () */0, handles[/* toggleDocking */2]);
  return Async$AgdaMode.resolve(/* () */0);
}
    ...
    switch (command.tag | 0) {
      ...
      case 8 : 
          ...
          if (enabled) {
            switch (command[0]) {
              case 0 : 
                  Event$AgdaMode.resolve(true, instance[/* view */1][/* activatePanel */3]);
                  Event$AgdaMode.resolve(true, instance[/* view */1][/* activateInputMethod */13]);
                  break;
              case 1 : 
                  Event$AgdaMode.resolve("{", instance[/* view */1][/* interceptAndInsertKey */14]);
                  break;
              case 2 : 
                  Event$AgdaMode.resolve("[", instance[/* view */1][/* interceptAndInsertKey */14]);
                  break;

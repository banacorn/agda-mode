...
function concatItems(lines) {
    ...
    lines.forEach(function (line, i) {
        ...
        var thisLineIsNewLine = newlineRegex.test(line);
        var nextLineIsNewLine = notTheLastLine ? newlineRegex.test(lines[i + 1]) : false;
        var thisLineAndNextLineIsNewLine = newlineRegex.test(preemptLine);

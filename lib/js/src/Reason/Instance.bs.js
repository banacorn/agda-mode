  ...
  if (typeof command === "number") {
    switch (command) {
      ...
      case 10 : 
          ...
          return Async$AgdaMode.resolve(undefined);
      case 11 : 
          View$AgdaMode.toggleDocking(instance[/* view */1]);
          return Async$AgdaMode.resolve(undefined);
      case 12 : 
            ...
            return Async$AgdaMode.thenOk((function (expr) {
                            ...
                            if (pointed !== undefined) {
                              ...
                              return Async$AgdaMode.reject(/* OutOfGoal */2);
                                ...
                                return /* Cancelled */0;
                              }))(View$AgdaMode.inquire("Scope info", "name:", "", instance[/* view */1])));
          } else {
            ...
            if (match !== undefined) {
              ...
              if (Goal$AgdaMode.isEmpty(goal)) {
                return Async$AgdaMode.thenOk((function (result) {
                                ...
                                return buff(/* Give */Block.variant("Give", 2, [
                                              goal,
                                              index
                                            ]), instance);
                              }))(Async$AgdaMode.mapError((function (param) {
                                    return /* Cancelled */0;
                                  }))(View$AgdaMode.inquire("Give", "expression to give:", "", instance[/* view */1])));
              } else {
                return buff(/* Give */Block.variant("Give", 2, [
                              goal,
                              index
      ...
      case 14 : 
          ...
          if (pointed$1 !== undefined) {
            ...
            if (match$1 !== undefined) {
              return buff(/* Refine */Block.variant("Refine", 3, [
                            goal$1,
                            match$1
                          ]), instance);
            } else {
      ...
      case 15 : 
          ...
          if (pointed$2 !== undefined) {
            ...
            if (match$2 !== undefined) {
              return buff(/* Auto */Block.variant("Auto", 4, [
                            goal$2,
                            match$2
                          ]), instance);
            } else {
            ...
            if (match$3 !== undefined) {
              ...
              if (Goal$AgdaMode.isEmpty(goal$3)) {
                return Async$AgdaMode.thenOk((function (result) {
                                ...
                                return buff(/* Case */Block.variant("Case", 5, [
                                              goal$3,
                                              index$1
                                            ]), instance);
                              }))(Async$AgdaMode.mapError((function (param) {
                                    return /* Cancelled */0;
                                  }))(View$AgdaMode.inquire("Case", "expression to case:", "", instance[/* view */1])));
              } else {
                return buff(/* Case */Block.variant("Case", 5, [
                              goal$3,
                              index$1
    ...
    switch (command.tag | 0) {
      case 4 : 
          var pointed$4 = Editors$AgdaMode.pointingAt(undefined, instance[/* goals */3], instance[/* editors */0]);
          if (pointed$4 !== undefined) {
            var match$4 = pointed$4[/* index */1];
            if (match$4 !== undefined) {
              return buff(/* GoalType */Block.variant("GoalType", 6, [
                            command[0],
                            match$4
                          ]), instance);
            } else {
      ...
      case 5 : 
          var pointed$5 = Editors$AgdaMode.pointingAt(undefined, instance[/* goals */3], instance[/* editors */0]);
          if (pointed$5 !== undefined) {
            var match$5 = pointed$5[/* index */1];
            if (match$5 !== undefined) {
              return buff(/* Context */Block.variant("Context", 7, [
                            command[0],
                            match$5
                          ]), instance);
            } else {
      ...
      case 6 : 
          var pointed$6 = Editors$AgdaMode.pointingAt(undefined, instance[/* goals */3], instance[/* editors */0]);
          if (pointed$6 !== undefined) {
            var match$6 = pointed$6[/* index */1];
            if (match$6 !== undefined) {
              return buff(/* GoalTypeAndContext */Block.variant("GoalTypeAndContext", 8, [
                            command[0],
                            match$6
                          ]), instance);
            } else {
      ...
      case 7 : 
          var pointed$7 = Editors$AgdaMode.pointingAt(undefined, instance[/* goals */3], instance[/* editors */0]);
          if (pointed$7 !== undefined) {
            var goal$4 = pointed$7;
            var match$7 = goal$4[/* index */1];
            if (match$7 !== undefined) {
              return buff(/* GoalTypeAndInferredType */Block.variant("GoalTypeAndInferredType", 9, [
                            command[0],
                            goal$4,
                            match$7
                          ]), instance);

  ...
  $$Promise.getOk($$Promise.tapError(Instance__Connections$AgdaMode.connect(instance), (function (e) {
          ...
          var onResponse = function (param) {
            if (param.tag) {
              ...
              } else if (Rebase.List.isEmpty(parseErrors.contents)) {
        ...
        while(true) {
          ...
          if (param) {
            ...
            if (typeof task === "number") {
              ...
              _param = param[1];
              continue ;
            } else if (task.tag === /* DispatchCommand */7) {
  ...
  var executeTask = function (task) {
    if (typeof task === "number") {
      switch (task) {
        ...
        case /* Activate */1 :
            return $$Promise.map(Curry._1(instance.view.activate, /* () */0), (function (param) {
                          return [];
                        }));
        case /* Deactivate */2 :
            return $$Promise.map(Curry._1(instance.view.deactivate, /* () */0), (function (param) {
                          return [];
                        }));
      ...
      switch (task.tag | 0) {
        ...
        case /* Goals */5 :
            ...
            if (typeof match === "number") {
              ...
              var handler = match[1];
              return handleCallback($$Promise.map($$Promise.mapOk(Instance__TextEditors$AgdaMode.getPointedGoal(instance), match[0]), (function (others) {
                                if (others.tag) {
                                  var match = others[0];
              ...
              return handleCallback($$Promise.mapOk(Instance__TextEditors$AgdaMode.getPointedGoal(instance), match[0]));
            }
...
function dispatchCommand(command, instance) {
  ...
  return $$Promise.flatMap($$Promise.flatMap($$Promise.map($$Promise.tap($$Promise.flatMap(before(/* () */0), (function (param) {
                            ...
                            return Curry._1(instance.onDispatch.emit, /* () */0);

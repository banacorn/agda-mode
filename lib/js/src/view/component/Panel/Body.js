...
const Expr_1 = require("./EmacsMetas/Expr");
...
class Body extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("section", { className: classes, tabIndex: -1, style: style },
            metas &&
                React.createElement(view_1.default.EventContext.Consumer, null, emitter => (React.createElement(Metas, { metas: metas, emit: (ev, range) => {
                        switch (ev) {
            ...
            emacsMetas &&
                React.createElement("div", null,
                    ...
                    React.createElement("ul", { className: "list-group body-legacy" },
                    ...
                    React.createElement("ul", { className: "list-group body-legacy" },
                        emacsMetas.warnings.length > 0 &&
                            React.createElement("li", { className: "list-item special-item" }, emacsMetas.warnings.join('\n')),
                        emacsMetas.errors.length > 0 &&
                            React.createElement("li", { className: "list-item special-item" }, emacsMetas.errors.join('\n')))),
            solutions.message &&
...
const goalAndHave = ({ goal, have }) => React.createElement("ul", { className: "list-group body-legacy" },
    React.createElement("li", { className: "list-item special-item" },
        React.createElement("div", { className: "item-heading text-info" }, "Goal"),
        React.createElement("div", { className: "item-colon" },
            React.createElement("span", null, " : ")),
        React.createElement("div", { className: "item-body" },
            React.createElement(Expr_1.default, null, goal))),
    have && (React.createElement("li", { className: "list-item special-item" },
        React.createElement("div", { className: "item-heading text-info" }, "Have"),
        React.createElement("div", { className: "item-colon" },
            React.createElement("span", null, " : ")),
        React.createElement("div", { className: "item-body" },
            React.createElement(Expr_1.default, null, have)))));

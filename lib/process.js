...
var Process = (function () {
    ...
    Process.prototype.getExecutablePath = function () {
        ...
        return this.getPathFromSettings() //  1
            .catch(error_1.InvalidExecutablePathError, function () { return _this.getPathByWhich(); }) //  2
        ...
        if (this.agdaProcessWired) {
            ...
            return this.getExecutablePath()
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    agdaProcess.on("error", function (error) {
                        reject(new error_1.InvalidExecutablePathError("Failed miserably, please report this issue."));
                    });

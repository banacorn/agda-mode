...
function maybePlaceholder(decoder) {
  return (function (param) {
      return Json_decode.andThen((function (kind, json) {
                    switch (kind) {
                      case "NoPlaceholder" : 
                          return /* NoPlaceholder */Block.variant("NoPlaceholder", 1, [
                                    Json_decode.field("position", (function (param) {
                      ...
                      default:
                        return Pervasives.failwith("unknown kind of MaybePlaceholder");
                    }
                  }), (function (param) {
                    return Json_decode.field("kind", Json_decode.string, param);
                  }), param);
  ...
  return (function (param) {
      return Json_decode.andThen((function (kind, json) {
                    switch (kind) {
                      ...
                      case "OpApp" : 
                          var decoder$3 = maybePlaceholder(opApp(expr(/* () */0)));
...
function opApp(decoder) {
  return (function (param) {
      return Json_decode.andThen((function (kind, json) {
                    switch (kind) {
                      case "Ordinary" : 
                          return /* Ordinary */Block.variant("Ordinary", 1, [Json_decode.field("value", decoder, json)]);
                      case "SyntaxBindingLambda" : 
                          var partial_arg = lamBinding(/* () */0);
                          return /* SyntaxBindingLambda */Block.variant("SyntaxBindingLambda", 0, [
                                    Json_decode.field("range", range, json),
                                    Json_decode.field("bindings", (function (param) {
                                            return Json_decode.list(partial_arg, param);
                                          }), json),

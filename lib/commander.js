...
var Commander = (function () {
    ...
    Commander.prototype.activate = function (command) {
        ...
        if (this.loaded || _.includes(exception, command.kind)) {
            this.dispatchCommand(command)
                ...
                _this.core.view.set("Query cancelled", [], 2);
            })
    ...
    Commander.prototype.whyInScope = function () {
        var _this = this;
        return this.core.view.query("Scope info", [], 0, "name:")
            .then(function (expr) {
    ...
    Commander.prototype.inferType = function (normalization) {
        ...
        return this.core.textBuffer.getCurrentGoal()
            .then(function (goal) {
            if (goal.isEmpty()) {
                return _this.core.view.query("Infer type " + toDescription(normalization), [], 4, "expression to infer:")
    ...
    Commander.prototype.moduleContents = function (normalization) {
        var _this = this;
        return this.core.view.query("Module contents " + toDescription(normalization), [], 0, "module name:")
            .then(function (expr) {
            return _this.core.textBuffer.getCurrentGoal()
    ...
    Commander.prototype.computeNormalForm = function () {
        ...
        return this.core.textBuffer.getCurrentGoal()
            .then(function (goal) {
            if (goal.isEmpty()) {
                return _this.core.view.query("Compute normal form", [], 4, "expression to normalize:")
    ...
    Commander.prototype.computeNormalFormIgnoreAbstract = function () {
        ...
        return this.core.textBuffer.getCurrentGoal()
            .then(function (goal) {
            if (goal.isEmpty()) {
                return _this.core.view.query("Compute normal form (ignoring abstract)", [], 4, "expression to normalize:")
    ...
    Commander.prototype.give = function () {
        ...
        return this.core.textBuffer.getCurrentGoal()
            .then(function (goal) {
            if (goal.isEmpty()) {
                return _this.core.view.query("Give", [], 0, "expression to give:")
            ...
            .catch(error_1.OutOfGoalError, function () {
            _this.core.view.set("Out of goal", ["\"Give\" is a goal-specific command, please place the cursor in a goal"], 1);
        })
    ...
    Commander.prototype.refine = function () {
        ...
        return this.core.textBuffer.getCurrentGoal()
            ...
            .catch(error_1.OutOfGoalError, function () {
            _this.core.view.set("Out of goal", ["\"Refine\" is a goal-specific command, please place the cursor in a goal"], 1);
        })
    ...
    Commander.prototype.auto = function () {
        ...
        return this.core.textBuffer.getCurrentGoal()
            ...
            .catch(error_1.OutOfGoalError, function () {
            _this.core.view.set("Out of goal", ["\"Auto\" is a goal-specific command, please place the cursor in a goal"], 1);
        })
    ...
    Commander.prototype.case = function () {
        ...
        return this.core.textBuffer.getCurrentGoal()
            .then(function (goal) {
            if (goal.isEmpty()) {
                return _this.core.view.query("Case", [], 0, "the argument to case:")
                    .then(goal.setContent);
            }
            else {
                return goal;
            ...
            .catch(error_1.OutOfGoalError, function () {
            _this.core.view.set("Out of goal", ["\"Case\" is a goal-specific command, please place the cursor in a goal"], 1);
        })
    ...
    Commander.prototype.goalType = function (normalization) {
        ...
        return this.core.textBuffer.getCurrentGoal()
            ...
            .catch(error_1.OutOfGoalError, function () {
            _this.core.view.set("Out of goal", ["\"Goal Type\" is a goal-specific command, please place the cursor in a goal"], 1);
        })
    ...
    Commander.prototype.context = function (normalization) {
        ...
        return this.core.textBuffer.getCurrentGoal()
            ...
            .catch(error_1.OutOfGoalError, function () {
            _this.core.view.set("Out of goal", ["\"Context\" is a goal-specific command, please place the cursor in a goal"], 1);
        })
    ...
    Commander.prototype.goalTypeAndContext = function (normalization) {
        ...
        return this.core.textBuffer.getCurrentGoal()
            ...
            .catch(error_1.OutOfGoalError, function () {
            _this.core.view.set("Out of goal", ["\"Goal Type & Context\" is a goal-specific command, please place the cursor in a goal"], 1);
        })
    ...
    Commander.prototype.goalTypeAndInferredType = function (normalization) {
        ...
        return this.core.textBuffer.getCurrentGoal()
            ...
            .catch(error_1.OutOfGoalError, function () {
            _this.core.view.set("Out of goal", ["\"Goal Type & Inferred Type\" is a goal-specific command, please place the cursor in a goal"], 1);
        })

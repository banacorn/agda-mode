...
function partite(p, xs) {
  ...
  if (match !== undefined) {
    var match$1 = match === 0;
    indicesWF = match$1 ? indices : Rebase.$$Array.concat(indices, /* array */[0]);
  } else {
    var match$2 = Rebase.$$Array.length(indices) === 0;
...
function mergeWithNext(p) {
  ...
  var partial_arg$1 = Rebase.$$Array.reduce;
  return (function (param) {
      return partial_arg$1((function (acc, x) {
                    ...
                    if (last !== undefined) {
                      ...
                      if (Curry._1(p, l)) {
                        ...
                        return Rebase.$$Array.concat(/* array */[x], acc);
                      }
                    } else {
                      return /* array */[x];
                    }

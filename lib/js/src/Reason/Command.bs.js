...
function dispatch(command, connection) {
  if (typeof command === "number" && command === 0) {
    return Connection$AgdaMode.send("IOTCM \"/Users/banacorn/agda/test/A.agda\" NonInteractive Direct ( Cmd_load \"/Users/banacorn/agda/test/A.agda\" [])\n", connection);
  } else {
...
exports.names = names;
/* Connection-AgdaMode Not a pure module */

...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/2eaeb872aa33a5f90215ca02d467be7286e741a7/atom/atom.d.ts
interface Window {
	atom: AtomCore.IAtom;
...
declare namespace AtomCore {
	...
	interface IEditor {
		...
		scan():any;
		scanInBufferRange(regex: RegExp, range: TextBuffer.IRange, iterator: any):any;
		backwardsScanInBufferRange(regex: RegExp, range: TextBuffer.IRange, iterator: any):any;
		isModified():boolean;
		isEmpty():boolean;

          ...
          return /* SideEffects */Block.variant("SideEffects", 1, [(function (self) {
                        ...
                        if (match !== undefined) {
                          ...
                          var tab = Tab$AgdaMode.make(editors[/* source */1], (function (param) {
                                  ...
                                  ReactDom.render(ReasonReact.element(undefined, undefined, Settings$AgdaMode.make(handles[/* inquireConnection */5], handles[/* onInquireConnection */6], handles[/* updateConnection */4], handles[/* navigateSettingsView */11], /* array */[])), element);
                                  return Event$AgdaMode.emitOk(true, handles[/* onSettingsView */10]);
  ...
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                Event$AgdaMode.destroyWhen(self[/* onUnmount */4], Event$AgdaMode.onOk((function (param) {
                              ...
                              Curry._1(self[/* send */3], /* UpdateHeader */Block.variant("UpdateHeader", 6, [param[0]]));
                              return Curry._1(self[/* send */3], /* UpdateBody */Block.variant("UpdateBody", 7, [param[1]]));
                            }))(handles[/* display */0]));
                Event$AgdaMode.destroyWhen(self[/* onUnmount */4], Event$AgdaMode.onOk((function (param) {
                              Curry._1(self[/* send */3], /* Activate */1);
                              Curry._1(self[/* send */3], /* UpdateMode */Block.variant("UpdateMode", 8, [/* Inquire */1]));
            ...
            (function (self) {
                ...
                return React.createElement(React.Fragment, undefined, ReasonReact.element(undefined, undefined, Curry._2(Type__View$AgdaMode.MouseEmitter[/* Provider */1][/* make */0], (function (ev) {
                                      return Curry._1(self[/* send */3], /* MouseEvent */Block.variant("MouseEvent", 9, [ev]));
                                              ...
                                              }), match[/* body */1], match[/* header */0], mountAt, match[/* mode */6], hidden, handles[/* onInquireQuery */7], (function (ref) {

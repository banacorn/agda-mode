  ...
  if (remote !== undefined) {
    ...
    return Async$AgdaMode.make((function (resolve$prime, reject$prime) {
                  Event$AgdaMode.on((function (param) {
                          if (param.tag) {
                            Curry._1(reject$prime, /* ConnectionError */Block.variant("ConnectionError", 1, [/* ConnectionError */Block.variant("ConnectionError", 2, [param[0]])]));
                            return /* () */0;
                          } else {
                            var match = param[0];
                            if (match) {
                              ...
                              Curry._1(reject$prime, /* ParseError */Block.variant("ParseError", 0, [/* Response */Block.variant("Response", 0, [parseErrors[0]])]));
                              return /* () */0;
                            } else {
                              Async$AgdaMode.mapOk((function (param) {
                                        return Curry._1(resolve$prime, /* () */0);

    ...
    render() {
        ...
        return (React.createElement("section", { className: this.props.className },
            ...
            React.createElement("ol", null, this.props.state.connectionInfos.map((connInfo) => {
                return React.createElement(ConnectionItem_1.default, { key: connInfo.guid, uri: connInfo.uri, protocol: connInfo.protocol, version: connInfo.version.raw, selected: this.props.state.selected === connInfo.guid, connected: this.props.state.connected === connInfo.guid, erred: _.includes(this.props.state.erred, connInfo.guid), onSelect: () => {

...
function handleCommandError(instance) {
  return Async$AgdaMode.thenError((function (error) {
                if (typeof error === "number") {
                  ...
                  var errors = error[0];
                  var intro = String(Rebase.$$Array[/* length */16](errors)) + " parse errors, here are the original texts:\n\n";
                  var message = Rebase.$$String[/* joinWith */11]("\n\n", Rebase.List[/* fromArray */12](errors));
                  View$AgdaMode.Handles[/* display */5]("Parse Errors", /* Error */1, /* Emacs */Block.variant("Emacs", 0, [/* PlainText */Block.variant("PlainText", 7, [intro + message])]), instance[/* view */2]);
                }
...
function parseResponse(raw) {
  ...
  if (Rebase.$$Array[/* length */16](errors) > 0) {
    return Async$AgdaMode.reject(/* ParseError */Block.variant("ParseError", 0, [errors]));
  } else {
    return Async$AgdaMode.resolve(Rebase.$$Array[/* filterMap */23](Rebase.Option[/* fromResult */12], results));
  }
}
    ...
    switch (response.tag | 0) {
      ...
      case 8 : 
          ...
          return Response$AgdaMode.Info[/* handle */1](response[0], (function (x, y, z) {
                        return View$AgdaMode.Handles[/* display */5](x, y, z, instance[/* view */2]);
                      }));
      default:
        exit = 1;
    }
...
function dispatch(command, instance) {
  return Async$AgdaMode.thenOk((function (remote) {
                  if (remote !== undefined) {
                    ...
                    return Async$AgdaMode.thenOk((function (responses) {
                                  ...
                                  }))(Async$AgdaMode.thenOk(parseResponse)(Async$AgdaMode.mapError((function (err) {
                                            return /* ConnectionError */Block.variant("ConnectionError", 1, [/* Connection */Block.variant("Connection", 2, [err])]);

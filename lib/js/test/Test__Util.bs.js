...
function insertUntilSuccess(editor, text) {
  ...
  return editor.save().then((function (param) {
                ...
                if (before !== after) {
                  ...
                  return insertUntilSuccess(editor, text);
                }
              }));
}
...
function insert(key, instance) {
  ...
  return insertUntilSuccess(instance[/* editors */1][/* source */1], key).then((function (param) {
                return onChange;
              }));
}

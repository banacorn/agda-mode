...
function wire(self) {
  ...
  var onData = function (chunk) {
    ...
    Rebase.$$Array[/* forEach */8]((function (line) {
            ...
            switch (match.tag | 0) {
              case 0 : 
                  return response(/* Error */Caml_chrome_debugger.variant("Error", 0, [/* SExpression */Caml_chrome_debugger.variant("SExpression", 0, [
                                    match[0],
                                    match[1]
                                  ])]));
              case 1 : 
              ...
              case 2 : 
                  var result = match[0];
                  Metadata$AgdaMode.logSExpression(result)(self[/* metadata */0]);
                  var match$1 = Response$AgdaMode.parse(result);
                  if (match$1.tag) {
                    response(/* Error */Caml_chrome_debugger.variant("Error", 0, [match$1[0]]));
                  } else {
                    var result$1 = match$1[0];
                    Metadata$AgdaMode.logResponse(result$1)(self[/* metadata */0]);
                    response(/* Data */Caml_chrome_debugger.variant("Data", 1, [result$1]));
                  }

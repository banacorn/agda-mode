...
const config = {
    ...
    inputTriePath: {
        ...
        description: 'Path to the folder containing your custom unicode bindings and character lookup table.  Generate with bananacorn\'s [keymap tool](https://github.com/banacorn/keymap). This is a temp solution to an uncommon problem, you likely don\'t have to mess with this config.',
        type: 'string',
        default: '',
        order: 60
    },

...
function Root(Props) {
  ...
  var match$1 = Hook$AgdaMode.useState(Type__View$AgdaMode.Debug[/* initialState */0]);
  var match$2 = Hook$AgdaMode.useState(/* record */Block.record([
          "text",
          "style"
        ], [
          "",
  ...
  return React.createElement(React.Fragment, undefined, React.createElement(Type__View$AgdaMode.Mouse[/* Provider */1][/* make */0], {
                  ...
                  children: React.createElement(Type__View$AgdaMode.Debug[/* Provider */2][/* make */0], {
                        value: match$1[1],
                        children: null

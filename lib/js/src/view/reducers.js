...
const body = redux_actions_1.handleActions({
    [actions_1.BODY.UPDATE_All_GOALS_WARNINGS]: (state, action) => (Object.assign({}, state, { emacs: defaultState.body.emacs, allGoalsWarnings: action.payload, solutions: defaultState.body.solutions, error: defaultState.body.error, plainText: defaultState.body.plainText })),
    [actions_1.BODY.UPDATE_EMACS_All_GOALS_WARNINGS]: (state, action) => (Object.assign({}, state, { emacs: {
        ...
        }, allGoalsWarnings: defaultState.body.allGoalsWarnings, solutions: defaultState.body.solutions, error: defaultState.body.error, plainText: defaultState.body.plainText })),
    [actions_1.BODY.UPDATE_EMACS_GOAL_TYPE_CONTEXT]: (state, action) => (Object.assign({}, state, { emacs: {
    ...
    [actions_1.BODY.UPDATE_EMACS_CONSTRAINTS]: (state, action) => (Object.assign({}, state, { emacs: {
            allGoalsWarnings: defaultState.body.emacs.allGoalsWarnings,
            goalTypeContext: defaultState.body.emacs.goalTypeContext,
    ...
    [actions_1.BODY.UPDATE_EMACS_ERROR]: (state, action) => (Object.assign({}, state, { emacs: {
            allGoalsWarnings: defaultState.body.emacs.allGoalsWarnings,
            goalTypeContext: defaultState.body.emacs.goalTypeContext,
            constraints: defaultState.body.emacs.constraints,
    ...
    [actions_1.BODY.UPDATE_ERROR]: (state, action) => (Object.assign({}, state, { emacs: defaultState.body.emacs, allGoalsWarnings: defaultState.body.allGoalsWarnings, solutions: defaultState.body.solutions, error: action.payload[0], plainText: defaultState.body.plainText })),
    [actions_1.BODY.UPDATE_SOLUTIONS]: (state, action) => (Object.assign({}, state, { emacs: defaultState.body.emacs, allGoalsWarnings: defaultState.body.allGoalsWarnings, solutions: action.payload, error: defaultState.body.error, plainText: defaultState.body.plainText })),
    [actions_1.BODY.UPDATE_PLAIN_TEXT]: (state, action) => (Object.assign({}, state, { emacs: defaultState.body.emacs, allGoalsWarnings: defaultState.body.allGoalsWarnings, solutions: defaultState.body.solutions, error: defaultState.body.error, plainText: action.payload })),

...
var Editor$AgdaMode = require("./View/Editor.bs.js");
  ...
  if (typeof action === "number") {
    if (action === 0) {
      ...
      return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                ...
                (function (self) {
                    return Editor$AgdaMode.Focus[/* onQuery */2](self[/* state */1][/* editor */3]);
                  })
              ]);
    } else {
      var init$1 = state[/* editor */3];
      return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                /* record */Block.record([
                    "header",
                    "body",
                ...
                (function (self) {
                    return Editor$AgdaMode.Focus[/* onSource */1](self[/* state */1][/* editor */3]);
                  })
              ]);
    }
  } else {
    switch (action.tag | 0) {
      case 0 : 
          var init$2 = state[/* editor */3];
          var init$3 = state[/* editor */3][/* query */2];
      ...
      case 1 : 
          var init$4 = state[/* editor */3];
          var init$5 = state[/* editor */3][/* query */2];
          return /* UpdateWithSideEffects */Block.variant("UpdateWithSideEffects", 2, [
                    /* record */Block.record([
                        "header",
                        "body",
      ...
      case 2 : 
          ...
          return /* SideEffects */Block.variant("SideEffects", 1, [(function (self) {
                        return mountPanel(self, state[/* editor */3][/* source */1], mountTo);
                      })]);
      case 3 : 
          return /* Update */Block.variant("Update", 0, [/* record */Block.record([
                        "header",
  ...
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                return Curry._1(queryGeneral, (function (placeholder, value) {
                              ...
                              Curry._2(self[/* handle */0], (function (param, newSelf) {
                                      Editor$AgdaMode.Query[/* inquire */0](newSelf[/* state */1][/* editor */3]).then((function (answer) {
            ...
            (function (self) {
                ...
                return React.createElement(React.Fragment, undefined, ReasonReact.element(undefined, undefined, Panel$AgdaMode.make(editor, element, (function (mountTo) {
                                    ...
                                    }), editor[/* query */2][/* placeholder */1], editor[/* query */2][/* value */0], (function (handle) {

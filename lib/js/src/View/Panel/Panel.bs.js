                ...
                return ReactDom.createPortal(React.createElement("section", {
                                className: className
                                    ...
                                    className: "panel-heading agda-header-container"
                                            ...
                                            }), isActive, /* array */[])), ReasonReact.element(undefined, undefined, Dashboard$AgdaMode.make(header, match[/* inputMethodActivated */1], isPending, mountAt, settingsView, onMountAtChange, onSettingsViewToggle, /* array */[]))), React.createElement("section", tmp, ReasonReact.element(undefined, undefined, Body$AgdaMode.make(body, mode !== /* Display */0, /* array */[])), ReasonReact.element(undefined, undefined, MiniEditor$AgdaMode.make(editorValue, editorPlaceholder, mode !== /* Inquire */1, "agda", (function (result) {

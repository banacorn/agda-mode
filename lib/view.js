...
var View = (function () {
    function View(core) {
        ...
        atom.workspace.addOpener(function (uriToOpen) {
            var _a = uriToOpen.split('://'), protocol = _a[0], path = _a[1];
    ...
    View.prototype.createEditor = function (path) {
        ...
        editor['getURI'] = function () { return _this.uri(); };
        ...
        if (this.state().mounted) {
            ...
            switch (this.state().mountAt.previous) {
                ...
                case 0 /* Pane */:
                    ...
                    if (pane) {
                        var editor = pane.itemForURI(this.uri());
    ...
    View.prototype.activate = function () {
        if (this.state().mountAt.current === 1 /* Bottom */) {

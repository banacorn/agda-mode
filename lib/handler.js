    ...
    switch (action.infoActionType) {
        case 0 /* AllGoals */:
            if (action.content.length === 0)
                ...
                core.view.setContent("Goals", action.content, 3 /* Judgement */);
            break;
        case 1 /* Error */:
            core.view.setContent("Error", action.content, 1 /* Error */);
            break;
        case 2 /* TypeChecking */:
            core.view.setContent("Type Checking", action.content);
            break;
        case 3 /* CurrentGoal */:
            core.view.setContent("Current Goal", action.content, 4 /* Value */);
            break;
        case 4 /* InferredType */:
        ...
        case 5 /* ModuleContents */:
            ...
            break;
        case 6 /* Context */:
            core.view.setContent("Context", action.content, 3 /* Judgement */);
            break;
        case 7 /* GoalTypeEtc */:
            core.view.setContent("Goal Type and Context", action.content, 3 /* Judgement */);
            break;
        case 8 /* NormalForm */:
            core.view.setContent("Normal Form", action.content, 4 /* Value */);
            break;
        case 9 /* Intro */:
        ...
        case 10 /* Auto */:
            ...
            break;
        case 11 /* Constraints */:
            core.view.setContent("Constraints", action.content, 3 /* Judgement */);
            break;
        case 12 /* ScopeInfo */:

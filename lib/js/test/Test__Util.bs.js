...
function wordsWithSpace(a, b) {
  return Rebase.$$Array.map(fromChangeObject, Diff.diffWordsWithSpace(a, b));
}
...
function firstChange(diffs) {
  ...
  Rebase.$$Array.forEach((function (diff) {
          if (Rebase.$$Option.isNone(change.contents)) {
            switch (diff.tag | 0) {
              case /* Added */0 :
              ...
              case /* Removed */1 :
                  ...
                  return /* () */0;
              case /* NoChange */2 :
                  count.contents = count.contents + Rebase.$$String.length(diff[0]) | 0;
                  return /* () */0;
  ...
  return Rebase.$$Option.map((function (change) {
                return /* tuple */[
                        change,
                        count.contents
                      ];
...
function compare(param) {
  ...
  Rebase.$$Option.forEach((function (param) {
          ...
          var diff = param[0];
          var value = diff[0];
          var change = Rebase.$$String.length(value) > 100 ? Rebase.$$String.sub(0, 100, value) + " ..." : value;
          var expected$prime = Rebase.$$String.sub(Caml_primitive.caml_int_max(0, count - 50 | 0), (50 + Rebase.$$String.length(value) | 0) + 50 | 0, expected);
          var actual$prime = Rebase.$$String.sub(Caml_primitive.caml_int_max(0, count - 50 | 0), (50 + Rebase.$$String.length(value) | 0) + 50 | 0, actual);
        ...
        }), firstChange(wordsWithSpace(actual, expected)));

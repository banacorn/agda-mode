...
var Webapi__Dom__HtmlElement = require("bs-webapi/lib/js/src/Webapi/Dom/Webapi__Dom__HtmlElement.js");
...
function createForBottom(param) {
  ...
  var containers = Rebase.$$Array.filter((function (elem) {
        ...
        }), Rebase.$$Array.flatMap(Curry._2(Rebase.Fn.$great$great, Curry._2(Rebase.Fn.$great$great, (function (prim) {
  ...
  var container = Rebase.$$Array.get(containers, 0);
  if (container !== undefined) {
    return {
            TAG: 0,
            _0: Caml_option.valFromOption(container),
            [Symbol.for("name")]: "Bottom"
          };
  } else {
    return {
            TAG: 0,
            _0: createBottomPanelContainer(undefined),
            [Symbol.for("name")]: "Bottom"
          };
  }
}

function fromMountingPoint(element) {
  if (element.TAG) {
    return Tab$AgdaMode.getElement(element._0);
  } else {
    return element._0;
  }
}
...
var PanelContainer = {
  createForBottom: createForBottom,
  fromMountingPoint: fromMountingPoint
};
...
function Panel(Props) {
  ...
  Hook$AgdaMode.useChannel((function (param) {
          ...
          Editors$AgdaMode.Focus.on(/* Query */1, editors);
          Curry._1(setHeader, param[0]);
          Curry._1(setEditorPlaceholder, param[1]);
          Curry._1(setEditorValue, param[2]);
          return $$Promise.tapOk(Curry._1(onInquireQuery.once, undefined), (function (param) {
                        Curry._1(setMode, /* Display */0);
                        return Editors$AgdaMode.Focus.on(/* Source */0, editors);
                      }));
        }), channels.inquire);
  ...
  Hook$AgdaMode.useChannel(Curry._2(Rebase.Fn.$great$great, match$7[1], $$Promise.resolved), channels.updateIsPending);
  React.useEffect((function () {
          return Curry._1(onInputMethodChange.on, (function (state) {
                        return Curry._1(setInputMethodActivation, state.activated);
                      }));
        }), []);
  var match$8 = Hook$AgdaMode.useState(createForBottom(undefined));
  ...
  var mountPanel = function (editors$1, mountingTarget) {
    var createTab = function (param) {
      return Tab$AgdaMode.make(editors$1.source, (function (param) {
                    return "[Agda Mode] " + editors$1.source.getTitle();
    ...
    if (match.TAG) {
      if (mountingTarget) {
        ...
        Tab$AgdaMode.kill(match._0);
        return Curry._1(setMountingPoint, createForBottom(undefined));
      }
    } else if (mountingTarget) {
      return Curry._1(setMountingPoint, {
                  TAG: 1,
                  _0: createTab(undefined),
                  [Symbol.for("name")]: "Pane"
                });
    } else {
      return ;
    }
  ...
  React.useEffect((function () {
          if (activated && mountingPoint.TAG) {
            Tab$AgdaMode.activate(mountingPoint._0);
          }
          
        }), [activated]);
  Hook$AgdaMode.useChannel((function (param) {
          Curry._1(setActivation, true);
          fromMountingPoint(mountingPointRef.current);
          return $$Promise.resolved(undefined);
  ...
  Hook$AgdaMode.useChannel((function (param) {
          ...
          if (mountingPoint.TAG) {
            Tab$AgdaMode.kill(mountingPoint._0);
          } else {
            var panel = panelRef.current;
            if (!(panel == null)) {
              mountingPoint._0.removeChild(panel);
            }
  ...
  return ReactDom.createPortal(React.createElement("section", {
                  ref: panelRef,
                  className: "agda-mode-panel" + Util$AgdaMode.React.showWhen(!hidden),
                  id: id
                      ...
                      className: "panel-heading agda-header-container"
                          ...
                          onConfirm: (function (result) {
                              return Curry._1(onInquireQuery.emit, {
                                          TAG: 0,
                                          _0: result,
                                          [Symbol.for("name")]: "Ok"
                                        });

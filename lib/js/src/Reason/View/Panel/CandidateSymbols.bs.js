...
function make(candidateSymbols, updateTranslation, chooseSymbol, _) {
            ...
            (function (self) {
                ...
                if (match !== undefined) {
                  var keys = Rebase.$$Array[/* mapi */27]((function (key, i) {
                          ...
                          var className = Util$AgdaMode.toClassName(Util$AgdaMode.addClass("selected", isSelected, /* :: */Block.simpleVariant("::", [
                                      "btn",
                                      /* [] */0
                                    ])));

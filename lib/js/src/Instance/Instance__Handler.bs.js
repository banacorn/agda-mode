...
function handleResponse(instance, response) {
  ...
  var filePath = Parser$AgdaMode.filepath(Rebase.$$Option[/* getOr */16]("untitled", textEditor.getPath()));
    ...
    return Async$AgdaMode.mapError((function (param) {
                    return /* Cancelled */0;
                        ...
                        return /* record */Caml_chrome_debugger.record([
                                  ...
                                  Parser$AgdaMode.filepath(Rebase.$$Option[/* getOr */16]("untitled", instance[/* editors */1][/* source */1].getPath())),
                                  command
                                ]);
          ...
          if (match.tag) {
            ...
            if (range) {
              ...
              if (match$2 !== undefined) {
                ...
                match$1 = /* tuple */[
                  true,
                  Rebase.$$Option[/* flatMap */5]((function (filePath) {
                          var match = path === filePath;
                          if (match) {
                            return undefined;
                          } else {
                            return path;
            ...
            if (match$1[0]) {
              if (otherFilePath !== undefined) {
                var match$3;
                if (range) {
                  var match$4 = Rebase.$$Array[/* get */17](range[1], 0);
...
function handleRemoteCommand(instance, handler, remote) {
  if (remote !== undefined) {
    ...
    Async$AgdaMode.mapOk((function (connection) {
              ...
              return Metadata$AgdaMode.createEntry(cmd[/* command */2], connection[/* metadata */0]);
            }))(Instance__Connections$AgdaMode.get(instance));

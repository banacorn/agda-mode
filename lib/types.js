...
(function (View) {
    ...
    (function (ErrorType) {
        ...
        ErrorType[ErrorType["WrongConstructor"] = 2] = "WrongConstructor";
        ErrorType[ErrorType["ApplicationParseError"] = 3] = "ApplicationParseError";
        ErrorType[ErrorType["TerminationError"] = 4] = "TerminationError";
        ErrorType[ErrorType["MissingDefinition"] = 5] = "MissingDefinition";
        ErrorType[ErrorType["MultipleDefinition"] = 6] = "MultipleDefinition";
        ErrorType[ErrorType["RHSOmitted"] = 7] = "RHSOmitted";
        ErrorType[ErrorType["ParseError"] = 8] = "ParseError";
        ErrorType[ErrorType["Unknown"] = 9] = "Unknown";

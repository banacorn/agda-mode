...
function Settings__Log$Entry(Props) {
  ...
  var rawTexts = Util$AgdaMode.React.manyIn("ol")(Rebase.$$Array.map((function (text) {
              return React.createElement("li", undefined, text);
            }), entry.response.rawText));
  var sexpressions = Util$AgdaMode.React.manyIn("ol")(Rebase.$$Array.map((function (text) {
              return React.createElement("li", undefined, Curry._1(Parser$AgdaMode.SExpression.toString, text));
            }), entry.response.sexpression));
  var responses = Util$AgdaMode.React.manyIn("ol")(Rebase.$$Array.map((function (text) {
  ...
  var errors = Util$AgdaMode.React.manyIn("ol")(Rebase.$$Array.map((function (text) {
...
function Settings__Log(Props) {
  ...
  var entries = Util$AgdaMode.React.manyIn("ol")(Rebase.$$Array.map((function (entry) {

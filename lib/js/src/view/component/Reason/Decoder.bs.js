                    ...
                    switch (kind) {
                      ...
                      case "RecUpdate" : 
                          ...
                          var partial_arg$10 = function (param) {
                            return fieldAssignment(partial_arg$9, param);
                          };
                    ...
                    switch (kind) {
                      ...
                      case "RecP" : 
                          return /* RecP */Block.variant("RecP", 13, [
                                    ...
                                    Json_decode.field("assignments", (function (param) {
                                            return Json_decode.list((function (param) {
                                                          return fieldAssignmentPattern(/* () */0, param);
                                                        }), param);
                                          }), json)
                                  ]);
                      case "WildP" : 
...
function fieldAssignment(decoder, json) {
  return /* record */Block.record([
            "name",
            "value"
          ], [
...
function fieldAssignmentPattern(_, json) {
  return /* record */Block.record([
            "name",
            "value"
          ], [
  ...
  return (function (param) {
      return Json_decode.andThen((function (kind, json) {
                    switch (kind) {
                      ...
                      case "DomainFull" : 
                          return /* DomainFull */Block.variant("DomainFull", 1, [Json_decode.field("value", (function (param) {
                                            return typedBindings(/* () */0, param);
                                          }), json)]);
                      default:
...
function recordAssignment() {
  return Json_decode.either((function (json) {
                var partial_arg = expr(/* () */0);
                return /* Left */Block.variant("Left", 0, [Json_decode.field("Left", (function (param) {
                                  return fieldAssignment(partial_arg, param);
                                }), json)]);
              }), (function (json) {

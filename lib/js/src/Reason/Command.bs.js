  ...
  if (typeof command === "number") {
    ...
    switch (command.tag | 0) {
      ...
      case 3 : 
          ...
          var content$3 = Goal$AgdaMode.getContent(goal$3);
          var range$3 = buildRange(goal$3);
          return commonPart(/* NonInteractive */1) + ("( Cmd_make_case " + (String(command[1]) + (" " + (String(range$3) + (" \"" + (String(content$3) + "\" )"))))));
      case 4 : 
      ...
      case 7 : 
          var content$4 = Goal$AgdaMode.getContent(command[1]);
          var normalization$prime$3 = of_string(command[0]);
          return commonPart(/* NonInteractive */1) + ("( Cmd_goal_type_context_infer " + (String(normalization$prime$3) + (" " + (String(command[2]) + (" noRange \"" + (String(content$4) + "\" )"))))));

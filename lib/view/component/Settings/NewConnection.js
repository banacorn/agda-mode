            ...
            React.createElement("section", null,
                React.createElement("form", { id: "new-connection-dashboard" },
                    ...
                    React.createElement("label", { htmlFor: "local-connection" },
                        ...
                        React.createElement("button", { className: "btn icon btn-primary icon-plus inline-block-tight", disabled: disableLocal, onClick: () => {
                        ...
                        React.createElement("button", { className: "btn icon btn-warning icon-search inline-block-tight", disabled: disableLocal, onClick: () => {
                                Conn.autoSearch()
                                    .then(uri => {
                                    this.setState({
                                        localURL: uri

...
var TextBuffer = (function () {
    ...
    TextBuffer.prototype.warnOutOfGoal = function () {
        this.core.view.setContent("Out of goal", ["For this command, please place the cursor in a goal"], 2 /* Warning */);
    };
    TextBuffer.prototype.warnEmptyGoal = function (error) {
        this.core.view.setContent("No content", [error.message], 2 /* Warning */);
    };
    ...
    TextBuffer.prototype.nextGoal = function () {
        ...
        return Promise.resolve({ type: 9 /* NextGoal */ });
    };
    TextBuffer.prototype.previousGoal = function () {
        ...
        return Promise.resolve({ type: 10 /* PreviousGoal */ });
    };

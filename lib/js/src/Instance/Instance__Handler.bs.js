...
function handleCommandError(instance) {
  return Async$AgdaMode.thenError((function (error) {
                if (typeof error === "number") {
                  switch (error) {
                    case 0 : 
                        Curry._3(instance[/* view */2][/* display */6], "Query Cancelled", /* Error */1, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [""])]));
                        break;
                    case 1 : 
                        Curry._3(instance[/* view */2][/* display */6], "Goal not indexed", /* Error */1, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, ["Please reload to re-index the goal"])]));
                        break;
                    case 2 : 
                        Curry._3(instance[/* view */2][/* display */6], "Out of goal", /* Error */1, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, ["Please place the cursor in a goal"])]));
                        break;
                    
                  }
                } else if (error.tag) {
                  var match = Connection$AgdaMode.$$Error[/* toString */0](error[0]);
                  Curry._3(instance[/* view */2][/* display */6], "Connection-related Error: " + match[0], /* Error */1, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [match[1]])]));
                } else {
                  var errors = error[0];
                  Rebase.$$Option[/* forEach */8]((function (conn) {
                          Rebase.$$Array[/* forEach */8]((function (e) {
                                  return Metadata$AgdaMode.logError(e)(conn[/* metadata */0]);
                                }), errors);
                          return Curry._3(instance[/* view */2][/* display */6], "Parse Error", /* Error */1, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* ParseError */Caml_chrome_debugger.variant("ParseError", 7, [conn[/* metadata */0]])]));
  ...
  if (typeof response === "number") {
    switch (response) {
      ...
      case 2 : 
          ...
          return Async$AgdaMode.resolve(/* () */0);
      case 3 : 
          Curry._3(instance[/* view */2][/* display */6], "Status", /* Warning */4, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, ["Done aborting"])]));
          return Async$AgdaMode.resolve(/* () */0);
    ...
    switch (response.tag | 0) {
      ...
      case 2 : 
          ...
          if (displayImplicit || checked) {
            Curry._3(instance[/* view */2][/* display */6], "Status", /* PlainText */0, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, ["Typechecked: " + (Pervasives.string_of_bool(checked) + ("\nDisplay implicit arguments: " + Pervasives.string_of_bool(displayImplicit)))])]));
          }
          return Async$AgdaMode.resolve(/* () */0);
      case 3 : 
      ...
      case 7 : 
          ...
          return Async$AgdaMode.thenOk((function (param) {
                          ...
                          if (size === 0) {
                            Curry._3(instance[/* view */2][/* display */6], "No solutions found", /* PlainText */0, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [""])]));
                          } else {
                            Curry._3(instance[/* view */2][/* display */6], String(size) + " goals solved", /* Success */3, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [""])]));
                          }
                          return Async$AgdaMode.resolve(/* () */0);
      ...
      case 8 : 
          ...
          Curry._3(instance[/* view */2][/* display */6], match$1[0], match$1[1], match$1[2]);
          return Async$AgdaMode.resolve(/* () */0);
      case 9 : 
          ...
          if (response[0] >= 2) {
            ...
            Curry._3(instance[/* view */2][/* display */6], "Type-checking", /* PlainText */0, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [message])]));
          }
          return Async$AgdaMode.resolve(/* () */0);
...
function handleResponseAndRecoverCursor(instance, response) {
  return Async$AgdaMode.mapOk((function (param) {
                  return /* () */0;
                }))(Instance__TextEditors$AgdaMode.updateCursorPosition((function (param) {
  ...
  var buff = function (command, instance) {
    return Async$AgdaMode.mapError((function (param) {
                    return /* Cancelled */0;
                        ...
                        Curry._3(instance[/* view */2][/* display */6], "Loading ...", /* PlainText */0, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [""])]));
    ...
    switch (command) {
      case 0 : 
          return Async$AgdaMode.thenOk((function (param) {
                          ...
                          Curry._3(instance[/* view */2][/* display */6], "Connecting ...", /* PlainText */0, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [""])]));
      ...
      case 10 : 
          ...
          return Async$AgdaMode.resolve(undefined);
      case 11 : 
          Curry._1(instance[/* view */2][/* toggleDocking */19], /* () */0);
          return Async$AgdaMode.resolve(undefined);
      case 12 : 
          ...
          if (Rebase.$$String[/* isEmpty */5](selectedText)) {
            return Async$AgdaMode.thenOk((function (expr) {
                            return Async$AgdaMode.thenOk((function (param) {
                                ...
                                return /* Cancelled */0;
                              }))(Curry._3(instance[/* view */2][/* inquire */7], "Scope info", "name:", "")));
          } else {
                          ...
                          if (Goal$AgdaMode.isEmpty(goal)) {
                            return Async$AgdaMode.thenOk((function (result) {
                                            ...
                                            return buff(/* Give */Caml_chrome_debugger.variant("Give", 9, [
                                                ...
                                                return /* Cancelled */0;
                                              }))(Curry._3(instance[/* view */2][/* inquire */7], "Give", "expression to give:", "")));
                          } else {
                            return buff(/* Give */Caml_chrome_debugger.variant("Give", 9, [
                                          goal,
                                          index
                          ...
                          if (Goal$AgdaMode.isEmpty(goal)) {
                            return Async$AgdaMode.thenOk((function (result) {
                                            ...
                                            return buff(/* Case */Caml_chrome_debugger.variant("Case", 12, [
                                                ...
                                                return /* Cancelled */0;
                                              }))(Curry._3(instance[/* view */2][/* inquire */7], "Case", "expression to case:", "")));
                          } else {
                            return buff(/* Case */Caml_chrome_debugger.variant("Case", 12, [
                                          goal,
                                          index
      ...
      case 17 : 
          ...
          var getSymbol = Rebase.$$String[/* isEmpty */5](Rebase.$$String[/* trim */8](selected)) ? (Curry._1(instance[/* view */2][/* updateShouldDisplay */4], true), Curry._1(instance[/* view */2][/* activate */0], /* () */0), Curry._3(instance[/* view */2][/* inquire */7], "Lookup Unicode Symbol Input Sequence", "symbol to lookup:", "")) : Async$AgdaMode.resolve(selected);
          Async$AgdaMode.finalOk((function (symbol) {
                  return Rebase.$$Option[/* forEach */8]((function (sequences) {
                                return Curry._3(instance[/* view */2][/* display */6], "Input sequence for " + symbol, /* PlainText */0, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [Rebase.$$String[/* joinWith */11]("\n", Rebase.List[/* fromArray */12](sequences))])]));
    ...
    switch (command.tag | 0) {
      case 0 : 
          ...
          return Async$AgdaMode.thenOk((function (expr) {
                          return buff(/* SearchAbout */Caml_chrome_debugger.variant("SearchAbout", 2, [
                              ...
                              return /* Cancelled */0;
                            }))(Curry._3(instance[/* view */2][/* inquire */7], "Searching through definitions [" + (Command$AgdaMode.Normalization[/* toString */0](normalization) + "]"), "expression to infer:", "")));
      case 1 : 
          ...
          return Instance__TextEditors$AgdaMode.handleOutOfGoal((function (param) {
                          return Async$AgdaMode.thenOk((function (expr) {
                                          return buff(/* InferTypeGlobal */Caml_chrome_debugger.variant("InferTypeGlobal", 4, [
                                              ...
                                              return /* Cancelled */0;
                                            }))(Curry._3(instance[/* view */2][/* inquire */7], "Infer type [" + (Command$AgdaMode.Normalization[/* toString */0](normalization$1) + "]"), "expression to infer:", "")));
                        }))(Async$AgdaMode.thenOk((function (param) {
                              var index = param[1];
                              var goal = param[0];
                              if (Goal$AgdaMode.isEmpty(goal)) {
      ...
      case 2 : 
          ...
          return Async$AgdaMode.thenOk((function (expr) {
                          return Instance__TextEditors$AgdaMode.handleOutOfGoal((function (param) {
                              ...
                              return /* Cancelled */0;
                            }))(Curry._3(instance[/* view */2][/* inquire */7], "Module contents [" + (Command$AgdaMode.Normalization[/* toString */0](normalization$2) + "]"), "module name:", "")));
      case 3 : 
          ...
          return Instance__TextEditors$AgdaMode.handleOutOfGoal((function (param) {
                          return Async$AgdaMode.thenOk((function (expr) {
                                          return buff(/* ComputeNormalFormGlobal */Caml_chrome_debugger.variant("ComputeNormalFormGlobal", 8, [
                                              ...
                                              return /* Cancelled */0;
                                            }))(Curry._3(instance[/* view */2][/* inquire */7], "Compute normal form", "expression to normalize:", "")));
                        }))(Async$AgdaMode.thenOk((function (param) {
                              var index = param[1];
                              var goal = param[0];
                              if (Goal$AgdaMode.isEmpty(goal)) {
      ...
      case 8 : 
          ...
          if (enabled) {
            ...
            switch (command[0]) {
              case 0 : 
                  console.log("[HAN] trigger 1");
                  return Async$AgdaMode.thenOk((function (param) {
                                  console.log("[HAN] trigger 2");
                                  Curry._1(instance[/* view */2][/* activateInputMethod */10], true);
                                  return Async$AgdaMode.resolve(undefined);
                                }))(Async$AgdaMode.mapError((function (param) {
                                      return /* Cancelled */0;
                                    }))(Curry._1(instance[/* view */2][/* activate */0], /* () */0)));
              case 1 : 
                  Curry._1(instance[/* view */2][/* interceptAndInsertKey */12], "{");
                  return Async$AgdaMode.resolve(undefined);
              case 2 : 
                  Curry._1(instance[/* view */2][/* interceptAndInsertKey */12], "[");
                  return Async$AgdaMode.resolve(undefined);
              ...
              case 6 : 
                  ...
                  return Async$AgdaMode.resolve(undefined);
              case 7 : 
                  Curry._1(instance[/* view */2][/* activateInputMethod */10], false);
                  return Async$AgdaMode.resolve(undefined);
...
function handleRemoteCommand(instance, handler, remote) {
  if (remote !== undefined) {
    var cmd = remote;
    Async$AgdaMode.mapOk((function (connection) {
              if (Command$AgdaMode.Remote[/* isLoad */1](cmd) && connection[/* resetLogOnLoad */5]) {
                Connection$AgdaMode.resetLog(connection);
              }
              return Metadata$AgdaMode.createLogEntry(cmd[/* command */2], connection[/* metadata */0]);
            }))(Instance__Connections$AgdaMode.get(instance));
    var handleResults = /* record */Caml_chrome_debugger.record(["contents"], [[]]);
    var parseErrors = /* record */Caml_chrome_debugger.record(["contents"], [[]]);
    var inputForAgda = Command$AgdaMode.Remote[/* toAgdaReadableString */0](cmd);
    return Async$AgdaMode.make((function (resolve$prime, reject$prime) {
                  Async$AgdaMode.mapOk((function (connection) {
                            Event$AgdaMode.on((function (param) {
                                    ...
                                    var param$1 = param;
                                    if (param$1.tag) {
                                      Curry._1(reject$prime$1, /* ConnectionError */Caml_chrome_debugger.variant("ConnectionError", 1, [/* ConnectionError */Caml_chrome_debugger.variant("ConnectionError", 2, [param$1[0]])]));
                                      return /* () */0;
                                    } else {
                                      var match = param$1[0];
                                      if (match) {
                                        var match$1 = match[0];
                                        if (match$1.tag) {
                                          parseErrors[0] = Rebase.$$Array[/* concat */11](/* array */[match$1[0]], parseErrors[0]);
                                          return /* () */0;
                                        } else {
                                      ...
                                      } else if (Rebase.$$Array[/* length */16](parseErrors[0]) > 0) {
                                        Curry._1(reject$prime$1, /* ParseError */Caml_chrome_debugger.variant("ParseError", 0, [parseErrors[0]]));
                                        return /* () */0;
                                      } else {
                                        Async$AgdaMode.thenOk((function (results) {
                                                  return Async$AgdaMode.resolve(Curry._1(resolve$prime$1, results));
                                                }))(Async$AgdaMode.all(handleResults[0]));
                                        return /* () */0;
                                      }
                                    }
                                  }), Connection$AgdaMode.send(inputForAgda, connection));
                            return /* () */0;
                          }))(Instance__Connections$AgdaMode.get(instance));
                  return /* () */0;
                }));

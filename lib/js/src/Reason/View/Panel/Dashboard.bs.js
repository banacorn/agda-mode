...
function setSettingsButtonRef(r, param) {
  param[/* state */1][/* settingsButtonRef */0][0] = (r == null) ? undefined : Js_primitive.some(r);
  return /* () */0;
}

function setDockingButtonRef(r, param) {
  param[/* state */1][/* dockingButtonRef */1][0] = (r == null) ? undefined : Js_primitive.some(r);
  return /* () */0;
}
  ...
  return /* record */Block.record([
            ...
            (function (self) {
                ...
                if (match !== undefined) {
                  ...
                  disposables.add(atom.tooltips.add(atom.views.getView(Js_primitive.valFromOption(match)), {
                            title: "settings",
                            delay: {
                              show: 100,
                              hide: 1000
                ...
                if (match$1 !== undefined) {
                  ...
                  disposables$1.add(atom.tooltips.add(atom.views.getView(Js_primitive.valFromOption(match$1)), {

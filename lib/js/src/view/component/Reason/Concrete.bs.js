...
function levelToString() {
  return (n.toString().split('').map(x => String.fromCharCode(0x2080 + parseInt(x))).join(
      ''));
}
  ...
  return /* record */Block.record([
            ...
            (function () {
                switch (value.tag | 0) {
                  ...
                  case 8 : 
                      return CommonPrim$AgdaMode.braces(/* array */[ReasonReact.element(undefined, undefined, CommonPrim$AgdaMode.Named[/* make */4](undefined, value[1], (function (_, value) {
                                              return ReasonReact.element(undefined, undefined, makeExpr(value, /* array */[]));
                                            })))]);
                  case 9 : 
                      return CommonPrim$AgdaMode.dbraces(/* array */[ReasonReact.element(undefined, undefined, CommonPrim$AgdaMode.Named[/* make */4](undefined, value[1], (function (_, value) {
                                              return ReasonReact.element(undefined, undefined, makeExpr(value, /* array */[]));
                                            })))]);
                  case 10 : 
                      var expr = value[2];
                      if (expr.tag === 11) {
                        return React.createElement("span", undefined, "λ", ReasonReact.element(undefined, undefined, CommonPrim$AgdaMode.Hiding[/* make */1](expr[1], undefined, undefined, /* array */[])));
                      } else {
                        return React.createElement("span", undefined, "unimplemented");
                      }
                  case 15 : 
                  ...
                  case 17 : 
                      return ReasonReact.element(undefined, undefined, Link$AgdaMode.make(value[0], true, true, /* array */["Set" + levelToString(value[1])]));
                  case 18 : 
                      return ReasonReact.element(undefined, undefined, Link$AgdaMode.make(value[0], true, true, /* array */["Prop" + levelToString(value[1])]));
                  default:
                    return React.createElement("span", undefined, "unimplemented");
                }
              }),

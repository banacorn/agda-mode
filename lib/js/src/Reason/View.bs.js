    ...
    switch (action.tag | 0) {
      ...
      case 2 : 
          ...
          return /* SideEffects */Block.variant("SideEffects", 1, [(function (self) {
                        ...
                        if (match !== undefined) {
                          if (open_) {
                            return Event$AgdaMode.resolve(true, handles[/* onSettingsView */11]);
                          } else {
                            Curry._1(match[/* kill */1], /* () */0);
                            Curry._1(self[/* send */3], /* UpdateSettingsView */Block.variant("UpdateSettingsView", 3, [undefined]));
                            return Event$AgdaMode.resolve(false, handles[/* onSettingsView */11]);
                          }
                        } else if (open_) {
...
function inquire(placeholder, value, handles) {
  Event$AgdaMode.resolve(true, handles[/* activatePanel */4]);

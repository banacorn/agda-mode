...
(function (View) {
    ...
    (function (ErrorType) {
        ...
        ErrorType[ErrorType["RHSOmitted"] = 2] = "RHSOmitted";
        ErrorType[ErrorType["MissingType"] = 3] = "MissingType";
        ErrorType[ErrorType["MultipleDefinition"] = 4] = "MultipleDefinition";
        ErrorType[ErrorType["MissingDefinition"] = 5] = "MissingDefinition";
        ErrorType[ErrorType["Termination"] = 6] = "Termination";
        ErrorType[ErrorType["ConstructorTarget"] = 7] = "ConstructorTarget";
        ErrorType[ErrorType["FunctionType"] = 8] = "FunctionType";
        ErrorType[ErrorType["Unparsed"] = 9] = "Unparsed";

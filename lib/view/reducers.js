...
const body = redux_actions_1.handleActions({
    ...
    [actions_1.BODY.UPDATE_ERROR]: (state, action) => (Object.assign({}, state, { body: defaultState.body.body, error: action.payload, plainText: defaultState.body.plainText })),
    [actions_1.BODY.UPDATE_PLAIN_TEXT]: (state, action) => (Object.assign({}, state, { body: defaultState.body.body, error: null, plainText: action.payload })),

...
function parseWarning(json) {
  return /* OverlappingTokensWarning */Block.simpleVariant("OverlappingTokensWarning", [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
}
...
function renaming_(decoderA, decoderB, json) {
  return /* record */Block.record([
            ...
            Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)
          ]);
}
...
function declarationWarning(param) {
  return Json_decode.andThen((function (kind, json) {
                switch (kind) {
                  case "EmptyAbstract" : 
                      return /* EmptyAbstract */Block.variant("EmptyAbstract", 0, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                  case "EmptyInstance" : 
                      return /* EmptyInstance */Block.variant("EmptyInstance", 1, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                  case "EmptyMacro" : 
                      return /* EmptyMacro */Block.variant("EmptyMacro", 2, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                  case "EmptyMutual" : 
                      return /* EmptyMutual */Block.variant("EmptyMutual", 3, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                  case "EmptyPostulate" : 
                      return /* EmptyPostulate */Block.variant("EmptyPostulate", 4, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                  case "EmptyPrivate" : 
                      return /* EmptyPrivate */Block.variant("EmptyPrivate", 5, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                  case "InvalidCatchallPragma" : 
                      return /* InvalidCatchallPragma */Block.variant("InvalidCatchallPragma", 6, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                  case "InvalidNoPositivityCheckPragma" : 
                      return /* InvalidNoPositivityCheckPragma */Block.variant("InvalidNoPositivityCheckPragma", 7, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                  case "InvalidNoUniverseCheckPragma" : 
                      return /* InvalidNoUniverseCheckPragma */Block.variant("InvalidNoUniverseCheckPragma", 8, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                  case "InvalidTerminationCheckPragma" : 
                      return /* InvalidTerminationCheckPragma */Block.variant("InvalidTerminationCheckPragma", 9, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                  ...
                  case "PragmaNoTerminationCheck" : 
                      return /* PragmaNoTerminationCheck */Block.variant("PragmaNoTerminationCheck", 13, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                  ...
                  case "UselessAbstract" : 
                      return /* UselessAbstract */Block.variant("UselessAbstract", 17, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                  case "UselessInstance" : 
                      return /* UselessInstance */Block.variant("UselessInstance", 18, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                  case "UselessPrivate" : 
                      return /* UselessPrivate */Block.variant("UselessPrivate", 19, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                  default:
  ...
  return (function (param) {
      return Json_decode.andThen((function (kind, json) {
                    switch (kind) {
                      ...
                      case "Prop" : 
                          return /* Prop */Block.variant("Prop", 16, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                      case "PropN" : 
                      ...
                      case "Set" : 
                          return /* Set */Block.variant("Set", 15, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                      case "SetN" : 
...
function pattern(param) {
  return (function (param) {
      return Json_decode.andThen((function (kind, json) {
                    switch (kind) {
                      case "AbsurdP" : 
                          return /* AbsurdP */Block.variant("AbsurdP", 9, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                      case "AppP" : 
                      ...
                      case "EllipsisP" : 
                          return /* EllipsisP */Block.variant("EllipsisP", 15, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                      case "EqualP" : 
                          var partial_arg = expr(/* () */0);
                          var partial_arg$1 = expr(/* () */0);
                      ...
                      case "QuoteP" : 
                          return /* QuoteP */Block.variant("QuoteP", 1, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                      case "RawAppP" : 
                      ...
                      case "WildP" : 
                          return /* WildP */Block.variant("WildP", 8, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                      case "WithP" : 
  ...
  return (function (param) {
      return Json_decode.andThen((function (kind, json) {
                    switch (kind) {
                      ...
                      case "CatchallPragma" : 
                          return /* CatchallPragma */Block.variant("CatchallPragma", 22, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                      case "CompilePragma" : 
                      ...
                      case "ImpossiblePragma" : 
                          return /* ImpossiblePragma */Block.variant("ImpossiblePragma", 18, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                      ...
                      case "NoPositivityCheckPragma" : 
                          return /* NoPositivityCheckPragma */Block.variant("NoPositivityCheckPragma", 24, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                      case "NoUniverseCheckPragma" : 
                          return /* NoUniverseCheckPragma */Block.variant("NoUniverseCheckPragma", 26, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                      case "OptionsPragma" : 
...
function recordAssignment(param) {
  return Json_decode.either((function (json) {
                return /* FieldAssignment */Block.variant("FieldAssignment", 0, [Json_decode.field("Left", fieldAssignmentExpr, json)]);
              }), (function (json) {
                return /* ModuleAssignment */Block.variant("ModuleAssignment", 1, [Json_decode.field("Right", moduleAssignment, json)]);
              }));
}
                            ...
                            case "SyntaxBindingLambda" : 
                                ...
                                return /* SyntaxBindingLambda */Block.variant("SyntaxBindingLambda", 1, [
                                          ...
                                          Json_decode.at(/* :: */Block.simpleVariant("::", [
                                                  ...
                                                  ]), Type__Location$AgdaMode.$$Range[/* decode */3])(json),
                                          Json_decode.at(/* :: */Block.simpleVariant("::", [
                                                    "value",
                                                    /* :: */Block.simpleVariant("::", [
                                                        "binding",
...
function call(param) {
  return Json_decode.andThen((function (kind, json) {
                switch (kind) {
                  ...
                  case "SetRange" : 
                      return /* SetRange */Block.variant("SetRange", 27, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                  default:
                ...
                switch (kind) {
                  ...
                  case "ClashingDefinition" : 
                      return /* ClashingDefinition */Block.variant("ClashingDefinition", 7, [
                                ...
                                Json_decode.field("previouslyAt", Type__Location$AgdaMode.$$Range[/* decode */3], json)
                              ]);
...
function error(param) {
  return Json_decode.andThen((function (kind, json) {
                switch (kind) {
                  ...
                  case "PatternError" : 
                      return /* PatternError */Block.variant("PatternError", 3, [Json_decode.field("range", Type__Location$AgdaMode.$$Range[/* decode */3], json)]);
                  case "TypeError" : 
  ...
  return Json_decode.andThen((function (kind, json) {
                switch (kind) {
                  ...
                  case "UnsolvedInteractionMetas" : 
                      var partial_arg$5 = Type__Location$AgdaMode.$$Range[/* decode */3];
                  ...
                  case "UnsolvedMetaVariables" : 
                      var partial_arg$6 = Type__Location$AgdaMode.$$Range[/* decode */3];

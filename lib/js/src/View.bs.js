...
function make(handles, channels) {
  ...
  var activateInputMethod = function (activate) {
    return Channel$AgdaMode.send(activate, channels[/* activateInputMethod */0]);
  };
  var interceptAndInsertKey = function (symbol) {
    return Channel$AgdaMode.send(symbol, channels[/* interceptAndInsertKey */1]);
  };
  var onInputMethodChange = handles[/* onInputMethodChange */15];
    ...
    return Async$AgdaMode.passOk((function (param) {
                    return Event$AgdaMode.emitOk(/* () */0, onDestroy);
                        ...
                        return Channel$AgdaMode.send(/* () */0, handles[/* destroy */14]);
                            ...
                            return Channel$AgdaMode.send(false, channels[/* activateInputMethod */0]);

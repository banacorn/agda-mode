...
var Process = (function () {
    function Process(core) {
        ...
        this.info = function () {
            ...
            _this.core.panel.setContent("Info", [
        ...
        this.inferType = function (normalization, expr, goal) {
            if (goal) {
        ...
        this.moduleContents = function (normalization, expr, goal) {
            if (goal) {
        ...
        this.computeNormalForm = function (expr, goal) {
            if (goal) {
        ...
        this.computeNormalFormIgnoreAbstract = function (expr, goal) {
            if (goal) {

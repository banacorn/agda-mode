...
function make$3(param) {
  return /* record */Block.record(["contents"], [0]);
}

function send(x, self) {
  return Rebase.List[/* forEach */8]((function (handler) {
                return handler(x);
              }), self[0]);
}
...
function make$4(resolve, reject, id) {
  return /* record */Block.record([
            "resolve",
            "reject",
            "id"
...
var Listener = /* module */Block.localModule(["make"], [make$4]);
...
function removeListener(_id, _self) {
  return (delete _self[1][string_of_int(_id)]);
}

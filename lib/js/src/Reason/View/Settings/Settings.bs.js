...
function make(connectionEditorModel, connectionEditorMessage, onConnectionEditorRef, navigate, _children) {
  return /* record */Block.record([
            ...
            (function (self) {
                return Curry._1(navigate, (function (uri) {
                                ...
                                className: "agda-settings-pages"
                                    ...
                                    className: at(/* Root */0, uri, /* :: */Block.simpleVariant("::", [
                                        ...
                                        onClick: (function (param) {
                                          ...
                                          }, "Protocol"))), ReasonReact.element(undefined, undefined, Settings__Connection$AgdaMode.make(connectionEditorModel, connectionEditorMessage, onConnectionEditorRef, uri !== /* Connection */1, true, false, (function (prim) {
                                          console.log(prim);
                                          return /* () */0;

...
function make(range, $staropt$star, _children) {
  ...
  return /* record */Block.record([
            ...
            (function (_self) {
                if (abbr) {
                  return ReasonReact.element(undefined, undefined, Component__Link$AgdaMode.make(/* RangeLink */Block.variant("RangeLink", 0, [range]), true, undefined, undefined, /* array */[React.createElement("span", {

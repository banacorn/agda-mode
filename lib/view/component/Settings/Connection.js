                    ...
                    React.createElement("li", null,
                        React.createElement("h2", null,
                            React.createElement("label", { className: 'input-label' },
                                ...
                                React.createElement("input", { className: 'input-toggle', type: 'checkbox', disabled: querying, onChange: this.toggleLSPChange })))),
                    React.createElement("li", null,
                        React.createElement("h2", null,
                            React.createElement("label", { className: 'input-label' },
                        ...
                        React.createElement("div", null,
                            React.createElement("p", null,
                                React.createElement("input", { className: 'input-text native-key-bindings', type: 'text', placeholder: 'path to Agda Language Server', value: this.state.languageServerPath, disabled: querying })),
                            React.createElement("p", null,

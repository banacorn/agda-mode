...
const protocol = redux_actions_1.handleActions({
    ...
    [actions_1.PROTOCOL.ADD_RESPONSE]: (state, action) => (Object.assign({}, state, { messages: _.concat([{
                kind: 'response',
                raw: action.payload,
    ...
    [actions_1.PROTOCOL.TOGGLE_ACCUMULATE]: (state, action) => (Object.assign({}, state, { accumulate: !state.vanilla.accumulate })),

...
function add(info, self) {
  ...
  if (match !== undefined) {
    ...
    self[/* buffer */2] = /* :: */Caml_chrome_debugger.simpleVariant("::", [
        info,
        self[/* buffer */2]
      ]);
    return Async$AgdaMode.resolve(/* () */0);
    ...
    return Async$AgdaMode.thenOk((function (newItem) {
                    ...
                    newItem.insertText(Rebase.$$String.join(self[/* buffer */2]));
                    self[/* buffer */2] = /* [] */0;
                    self[/* subscriptions */3].add(newItem.onDidDestroy((function (param) {
                                return destroy(self);
                              })));
                    return Async$AgdaMode.resolve(/* () */0);
                  }))(Async$AgdaMode.fromPromise(atom.workspace.open("agda-mode://running-info", itemOptions)));
  }
}

...
function reducer(onInquireConnection, action, state) {
  if (action) {
    ...
    return /* SideEffects */Block.variant("SideEffects", 1, [(function (param) {
                  return Event$AgdaMode.emitOk(/* Connect */Block.simpleVariant("Connect", [path]), onInquireConnection);
                })]);
  } else {
    return /* SideEffects */Block.variant("SideEffects", 1, [(function (param) {
                  return Event$AgdaMode.emitOk(/* AutoSearch */0, onInquireConnection);
                })]);
  }
}
...
function make(inquireConnection, onInquireConnection, connection, error, hidden, _children) {
  return /* record */Block.record([
            ...
            (function (self) {
                Event$AgdaMode.destroyWhen(self[/* onUnmount */4], Event$AgdaMode.pipeMap(onInquireConnection, (function (x) {
                            return /* Connect */Block.simpleVariant("Connect", [x]);
                          }), self[/* state */1][/* editorModel */2][0][/* result */3]));
                ...
                return React.createElement("section", {
                            className: className
                                    ...
                                    className: "icon icon-plug"
                                          ...
                                          return Curry._1(self[/* send */3], /* Connect */Block.simpleVariant("Connect", [result]));
                                  ...
                                  }, "auto search")), error !== undefined ? ReasonReact.element(undefined, undefined, Settings__Connection__Error$AgdaMode.make(error, /* array */[])) : null);
              }),
            initialState,

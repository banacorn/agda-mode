...
function compare(param) {
  ...
  Rebase.$$Array[/* forEach */8]((function (diff) {
          ...
          var expected$prime = Rebase.$$String[/* sub */9](count[0] - 50 | 0, (50 + Rebase.$$String[/* length */1](diff.value) | 0) + 50 | 0, expected);
          var actual$prime = Rebase.$$String[/* sub */9](count[0] - 50 | 0, (50 + Rebase.$$String[/* length */1](diff.value) | 0) + 50 | 0, actual);

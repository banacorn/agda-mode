  ...
  if (typeof response === "number") {
    ...
    switch (response.tag | 0) {
      ...
      case /* SolveAll */7 :
          ...
          return $$Promise.flatMapOk(Rebase.$$Array.reduce((function (promise, solution) {
                            return $$Promise.flatMapOk(promise, (function (param) {
                                          ...
                                          if (match !== undefined) {
                                            ...
                                            return dispatch(/* Give */13, instance);
                                          } else {
                                            return $$Promise.resolved(/* Ok */Caml_chrome_debugger.variant("Ok", 0, [/* () */0]));
                                          }
                                        }));
                        ...
                        if (size === 0) {
                          return $$Promise.map(Curry._3(instance[/* view */2][/* display */3], "No solutions found", /* PlainText */0, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [""])])), (function (param) {
                                        return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [/* () */0]);
                                      }));
                        } else {
                          return $$Promise.map(Curry._3(instance[/* view */2][/* display */3], String(size) + " goals solved", /* Success */3, /* Emacs */Caml_chrome_debugger.variant("Emacs", 0, [/* PlainText */Caml_chrome_debugger.variant("PlainText", 8, [""])])), (function (param) {
                                        return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [/* () */0]);
                                      }));
                        }
                      }));
      case /* DisplayInfo */8 :
          ...
          return $$Promise.map(Curry._3(instance[/* view */2][/* display */3], match$1[0], match$1[1], match$1[2]), (function (param) {
                        return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [/* () */0]);
                      }));
      case /* RunningInfo */9 :
...
function handleCommand(command, instance) {
  var buff = function (request, instance) {
    ...
    switch (command) {
      case /* Load */0 :
          return $$Promise.flatMapOk($$Promise.mapError($$Promise.Js.toResult($$Promise.Js.fromBsPromise(instance[/* editors */1][/* source */1].save())), (function (param) {
                        ...
                        return $$Promise.flatMap($$Promise.flatMap($$Promise.flatMap(Curry._1(instance[/* view */2][/* activate */0], /* () */0), (function (param) {
      ...
      case /* Restart */2 :
          return $$Promise.flatMap(Instance__Connections$AgdaMode.disconnect(instance), (function (param) {
                        return buff(/* Load */0, instance);
                      }));
      case /* Abort */3 :
      ...
      case /* GotoDefinition */18 :
          if (instance[/* isLoaded */0]) {
            ...
            return $$Promise.flatMap(handleCommandError(dispatch(/* Load */0, instance), instance), (function (param) {
                          return handleCommand(/* GotoDefinition */18, instance);
                        }));
          }
...
function dispatch(command, instance) {
  return $$Promise.tapError($$Promise.mapOk($$Promise.flatMap($$Promise.tap($$Promise.flatMapOk($$Promise.flatMap($$Promise.tap(handleCommand(command, instance), (function (param) {
                                ...
                                return handleRequest(instance, handleResponse, param);
                              })), (function (param) {
...
function handleRequest(instance, handler, remote) {
  if (remote !== undefined) {
    var req = remote;
    ...
    $$Promise.getOk($$Promise.tapError(Instance__Connections$AgdaMode.get(instance), (function (_error) {
            ...
            if (Request$AgdaMode.isLoad(req) && connection[/* resetLogOnLoad */3]) {
              Connection$AgdaMode.resetLog(connection);
            }
            Log$AgdaMode.createEntry(req[/* request */2], connection[/* log */5]);
            var inputForAgda = Request$AgdaMode.toAgdaReadableString(req);

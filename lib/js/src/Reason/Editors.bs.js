...
function answer(x, editors) {
  return Curry._1(editors[/* query */2][/* telePromise */3][/* resolve */1], x);
}

function reject(exn, editors) {
  return Curry._1(editors[/* query */2][/* telePromise */3][/* reject */2], exn);
}
...
function answer$1(x, editors) {
  return Curry._1(editors[/* connection */3][/* telePromise */3][/* resolve */1], x);
}

function reject$1(exn, editors) {
  return Curry._1(editors[/* connection */3][/* telePromise */3][/* reject */2], exn);
}

...
var warning = /* String */Block.variant("String", 1, [(function (raw) {
        var lines = raw.split("\n");
        var partial_arg = Util$AgdaMode.Parser[/* parse */1];
        var range$1 = Rebase.Option[/* flatMap */5]((function (param) {
                return partial_arg(range, param);
              }), Rebase.$$Array[/* get */17](lines, 0));
        var body = Rebase.$$String[/* joinWith */11]("\n", Rebase.List[/* fromArray */12](lines.slice(1)));
...
var error = /* String */Block.variant("String", 1, [(function (raw) {
        var lines = raw.split("\n");
        var partial_arg = Util$AgdaMode.Parser[/* parse */1];
        var range$1 = Rebase.Option[/* flatMap */5]((function (param) {
                return partial_arg(range, param);

...
// Events
exports.OPEN = 'OPEN';
exports.CLOSE = 'CLOSE'; // deliberately closing the pane item
exports.KILL = 'KILL'; //  unintentionally destroying the pane item
class PaneItem {
                ...
                this.subscriptions.add(currentPane.onWillDestroyItem(event => {
                    if (this.paneItem && event.item.getURI() === this.getURI()) {
                        ...
                        if (this.closedDeliberately) {
                            this.emitter.emit(exports.CLOSE, paneItem);
                        }
                        else {
                            this.emitter.emit(exports.KILL, paneItem);
                        }
                        // reset flags
                        this.closedDeliberately = false;
                    }

  ...
  return /* record */Block.record([
            ...
            (function () {
                return React.createElement("li", {
                            className: "goal-or-have"
                          }, "Goal : ", ReasonReact.element(undefined, undefined, make$1(value[0], /* array */[])));
              }),
...
var Goal = /* module */Block.localModule([
    "component",
    "make"
  ], [
    component$3,
...
var component$4 = ReasonReact.statelessComponent("EmacsHave");
...
function make$4(value, _) {
  return /* record */Block.record([
            ...
            (function () {
                return React.createElement("li", {
                            className: "goal-or-have"
                          }, "Have : ", ReasonReact.element(undefined, undefined, make$1(value[0], /* array */[])));
              }),
...
var Have = /* module */Block.localModule([
    "component",
    "make"
  ], [
    component$4,
...
var component$5 = ReasonReact.statelessComponent("EmacsInteractionMeta");
...
var InteractionMeta = /* module */Block.localModule([
    "component",
    "make"
  ], [
    component$5,
...
var component$6 = ReasonReact.statelessComponent("EmacsHiddenMeta");
...
var HiddenMeta = /* module */Block.localModule([
    "component",
    "make"
  ], [
    component$6,
...
var component$7 = ReasonReact.statelessComponent("EmacsRawError");

function make$7(value, _) {
  return /* record */Block.record([
            "debugName",
            "reactClassInternal",
            "handedOffState",
            ...
            component$7[/* debugName */0],
            component$7[/* reactClassInternal */1],
            component$7[/* handedOffState */2],
            component$7[/* willReceiveProps */3],
            component$7[/* didMount */4],
            component$7[/* didUpdate */5],
            component$7[/* willUnmount */6],
            component$7[/* willUpdate */7],
            component$7[/* shouldUpdate */8],
            (function () {
            ...
            component$7[/* initialState */10],
            component$7[/* retainedProps */11],
            component$7[/* reducer */12],
            component$7[/* jsElementWrapped */13]
          ]);
}

...
function resetLog(self) {
  if (self !== undefined) {
    var conn = self;
    conn[/* log */4][/* rawText */0] = /* array */[];
    conn[/* log */4][/* sexpression */1] = /* array */[];
    conn[/* log */4][/* response */2] = /* array */[];
    return /* () */0;
  } else {
    return /* () */0;
  }
...
function disconnect(error, self) {
  ...
  self[/* log */4][/* rawText */0] = /* array */[];
  self[/* log */4][/* sexpression */1] = /* array */[];
  self[/* log */4][/* response */2] = /* array */[];
...
function wire(self) {
  ...
  var onData = function (chunk) {
    ...
    self[/* log */4][/* rawText */0].push(rawText);

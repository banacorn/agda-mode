...
var expr = /* String */Block.variant("String", 1, [(function (raw) {
        return Rebase.$$Option[/* some */11](Rebase.$$Array[/* mapi */27]((function (token, i) {
                          ...
                          if (match !== 1) {
                            ...
                            return /* QuestionMark */Block.variant("QuestionMark", 1, [Caml_format.caml_int_of_string(token.slice(1))]);
                          }
        ...
        return Rebase.$$Option[/* some */11](Rebase.$$Array[/* mapi */27]((function (token, i) {
                          ...
                          if (match !== 1) {
                            ...
                            return Rebase.$$Option[/* mapOr */18]((function (x) {
                                        ...
                                        }), /* Text */Block.variant("Text", 0, [token]), Util$AgdaMode.Parser[/* parse */1](range, token));
                          }
                        }), Rebase.$$Array[/* filterMap */23]((function (x) {
                              return x;

...
var meta = Util$AgdaMode.Parser[/* choice */4](/* array */[
      hiddenMeta,
      interactionMeta
    ]);
...
function allGoalsWarnings(title, body) {
  ...
  var metas = Util$AgdaMode.Parser[/* parseArray */2](meta, preprocessed[/* metas */0]);
  return /* record */Block.record([
            "metas",
            "warnings",
            "errors"
...
function goalTypeContext(body) {
  ...
  if (indexOfHave === -1) {
    return /* record */Block.record([
              ...
              undefined,
              Util$AgdaMode.Parser[/* parseArray */2](meta, shitpile.slice(indexOfDelimeter + 1 | 0))
            ]);
  } else {
    return /* record */Block.record([
              "goal",

...
var component$5 = ReasonReact.statelessComponent("WarningError");
                ...
                if (value.tag) {
                  return React.createElement("li", {
                              className: "warning-error"
                                ...
                                }, "error"), ReasonReact.element(undefined, undefined, Syntax__Range$AgdaMode.make(value[0], undefined, /* array */[])), React.createElement("br", undefined), ReactDOMRe.createElementVariadic("span", undefined, Rebase.$$Array[/* map */0]((function (token) {
                                        if (token.tag) {
                  ...
                  return React.createElement("li", {
                              className: "warning-error"
                                ...
                                }, "warning"), ReasonReact.element(undefined, undefined, Syntax__Range$AgdaMode.make(value[0], undefined, /* array */[])), React.createElement("br", undefined), ReactDOMRe.createElementVariadic("span", undefined, Rebase.$$Array[/* map */0]((function (token) {
                                        if (token.tag) {
                                          return ReasonReact.element(undefined, undefined, Syntax__Range$AgdaMode.make(token[0], undefined, /* array */[]));
                                        } else {
                                          return token[0];

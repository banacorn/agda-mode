...
function activate(instance) {
  return View$AgdaMode.activate(instance[/* view */2]);
}

function deactivate(instance) {
  return View$AgdaMode.deactivate(instance[/* view */2]);
}

function destroy(instance) {
  return View$AgdaMode.destroy(instance[/* view */2]);
}
...
function make(textEditor) {
  ...
  var destructor0 = Event$AgdaMode.onOk((function (path) {
            ...
            return /* () */0;
          }))(instance[/* view */2][/* onInquireConnection */8]);
